...
6.4 릴리스 이후 AEM Communities에 대한 개선 사항을 확인하십시오. 새로운 기능에 대한 자세한 내용은 [AEM 6.5 커뮤니티 사용자 안내서](https://helpx.adobe.com/kr/experience-manager/6-4/communities/user-guide.html)를 참조하십시오.
...
**@언급**
지원AEM Communities를 사용하면 등록된 사용자가 사용자 생성 컨텐츠에서 다른 등록된 멤버에 태그를 지정하여 관심을 유도할 수 있습니다. 그런 다음 태그가 지정된(멘션된) 구성원에게 해당 사용자 생성 컨텐츠에 대한 상세 링크와 정보가 제공됩니다. 그러나 사용자는 웹 및 이메일 알림을 비활성화/활성화하도록 선택할 수 있습니다.
...
커뮤니티 관리자는 등록된 사용자가 해당 구성 요소의 기능을 사용할 수 있도록 하려면 커뮤니티 구성 요소에서 **언급**&#x200B;을 활성화해야 합니다.

**그룹 메시징**

등록된 커뮤니티 회원은 그룹 구성원에게 동일한 메시지를 개별적으로 보내는 대신 단일 이메일 작성을 통해 대량으로 메시지를 그룹에게 전송할 수 있습니다. [그룹 메시징](/help/communities/configure-messaging.md)을 허용하려면 [메시징 작업 서비스](/help/communities/messaging.md#group-messaging)의 인스턴스를 모두 활성화합니다.
...
[사용자 ](/help/communities/moderation.md#custom-filters) 정의 필터 스캔을 개발하여 벌크 중재 UI에 추가할 수 있습니다.
...
AEM 6.5 Communities의 지원 기능은 ShareAble Content Object Reference Model [(SCORM) 2017.1](https://rusticisoftware.com/blog/scorm-engine-2017-released/) 엔진을 지원합니다.
