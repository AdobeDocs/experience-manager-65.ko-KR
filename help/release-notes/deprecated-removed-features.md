...
| Assets | `AssetDownloadServlet` 는 게시 인스턴스에 대해 기본적으로 비활성화되어 있습니다. 자세한 내용은 [AEM 보안 검사 목록](/help/sites-administering/security-checklist.md). | 다음에 설명된 구성 [AEM Security 검사 목록](/help/sites-administering/security-checklist.md). |  |
