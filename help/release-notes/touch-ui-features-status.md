...
버전 6.0부터 AEM에는 와(과) 정렬되는 &quot;터치 지원 UI&quot;(&quot;Touch UI&quot;라고 함)라는 새 사용자 인터페이스가 도입되었습니다. [!DNL Adobe Experience Cloud] 전체 Adobe 사용자 인터페이스 지침을 참조하십시오. 거의 기능 패리티에 도달함에 따라 &quot;클래식 UI&quot;라고 하는 레거시 데스크탑 지향 인터페이스를 사용하는 AEM의 표준 UI가 되었습니다.
