...
* [Experience Manager 6.5.25.0에 포함된 OSGi 번들 목록](/help/release-notes/assets/65250-bundles.txt)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Experience Manager 6.5.25.0에 포함된 콘텐츠 패키지 목록](/help/release-notes/assets/65250-packages.txt)
<!-- UPDATE FOR EACH NEW RELEASE -->
