...
* 이제 [!DNL Dynamic Media Classic] 데스크톱 응용 프로그램을 사용하지 않고 [!DNL Dynamic Media]을(를) 사용하여 게시 설정을 구성할 수 있습니다. [Dynamic Media 게시 설정 구성](/help/assets/dm-publish-settings.md)을 참조하십시오.
...
* `ActivationModel`을(를) 워크플로우로 사용하는 사용자 지정 런처가 포함된 [!DNL Experience Manager] 설정에서 PDF 파일을 업로드할 때 메모리 문제로 인해 Experience Manager이 충돌합니다. (CQ-4330512).
