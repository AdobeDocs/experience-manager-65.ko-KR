...
* 지원 대상 [automated forms conversion 서비스의 Adobe Sign 텍스트 태그](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html?lang=ko).
