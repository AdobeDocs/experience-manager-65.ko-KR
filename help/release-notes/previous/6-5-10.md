...
* **Camera Raw 지원**: [!DNL Adobe Camera Raw] v10.4를 지원하는 새 [!DNL Camera Raw] 패키지를 사용할 수 있습니다. [다음을 사용하여 이미지 처리 [!DNL Camera Raw]](/help/assets/camera-raw.md)를 참조하세요.
...
* 사용자 지정 서블릿 필터 번들에 의해 링크가 수정되는 경우 웹 페이지가 렌더링되지 않습니다. (NPR-36857) <!-- Note updated as per CQDOC-19203, April 07, 2022 -->
