...
[!DNL Adobe Experience Manager] 6.5.1.0은(는) 2019년 4월 *에 [!DNL Adobe Experience Manager] 6.5의 공식 출시 이후에 발표된 성능, 안정성, 보안 및 주요 고객 수정 사항과 개선 사항을 포함하는 중요한 릴리스입니다.* [!DNL Experience Manager] 6.5의 맨 위에 설치할 수 있습니다.
...
* 변환 미리 보기는 [!DNL Experience Manager] 6.5로 업그레이드한 후 `Only empty tenantId is currently supported` 오류를 생성합니다. NPR-29986: CQ-4272353용 핫픽스
...
* [!DNL Experience Manager] 경험 조각을 [!DNL Adobe Target]으로 내보냅니다. CQ-4265469용 핫픽스
...
* [!DNL Experience Manager] Author /content/dam/mac 폴더에서 [!DNL Brand Portal]&#x200B;(으)로 [!DNL Experience Manager Assets] 게시가 작동하지 않습니다. NPR-29819: CQ-4271118용 핫픽스
...
[!DNL Experience Manager Forms] 6.5.1.0의 주요 특징:
...
* [!DNL Experience Manager] 6.5에서 응용 Forms에 대한 확인 단계가 복원되었습니다. CQ-4269583용 핫픽스
...
* [!DNL Experience Manager Forms] 6.5 CCR UI(Create Correspondence UI)에서 [!DNL Experience Manager Forms] 6.3으로 작성된 서신을 열지 못합니다. CQ-4266392용 핫픽스
...
Experience Manager 6.5.1.0용 UberJar를 [Maven 중앙 저장소](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.1/)에서 사용할 수 있습니다.
...
* [!DNL Experience Manager] 경험 조각을 [!DNL Adobe Target]으로 내보냅니다. 자세한 내용은 [경험 구성요소 링크 재작성기 공급자 - HTML](https://experienceleague.adobe.com/docs/experience-manager-65/developing/extending-aem/experience-fragments.html?lang=ko#the-experience-fragment-link-rewriter-provider-html)을 참조하십시오. CQ-4265469용 핫픽스

### Forms - 문서 서비스 - 포함

* OSGi 전용: 출력 및 Forms 서비스에 새 속성 PAGECOUNT가 추가되었습니다. NPR-28922: CQ-4270870용 핫픽스
...
다음 텍스트 문서에는 [!DNL Experience Manager] 6.5.1.0에 포함된 OSGi 번들 및 콘텐츠 패키지가 나열되어 있습니다.

[!DNL Experience Manager] 6.5.1.0에 포함된 OSGi 번들 목록

[파일 가져오기](/help/release-notes/assets/6_5-bundle-list.txt)

[!DNL Experience Manager] 6.5.1.0에 포함된 콘텐츠 패키지 목록
