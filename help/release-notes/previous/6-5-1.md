...
[!DNL Adobe Experience Manager] 6.5.1.0은(는) 2019년 4월 [!DNL Adobe Experience Manager]에 *6.5의 공식 출시 이후에 발표된 성능, 안정성, 보안 및 주요 고객 수정 사항과 개선 사항을 포함하는 중요한 릴리스입니다.*[!DNL Experience Manager] 6.5의 맨 위에 설치할 수 있습니다.
...
* [!DNL Experience Manager Assets] Author /content/dam/mac 폴더에서 [!DNL Experience Manager]&#x200B;(으)로 [!DNL Brand Portal] 게시가 작동하지 않습니다. NPR-29819: CQ-4271118용 핫픽스
