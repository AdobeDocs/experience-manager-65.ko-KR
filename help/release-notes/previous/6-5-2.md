...
[!DNL Adobe Experience Manager] 6.5.2.0은(는) **2019년 4월**&#x200B;에 [!DNL Adobe Experience Manager] 6.5의 공식 출시 이후에 발표된 성능, 안정성, 보안 및 주요 고객 수정 사항과 개선 사항을 포함하는 중요한 릴리스입니다. [!DNL Experience Manager] 6.5의 맨 위에 설치할 수 있습니다.
...
* [!DNL Experience Manager] 기본 메일 보낸 사람이 TLS v1.2를 통해 원격 SMTP 서버로 메일을 보낼 수 없습니다. NPR-30476: GRANITE-26605용 핫픽스
