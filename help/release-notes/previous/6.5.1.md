...
* 커뮤니티용 사용자 로그인 시 최대 40~50초의 높은 응답 시간이 관찰됩니다. NPR-29677: CQ-4269444용 핫픽스
...
* HSM(하드웨어 보안 모듈)을 사용한 디지털 서명이 JEE Linux 및 지원되는 모든 앱 서버(예: JBoss 및 Websphere)에서 작동하지 않습니다. NPR-29839: CQ-4266721용 핫픽스
