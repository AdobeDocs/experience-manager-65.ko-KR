...
* [구성 브라우저 설명서](https://experienceleague.adobe.com/docs/experience-manager-65/administering/introduction/configurations.html?lang=ko#using-configuration-browser)에 설명된 대로 _이름이 저장소의 노드 이름이 됩니다_. 단, 구성 브라우저에서는 구성 제목 이 CRXDE Lite의 경로에 사용되며 구성 이름은 무시됩니다. (NPR-40607)
