...
* Experience Manager Dynamic Media 하이브리드 모드의 IE 11에서 회전 편집기 가 열리지 않습니다(CQ-4255590). **Dynamic Media Adobe - 하이브리드 모드 고객의 경우:** Adobe은 2022년 5월 이후 Dynamic Media - 하이브리드 모드에서 Internet Explorer 11에 대한 지원을 종료합니다.
...
### 구성 [!DNL Experience Manager Assets] 포함 [!DNL Brand Portal] (6.5.4.0) {#configure-assets-bp}
