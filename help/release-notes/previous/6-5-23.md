...
* **FORMS-23881**: 6.5.23.0 전체 설치 관리자를 사용하여 설정된 AEM Forms JEE 배포에서 호출에서 사용자 지정 XCI 파일이 제공되면 출력 서비스에서 요청을 처리하지 못합니다. 이 문제를 해결하려면 6.5.24.0소프트웨어 배포[&#x200B; 포털에서 최신 AEM &#x200B;](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html) Forms 서비스 팩을 설치하십시오.
