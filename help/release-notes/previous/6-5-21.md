...
* AEM 6.5에서 알림에 따라 [2022년 9월](https://experienceleague.adobe.com/ko/docs/discontinued/using/search-promote)에 종료되는 Adobe Search&amp;Promote의 코드 및 종속성을 제거합니다. (NPR-41855)
