...
* automated forms conversion 서비스의 [Adobe Sign 텍스트 태그](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html?lang=ko-KR)를 지원합니다.

* [!DNL Automated Forms Conversion service]을(를) 사용하여 [컬러 양식을 적응형 양식으로 변환](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html?lang=ko-KR)할 수 있도록 지원합니다.
...
보안 업데이트에 대한 자세한 내용은 [보안 게시판 Experience Manager](https://helpx.adobe.com/security/products/experience-manager.html)을 참조하세요.
