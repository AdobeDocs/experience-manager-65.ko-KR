...
* AEM 6.5.7.0 Forms에서 AEM 6.5.10.0 Forms으로 업그레이드한 후 PDF 생성기 서비스를 사용하는 동안 Office 문서와 관련된 문제입니다(NPR-37758).
...
* 멀티스레드 PDF 생성기 서비스가 AEM 6.5.7.0 Forms에 대해 임의의 시간 이후 교착 상태에 빠집니다(NPR-38053).
