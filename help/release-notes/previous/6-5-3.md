...
* AXIS 1.4 jar에서 보안 취약성 2012-5784 및 2014-3596을 발견했으며 [AXIS1.4.1 jar](https://helpx.adobe.com/kr/aem-forms/quick-fixes/6-5/jee-patch-0014.html)과(와) 함께 제공된 수정 사항입니다(NPR-31015).
...
Experience Manager 6.5.3.0용 UberJar는 [Maven 중앙 저장소](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.3/)에서 사용할 수 있습니다.
