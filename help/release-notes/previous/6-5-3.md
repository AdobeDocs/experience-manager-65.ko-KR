...
* 이제 [!DNL Dynamic Media]에서 스마트 자르기 비디오 자산을 지원합니다. 스마트 자르기는 장면의 초점을 따라 프레임을 이동하면서 비디오를 다시 자르도록 하는 머신 러닝 기반의 기능입니다. 다음을 참조하십시오 [비디오 프로필에서 스마트 자르기 사용 정보](/help/assets/video-profiles.md).

* [!DNL Dynamic Media] 는 스마트 이미징을 지원합니다. [스마트 이미징](/help/assets/imaging-faq.md)을 참조하십시오.
