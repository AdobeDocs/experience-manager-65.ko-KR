...
* 에서 관리자 사용자의 기본 암호를 변경하는 경우 `admin`, 을 수행하는 동안 `Prepare Adobe Experience Manager Server For DSC deployment` AEM Forms JEE 서비스 팩이 실패하는지 확인합니다. (NPR-40062) 및 (NPR-39387)
