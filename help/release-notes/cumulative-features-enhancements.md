...
[Dynamic Media 스냅숏](https://experienceleague.adobe.com/ko/docs/experience-manager-learn/assets/dynamic-media/images/dynamic-media-snapshot)을 참조하세요.
...
* **[Experience Manager Forms과 정부용 Adobe Acrobat Sign에 대한 지원이 추가되었습니다](/help/forms/using/adobe-sign-integration-adaptive-forms.md)** - 이제 AEM Forms을 정부용 Adobe Acrobat Sign과 통합(FedRAMP 규격)합니다. 이 통합은 공공기관 관련 계정(정부 부서 및 기관)에 대한 적응형 양식 제출과 함께 전자 서명의 고급 규정 준수 및 보안을 제공합니다. Adobe Acrobat Sign for Government와의 통합을 통해 Adobe 파트너 및 정부 고객은 적응형 Forms에서 전자 서명을 사용하여 가장 미션 크리티컬하고 민감한 비즈니스 라인 중 일부를 수행할 수 있습니다. 이 보안 계층이 추가되면 Adobe의 공공기관 고객들이 안심할 수 있도록 모든 전자 서명은 FedRAMP Moderate 규정을 완전히 준수해야 합니다.
