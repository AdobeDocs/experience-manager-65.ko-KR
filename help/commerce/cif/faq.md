...
## &#x200B;1. CIF GraphQL은 상업용으로만 사용됩니까, 아니면 AEMs JCR에서 작성된 콘텐츠를 쿼리하는 데 사용됩니까?
...
## &#x200B;2. Adobe Commerce 관리자를 통해 AEM에서 제품 에셋(이미지)을 저장하고 참조할 수 있습니까? Dynamic Media의 자산을 어떻게 사용할 수 있습니까?
...
## &#x200B;3. 상거래 솔루션이 배포되는 위치가 중요합니까? (On-prem 또는 클라우드에서)
...
## &#x200B;4. AEM에서 카탈로그 페이지 또는 제품 페이지는 어떻게 만들어집니까? AEM에서 어떻게 지속됩니까?

카탈로그 페이지 및 제품 페이지는 일반 카탈로그 및 제품 페이지 템플릿을 기반으로 AEM에서 동적으로 생성되고 캐시됩니다. 제품 또는 카탈로그 데이터는 AEM에 가져와서 저장되지 않습니다.

## &#x200B;5. 상거래 솔루션에서 제품 데이터를 업데이트할 때 AEM에 실시간으로 푸시됩니까? 아니면 배치 프로세스입니까?
...
## &#x200B;8. 또한 Dispatcher을 통해 가격 및 기타 데이터를 캐시합니까? 캐시 무효화 문제가 자주 발생합니까?
...
Adobe는 Dispatcher에 캐시된 페이지에 대해 TTL 기반의 캐시 무효화를 설정할 것을 권장합니다. 가격이나 주식과 같은 동적 정보의 경우, Adobe에서는 클라이언트측에서 날짜를 렌더링하는 것이 좋습니다. TTL 기반 캐시 무효화에 대한 자세한 내용은 [AEM Dispatcher](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17458.html)를 참조하십시오.

## &#x200B;10. Commerce을 사용하는 AEM 콘텐츠 전반에서 통합 검색에 대한 권장 사항이 있습니까?

제품 검색 참조 구현이 제공되지만 콘텐츠가 포함된 통합 검색은 제공되지 않습니다. 이 기능은 고객별로 다르며 프로젝트별 수준에서 더 잘 해결됩니다.

## &#x200B;11. CIF을 사용하여 AEM 및 상거래에서 검색은 어떻게 작동합니까?
...
## &#x200B;12. MSM이나 번역에서 제품 데이터를 사용하는 방법은 무엇입니까?
...
## &#x200B;13. 상업용 텍스트로 제품 데이터를 향상시킬 수 있는 방법이 있습니까? 그렇다면 어디에서 합니까? AEM 또는 상거래 솔루션일까요?
