...
이러한 프로젝트들은 상거래 솔루션 통합의 복잡성에 대처해야 합니다. 상거래 솔루션은 Adobe 상거래와 같은 상업 솔루션에서 사용자 지정 상거래 서비스 세트에 이르기까지 어떤 것이든 될 수 있습니다. 통합은 사용 사례 및 에코시스템에 크게 의존합니다. 보통 다양한 장소에 접촉하고 많은 다른 맛으로 나옵니다.
...
[AEM 코어 구성 요소](https://www.aemcomponents.dev/), [AEM Venia 참조 storefront](https://github.com/adobe/aem-cif-guides-venia), [AEM Project Archetype](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html) 및 PWA(헤드리스 컨텐츠 및 상거래)에 대한 통합 패턴을 사용하여 프로젝트 개발을 가속화합니다.
