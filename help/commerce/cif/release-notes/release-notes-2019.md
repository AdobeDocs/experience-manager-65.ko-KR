...
* 카테고리/제품 선택기가 다중 저장소 설정에서 지정된 Adobe Commerce 저장소 보기를 준수하도록 개선되었습니다.
...
* GraphQL 쿼리 사용자 지정을 간소화했습니다. 이렇게 하면 개발자가 적은 코드로 CIF 코어 구성 요소를 사용자 지정할 수 있습니다.
...
* 모든 작성자에게 친숙한 CIF 핵심 구성 요소가 지원되도록 개선되었습니다 [AEM 스타일 시스템](https://helpx.adobe.com/experience-manager/6-5/sites/authoring/using/style-system.html). 제품 목록 구성 요소에 대한 예제 스타일이 제공되었습니다.
...
* React 기반 클라이언트측 체크아웃 및 GraphQL을 사용하여 전체 기본 쇼핑 여정을 지원합니다.
...
* 여러 AEM 사이트 구조에서 CIF 코어 구성 요소를 사용할 수 있고 기본 GraphQL 클라이언트 구현에서 다른 Adobe Commerce 스토어/저장소 보기에 연결할 수 있는 다중 저장소/사이트 기능입니다.
...
* Adobe Commerce 스토어 구성을 OSGi에서 AEM 제품 콘솔로 이동하여 통합 설정을 보다 작성자가 친숙한 형식으로 만듭니다.
...
* 제품 속성과 관련된 Adobe Commerce 2.3.2 지원 및 버그 수정이 제품 콘솔에 표시됩니다.
