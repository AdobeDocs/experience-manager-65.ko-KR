...
Adobe에서는 통합 레이어에 [Adobe I/O Runtime](https://developer.adobe.com/apis/experienceplatform/runtime.html)을(를) 사용하는 것이 좋습니다. 서드파티용 CIF 추가 기능에 포함되어 있습니다. 마이크로서비스와 유사한 접근 방식으로 작동하므로 쉽게 여러 솔루션을 통합하는 것이 적합합니다.
