...
![eommercproductvariables](/help/sites-administering/assets/ecommerceproductvariants.png)
...
* [정기적인 동기화는 변경 사항](/help/commerce/cif-classic/developing/sap-commerce-cloud.md#product-synchronization-and-publishing)의 데이터 피드와 함께 사용됩니다.
...
* [프록시 페이지](#proxy-pages)의 사용을 고려합니다.
...
![eomerce_nairobirstis 녹색](/help/sites-administering/assets/ecommerce_nairobirunnersgreen.png)
