...
1. 지정:
   ...
   * **가져오기**
      ...
      특정 세그먼트의 가져오기 [전자 상거래 업체](/help/commerce/cif-classic/administering/concepts.md#commerce-providers)기본적으로 `Geometrixx`.
...
1. 지정:
   ...
   * **상거래 공급자**
      ...
      사용자의 가져오기 [전자 상거래 업체](/help/commerce/cif-classic/administering/concepts.md#commerce-providers); 기본 Geometrixx.
...
1. 마법사가 열립니다. 를 사용하십시오 **기본** 및 **제품 탭** 을 입력합니다. [제품 속성](/help/commerce/cif-classic/administering/concepts.md#product-attributes) 새 제품 또는 제품 변형에 대해 설명합니다.
...
>
>즉, 기본적으로 [dispatcher](https://experienceleague.adobe.com/docs/experience-manager-dispatcher/using/configuring/dispatcher-configuration.html?lang=ko-KR), 필요에 따라 구성합니다.
...
1. 다음 [제품 속성](/help/commerce/cif-classic/administering/concepts.md#product-attributes) 이 표시됩니다. 사용 **편집** 및 **완료** 을 눌러 변경합니다.
...
1. 추가할 자산을 선택합니다.
   ...
   >[!NOTE]
   >
   >선택할 수 있는 자산은 다음과 같습니다 [자산](/help/assets/assets.md).
...
>[!NOTE]
>
>읽기 [AEM의 이벤트 처리](https://blogs.adobe.com/experiencedelivers/experience-management/event_handling_incq/).
...
1. 다음으로 전환 [미리 보기](/help/sites-authoring/editing-content.md#previewingpagestouchoptimizedui) 모드.
...
>[!NOTE]
>
>카탈로그에서 [제품 데이터](#products-and-product-variants).
...
1. 대화 상자가 열립니다. 탭/클릭 **완료** 프로세스가 완료되면
...
>[!NOTE]
>
>다음 예에서는 [campaign](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md): 바우처에 사용됩니다.
>
...
1. 마법사가 열립니다. 를 사용하십시오 **기본**, **컨텐츠**, **결제** 및 **이행** 탭을 입력하여 [새 주문에 대한 정보](/help/commerce/cif-classic/administering/concepts.md#order-information).
...
1. 다음 [주문 정보](/help/commerce/cif-classic/administering/concepts.md#order-information) 이 표시됩니다. 사용 **편집** 및 **완료** 을 눌러 변경합니다.
