...
변환이 올바르게 수행되려면 관리자가 별도로 [FFmpeg를 설치](/help/sites-administering/config-video.md#install-ffmpeg)해야 합니다. 이러한 기능은 [비디오 프로필 구성](/help/sites-administering/config-video.md#configure-video-profiles) html5 요소에 사용할 수 있습니다.
