...
>[!NOTE]
>
>AEM 6.5에서 [oak-run.jar는 MongoMK 또는 RDBMK 리포지토리에서 재색인화를 위해 지원되는 유일한 메서드](/help/sites-deploying/indexing-via-the-oak-run-jar.md#reindexingapproachdecisiontree)입니다.
