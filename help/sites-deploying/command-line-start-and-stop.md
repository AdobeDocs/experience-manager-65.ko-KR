...
`start` 스크립트는 *the &lt;cq-installation>/bin* 디렉토리에서 사용할 수 있습니다. Unix 버전과 Windows 버전이 모두 제공됩니다. 스크립트는 *&lt;cq-installation>* 디렉터리에 설치된 인스턴스를 시작합니다.
...
<table>
 <tbody>
  ...
  <tr>
   <td>CQ_INTERFACE</td>
   <td>이 서버가<br />을(를) 수신해야 하는 인터페이스 </td>
  </tr>
  <tr>
   <td>CQ_RUNMODE</td>
...
>[!CAUTION]
>
>작성자 및 게시 중 일부 실행 모드는 AEM을 처음 시작하기 전에 설정해야 하며 이후 변경할 수 없습니다. 프로덕션에서 사용할 AEM 인스턴스를 설정하기 전에 자세한 내용은 [실행 모드 설명서](/help/sites-deploying/configure-runmodes.md)를 참조하십시오.
...
>[!NOTE]
>
>시작 스크립트는 *the &lt;cq-installation>/app* 폴더 아래에 설치된 AEM Quickstart를 실행합니다.
...
* jar 파일을 두 번 클릭하여 AEM을 시작한 경우 시작 창에서 **On** 단추를 클릭합니다. 그러면 이 단추는 **Off**&#x200B;로 변경되며 서버를 종료합니다.

   ![chlimage_1-63](assets/chlimage_1-63.png)

## 명령줄 {#stopping-adobe-experience-manager-from-the-command-line}에서 Adobe Experience Manager 중지

`stop` 스크립트는 *the &lt;cq-installation>/bin* 디렉토리에서 사용할 수 있습니다. Unix 버전과 Windows 버전이 모두 제공됩니다. 스크립트는 *&lt;cq-installation>* 디렉터리에 설치된 실행 중인 인스턴스를 중지합니다.
