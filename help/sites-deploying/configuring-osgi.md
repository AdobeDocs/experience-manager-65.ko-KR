...
>[!NOTE]
>
>읽기 전용 [특정 인스턴스에 대해서만 저장소 기반 구성을 정의하는 방법](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17500.html).
...
1. 이 폴더 아래에 노드를 만듭니다.
   ...
   * 이름: 영구 ID(PID);
     ...
     예를 들어 AEM WCM 버전 관리자의 경우 `com.day.cq.wcm.core.impl.VersionManagerImpl`
