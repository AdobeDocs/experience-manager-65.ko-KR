...
>[!NOTE]
>
>Adobe은 Adobe Managed Services을 사용하여 Azure 또는 Amazon Web Services(AWS)에 AEM을 배포하는 옵션을 선택할 것을 권장합니다. 고객은 이러한 클라우드 컴퓨팅 환경에서 AEM을 배포하고 운영할 수 있는 경험과 기술을 갖춘 팀의 도움을 받을 수 있습니다. Adobe Managed Services에 대한 [추가 설명서](https://business.adobe.com/kr/products/experience-manager/managed-services.html?aemClk=t)를 참조하세요.
>
