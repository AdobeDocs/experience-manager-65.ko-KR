...
1. **로깅 로거**&#x200B;은 이 메시지를 가져와서 사용자의 사양에 따라 형식을 지정합니다.
1. **로깅 작성자**&#x200B;는 이러한 모든 메시지를 사용자가 정의한 실제 파일에 기록합니다.
...
첫 번째는 `request.log` 파일과 `access.log` 파일을 모두 제어하는 특수 경우입니다.
...
(org.apache.sling.commons.log.LogManager.factory.config.649d51b7-6425-45c9-81e6-2697a03d6be7)
   ...
   * 서비스 `org.apache.pdfbox`에 대해 `Warning` 메시지를 기록합니다.`../logs/error.log`

* 특정 작성기에 링크하지 않으므로 기본 구성(일별 로그 회전)으로 암시적 작성기를 만들고 사용합니다.

### 고유한 로거 및 작성자 만들기 {#creating-your-own-loggers-and-writers}

로거/작성기 쌍을 정의할 수 있습니다.

1. Factory 구성 [Apache Sling Logging Logger 구성](/help/sites-deploying/osgi-configuration-settings.md)의 새 인스턴스를 만듭니다.
