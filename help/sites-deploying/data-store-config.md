...
>
> 1. AEM 인스턴스를 중지합니다.
> 2. `crx-quickstart/install/org.apache.jackrabbit.oak.segment.SegmentNodeStoreService.config` 파일에 `blobTrackSnapshotIntervalInSecs=L"0"` 매개 변수를 추가합니다. 이 매개 변수에는 Oak 1.12.0, 1.10.2 이상이 필요합니다.
