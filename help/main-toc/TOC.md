...
+ Sites {#sites}
   + 작성 {#authoring}
      ...
      + AEM 및 Adobe Campaign {#aem-adobe-campaign}
         + [Adobe Campaign 작업](/help/sites-authoring/adobe-campaign.md)
   ...
   + 관리 {#administering}
      ...
      + Sites 기능 {#introduction}
         + [웹 사이트 관리](/help/sites-administering/msm-and-translation.md)
      ...
      + 개인 맞춤화 {#personalization}
         ...
         + [캠페인](/help/sites-administering/campaigns.md)
      ...
      + 통합 {#integration}
         ...
         + [관련 커뮤니티 문서](/help/sites-administering/related-community-articles.md)
         + [Adobe Campaign Standard와 통합](/help/sites-administering/campaignstandard.md)
         + [Flash 뷰어 서비스 종료 알림](/help/sites-administering/flash-viewers-eol.md)
      ...
      + 우수 사례 {#bestpractices}
         ...
         + [AEM Foundation에 대한 GDPR 요청 처리](https://experienceleague.adobe.com/docs/experience-manager-65/content/sites/administering/security/handling-gdpr-requests-for-aem-platform.html)
...
+ Assets {#assets}
   ...
   + Experience Manager Assets 사용 {#using}
      ...
      + [사용 [!DNL Adobe Stock] 자산의 자산](/help/assets/aem-assets-adobe-stock.md)
      ...
      + [연결된 자산 [!DNL Sites]](/help/assets/use-assets-across-connected-assets-instances.md)
   + Dynamic Media{#dynamic}
      + [뉴스레터 Experience League 아카이브](/help/assets/dynamic-media-newsletter.md)
   ...
   + 자산 확장 {#extending}
      + [사용자 지정 및 확장 [!DNL Assets]](/help/assets/extending-assets.md)
      + [미디어 핸들러 및 워크플로우를 사용하여 에셋 처리](/help/assets/media-handlers.md)
      + [검색 기능 확장](/help/assets/searchx.md)
      + [설치 및 구성 [!DNL ImageMagick] 로 작업하기 [!DNL Assets]](/help/assets/best-practices-for-imagemagick.md)
      ...
      + [에서 콘텐츠 조각 지원 [!DNL Assets] HTTP API](/help/assets/assets-api-content-fragments.md)
   ...
   + 자산 관리 {#administer}
      ...
      + [자산 크기 조정 안내서](/help/assets/assets-sizing-guide.md)
      ...
      + [Adobe 에셋 링크 구성](/help/assets/configure-asset-link.md)
      + [Adobe InDesign용 FPO 렌디션 생성](/help/assets/configure-fpo-renditions.md)
      + [자산 파일 형식 우수 사례](/help/assets/assets-file-format-best-practices.md)
   ...
   + Brand Portal {#brandportal}
      ...
      + [폴더 게시 위치 [!DNL Brand Portal]](/help/assets/brand-portal-publish-folder.md)
      + [컬렉션 게시 위치 [!DNL Brand Portal]](/help/assets/brand-portal-publish-collection.md)
   ...
   + 자산 관리 {#managing}
      ...
      + [자산 통찰력](/help/assets/asset-insights.md)
...
+ 양식 {#forms}
   ...
   + AEM Forms 설치 및 구성 {#install-aem-forms}
      ...
      + OSGi에 AEM Forms 설치 {#osgi-installation}
         + [OSGi에서 AEM Forms에 대해 지원되는 플랫폼](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/deploying/introduction/technical-requirements.html)
         ...
         + [automated forms conversion 서비스 설치 및 구성](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html)
   ...
   + AEM Forms 관리 {#manage-administer-aem-forms}
      ...
      + AEM Forms 환경 강화 {#hardening-aem-forms-environment}
         + [OSGi 환경에서 AEM Forms 강화 및 보안](/help/forms/using/hardening-securing-aem-forms-environment.md)
   ...
   + 적응형 Forms - 기본 작성 {#adaptive-forms-basic-authoring}
      ...
      + [AEM sites 페이지에 적응형 양식 또는 대화형 통신 포함](/help/forms/using/embed-adaptive-form-aem-sites.md)
   ...
   + 워크플로 {#workflows}
      ...
      + [OSGi 및 AEM Forms JEE 워크플로우에서 양식 중심 AEM 워크플로우의 작업 및 기능](/help/forms/using/capabilities-osgi-jee-workflows.md)
      + [AEM Workflow에서 문서 서비스 API 시작](/help/forms/using/initiating-document-services-apis-aem.md)
   ...
   + AEM Forms 작업 공간 {#use-aem-forms-workspace}
      ...
      + [HTML 작업 영역에서 적응형 양식 사용](/help/forms/using/using-adaptive-form-html-workspace.md)
   ...
   + HTML5 양식 {#html5-forms}
      + [HTML 5 양식 소개](/help/forms/using/introduction.md)
      + [HTML 5 양식 시작하기](/help/forms/using/get-started.md)
      + [HTML5 양식의 건축](/help/forms/using/html5-forms-architecture.md)
      + [HTML 5 양식과 PDF forms 간의 차별화된 기능](/help/forms/using/feature-differentiation-html5-forms-pdf-forms.md)
      + [HTML5 양식에 대한 FAQ](/help/forms/using/faq.md)
      + [HTML5 양식용 양식 템플릿 디자인](/help/forms/using/designing-form-template.md)
      + [HTML 5 양식 우수 사례](/help/forms/using/best-practices-for-html5-forms.md)
      + [액세스 가능한 HTML 5 양식 디자인](/help/forms/using/design-accessible-html5-forms.md)
      + [XDP 양식의 HTML5 미리 보기 생성](/help/forms/using/preview-xdp-forms-html.md)
      ...
      + [HTML5 forms 서비스 프록시](/help/forms/using/service-proxy.md)
      + [HTML 5 양식 최적화](/help/forms/using/optimize-html5-forms.md)
      + [HTML 5 양식용 화면 판독기](/help/forms/using/screen-readers.md)
      + [HTML5 양식에 대한 사용자 지정 프로필 만들기](/help/forms/using/custom-profile.md)
      + [HTML 5 양식의 오른쪽에서 왼쪽 언어](/help/forms/using/right-left-languages.md)
      + [Form Bridge와 HTML 5 Forms용 사용자 정의 포털 통합](/help/forms/using/integrate-form-bridge-forms-portal.md)
      + [HTML5 양식에서 사용자 정의 표시 만들기](/help/forms/using/custom-widgets.md)
      + [HTML5 양식의 기본 스타일 변경](/help/forms/using/changing-default-styles.md)
      + [HTML5 양식에 대한 그림 절 지원](/help/forms/using/picture-clause-support.md)
      + [HTML5 양식에서 액세스 가능한 복잡한 표 만들기](/help/forms/using/accessible-tables.md)
      + [HTML5 양식용 CSS 스타일 만들기](/help/forms/using/css-styles.md)
      + [HTML5 양식에 대한 오류 메시지 사용자 지정](/help/forms/using/customzing-errors-html5-forms.md)
      + [HTML5 양식을 초안으로 저장](/help/forms/using/saving-html5-form-draft.md)
      + [HTML 5 양식에 대한 로깅 활성화](/help/forms/using/enable-logs.md)
   ...
   + 편지 및 서신 {#letters-correspondences}
      ...
      + [텍스트 편집기 사용자 지정](/help/forms/using/customize-text-editor.md)
   ...
   + 문서 서비스 {#use-document-services}
      + [AEM Document Services 개요](/help/forms/using/overview-aem-document-services.md)
      ...
      + [프로그래밍 방식으로 AEM Document Services 사용](/help/forms/using/aem-document-services-programmatically.md)
   ...
   + 문서 보안 {#use-document-security}
      ...
      + [다른 사용자를 대신하여 문서 Protect](/help/forms/using/protect-document-on-behalf-of-another-user.md)
   ...
   + 개발자 참조 {#developer-reference}
      ...
      + [HTML 5 양식용 Form Bridge API](/help/forms/using/form-bridge-apis.md)
      ...
      + JEE의 AEM Forms을 사용한 프로그래밍 {#programming-aem-forms-jee}
         ...
         + Java API 빠른 시작 - 코드 예 {#java-api-quick-start-code-examples}
            ...
            + [Application Manager 서비스 JavaAPI 빠른 시작(SOAP)](/help/forms/developing/application-manager-service-java-api.md)
            ...
            + [바코드 Forms 서비스 Java APIuick 시작(SOAP)](/help/forms/developing/barcoded-forms-service-java-api.md)
            + [구성 요소 및 서비스 Java API빠른 시작(SOAP)](/help/forms/developing/components-services-java-api-quick.md)
            + [PDF 서비스 Java API 빠른 시작(SOAP) 변환](/help/forms/developing/convert-pdf-service-java-api.md)
            ...
            + [PDF 서비스 Java API 빠른 시작(SOAP) 생성](/help/forms/developing/generate-pdf-service-java-api.md)
         ...
         + API를 사용하여 서비스 작업 수행 {#performing-service-operations-using-apis}
            ...
            + [PDF Portfolio 어셈블](/help/forms/developing/assembling-pdf-portfolios.md)
            ...
            + [문서의 PDF/A 호환 여부 확인](/help/forms/developing/determining-whether-documents-pdf-a.md)
            ...
            + [PDF을 Postscript 및 이미지 파일로 변환](/help/forms/developing/converting-pdf-postscript-image-files.md)
...
+ 구현 {#implementing}
   + 개발 {#developing}
      ...
      + 플랫폼 {#platform}
         ...
         + [이름 지정 규칙](/help/sites-developing/naming-conventions.md)
      ...
      + 헤드리스 경험 관리 {#headless}
         ...
         + 헤드리스 여정 {#journeys}
            + Headless 개발자 여정 {#developer}
               + [AEM의 Headless 이해](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/overview.html)
               + [CMS Headless 개발에 대해 알아보기](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/learn-about.html)
               + [AEM Headless as a Cloud Service 시작하기](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/getting-started.html)
               + [AEM Headless를 사용한 첫 번째 경험으로의 경로](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/path-to-first-experience.html)
               + [콘텐츠를 AEM 콘텐츠 모델로 모델링하는 방법](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/model-your-content.html)
               + [AEM 게재 API를 통해 콘텐츠에 액세스하는 방법](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/access-your-content.html)
               + [AEM Assets API를 통해 콘텐츠를 업데이트하는 방법](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/update-your-content.html)
               + [결합 방법](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/put-it-all-together.html)
               + [Headless 애플리케이션 실행 방법](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/go-live.html)
               + [선택 사항 - AEM으로 단일 페이지 애플리케이션을 만드는 방법](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/create-spa.html)
            + Headless 콘텐츠 설계 여정 {#architect}
               + [AEM Headless 콘텐츠 설계 여정 개요](https://experienceleague.adobe.com/docs/experience-manager-65/headless/architect/overview.html)
               + [AEM을 통한 헤드리스용 콘텐츠 모델링 - 소개](https://experienceleague.adobe.com/docs/experience-manager-65/headless/architect/introduction.html)
               + [AEM을 통한 Headless용 콘텐츠 모델링 기본 사항 알아보기](https://experienceleague.adobe.com/docs/experience-manager-65/headless/architect/basics.html)
               + [AEM에서 컨텐츠 조각 모델을 만드는 방법에 대해 알아봅니다.](https://experienceleague.adobe.com/docs/experience-manager-65/headless/architect/model-structure.html)
         ...
         + 배달 API{#delivery-api}
            ...
            + [콘텐츠 조각 GraphQL API](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/headless/delivery-api/graphql-api-content-fragments.html)
            + [GraphQL 엔드포인트 관리](/help/sites-developing/headless/graphql-api/graphql-endpoint.md)
            + [GraphiQL IDE 사용](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/headless/delivery-api/graphiql-ide.html)
            + [지속 쿼리](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/headless/delivery-api/persisted-queries.html)
            ...
            + [콘텐츠 조각의 원격 AEM GraphQL 구문 인증](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/headless/delivery-api/graphql-authentication-content-fragments.html)
            + [콘텐츠 조각이 있는 AEM GraphQL API - 샘플 콘텐츠 및 구문](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/headless/delivery-api/content-fragments-graphql-samples.html)
      + 하이브리드 및 SPA AEM 개발 {#spas}
         ...
         + [SPA용 동적 모델과 구성 요소 간 매핑](/help/sites-developing/spa-dynamic-model-to-component-mapping.md)
      ...
      + 개발 도구 {#devtools}
         ...
         + [CRXDE Lite을 사용한 개발](/help/sites-developing/developing-with-crxde-lite.md)
   ...
   + 배포 {#deploying}
      ...
      + AEM 플랫폼 소개 {#introduction}
         ...
         + [AEM 6.5의 저장소 요소](/help/sites-deploying/storage-elements-in-aem-6.md)
      ...
      + AEM 배포 {#deploying}
         ...
         + [Oak-run Jar를 통한 인덱싱](/help/sites-deploying/indexing-via-the-oak-run-jar.md)
