...
+ Forms {#forms}
   ...
   + JEE의 AEM Forms에 대한 관리자 도움말 {#administrator-help}
      ...
      + 문서 보안 작업 {#work-with-document-security}
         ...
         + [문서 보안을 위해 외부 브라우저에서 확장 인증 구성](/help/forms/using/admin-help/configure-external-browser-authentication-document-security.md)
      ...
      + 헤드리스 환경 관리 {#headless}
         ...
         + Headless 여정 {#journeys}
            + Headless 개발자 여정 {#developer}
               ...
               + [옵션 - AEM을 통해 단일 페이지 애플리케이션을 제작하는 방법](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/create-spa.html)
         ...
         + 배달 API{#delivery-api}
            ...
            + [콘텐츠 조각의 원격 AEM GraphQL 쿼리 인증](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/extending/graphql-authentication-content-fragments.html)
