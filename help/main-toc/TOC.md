...
+ 보안 {#security}
   ...
   + [보안 체크리스트](/help/sites-administering/security-checklist.md)
   + [OWASP 상위 10개](/help/sites-administering/owasp-top10.md)
   ...
   + [폐쇄형 사용자 그룹 생성](/help/sites-administering/cug.md)
   + [AEM에서 직렬화 문제 완화](/help/sites-administering/mitigating-serialization-issues.md)
   + [사용자 동기화](/help/sites-administering/sync.md)
   + [캡슐화된 토큰 지원](/help/sites-administering/encapsulated-token.md)
   ...
   + [SSL(기본값)](/help/sites-administering/ssl-by-default.md)
   ...
   + [콘텐츠 배치 필터](/help/sites-administering/content-disposition-filter.md)
   + [AEM 6.5의 사용자 정의 사용자 그룹 매핑](/help/sites-administering/cug-mapping.md)
   + [동일 사이트 쿠키 지원](/help/sites-administering/same-site-cookie-support.md)
   ...
   + [AEM에 대한 IMS 통합 설정](/help/sites-administering/setting-up-ims-integrations-for-aem.md)
...
+ Sites {#sites}
   + 작성 {#authoring}
      + AEM 작성을 위한 필수 작업, 도구 및 개념 {#essentials}
         ...
         + [페이지 작성에 대한 빠른 안내](/help/sites-authoring/qg-page-authoring.md)
      ...
      + 작성 {#authoring}
         ...
         + [서식 있는 텍스트 편집기를 사용한 콘텐츠 작성](/help/sites-authoring/rich-text-editor.md)
      ...
      + 사이트 및 페이지 기능 {#siteandpage}
         ...
         + [콘텐츠 인사이트](/help/sites-authoring/content-insights.md)
         + [액세스 가능한 콘텐츠 만들기(WCAG 2.1 준수)](/help/sites-authoring/creating-accessible-content.md)
      ...
      + 개인화 {#personalization}
         ...
         + [세분화 이해](/help/sites-authoring/segmentation-overview.md)
   ...
   + 관리 {#administering}
      ...
      + 작업 {#operations}
         ...
         + [데이터 저장소 가비지 수집](/help/sites-administering/data-store-garbage-collection.md)
         ...
         + [서식 있는 텍스트 편집기 구성](/help/sites-administering/rich-text-editor.md)
         + [RTE를 구성하여 액세스 가능한 사이트 만들기](/help/sites-administering/rte-accessible-content.md)
         + [페이지 편집을 위한 실행 취소 구성](/help/sites-administering/config-undo.md)
         + [서식 있는 텍스트 편집기 플러그인 구성](/help/sites-administering/configure-rich-text-editor-plug-ins.md)
         + [비디오 구성 요소 구성](/help/sites-administering/config-video.md)
         + [대량 편집기](/help/sites-administering/bulk-editor.md)
         ...
         + [AEM과 함께 cURL 사용](/help/sites-administering/curl.md)
         + [프록시 서버 도구(proxy.jar)](/help/sites-administering/proxy-jar.md)
         + [AEM 앱 구성](/help/sites-administering/config-apps.md)
      ...
      + 통합 {#integration}
         ...
         + [DHTML 뷰어 지원 중단 FAQ](/help/sites-administering/dhtml-viewer-endoflifefaqs.md)
         ...
         + [Adobe Dynamic Tag Management와 통합](/help/sites-administering/dtm.md)
         + [Adobe Analytics 및 Adobe Target 선택](/help/sites-administering/opt-in.md)
         + [AEM 포털 및 포트릿](/help/sites-administering/aem-as-portal.md)
         + [Dynamic Media Classic(Scene7)과 통합](/help/sites-administering/scene7.md)
...
+ 자산 {#assets}
   ...
   + Dynamic Media{#dynamic}
      ...
      + [Dynamic Media - Scene7 모드 구성](/help/assets/config-dms7.md)
   ...
   + 자산 관리 {#administer}
      ...
      + [자산 크기 조정 가이드](/help/assets/assets-sizing-guide.md)
      + [자산 번역 모범 사례](/help/assets/best-practices-for-translating-assets-efficiently.md)
      + [[!DNL Assets] 성능 조정 안내서](/help/assets/performance-tuning-guidelines.md)
   ...
   + 자산 관리 {#managing}
      ...
      + [자산 번역 준비](/help/assets/preparing-assets-for-translation.md)
      + [Experience Manager에서 자산 다운로드](/help/assets/download-assets-from-aem.md)
      + [Lightbox](/help/assets/light-box.md)
      + [자산 인사이트](/help/assets/asset-insights.md)
      + [DTM을 통해 자산 인사이트 활성화](/help/assets/use-dtm-for-asset-insights.md)
      + [자산 인사이트 구성](/help/assets/configure-asset-insights.md)
      + [자산 체크인 및 체크아웃](/help/assets/check-out-and-submit-assets.md)
      + [폴더에 번역 클라우드 서비스 적용](/help/assets/transition-cloud-services.md)
      + [웹 페이지에 페이지 추적기 및 임베드 코드 사용](/help/assets/use-page-tracker.md)
      + [조합 자산 관리](/help/assets/managing-linked-subassets.md)
      + [관련 자산](/help/assets/related-assets.md)
...
+ Forms {#forms}
   ...
   + 시작하기 {#getting-started}
      ...
      + 튜토리얼: 첫 번째 적응형 양식 만들기 {#create-first-adaptive-form}
         ...
         + [튜토리얼: 양식 데이터 모델 만들기](/help/forms/using/create-form-data-model.md)
         + [튜토리얼: 적응형 양식 필드에 규칙 적용 l](/help/forms/using/apply-rules-to-adaptive-form-fields.md)
         + [튜토리얼: 적응형 양식 스타일 지정](/help/forms/using/style-your-adaptive-form.md)
         + [튜토리얼: 적응형 양식 게시](/help/forms/using/publish-your-adaptive-form.md)
      + 튜토리얼: 첫 번째 인터랙티브 커뮤니케이션 만들기 {#create-first-interactive-communication}
         + [튜토리얼: 첫 번째 인터랙티브 커뮤니케이션 만들기](/help/forms/using/create-your-first-interactive-communication.md)
         + [튜토리얼: 인터랙티브 커뮤니케이션 계획](/help/forms/using/planning-interactive-communications.md)
         + [튜토리얼: 양식 데이터 모델 만들기](/help/forms/using/create-form-data-model0.md)
         + [튜토리얼: 문서 조각 만들기](/help/forms/using/create-document-fragments.md)
         + [튜토리얼: 템플릿 만들기](/help/forms/using/create-templates-print-web.md)
         + [튜토리얼: 인터랙티브 커뮤니케이션 만들기](/help/forms/using/create-interactive-communication0.md)
      + AEM Forms 참조 자료 {#aem-forms-reference-collaterals}
         ...
         + [We.Gov 및 We.Finance 참조 사이트 둘러보기](/help/forms/using/forms-gov-reference-site-user-demo.md)
         + [직원 채용 참조 사이트 둘러보기](/help/forms/using/employee-recruitment-reference-site.md)
         + [We.Finance 자동차 보험 갱신 참조 사이트](/help/forms/using/finance-auto-insurance-renewal-reference-site-walkthrough.md)
         + [We.Gov 참조 사이트 FOIA 둘러보기](/help/forms/using/gov-reference-site-foia-walkthrough.md)
         + [적응형 양식 조각 참조](/help/forms/using/reference-adaptive-form-fragments.md)
         + [참조 테마](/help/forms/using/reference-themes.md)
         + [추천서 템플릿](/help/forms/using/reference-cm-layout-templates.md)
         + [We.Finance 참조 사이트의 주택 담보 대출 워크플로를 위한 Microsoft Dynamics 365 구성](/help/forms/using/ms-dynamics-configuration-home-mortgage.md)
   + AEM Forms 설치 및 구성 {#install-aem-forms}
      ...
      + JEE에 AEM Forms 설치 {#jee-installation}
         ...
         + [JBoss 턴키를 사용하여 JEE에서 AEM Forms 설치 및 배포](https://www.adobe.com/go/learn_aemforms_installTurnkey_65)
         + [AEM Forms Document Security 서버 설치 및 구성](/help/forms/using/installing-and-configuring-the-document-security-server.md)
         + [AEM Forms(단일 서버) 설치 준비](https://www.adobe.com/go/learn_aemforms_prepareInstallsingle_65)
         + [JBoss용 JEE에서 Adobe Experience Manager Forms 설치 및 배포](https://www.adobe.com/go/learn_aemforms_installJBoss_65)
         + [WebSphere용 JEE에서 Adobe Experience Manager Forms 설치 및 배포](https://www.adobe.com/go/learn_aemforms_installWebSphere_65)
         + [WebLogic용 JEE에서 AEM Forms 설치 및 배포](https://www.adobe.com/go/learn_aemforms_installWebLogic_65)
         ...
         + [WebSphere 클러스터의 JEE에서 Adobe Experience Manager Forms 구성](https://www.adobe.com/go/learn_aemforms_clusterWebSphere_65)
         + [WebLogic 클러스터의 JEE에서 Adobe Experience Manager Forms 구성](https://www.adobe.com/go/learn_aemforms_clusterWebLogic_65)
   ...
   + AEM Forms 업그레이드 {#upgrade-aem-forms}
      ...
      + OSGi에서 AEM Forms 업그레이드 {#aem-forms-osgi-upgrade}
         + [OSGi에서 AEM 6.5 Forms로 업그레이드](/help/forms/using/upgrade-forms-osgi.md)
      ...
      + JEE에서 AEM Forms 업그레이드 {#aem-forms-jee-upgrade}
         + [AEM Forms 업그레이드 준비](https://www.adobe.com/go/learn_aemforms_prepareupgrade_65)
         + [JEE 업그레이드 체크리스트 및 계획 수립에 대한 Adobe Experience Manager Forms](https://www.adobe.com/go/learn_aemforms_upgrade_checklist_65)
         + [JEE에서 AEM 6.5로 업그레이드](/help/forms/using/upgrade-forms-jee.md)
         + [JBoss용 JEE에서 Adobe Experience Manager Forms로 업그레이드](https://www.adobe.com/go/learn_aemforms_upgradeJBoss_65)
         + [JBoss 턴키용 JEE에서 AEM Forms로 업그레이드](https://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
         + [WebSphere용 JEE에서 Adobe Experience Manager Forms로 업그레이드](https://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65)
         + [WebLogic용 JEE에서 Adobe Experience Manager Forms로 업그레이드](https://www.adobe.com/go/learn_aemforms_upgradeWebLogic_65)
   ...
   + 적응형 양식 - 핵심 구성 요소 {#adaptive-forms-core-components}
   ...
   + 적응형 양식 - 기본 작성 {#adaptive-forms-basic-authoring}
      ...
      + [적응형 양식 조각](/help/forms/using/adaptive-form-fragments.md)
      ...
      + [적응형 양식의 테이블](/help/forms/using/adaptive-forms-tables.md)
      ...
      + [접근성 높은 적응형 양식 만들기](/help/forms/using/creating-accessible-adaptive-forms.md)
      + [반복 가능한 섹션으로 양식 만들기](/help/forms/using/creating-forms-repeatable-sections.md)
      + [AEM Sites 페이지에 적응형 양식 또는 인터랙티브 커뮤니케이션 임베드](/help/forms/using/embed-adaptive-form-aem-sites.md)
   ...
   + 적응형 양식 - 고급 작성 {#adaptive-forms-advanced-authoring}
      ...
      + [적응형 양식에서 양식 데이터 모델 서비스 호출을 위한 API](/help/forms/using/invoke-form-data-model-services.md)
      + [적응형 양식의 비동기 제출](/help/forms/using/asynchronous-submissions-adaptive-forms.md)
      + [적응형 양식 집합을 사용하여 적응형 양식 만들기](/help/forms/using/create-adaptive-form-using-adaptive-form-set.md)
      + [적응형 양식 템플릿](/help/forms/using/template-editor.md)
      + [적응형 양식 표현식](/help/forms/using/adaptive-form-expressions.md)
      + [적응형 양식의 기록 문서 생성](/help/forms/using/generate-document-of-record-for-non-xfa-based-adaptive-forms.md)
   ...
   + 대화형 통신 {#interactive-communications}
      + [인터랙티브 커뮤니케이션 작성 UI 소개](/help/forms/using/introduction-interactive-communication-authoring.md)
      + [인터랙티브 커뮤니케이션 만들기](/help/forms/using/create-interactive-communication.md)
      + [인터랙티브 커뮤니케이션에서 차트 사용](/help/forms/using/chart-component-interactive-communications.md)
      ...
      + [에이전트 UI를 사용하여 인터랙티브 커뮤니케이션 준비 및 전송](/help/forms/using/prepare-send-interactive-communication.md)
      + [인쇄 채널 및 웹 채널](/help/forms/using/web-channel-print-channel.md)
      + [인터랙티브 커뮤니케이션 구성 속성](/help/forms/using/interactive-communication-configuration-properties.md)
      + [다양한 인터랙티브 커뮤니케이션 생성](/help/forms/using/generate-multiple-interactive-communication-using-batch-api.md)
      + [레이아웃 모드를 사용하여 구성 요소 크기 변경](/help/forms/using/resize-using-layout-mode-interactive-communication.md)
   + 워크플로 {#workflows}
      + [OSGi의 Forms 중심 워크플로](/help/forms/using/aem-forms-workflow.md)
      + [OSGi의 Forms 중심 워크플로 - 단계 참조](/help/forms/using/aem-forms-workflow-step-reference.md)
   ...
   + AEM Forms Workspace {#use-aem-forms-workspace}
      + [AEM Forms Workspace 소개](/help/forms/using/introduction-html-workspace.md)
      + [AEM Forms Workspace 작업](/help/forms/using/html-workspace-overview.md)
      + [AEM Forms Workspace 아키텍처](/help/forms/using/html-workspace-architecture.md)
      + [Flex Workspace에서 사용할 수 없는 AEM Forms Workspace 기능](/help/forms/using/features-html-workspace-available-flex.md)
      + [AEM Forms Workspace에서 사용할 수 없는 Flex Workspace 기능](/help/forms/using/features-flex-workspace-available-html.md)
      ...
      + [AEM Forms Workspace 사용자 인터페이스 로케일 변경](/help/forms/using/changing-locale-user-interface.md)
      + [로그인 화면 만들기](/help/forms/using/creating-new-login-screen.md)
      + [오류 대화 상자 사용자 정의](/help/forms/using/customizing-error-dialogs.md)
      + [작업 탭 사용자 정의](/help/forms/using/customizing-tabs-task.md)
      ...
      + [작업 동작 사용자 정의](/help/forms/using/customizing-task-actions.md)
      + [ToDo 목록에 추가 데이터 표시](/help/forms/using/display-additional-data-in-todo-list.md)
      + [요약 URL에서 작업 변수 가져오기](/help/forms/using/getting-task-variables-summary-url.md)
      + [경로 작업에 사용되는 이미지 사용자 정의](/help/forms/using/images-route-actions.md)
      + [JavaScript 파일 축소](/help/forms/using/minification-javascript-files.md)
      + [추적 테이블 사용자 정의](/help/forms/using/sorting-tracking-tables-add-columns.md)
      + [설명서 링크 업데이트](/help/forms/using/updating-link-help-documentation.md)
      + [AEM Forms Workspace에서 양식 집합 작업](/help/forms/using/form-sets-html-workspace.md)
      + [AEM Forms Workspace에서 사용되는 API](/help/forms/using/apis-used-html-workspace.md)
      + [AEM Forms Workspace에서 기존 프로세스 데이터로 새 프로세스 시작](/help/forms/using/initiating-new-process-existing-process.md)
      + [단일 서버에 두 개의 AEM Forms Workspace 인스턴스 호스팅](/help/forms/using/two-html-workspace-instances-one.md)
      + [인터페이스의 색상 구성표 변경](/help/forms/using/changing-color-scheme-interface.md)
      + [인터페이스 글꼴 변경](/help/forms/using/changing-font-interface.md)
      + [브랜딩을 위한 조직 로고 변경](/help/forms/using/changing-organization-logo-branding.md)
      ...
      + [AEM Forms Workspace 시작](/help/forms/using/getting-started-livecycle-html-workspace.md)
      + [관리자 보기를 사용하여 조직 계층에서 작업 관리](/help/forms/using/tasks-organizational-hierarchy-using-manager.md)
      + [프로세스 시작](/help/forms/using/starting-processes.md)
      + [프로세스 추적](/help/forms/using/tracking-processes.md)
      + [Single Sign On 및 시간 초과 핸들러](/help/forms/using/single-sign-timeout-handlers.md)
      + [HTML Workspace에서 적응형 양식 사용](/help/forms/using/using-adaptive-form-html-workspace.md)
      + [AEM Forms Workspace를 Microsoft Office SharePoint Server와 통합](/help/forms/using/integrating-aem-forms-workspace-with-microsoft-office-sharepoint-server.md)
      + [할 일 목록 작업](/help/forms/using/todo-lists.md)
      + [AEM Forms Workspace에 대한 문제 해결 지침](/help/forms/using/troubleshooting-guidelines-html-workspace.md)
   + AEM Forms 앱 {#aem-forms-app}
      ...
      + [iOS를 위한 안전한 AEM Forms 앱 빌드](/help/forms/using/building-secure-mobile-workspace-app.md)
      ...
      + [일반 설정 업데이트](/help/forms/using/update-general-settings.md)
   ...
   + 편지와 서신 {#letters-correspondences}
      ...
      + [인터랙티브 커뮤니케이션 및 편지의 인라인 조건 및 반복](/help/forms/using/cm-inline-condition.md)
      + [문서 조각](/help/forms/using/lists.md)
      + [서신 관리 구성 속성](/help/forms/using/cm-configuration-properties.md)
   + AEM Forms를 Experience Cloud 솔루션과 통합 {#integrate-aem-forms-with-experience-cloud-solutions}
      + [AEM Forms에서 타기팅된 경험 만들기](/help/forms/using/experience-targeting-forms.md)
      + [양식의 효과와 전환 측정 및 향상](/help/forms/using/measure-improve-performance-forms-documents.md)
      + [Cloud Service Framework를 사용한 분석](/help/forms/using/configure-analytics-forms-documents.md)
      + [Adobe 론치를 사용한 Analytics](/help/forms/using/integrate-aem-forms-with-adobe-analytics.md)
   ...
   + AEM Forms 게시 및 처리 {#publish-process-aem-forms}
      ...
      + [게시된 양식 액세스 및 채우기](/help/forms/using/accessing-filling-published-forms.md)
      + [이메일을 통해 양식 제출 확인서 보내기](/help/forms/using/form-submission-receipt-via-email.md)
      ...
      + [이메일 알림에 메타데이터 사용](/help/forms/using/use-metadata-in-email-notifications.md)
   + Forms 포털 {#use-forms-portal}
      ...
      + [Forms 포털에서 제출된 양식을 처리하는 API](/help/forms/using/report-submitted-data-forms.md)
      + [초안 및 제출 구성 요소를 위한 사용자 정의 스토리지](/help/forms/using/adding-custom-storage-provider-forms.md)
   ...
   + AEM Forms 사용자 정의 {#customize-aem-forms}
      ...
      + [양식 목록 작성자 항목에 사용자 정의 작업 추가](/help/forms/using/add-custom-action-form-lister.md)
      + [적응형 양식의 오류 메시지 레이아웃 및 위치 지정 사용자 정의](/help/forms/using/customize-layout-positioning-error-messages-adaptive-form.md)
      + [사용자 정의 도구 모음 작업 만들기](/help/forms/using/creating-custom-toolbar-action.md)
      + [양식 이벤트 추적 사용자 정의](/help/forms/using/customizing-form-event-tracking.md)
      + [적응형 양식 필드에 대한 사용자 정의 모양 만들기](/help/forms/using/custom-appearance-widget-adaptive-form.md)
      + [초안 및 제출 데이터 서비스 사용자 정의](/help/forms/using/custom-draft-submission-data-services.md)
      + [드롭다운 목록을 동적으로 채우기](/help/forms/using/dynamically-populate-dropdowns.md)
      + [적응형 양식에 대한 사용자 정의 제출 작업 작성](/help/forms/using/custom-submit-action-form.md)
      + [사용자 정의 도구 모음 레이아웃 만들기](/help/forms/using/creating-custom-toolbar-layout.md)
      + [사용된 템플릿을 기반으로 구성 요소 표시](/help/forms/using/displaying-components-based-on-template.md)
      + [사용자 정의 적응형 양식 테마 만들기](/help/forms/using/creating-custom-adaptive-form-themes.md)
   + 트랜잭션 보고서 {#transaction-reports}
      + [트랜잭션 보고 개요](/help/forms/using/transaction-reports-overview-jee-osgi.md)
      + OSGi의 AEM Forms에 대한 트랜잭션 보고서 {#transaction-reports-osgi}
      ...
      + JEE의 AEM Forms에 대한 트랜잭션 보고서 {#transaction-reports-jee}
         ...
         + [사용자 정의 구성 요소 API에 대한 트랜잭션 기록](/help/forms/using/record-transaction-custom-component-jee.md)
   + JEE의 AEM Forms에 대한 관리자 도움말 {#administrator-help}
      + 시작하기 {#get-started}
         ...
         + [배포를 위한 라이선스 유형 업데이트](/help/forms/using/admin-help/update-license-type-deployment.md)
      + 도메인 설정 및 관리 {#setup-manage-domains}
         ...
         + [인증 제공자 구성](/help/forms/using/admin-help/configuring-authentication-providers.md)
      ...
      + 사용자 관리 구성 {#configure-user-management}
         + [인증 평가 순서 변경](/help/forms/using/admin-help/change-order-evaluation-authentication.md)
      ...
      + 사용자 설정 및 구성 {#setup-organize-users}
         ...
         + [사용자 적시 프로비저닝](/help/forms/using/admin-help/just-in-time-user-provisioning.md)
      ...
      + 엔드포인트 관리 {#manage-endpoints}
         + [엔드포인트 추가, 활성화, 수정 또는 제거](/help/forms/using/admin-help/adding-enabling-modifying-or-removing.md)
         ...
         + [Remoting 엔드포인트 구성](/help/forms/using/admin-help/configuring-remoting-endpoints.md)
         + [감시 폴더 엔드포인트 구성](/help/forms/using/admin-help/configuring-watched-folder-endpoints.md)
         + [작업 관리자 엔드포인트 구성](/help/forms/using/admin-help/configuring-task-manager-endpoints.md)
         + [엔드포인트 유형](/help/forms/using/admin-help/types-endpoints.md)
      + Acrobat Reader DC 확장 프로그램 구성 {#configure-acrobat-reader-dc-extensions}
         + [Acrobat Reader DC 확장 프로그램에서 사용하는 인증서 유형](/help/forms/using/admin-help/certificate-types-used-acrobat-reader.md)
         + [PDF 문서에서 유효한 인증서와 만료된 인증서 인식](/help/forms/using/admin-help/recognizing-valid-expired-certificates-pdf.md)
         + [데이터 캡처를 위한 Acrobat Reader DC 확장 프로그램 구성](/help/forms/using/admin-help/configuring-acrobat-reader-dc-extensions.md)
         + [자격 증명 사용 정보 검토](/help/forms/using/admin-help/review-credential-information.md)
         + [Acrobat Reader DC 확장 프로그램에서 사용할 자격 증명 구성](/help/forms/using/admin-help/configuring-credentials-acrobat-reader-dc.md)
         + [PDF 파일의 사용 권한 검토](/help/forms/using/admin-help/review-usage-rights-pdf-file.md)
         + [Adobe Reader 웹 브라우저 플러그인에서 온라인 주석 달기 활성화](/help/forms/using/admin-help/enabling-online-commenting-reader-web.md)
         + [Acrobat Reader DC 확장 프로그램에서 사용할 시간 초과 값 설정](/help/forms/using/admin-help/setting-timeout-values-acrobat-reader.md)
         + [만료된 Reader 확장 프로그램 서비스 인증서 업데이트](/help/forms/using/admin-help/updating-expired-reader-extension-certificates.md)
      + PDF Generator 작업 {#work-with-pdf-generator}
         + [PDF Generator 사용 소개](/help/forms/using/admin-help/overview-5.md)
      ...
      + SSL 구성 {#configure-ssl}
         ...
         + [JBoss Application Server에 대한 SSL 구성](/help/forms/using/admin-help/configuring-ssl-jboss-application-server.md)
         + [Windows Vista에서 SSL 구성](/help/forms/using/admin-help/configuring-ssl-windows-vista.md)
         + [WebSphere Application Server에 대한 SSL 구성](/help/forms/using/admin-help/configuring-ssl-websphere-application-server.md)
      + 문서 보안 작업 {#work-with-document-security}
         + [문서 보안 정보](/help/forms/using/admin-help/document-security.md)
         + [대용량 보안 정보 전송](/help/forms/using/admin-help/high-volume-secure-information-delivery.md)
         ...
         + [정책으로 보호된 문서에 대한 액세스 권한 제어](/help/forms/using/admin-help/controlling-access-policy-protected-documents.md)
         ...
         + [정책 세트 만들기 및 관리](/help/forms/using/admin-help/creating-policy-sets.md)
      ...
      + 양식 구성 {#configure-forms}
         ...
         + [임베드할 글꼴 지정](/help/forms/using/admin-help/specifying-fonts-embed.md)
      ...
      + 출력 구성 {#configure-output}
         ...
         + [임베드할 글꼴 지정](/help/forms/using/admin-help/specify-fonts-embed.md)
      ...
      + Forms Workflow 구성{#configure-forms-workflow}
         ...
         + [Forms Workflow 개요](/help/forms/using/admin-help/overview-9.md)
         + [부재중 설정 구성](/help/forms/using/admin-help/configuring-out-office-settings.md)
         ...
         + [중단된 작업 및 분기 처리](/help/forms/using/admin-help/stalled-operations-branches.md)
         + [공유 대기열 구성](/help/forms/using/admin-help/configuring-shared-queues.md)
         + [작업 처리](/help/forms/using/admin-help/tasks.md)
      ...
      + 상태 모니터 {#health-monitor}
         ...
         + [상태 모니터 성능 세부 조정](/help/forms/using/admin-help/fine-tuning-health-monitor-performance.md)
      ...
      + AEM Forms 데이터베이스 유지 관리 {#maintain-aem-forms-database}
         ...
         + [IBM DB2 데이터베이스: 정기적 유지 관리를 위한 명령 실행](/help/forms/using/admin-help/ibm-db2-database-running-commands.md)
      ...
      + 애플리케이션 서버 유지 관리 {#manage-application-server}
         + [애플리케이션 서버 웹 사이트](/help/forms/using/admin-help/application-server-websites.md)
         + [전역 문서 스토리지 디렉터리](/help/forms/using/admin-help/global-document-storage-directory.md)
         + [AdministrationConsole을 실행할 때의 고려 사항](/help/forms/using/admin-help/considerations-running-administration-console.md)
      ...
      + AEM Forms 백업 및 복구 {#aem-forms-backup-recovery}
         ...
         + [AEM Forms에 대한 백업 및 복구 전략](/help/forms/using/admin-help/backup-recovery-strategy-aem-forms.md)
         + [PDF Generator 백업 제한 사항](/help/forms/using/admin-help/pdf-generator-backup-limitations.md)
         + [감시 폴더에 대한 백업 전략](/help/forms/using/admin-help/backup-strategies-watched-folders.md)
         + [AEM Forms 데이터 복구](/help/forms/using/admin-help/recovering-aem-forms-data.md)
         + [EMC Documentum용 커넥터 사용자를 위한 백업 전략](/help/forms/using/admin-help/backup-strategy-connector-emc-documentum.md)
         + [클러스터링된 환경에서의 백업 및 복원 전략](/help/forms/using/admin-help/strategy-backup-restore-clustered-environment.md)
   ...
   + 프로세스 보고 {#process-reporting}
      ...
      + [프로세스 보고의 미리 정의된 보고서](/help/forms/using/process-reporting/pre-defined-reports-in-process-reporting.md)
      + [프로세스 보고의 사용자 정의 보고서](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
   ...
   + 개발자 참조 {#developer-reference}
      ...
      + [워크벤치 도움말](https://www.adobe.com/go/learn_aemforms_workbench_65)
      + JEE에서 AEM Forms를 사용한 프로그래밍 {#programming-aem-forms-jee}
         ...
         + Java API 빠른 시작 - 코드 예시 {#java-api-quick-start-code-examples}
            + [애플리케이션 관리자 클라이언트 Java API 빠른 시작(SOAP)](/help/forms/developing/application-manager-client-java-api.md)
            + [애플리케이션 관리자 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/application-manager-service-java-api.md)
            ...
            + [문서 관리 서비스(더 이상 사용되지 않음) Java API 빠른 시작(SOAP)](/help/forms/developing/document-management-service-deprecated-java.md)
            + [문서 보안 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/document-security-service-java-api.md)
            + [암호화 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/encryption-service-java-api-quick.md)
            + [엔드포인트 레지스트리 Java API 빠른 시작(SOAP)](/help/forms/developing/endpoint-registry-java-api-quick.md)
            + [양식 데이터 통합 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/form-data-integration-service-java.md)
            + [양식 서비스 API 빠른 시작](/help/forms/developing/forms-service-api-quick-starts.md)
            ...
            + [사용자 관리자 Java API 빠른 시작(SOAP)](/help/forms/developing/user-manager-java-api-quick.md)
            + [XMP 유틸리티 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/xmp-utilities-service-java-api.md)
         + API를 사용하여 JEE에서 AEM Forms 호출 {#invoking-aem-forms-jee-apis}
            ...
            + [Remoting을 사용하여 AEM Forms 호출](/help/forms/developing/invoking-aem-forms-using-remoting.md)
            ...
            + [HTTP 토큰을 사용하여 SSO 인증을 수행하는 Flash Builder 애플리케이션 만들기](/help/forms/developing/creating-flash-builder-applications-perform.md)
         + API를 사용하여 서비스 작업 수행 {#performing-service-operations-using-apis}
            ...
            + [Forms 서비스 성능 최적화](/help/forms/developing/optimizing-performance-forms-service.md)
            + [Forms 서비스에 문서 전달](/help/forms/developing/passing-documents-forms-service.md)
            + [유동 레이아웃으로 양식 미리 채우기](/help/forms/developing/prepopulating-forms-flowable-layouts.md)
            + [조각 기반 양식 렌더링](/help/forms/developing/rendering-forms-based-fragments.md)
            + [값으로 양식 렌더링](/help/forms/developing/rendering-forms-value.md)
            + [HTML로 양식 렌더링](/help/forms/developing/rendering-forms-html.md)
            + [클라이언트에서 양식 렌더링](/help/forms/developing/rendering-forms-client.md)
            + [사용자 정의 CSS 파일을 사용하여 HTML 양식 렌더링](/help/forms/developing/rendering-html-forms-using-custom.md)
            + [CustomToolbars를 사용하여 HTML 양식 렌더링](/help/forms/developing/rendering-html-forms-custom-toolbars.md)
            + [대화형 PDF 양식 렌더링](/help/forms/developing/rendering-interactive-pdf-forms.md)
            + [렌더링 권한이 활성화된 양식](/help/forms/developing/rendering-rights-enabled-forms.md)
            + [DDX 문서의 유효성 검사](/help/forms/developing/validating-ddx-documents.md)
            + [PDF를 PostScript 및 이미지 파일로 변환](/help/forms/developing/converting-pdf-postscript-image-files.md)
            + [PostScript를 PDF 문서로 변환](/help/forms/developing/converting-postscript-pdf-documents.md)
            + [문서 출력 스트림 만들기](/help/forms/developing/creating-document-output-streams.md)
            + [문서 디지털 서명 및 인증](/help/forms/developing/digitally-signing-certifying-documents.md)
            + [PDF 문서 암호화 및 암호 해독](/help/forms/developing/encrypting-decrypting-pdf-documents.md)
            ...
            + [바코드 양식 작업](/help/forms/developing/barcoded-forms.md)
            + [자격 증명 작업](/help/forms/developing/credentials.md)
            ...
            + [백업을 위한 AEM Forms 준비](/help/forms/developing/preparing-aem-forms-backup.md)
            + [프로그래밍 방식으로 엔드포인트 관리](/help/forms/developing/programmatically-endpoints.md)
            + [프로그래밍 방식으로 환경 설정 노드 관리](/help/forms/developing/programmatically-preferences-nodes.md)
            + [정책을 사용하여 문서 보호](/help/forms/developing/protecting-documents-policies.md)
            + [웹 서비스 API를 사용하여 DDX 문서의 유효성 검사](/help/forms/developing/validate-ddx-document-using-web.md)
   + 문제 해결 {#troubleshooting}
      + [특정 버전의 Oracle JDK에서는 일부 양식 기능을 사용할 수 없음](/help/forms/using/unable-to-use-forms-features-with-certain-versions-of-oracle-jdk.md)
      + [JEE 버전에서 적응형 양식에 첨부 파일이 포함된 이메일을 받기 위한 추가 단계](/help/forms/using/additional-steps-to-use-email-with-attachments.md)
      + [Windows Server에서 Word 또는 Excel 파일을 PDF로 변환할 수 없음](/help/forms/using/disable-uac-for-pdfgconfiguration.md)
      + [Google Chrome, Firefox, Microsoft Edge, Microsoft Internet Explorer, Apple Safari에서 XFA 기반 PDF 양식을 열 수 없음](/help/forms/using/xfa-based-forms-in-chrome-firefox-ie-internet-explorter-safari-edge.md)
      + [CRX 저장소를 복원할 수 없음](/help/forms/using/restore-crx-repository.md)
      + [AEM 6.5.15.0 서비스 팩 설치 후 서비스를 사용할 수 없음 오류 발생](/help/forms/using/aem-service-pack-installation-solution.md)
      + [JBoss Linux 환경에서 AEM Forms JEE 6.5.15.0 서비스 팩 설치 문제 발생](/help/forms/using/linux-jboss-installation-issue-on-sp15.md)
      ...
      + [JEE의 AEM Forms에 대한 Spring Framework 취약점 완화](/help/forms/using/mitigating-spring-framework-vulnerabilities-for-aem-forms-on-jee.md)
      + [Experience Manager Forms에 대한 Log4j2 취약점 완화](/help/forms/using/aem-forms-vulnerability-cve.md)
      + [JEE의 AEM Forms에 대한 원격 코드 실행 취약점 완화](/help/forms/using/aem-forms-rce-vulnerability-mitigation-troubleshooting.md)
      + [JEE의 AEM Forms에 대한 XXE, 구성 및 원격 코드 실행 취약점 완화](/help/forms/using/mitigating-xxe-and-configuration-vulnerabilities-for-experience-manager-forms-jee.md)
      + [XFA 기반 PDF 양식 및 정책으로 보호된 문서에서 표시 문제 발생](/help/forms/using/xfa-pdf-forms-policy-protected-documents-not-displayed.md)
      + [Firefox 및 Chrome에서 XFA 기반 PDF 양식을 여는 방법](/help/forms/using/xfa-forms-firefox-chrome.md)
      + [BlazeDS의 XML 외부 엔터티(XXE) 취약점](/help/forms/using/xxe-vulnerability-blaze-ds.md)
...
+ Content 및 Commerce {#commerce}
   ...
   + AEM CIF Classic {#classic}
      ...
      + 배포 {#deploying}
         + [전자 상거래 개요](/help/commerce/cif-classic/deploying/ecommerce.md)
         + [SAP Commerce Cloud](/help/commerce/cif-classic/deploying/sap-commerce-cloud.md)
      + 관리 {#administering}
         + [전자 상거래](/help/commerce/cif-classic/administering/ecommerce.md)
      ...
      + 개발 {#developing}
         + [전자 상거래](/help/commerce/cif-classic/developing/ecommerce.md)
...
+ 헤드리스 {#headless}
   ...
   + [설명서 여정이란?](/help/journey-documentation/home.md)
+ 구현 {#implementing}
   + 개발 {#developing}
      + 개발자를 위한 소개 {#introduction}
         ...
         + [디자인과 디자이너(클래식 UI)](/help/sites-developing/designer.md)
      ...
      + Platform {#platform}
         ...
         + [AEM에서 Sling Resource Merger 사용](/help/sites-developing/sling-resource-merger.md)
      ...
      + 헤드리스 환경 관리 {#headless}
         ...
         + 헤드리스 여정 {#journeys}
            + 헤드리스 개발자 여정 {#developer}
               + [AEM 헤드리스 이해](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/overview.html)
               + [CMS 헤드리스 개발에 대해 알아보기](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/learn-about.html)
               + [AEM 헤드리스를 클라우드 서비스로 시작하기](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/getting-started.html)
               + [AEM 헤드리스로 첫 경험 쌓기](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/path-to-first-experience.html)
               ...
               + [헤드리스 애플리케이션 실행 방법](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/go-live.html)
               + [선택 사항 - AEM을 통해 단일 페이지 애플리케이션을 제작하는 방법](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/create-spa.html)
            + 헤드리스 콘텐츠 설계 여정 {#architect}
               + [AEM 헤드리스 콘텐츠 설계 여정 개요](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/architect/overview.html)
               + [AEM을 통한 헤드리스용 콘텐츠 모델링 - 소개](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/architect/introduction.html)
               ...
               + [AEM에서 콘텐츠 조각 모델 만들기에 대해 알아보기](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/architect/model-structure.html)
      ...
      + 개발 도구 {#devtools}
         ...
         + [CRXDE Lite를 사용한 개발](/help/sites-developing/developing-with-crxde-lite.md)
      ...
      + 개인화 {#personlization}
         ...
         + [타기팅된 콘텐츠를 위한 개발](/help/sites-developing/target.md)
         + [ContextHub JavaScript API 참조](/help/sites-developing/contexthub-api.md)
         + ClientContext{#client-context}
            + [ClientContext 관련 세부 사항](/help/sites-developing/client-context.md)
      ...
      + 모범 사례 {#bestpractices}
         ...
         + [AEM 개발 지침 및 모범 사례](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/introduction/dev-guidelines-bestpractices.html)
   ...
   + 배포 {#deploying}
      ...
      + AEM 배포 {#deploying}
         ...
         + [TarMK 콜드 스탠바이로 AEM을 실행하는 방법](/help/sites-deploying/tarmk-cold-standby.md)
         + [AEM 6.5의 RDBMS 지원](/help/sites-deploying/rdbms-support-in-aem.md)
         + [Oak-run Jar를 통한 색인화](/help/sites-deploying/indexing-via-the-oak-run-jar.md)
         + [Oak-run.jar 색인화 사용 사례](/help/sites-deploying/oak-run-indexing-usecases.md)
         + [Oak 색인 문제 해결](/help/sites-deploying/troubleshooting-oak-indexes.md)
         + [집계된 사용 통계 수집 선택](/help/sites-deploying/opt-in-aggregated-usage-statistics.md)
      ...
      + AEM 구성 {#configuring}
         ...
         + [정적 오브젝트 만료](/help/sites-deploying/expiration-static-objects.md)
         + [버전 제거](/help/sites-deploying/version-purging.md)
         + [AEM 인스턴스 모니터링 및 유지 관리](/help/sites-deploying/monitoring-and-maintaining.md)
         + [오프로딩 작업](/help/sites-deploying/offloading.md)
      ...
      + AEM 6.5로 업그레이드 {#upgrading}
         ...
         + [업그레이드 중 가동 중지 시간을 줄이기 위한 오프라인 재색인화 사용](/help/sites-deploying/upgrade-offline-reindexing.md)
         ...
         + [사용자 정의 검색 양식 업그레이드](/help/sites-deploying/upgrading-custom-search-forms.md)
         ...
         + [애플리케이션 서버 설치를 위한 업그레이드 단계](/help/sites-deploying/app-server-upgrade.md)
         + [업그레이드 후 제거된 더 이상 사용되지 않는 번들 목록](/help/sites-deploying/obsolete-bundles.md)
      + 저장소 재구성 {#restructuring}
         + [AEM 6.5의 저장소 재구성](/help/sites-deploying/repository-restructuring.md)
         + [AEM 6.5의 공통 저장소 재구성](/help/sites-deploying/all-repository-restructuring-in-aem-6-5.md)
         ...
         + [AEM 6.5의 동적 미디어 저장소 재구성](/help/sites-deploying/dynamicmedia-repository-restructuring-in-aem-6-5.md)
         ...
         + [6.5의 AEM Communities 저장소 재구성](/help/sites-deploying/communities-repository-restructuring-in-aem-6-5.md)
      + 모범 사례 {#practices}
         + [배포 모범 사례](/help/sites-deploying/best-practices.md)
         + [성능 트리](/help/sites-deploying/performance-tree.md)
         + [성능 테스트 모범 사례](/help/sites-deploying/best-practices-for-performance-testing.md)
   ...
   + 유동적 경험 {#fluid-experiences}
      + [기능 목록](/help/fluid-experiences/feature-list.md)
+ 관리 {#managing}
   + [관리 사용 안내서](/help/managing/home.md)
   + 관리 - 모범 사례 체크리스트 {#managing-best-practices-checklist}
      + [프로젝트 관리 - 모범 사례 체크리스트](/help/managing/best-practices.md)
      + [체크리스트](/help/managing/best-practices-checklist.md)
      + [용어 설명](/help/managing/best-practices-glossary.md)
      + [체크리스트 - 추가 참조](/help/managing/best-practices-further-reference.md)
