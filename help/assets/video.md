...
도구의 **[!UICONTROL 비디오 파일의 URL 입력]** 필드에 비디오 파일의 복사한 URL을 붙여 넣은 다음 **[!UICONTROL 로드]**&#x200B;를 클릭합니다. 비디오 파일 자체의 URL을 가져오려면 [자산의 URL 가져오기](/help/assets/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset)를 참조하십시오. 그러면 이 URL을 **[!UICONTROL 비디오 파일의 URL 입력 필드]**에 붙여 넣을 수 있습니다. 그런 다음 Internet Explorer, Chrome 또는 Safari에서 기본적으로 비디오를 재생할 수 있습니다.
-->
