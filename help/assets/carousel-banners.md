...
1. 선택 사항:필요에 [따라 회전판 세트 뷰어 사전 설정을](/help/assets/managing-viewer-presets.md)만듭니다.
...
1. 다음 중 하나를 수행하십시오.
   ...
   * [AEM 파섹
      ](/help/assets/adding-dynamic-media-assets-to-pages.md)AEM Sites 고객의 경우 대화형 미디어 구성 요소를 사용하여 AEM의 페이지에 직접 회전판 세트를 추가할 수 있습니다.


회전판 세트를 편집해야 하는 경우 회전판 세트 [편집을 참조하십시오.](#editing-carousel-sets) 또한 회전판 세트 속성을 보고 편집할 [수](https://helpx.adobe.com/experience-manager/6-5/help/assets/managing-assets-touch-ui.md#editingproperties)있습니다.
...
이미지 배너를 업로드하려면 자산 [업로드를](/help/assets/managing-assets-touch-ui.md)참조하십시오.
...
1. 동작 및 모양 탭을 탭하거나 클릭하고 캐러셀 배너의 모양 또는 특정 구성 요소의 작동 방식을 조정하여 회전판 세트의 시각적 디자인과 동작을 변경할 수 있습니다. 뷰어 편집기를 사용하는 방법에 대한 자세한 내용은 뷰어 사전 설정 [관리를](/help/assets/viewer-presets.md) 참조하십시오.
   ...
   >
   >
   >뷰어 [편집기에 대한 자세한 설명과](/help/assets/viewer-presets.md#specialconsiderationsforcreatingacarouselbannerviewerpreset) 자세한 내용은 회전판 배너에 대한 특별 고려 사항을 참조하십시오.
...
>[!NOTE]
>
>대화형 이미지 또는 회전 [배너에서](/help/assets/interactive-images.md) 이미지에 핫스팟을 추가하면 핫스팟 정보가 대화형 이미지 또는 회전 메뉴 배너인지 여부에 관계없이 동일한 메타데이터 위치에 저장됩니다. 이 기능은 두 뷰어 중 하나에서 동일한 이미지를 정의된 핫스팟 데이터와 함께 쉽게 다시 사용할 수 있음을 의미합니다.
...
1. [작업] 탭에서 다음 중 **[!UICONTROL 하나를]** 수행합니다.
   ...
   * 빠른 보기를 **[!UICONTROL 누릅니다]**.
      ...
      * AEM Sites 및 Ecommerce 고객인 경우 제품 선택기 아이콘(확대경)을 눌러 제품 선택 페이지를 엽니다. 사용할 제품을 누른 다음 페이지의 오른쪽 위 모서리에 있는 확인 표시를 눌러 회전판 배너 편집기로 돌아갑니다.
...
1. 회전판 세트를 게시합니다. 게시를 사용하면 웹 사이트 페이지에서 사용할 수 있는 포함 코드 또는 URL이 만들어집니다. AEM Sites 고객의 경우 회전판 세트를 웹 페이지에 직접 추가할 수 있습니다.
   ...
   자산 [게시를](/help/assets/publishing-dynamicmedia-assets.md)참조하십시오.
...
* 슬라이드 모음을 회전판 세트에 추가합니다. 선택기 [작업을 참조하십시오](/help/assets/working-with-selectors.md).
...
캐러셀 [배너를 게시하는](/help/assets/publishing-dynamicmedia-assets.md) 방법에 대한 자세한 내용은 Dynamic Media 자산 게시를 참조하십시오.
