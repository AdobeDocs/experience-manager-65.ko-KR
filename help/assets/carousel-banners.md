...
1. 선택 사항: 필요에 따라 [슬라이드 세트 뷰어 사전 설정](/help/assets/managing-viewer-presets.md)을(를) 만듭니다.
...
>[!NOTE]
>
>Experience Manager Sites 및/또는 Experience Manager Ecommerce 고객의 경우 이 단계를 건너뜁니다. 핫스팟 또는 이미지 맵 변수를 수동으로 식별할 필요가 없으며, 제품 통합을 위해 Ecommerce와의 통합을 사용할 수 있습니다. [전자 상거래 설정](/help/commerce/cif-classic/administering/generic.md)에 대한 정보를 참조하세요. 또한 대화형 구성 요소를 사용하여 웹 페이지에 추가할 수 있습니다.
>
...
1. 다음 중 하나를 수행합니다.
   ...
   * 이미지 맵의 경우: 이미지에서 을 선택한 다음 왼쪽 상단에서 오른쪽 하단으로 드래그하여 이미지 맵 영역을 만듭니다. 모퉁이를 드래그하여 이미지 맵의 크기를 조정할 수 있습니다.
   ...
   핫스팟 또는 이미지 맵을 삭제하려면 **[!UICONTROL 작업]** 탭을 선택합니다. **[!UICONTROL 지도 및 핫스팟]** 제목 아래에서, **[!UICONTROL 선택 유형]** 드롭다운 메뉴에서 삭제하려는 핫스팟 또는 이미지 맵의 이름을 선택하세요. 메뉴 옆에 있는 **[!UICONTROL 휴지통]** 아이콘을 선택한 다음 **[!UICONTROL 삭제]**&#x200B;를 선택합니다.
