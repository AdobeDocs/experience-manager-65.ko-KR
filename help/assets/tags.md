...
1. 먼저 Experience Cloud [홈 페이지](https://experience.adobe.com/#/home)에서 Experience Platform 태그에 액세스하십시오. 메뉴 표시줄에서 페이지의 오른쪽 위 모서리 근처에 있는 **[!UICONTROL 솔루션]** 아이콘(세 개의 점 테이블)을 선택한 다음 **[!UICONTROL 태그]**&#x200B;를 선택합니다.
