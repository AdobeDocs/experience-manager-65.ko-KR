...
* [!DNL Adobe Developer Console] - 통합이 Experience Platform 태그에 대해 생성됩니다.
...
다음을 참조하십시오 [Adobe Experience Cloud ID 서비스 확장](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/client/id-service/overview.html).
...
1. 사용 **[!UICONTROL 새 인증서 만들기]**&#x200B;를 클릭한 다음 텍스트 필드에 인증서에 대한 의미 있는 값을 입력합니다. 예를 들어, *AdobeLaunchIMSCert*. 선택 **[!UICONTROL 인증서 만들기]**.
   ...
   *올바른 액세스 토큰을 검색하려면 새 인증서의 공개 키가 Adobe Developer 콘솔의 기술 계정에 추가됩니다.*
...
1. 새 브라우저 탭에서 다음 위치로 이동합니다. [[!DNL Adobe Developer Console]](https://developer.adobe.com/console/integrations).
...
다음을 참조하십시오 [의 방식으로 Experience Platform 태그와 Experience Manager 통합 [!DNL Adobe Developer Console]](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/experience-platform-data-collection-tags/overview.html) Experience Platform 태그 클라우드 구성 설정에 대한 자세한 정보입니다.
