...
>[!NOTE]
>
> 회사 프록시 서버를 사용하는 경우 [!UICONTROL 향상된 Workfront 커넥터]에 대한 [!UICONTROL Apache HTTP 구성 요소 프록시 구성 PID]에 [!DNL workfront]을(를) 포함하여 인식하십시오. 필요한 PID 형식은 `org.apache.http.proxyconfigurator~workfront`입니다.
