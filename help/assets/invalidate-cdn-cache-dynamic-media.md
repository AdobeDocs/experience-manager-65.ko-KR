...
1. 6.5.6 이상 Experience Manager에서 **[!UICONTROL 도구]** > **[!UICONTROL Assets]** > **[!UICONTROL CDN 무효화]**&#x200B;로 이동합니다.
...
1. Experience Manager as a Cloud Service에서 **[!UICONTROL 도구]** > {2 Assets ]**>**[!UICONTROL  CDN 무효화&#x200B;]**를 선택합니다.**[!UICONTROL 
...
| 오류 | 설명 |
| --- | --- |
| *선택한 자산의 URL을 검색하지 못했습니다.* | 다음 시나리오 중 하나가 충족되면 발생합니다.<br>- Dynamic Media 구성을 찾을 수 없습니다.<br>- Dynamic Media 구성을 읽는 서비스 사용자를 검색하는 동안 예외가 발생했습니다.<br>- URL을 구성하는 데 사용되는 Publish 서버 또는 회사 루트가 Dynamic Media 구성에 없습니다. |
