...
1. 마법사에서 데이터 센터를 선택하고 조직 이름, 사용자 이름 및 공유 암호를 포함한 자격 증명을 제공합니다.
   ...
   *그림: [!DNL Adobe Analytics]에서 Assets Insights에 대해 [!DNL Experience Manager] 구성.*
