...
1. 필요에 [따라 이미지 집합 뷰어 사전 설정을](/help/assets/managing-viewer-presets.md)추가합니다.
...
1. (선택 사항) [일괄](/help/assets/image-sets.md#viewing-image-sets) 세트 사전 설정을 사용하여 만든 이미지 세트 보기
...
1. [이미지 세트 게시를 참조하십시오.](/help/assets/publishing-dynamicmedia-assets.md)
   ...
   이미지 세트 게시를 사용하면 URL 및 포함 문자열이 활성화됩니다. 또한 만든 사용자 정의 뷰어 사전 설정을 [게시해야](/help/assets/managing-viewer-presets.md) 합니다. 즉시 사용 가능한 뷰어 사전 설정이 이미 게시되었습니다.

1. [웹 응용 프로그램에 URL을 연결하거나 비디오](/help/assets/linking-urls-to-yourwebapplication.md) 또는 [이미지 뷰어를 포함합니다](/help/assets/embed-code.md).
   ...
   이미지 [세트를 웹 페이지에](/help/assets/linking-urls-to-yourwebapplication.md) 연결 및 비디오 또는 이미지 [뷰어 포함을 참조하십시오](/help/assets/embed-code.md).

이미지 세트를 편집하려면 이미지 세트 [편집을 참조하십시오.](#editing-image-sets) 또한 이미지 세트 속성을 보고 편집할 [수](/help/assets/managing-assets-touch-ui.md#editing-properties)있습니다.

세트를 만드는 데 문제가 있는 경우, 다이내믹 미디어 문제 해결 - [Scene7 모드의](/help/assets/troubleshoot-dms7.md#images-and-sets)이미지 및 세트를 참조하십시오.
...
자산에서 다른 자산을 [업로드하듯이 이미지 세트에 대한 이미지를 업로드할 수 있습니다](/help/assets/managing-assets-touch-ui.md#uploading-assets).
...
>[!NOTE]
>
>또한 [일괄 처리 집합 사전 설정을](/help/assets/config-dms7.md#creating%20batch%20set%20presets%20to%20auto-generate%20image%20sets%20and%20spin%20sets)통해 자동으로 이미지 집합을 만들 수 있습니다.
...
사용자 인터페이스에서 또는 [일괄 세트 사전 설정을](/help/assets/config-dms7.md#creating%20batch%20set%20presets%20to%20auto-generate%20image%20sets%20and%20spin%20sets)사용하여 자동으로 이미지 세트를 만들 수 있습니다.

>[!IMPORTANT]
>
>배치 세트는 IPS 이미지 [프로덕션 시스템에서] 자산 수집의 일부로 생성되며 다이내믹 미디어 - Scene7 모드에서만 사용할 수 있습니다.)
...
자산 [미리 보기를](/help/assets/previewing-assets.md)참조하십시오.
