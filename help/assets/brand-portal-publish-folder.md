...
1. AEM Assets 인터페이스에서 원하는 폴더를 마우스로 가리킨 다음 을 선택합니다 **게시** 옵션을 선택합니다.
...
1. **지금 폴더 게시**
   ...
   * 도구 모음에서 **빠른 게시**&#x200B;를 선택합니다. 그런 다음 메뉴에서 **Brand Portal에 게시**.

   * 도구 모음에서 **게시 관리**&#x200B;를 선택합니다.
   1. From **작업** 선택 **Brand Portal에 게시**, 시작 **예약** 선택 **지금**&#x200B;를 클릭하고 **다음.**
   ...
   **나중에 폴더 게시**
   ...
   1. 게시할 자산/폴더를 선택한 후 을 선택합니다. **게시 관리** 맨 위에 있는 도구 모음에서 를 클릭합니다.
   1. From **작업** 선택 **Brand Portal에 게시**, 시작 **예약** 선택 **나중에**.
...
1. **지금 Brand Portal에서 게시 취소**
   ...
   1. From **작업** 선택 **Brand Portal에서 게시 취소**, 시작 **예약** 선택 **지금**&#x200B;를 클릭하고 **다음.**
   ...
   **나중에 Brand Portal에서 게시 취소**
   ...
   1. 도구 모음에서 **게시 관리**&#x200B;를 선택합니다.
   1. From **작업** 선택 **Brand Portal에서 게시 취소**, 및에서 **예약** 선택 **나중에**.
   1. **활성화 날짜**&#x200B;를 선택하고 시간을 지정합니다. **다음**&#x200B;을 클릭합니다.
