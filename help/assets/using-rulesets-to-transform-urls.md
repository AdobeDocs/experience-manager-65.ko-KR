...
참조 - [규칙 세트에서 &#39;is&#39; 이미지 대신 &#39;asset&#39;를 사용하십시오](https://helpx.adobe.com/experience-manager/scene7/kb/base/scene7-rulesets/ruleset-asset-instead-image.html).
...
1. 다음을 수행하여 규칙 세트 파일을 업로드합니다.
   ...
   * 페이지 하단 근처에 있는 **[!UICONTROL 업로드 후 게시]** 이(가) 선택되어 있습니다.
...
1. 페이지 상단 근처에 있는 탐색 모음에서 를 선택합니다 **[!UICONTROL 설정]** > **[!UICONTROL 애플리케이션 설정]** > **[!UICONTROL 게시 설정]** > **[!UICONTROL 이미지 서버]**.
