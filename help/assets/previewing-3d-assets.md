...
자세한 내용은 [3D 미리 보기에 대해 지원되는 형식](#supported-3d-previewing-assets) 및 [자산 업로드](/help/assets/manage-assets.md#uploading-assets).
1. Experience Manager에서 **[!UICONTROL 탐색]** 페이지를 선택하고 **[!UICONTROL 자산]** > **[!UICONTROL 파일]**.
