...
1. AEM 로고를 탭/클릭하고 작업 > **[!UICONTROL 작업으로]** 이동합니다 ****.
...
1. 활성 작업을 중지하려면 목록에서 해당 작업을 선택하고 도구 **[!UICONTROL 모음에서]** 중지를 누릅니다.

   ![stop_icon](assets/stop_icon.png)

1. 설명 및 로그와 같은 추가 세부 사항을 보려면 작업을 선택하고 도구 **[!UICONTROL 모음에서 열기를]** 누릅니다.
...
1. 목록에서 작업을 삭제하려면 도구 모음에서 **[!UICONTROL 삭제를]** 선택합니다. CSV 파일로 세부 사항을 다운로드하려면 다운로드를 **[!UICONTROL 누릅니다]**.
