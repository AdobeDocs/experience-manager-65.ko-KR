...
1. [프로비저닝 이메일에서 ](https://www.adobe.com/marketing-cloud/experience-manager/scene7-login.html) 받은 자격 증명을 사용하여 Dynamic Media Classicics에 로그인합니다. 전역 탐색 막대에서 **[!UICONTROL 업로드]**&#x200B;를 클릭합니다.
