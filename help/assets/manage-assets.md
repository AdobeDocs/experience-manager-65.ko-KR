...
|  | 데스크탑 | 데스크탑 컴퓨터에 스트리밍 또는 점진적 비디오 경험을 제공하기 위한 MP4 파일을 만듭니다. 해상도 크기와 원하는 대상 데이터 비율로 하나 이상의 종횡비를 선택합니다. |
...
1. 자산 또는 폴더를 선택하고 **[!UICONTROL 삭제]** ![삭제 옵션](assets/do-not-localize/deleteoutline.png) 를 클릭합니다.
   ...
   * 자산에 참조가 있으면, 오류 메시지에 다음 내용이 표시됩니다 **하나 이상의 자산을 참조했습니다.**. 선택할 수 있습니다 **[!UICONTROL 강제 삭제]** 또는 **[!UICONTROL 취소]**.
   >[!NOTE]
   >
