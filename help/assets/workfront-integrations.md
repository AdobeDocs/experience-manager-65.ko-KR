...
# [!DNL Adobe Experience Manager Assets]과(와) [!DNL Adobe Workfront] 통합 {#assets-integration-overview}
...
>
>* Adobe은 향상된 커넥터 버전 1.7.4 이상을 지원합니다. 이전 프리릴리스 및 사용자 지정 버전은 지원되지 않습니다. 향상된 커넥터 버전을 확인하려면 `digital.hoodoo`패키지 관리자[의 왼쪽 창에서 사용할 수 있는 &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-65/administering/contentmanagement/package-manager.html?lang=en) 그룹으로 이동하십시오.
>
