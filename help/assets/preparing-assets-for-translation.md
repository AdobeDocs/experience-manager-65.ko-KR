...
in [!DNL Adobe Experience Manager Assets], 다국어 자산이 폴더에 포함되며, 여기서 각 폴더는 다른 언어로 된 자산을 포함합니다.
...
1. 기본 언어의 언어 루트를 만듭니다. 예를 들어 샘플 폴더 계층 구조에서 영어 사본의 언어 루트는 다음과 같습니다 `/content/dam/en`. 의 정보에 따라 언어 루트가 올바르게 구성되었는지 확인합니다. [언어 루트 만들기](preparing-assets-for-translation.md#creating-a-language-root).
...
1. 에서 [!DNL Assets] 콘솔 **[!UICONTROL 만들기]** 및 **[!UICONTROL 폴더]** 메뉴 아래의 제품에서 사용할 수 있습니다.

   ![폴더 만들기](assets/Create-folder.png)

1. 에서 **[!UICONTROL 이름]** 필드에 국가 코드를 `<language-code>`.
...
1. 에서 [!DNL Assets] 콘솔에서 언어 사본을 만들 기본 언어를 선택합니다.
1. 왼쪽 레일에서 를 선택합니다. **[!UICONTROL 참조]** 옵션을 엽니다. [!UICONTROL 참조] 창

   ![chlimage_1-122](assets/chlimage_1-122.png)

1. 참조 창에서 **[!UICONTROL 언어 복사]**. 다음 [!UICONTROL 언어 복사] 패널에 자산의 언어 사본이 표시됩니다.
