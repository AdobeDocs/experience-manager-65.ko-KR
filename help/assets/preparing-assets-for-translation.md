...
[!DNL Adobe Experience Manager Assets]에서 다국어 자산은 폴더에 포함되며, 여기서 각 폴더는 다른 언어의 자산을 포함합니다.
...
[!DNL Experience Manager] 인터페이스는  **** 내에서 만들어진 언어 루트 목록을 표시하는 참조 패널을 제공합니다 [!DNL Assets].
...
1. 참조 창에서 **[!UICONTROL 언어 사본]**&#x200B;을 클릭합니다. [!UICONTROL 언어 사본] 패널에는 자산의 언어 사본이 표시됩니다.
