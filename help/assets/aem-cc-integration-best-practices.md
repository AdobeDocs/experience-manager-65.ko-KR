...
| [!DNL Adobe Stock]에서 바로 사용할 수 있는 고품질 자산 제공 | 마케터는 자산 소싱 및 검색을 지원하여 콘텐츠 작성 프로세스를 가속화합니다. Creative 전문가는 승인된 자산을 자체 제작 도구 내에서 바로 사용합니다. | [!DNL Experience Manager Assets]; [!DNL Adobe Stock] 마켓플레이스; 메타데이터 필드 |
...
* **Creative 지원 에셋:** [!DNL Assets] 더 광범위한 팀과 공유할 준비가 되었거나 마케팅 또는 LOB 팀과 공유하기 위해 크리에이티브 팀이 선택 또는 승인한 에셋입니다.
