...
| 버전 | 문서 링크 |
| -------- | ---------------------------- |
| AEM as a Cloud Service | [여기를 클릭하십시오.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/brand-portal/configure-aem-assets-with-brand-portal.html?lang=ko) |
| AEM 6.5 | 이 문서 |
...
* [구성 업그레이드](#upgrade-integration-65): 기존 OAuth 게이트웨이에 대한 구성을 가진 기존 Brand Portal 사용자인 경우 기존 구성을 삭제하고 Adobe Developer 콘솔을 통해 새 구성을 만드십시오.
...
Brand Portal을 사용하여 AEM Assets을 구성하려면 AEM Assets 작성자 인스턴스와 Adobe Developer 콘솔 모두에서 구성이 필요합니다.
...
IMS 구성은 AEM Assets 테넌트를 사용하여 Brand Portal 작성자 인스턴스를 인증합니다.
...
수정하기 전에 AEM Assets 작성자 인스턴스에서 게시 작업이 실행되고 있지 않은지 확인합니다. 이를 위해 4개의 복제 에이전트 모두에서 활성 작업 상태를 확인하고 큐가 유휴 상태인지 확인할 수 있습니다.
