...
1. 다음 중 하나를 수행합니다.
   ...
   * 프로젝트의 대시보드에서 시작 카드에서 을 누릅니다 **[!UICONTROL API 탐색 및 활성화]**.
   * 프로젝트의 대시보드에서 API 카드에서 을 누릅니다. **[!UICONTROL API 개요로 이동]**.

   ![6_5_googleaccount-apis-enable2](assets/6_5_googleaccount-apis-enable2.png)

1. API 및 서비스 페이지 상단 근처에서 을 누릅니다. **[!UICONTROL API 및 서비스 활성화]**.
1. API 라이브러리 페이지의 왼쪽에 있는 **[!UICONTROL 범주]**, 탭 **[!UICONTROL YouTube]**. 페이지 오른쪽에서 을 누릅니다. **[!UICONTROL YouTube 데이터 API]**.
1. YouTube Data API v3 페이지에서 을 누릅니다. **[!UICONTROL 사용]**.
...
1. 다음에서 **[!UICONTROL 프로젝트에 자격 증명 추가]** 페이지, 1단계에서 다음을 수행합니다.
   ...
   * 다음에서 **[!UICONTROL 어떤 데이터에 액세스하고 있습니까?]** 드롭다운 목록, 탭 **[!UICONTROL 사용자 데이터]**.

   ![6_5_googleaccount-apis-createcredentials2](assets/6_5_googleaccount-apis-createcredentials2.png)

1. 누르기 **[!UICONTROL 어떤 자격 증명이 필요합니까?]**
...
YouTube 게시 복제 에이전트를 활성화한 후 Google Cloud 계정에 대한 연결을 테스트하려면 을 누릅니다 **[!UICONTROL 연결 테스트]**. 브라우저 탭에 연결 결과가 표시됩니다. YouTube 채널을 추가한 경우 테스트 일부로 채널 목록이 표시됩니다.
...
1. 왼쪽 상단 모서리에서 Experience Manager 로고를 탭한 다음 왼쪽 레일에서 을 누릅니다 **[!UICONTROL 도구]**(망치 아이콘) > **[!UICONTROL Cloud Services]** > **[!UICONTROL YouTube 게시 구성]**.
1. 누르기 **[!UICONTROL 글로벌]** (선택하지 마십시오.)

1. 글로벌 페이지의 오른쪽 상단 모서리 근처에서 을 누릅니다 **[!UICONTROL 만들기]**.
...
1. YouTube/Google 인증이 표시됩니다. Google Cloud 계정에 아직 로그인하지 않은 경우 이 단계를 건너뜁니다.
   ...
   * 다음 페이지에서 을 누릅니다 **[!UICONTROL Accept]** 이 채널에 대한 액세스를 허용합니다.

1. 누르기 **[!UICONTROL 허용]**.

   이제 게시할 태그를 설정합니다.

1. **[!UICONTROL 게시용 태그 설정]** - Cloud Services > YouTube 페이지에서 연필 아이콘을 탭하여 사용할 태그 목록을 편집합니다.
1. 사용 가능한 태그 목록을 Experience Manager에 표시할 수 있도록 드롭다운 목록 아이콘(거꾸로 캐럿)을 탭합니다.
1. 태그를 추가할 수 있도록 하나 이상의 태그를 탭합니다.

   추가한 태그를 삭제하려면 태그를 선택하고 을 누릅니다 **[!UICONTROL X]**.

1. 원하는 태그를 모두 추가했으면 을 누릅니다 **[!UICONTROL 저장]**.
...
1. 왼쪽 상단 모서리에서 Experience Manager 로고를 탭한 다음 왼쪽 레일에서 을 누릅니다 **[!UICONTROL 도구]** (망치 아이콘) > **[!UICONTROL 배포]** > **[!UICONTROL Cloud Services]**.
1. 서드파티 서비스 제목에서 YouTube의 **[!UICONTROL 지금 구성]**.
...
1. 태그를 추가할 수 있도록 하나 이상의 태그를 탭합니다.
   ...
   추가한 태그를 삭제하려면 태그를 선택하고 을 누릅니다 **X**.

1. 원하는 태그를 모두 추가했으면 을 누릅니다 **[!UICONTROL 확인]**.
...
1. 왼쪽 상단 모서리에서 Experience Manager 로고를 탭한 다음 왼쪽 레일에서 을 클릭합니다 **[!UICONTROL 도구]** (망치 아이콘) > **[!UICONTROL 에셋]** > **[!UICONTROL 메타데이터 스키마]**.
1. 클릭 **[!UICONTROL 기본값]**. (&quot;기본값&quot; 왼쪽에 선택 상자에 확인 표시를 추가하지 마십시오.)
1. 다음에서 **[!UICONTROL 기본값]** 페이지를 만든 후 왼쪽에 있는 상자를 선택합니다. **[!UICONTROL 비디오]**, 다음 탭 **[!UICONTROL 편집]**.
...
1. YouTube 게시 제목에서 다음을 누릅니다. **[!UICONTROL YouTube 개인 정보 보호]**.
1. 페이지 오른쪽의 **[!UICONTROL 설정]** 탭에서 다음을 수행합니다.
...
1. Experience Manager의 왼쪽 상단 모서리에서 Experience Manager 로고를 탭한 다음 왼쪽 레일에서 을 클릭합니다 **[!UICONTROL 도구]** (망치 아이콘) > **[!UICONTROL 에셋]** > **[!UICONTROL 메타데이터 프로필]**.
...
1. 도구 모음에서 를 클릭합니다 **[!UICONTROL 게시 관리]**. 점 세 개 아이콘( )을 누릅니다. . .) 을 클릭하여 **[!UICONTROL 게시 관리]** 열림.
1. 게시 관리 페이지에서 을 누릅니다. **[!UICONTROL 게시 취소]**.
1. 페이지의 오른쪽 상단 모서리에서 을 누릅니다 **[!UICONTROL 다음]**.
1. 페이지의 오른쪽 상단 모서리에서 을 누릅니다 **[!UICONTROL 게시 취소]**.
...
1. 에셋 세부 사항에서 진행 상황 보기 에셋을 탭하거나 클릭하면 드롭다운 메뉴가 열리고 다음을 선택합니다. **[!UICONTROL 타임라인]**. 인코딩 또는 YouTube 게시와 같은 워크플로우 활동으로 범위를 좁히려면 다음을 선택합니다. **[!UICONTROL 워크플로]**.
...
1. For workflows in progress, see Workflow Instances available from **[!UICONTROL Tools]** > **[!UICONTROL Workflow]** > **[!UICONTROL Instances]**.
   ...
   인스턴스를 선택하고 을 누릅니다 **[!UICONTROL 내역 열기]**.
...
1. Experience Manager에서 을 누릅니다. **[!UICONTROL 도구]** > **[!UICONTROL 워크플로]** > **[!UICONTROL 모델]**.
1. 워크플로 모델 페이지에서 을 선택합니다. **[!UICONTROL YouTube에 게시]**, 다음 탭 **[!UICONTROL 편집]** 을 클릭합니다.
1. YouTube에 게시 워크플로우 페이지의 오른쪽 상단 모서리에서 을 누릅니다 **[!UICONTROL 편집]**.
1. YouTube 업로드 구성 요소에서 마우스 포인터를 가져간 다음 한 번 탭하여 인라인 도구 모음을 표시합니다.

   ![6_5_publishtoyoutubeworkflow](assets/6_5_publishtoyoutubeworkflow.png)

1. 인라인 도구 모음에서 구성 아이콘(렌치)을 탭합니다. 다음을 클릭합니다. **[!UICONTROL 인수]** 탭.
...
1. 완료되면 대화 상자의 오른쪽 상단 모서리 근처에서 을 탭합니다 **[!UICONTROL 완료]** 아이콘(확인 표시).
1. YouTube에 게시 워크플로우 페이지의 오른쪽 상단 모서리에서 을 누릅니다. **[!UICONTROL 동기화]**.
