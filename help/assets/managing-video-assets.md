...
1. **[!UICONTROL 자격 증명을 프로젝트에 추가]** 페이지의 1단계에서 다음을 수행합니다.
   ...
   * **[!UICONTROL 어떤 API를 사용 중입니까?]** 드롭다운 목록에서 **[!UICONTROL YouTube 데이터 API v3]**&#x200B;을(를) 선택합니다.

   * **[!UICONTROL 어디에서 API를 호출하고 있습니까?]** 드롭다운 목록에서 **[!UICONTROL 웹 서버(예: node.js, Tomcat)]**&#x200B;를 선택합니다.

   * **[!UICONTROL 어떤 데이터에 액세스하고 있습니까?]** 드롭다운 목록에서 **[!UICONTROL 사용자 데이터]**&#x200B;를 선택합니다.
