...
선택 [우주 정거장 360](https://s7d1.scene7.com/s7viewers/html5/Video360Viewer.html?asset=Viewers/space_station_360-AVS) 브라우저 창을 열고 360도 비디오를 보십시오. 비디오 재생 중에 마우스 포인터를 새 위치로 드래그하여 보기 각도를 변경합니다.

![우주 공간에는 국제 우주 정거장이 떠있고 그 뒤에 지구와 태양이 떠있는 360개의 비디오 샘플입니다.](assets/6_5_360videoiss_simplified.png)
...
Adobe Experience Manager에 업로드된 360개의 비디오 자산은 다음과 같이 레이블이 지정됩니다 **멀티미디어** 일반 비디오 자산과 유사한 자산 페이지.
...
1. [폴더에 응용 비디오 프로필 적용](/help/assets/video-profiles.md#applying-a-video-profile-to-folders).
   ...
   * [사용자 지정 응용 비디오 프로필 만들기](/help/assets/video-profiles.md#creating-a-video-encoding-profile-for-adaptive-streaming) 고품질 표현물 사용. 예를 들어 다음 세 가지 설정을 포함하는 응용 비디오 프로필 을 만듭니다.
...
기본적으로 Experience Manager은 해당 종횡비(너비/높이)가 2.0이면 비디오를 &quot;360&quot;으로 감지합니다. 관리자라면 선택 사항을 설정하여 기본 종횡비 설정을 2로 재정의할 수 있습니다 `s7video360AR` 속성(CRXDE Lite 위치:
...
종횡비는 자산 세부 사항 페이지 및 [비디오 360 Media WCM 구성 요소](/help/assets/adding-dynamic-media-assets-to-pages.md#dynamic-media-components).
...
1. in **[!UICONTROL 자산]**&#x200B;를 만든 기존 360 비디오로 이동합니다. 미리 보기 모드에서 열 수 있도록 360 비디오 자산을 선택합니다.
...
1. 미리 보기 페이지의 왼쪽 위 모서리 근처에 있는 드롭다운 목록을 선택한 다음 을 선택합니다 **[!UICONTROL 뷰어]**.
   ...
   * 비디오의 을(를) 선택합니다 **[!UICONTROL 재생]** 단추를 클릭하여 재생을 시작합니다. 비디오가 재생될 때 마우스 포인터를 비디오 위로 드래그하여 보기 각도를 변경합니다.

   ![지구 뒤에 태양을 배경으로 한 우주 공간인 우주국의 스크린샷이다&#x200B;](assets/6_5_360video-preview-video360-social.png)*360개의 비디오 스크린샷입니다.*
   ...
   * 뷰어 목록에서 를 선택합니다. **[!UICONTROL Video360VR]**.
   ...
   ![지구 및 태양이 배경에서 부분적으로 볼 수 있는 지구 외 공간에 부유하는 국제 우주 정거장의 클로즈업 스크린샷이다](assets/6_5_360video-preview-video360vr.png)
   *360 VR 비디오 스크린샷입니다.*
...
자세한 내용은 [Dynamic Media 자산 게시](/help/assets/publishing-dynamicmedia-assets.md) 를 참조하십시오.
참조 - [웹 페이지에 비디오 또는 이미지 뷰어 포함](/help/assets/embed-code.md).
참조 - [웹 애플리케이션에 URL 연결](/help/assets/linking-urls-to-yourwebapplication.md). 대화형 컨텐츠에 상대 URL이 있는 링크, 특히 Experience Manager Sites 페이지에 대한 링크가 있는 경우 URL 기반 연결 방법이 없습니다.
