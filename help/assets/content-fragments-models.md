...
컨텐츠 조각 모델은 [컨텐츠 조각에](/help/assets/content-fragments.md)대한 컨텐츠 구조를 정의합니다.
...
1. 만들기를 **사용하여** 다음 위치에서 대화 상자를 엽니다.
...
비교 가능한 자산 폴더와 함께 다른 구성(예: 글로벌 제외)을 사용하려면 연결을 정의해야 합니다. 이 작업은 **해당** 폴더의 폴더 **속성** 탭의 **클라우드 서비스** 탭에서구성을사용하여 수행됩니다.
