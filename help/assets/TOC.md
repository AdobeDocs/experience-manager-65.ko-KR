...
+ [자산 사용 안내서](home.md)
+ [AEM 6.5 자산 릴리스 노트](../release-notes/assets.md)
+ [DAM 정보](assets.md)
...
+ AEM 자산 사용 {#using}
   ...
   + [자산에 워크플로우 적용](assets-workflow.md)
...
+ 다이내믹 미디어{#dynamic}
   ...
   + [다이내믹 미디어 이미지 사전 설정 적용](image-presets.md)
   + [다이내믹 미디어 비디오 프로필](video-profiles.md)
   + [다이내믹 미디어 이미지 프로필](image-profiles.md)
   + [스마트 이미징](imaging-faq.md)
   + [비디오](s7-video.md)
   + [페이지에 Scene7 기능 추가](scene7.md)
   + [HTTP2 컨텐츠 전달](http2.md)
   + [다이내믹 미디어 에셋 제공](delivering-dynamic-media-assets.md)
   ...
   + [360 VR 파섹](/help/assets/360-video.md)
   ...
   + [웹 페이지에 동적 비디오 또는 이미지 뷰어 포함](embed-code.md)
