...
미리 볼 때 이미지 사전 설정(이미지에만 해당) 또는 뷰어 사전 설정(비디오 및 이미지의 경우)을 적용할 수도 있습니다. 두 항목을 모두 자산에 적용할 수 없습니다. 자세한 내용은 [뷰어 사전 설정 적용](/help/assets/viewer-presets.md) 및 [이미지 사전 설정 적용](/help/assets/image-sets.md).

자산 관리에 대한 일반적인 정보는 [자산 관리](/help/assets/manage-assets.md).
