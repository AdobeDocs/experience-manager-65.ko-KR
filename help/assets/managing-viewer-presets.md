...
1. Experience Manager의 왼쪽 위 모서리에서 AEM 로고를 탭한 다음 왼쪽 레일에서 **[!UICONTROL 도구]**(망치 아이콘) > **[!UICONTROL 자산]** > **[!UICONTROL 뷰어 사전 설정]**&#x200B;을 누릅니다.
...
1. AEM의 왼쪽 위 모서리에서 AEM 로고를 탭한 다음 왼쪽 레일에서 **[!UICONTROL 도구]** (망치 아이콘) **[!UICONTROL 자산]** > **[!UICONTROL 뷰어 사전 설정]**&#x200B;을 탭합니다.
