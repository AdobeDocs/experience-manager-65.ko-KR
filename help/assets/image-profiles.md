...
내에서 폴더에 이미지 프로필을 적용할 수 있습니다. **[!UICONTROL 도구]** 메뉴 또는 폴더에 있는 경우 **[!UICONTROL 속성]**. 이 섹션에서는 두 가지 방법으로 이미지 프로필을 폴더에 적용하는 방법에 대해 설명합니다.
...
폴더 내에서 이미지 프로필을 제거할 수 있습니다. **[!UICONTROL 도구]** 메뉴 또는 폴더에 있는 경우 **[!UICONTROL 속성]**. 이 섹션에서는 두 가지 방법으로 폴더에서 이미지 프로필을 제거하는 방법을 설명합니다.
