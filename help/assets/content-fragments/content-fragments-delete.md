...
예를 들어 변형을 조작할 때, 메타데이터를 편집할 때 또는 관련 컨텐츠를 관리할 때 사용합니다.
...
>
>하지만 이 작업은 다른 자산 유형 *모두*&#x200B;에도 동일한 삭제 권한을 적용합니다.
...
`add` 및 `modify` 권한은 CRXDE Lite에서 관리하거나 사용자 관리 콘솔을 사용하여 관리할 수도 있습니다.
