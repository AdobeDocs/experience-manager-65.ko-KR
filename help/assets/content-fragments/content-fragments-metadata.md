...
예를 들어 관련 조각에 &quot;크리스마스 시작&quot;으로 태그를 지정하여 하위 집합으로 검색할 수 있도록 하거나, 새 폴더에서 다른 향후 실행 시 사용할 수 있도록 복사할 수 있습니다.
      >[!NOTE]
      >
      >**태그** 다음 경우에 추가할 수도 있습니다. [변형 컨텐츠 작성](/help/assets/content-fragments/content-fragments-variations.md#authoring-your-content) 그리고 [변형 만들기](/help/assets/content-fragments/content-fragments-variations.md#creating-a-variation).
