...
* API 키 및 Adobe I/O의 다른 자격 증명을 사용하여 AEM 인스턴스를 구성합니다.
...
1. AEM 사용자 인터페이스에서 AEM 로고를 누르고 도구 > 클라우드 **[!UICONTROL 서비스]**> 레거시 클라우드 서비스로 **[!UICONTROL 이동합니다]**.
...
1. AEM 배포에 관리자로 로그인합니다. 도구 **[!UICONTROL > 보안]** **[!UICONTROL > 사용자를]** **[!UICONTROL 클릭합니다]**.

1. DAM **[!UICONTROL 업데이트 서비스]** 사용자를 찾아 클릭합니다. Keystore **[!UICONTROL 탭을]** 클릭합니다.
1. 만료된 인증서로 기존 **[!UICONTROL 유사성 검색]** 키 저장소를 삭제합니다. 저장 **[!UICONTROL 및 닫기를 클릭합니다]**.
...
1. 새 **[!UICONTROL 통합을]**&#x200B;누릅니다.
1. 새 **[!UICONTROL 통합]** 만들기 페이지에서 API **[!UICONTROL 액세스를 선택합니다]**. 계속을 **[!UICONTROL 누릅니다]**.
1. Experience **[!UICONTROL Cloud]**&#x200B;아래에서 스마트 **[!UICONTROL 콘텐츠를 선택합니다]**. 계속을 **[!UICONTROL 누릅니다]**.
...
1. 에서 AEM 서버에 액세스합니다 `https://[server]:[port]`.
...
1. 확인을 **[!UICONTROL 눌러]** 프로세스 단계를 닫은 다음 워크플로우를 저장합니다.
