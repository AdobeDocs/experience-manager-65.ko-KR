...
1. AEM 사용자 인터페이스에서 AEM 로고를 클릭하고 도구 > 클라우드 **[!UICONTROL 서비스]**> 레거시 클라우드 서비스로 **[!UICONTROL 이동합니다]**.
...
1. Experience Manager에서 도구 > 클라우드 **[!UICONTROL 서비스 > 레거시 클라우드 서비스로]** 이동하여 [!UICONTROL 클라우드 서비스] 콘솔을 엽니다.
...
1. 사이드 패널을 확장하여 단계를 표시합니다. DAM **[!UICONTROL 워크플로우]** 섹션에서 사용할 수 있는 스마트 태그 자산 단계를 드래그하여 [축소판 처리] **[!UICONTROL 단계 다음에 배치합니다]** .
   ...
   *그림:DAM 자산 업데이트 워크플로우에서 프로세스 축소판 단계 이후 스마트 태그[!UICONTROL 자산 추가]*
