...
1. 선택한 자산에 따라 다음 중 하나를 수행합니다.
   ...
   * 이미지를 선택한 경우 드롭다운 메뉴에서 **[!UICONTROL 표현물을 누릅니다.]**
...
1. 텍스트를 선택하여 웹 브라우저에 복사하여 자산을 미리 보거나 웹 컨텐츠 페이지에 추가합니다.
   ...
   URL 창을 종료하려면 **[!UICONTROL X]**&#x200B;을 누르거나 **[!UICONTROL Close를 누릅니다.]**
...
1. 페이지의 왼쪽 위 모서리 근처에 있는 **[!UICONTROL Cloud Services]**&#x200B;을 탭한 다음 Experience Manager 로고를 누르고 **[!UICONTROL 일반 > CRXDE Lite으로 이동합니다.]**
...
1. 사용 중인 비디오 전달 프로토콜을 기반으로 각 프로토콜 선택기를 복사합니다. 이 단계 후반부에 복사된 프로토콜 선택기가 필요합니다.
   ...
   |---|---|
   | HTTP <br> HTTP(비보안 비디오 배달)를 사용하는 경우 이전에 복사한 비디오 서비스 URL 값에서 https를 http로 변경했는지 확인하십시오. | `public/` |
   | HTTPS | `public-ssl/` |
