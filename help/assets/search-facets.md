...
| [!UICONTROL 파일 크기] | 검색 조건자를 사용하여 크기를 기준으로 자산을 검색합니다. 구성 가능한 노드에서 슬라이더 옵션을 선택하는 슬라이더 기반 조건자입니다. 기본 옵션은 CRXDE 저장소의 /libs/dam/options/predictions/filesize에서 정의됩니다. 파일 크기가 바이트 단위로 제공됩니다. | <ul><li>레이블</li><li>속성 이름</li><li>경로</li><li>설명</li></ul> |
