...
1. 빠른 게시 메뉴 목록에서 다음 옵션 중 **[!UICONTROL 하나를]** 선택합니다.
   ...
   | Dynamic Media에 게시 | 선택한 자산을 Dynamic Media에 즉시 게시합니다.<br>자산은 이미 Dynamic Media에 동기화되어야 합니다. 필요한 경우 폴더 속성의 **[!UICONTROL 동기화 모드]** 가 이 폴더 하위 트리의 모든 것 **[!UICONTROL 동기화에서 동적 미디어로 이미 설정되어 있는지 확인하십시오]**. |
