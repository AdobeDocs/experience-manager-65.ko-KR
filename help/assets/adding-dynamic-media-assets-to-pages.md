...
AEM을 WCM으로 사용하는 경우 Dynamic Media 자산을 페이지에 직접 추가합니다. WCM에 대해 서드 파티를 사용하는 경우, [link](/help/assets/linking-urls-to-yourwebapplication.md) 또는 [embed](/help/assets/embed-code.md) 자산을 사용하십시오. 응답형 타사 웹 사이트의 경우 응답형 사이트[에 최적화된 이미지 배달을 참조하십시오.](/help/assets/responsive-site.md)

>[!NOTE]
>
>AEM의 페이지에 자산을 추가하려면 먼저 자산을 게시해야 합니다. [다이내믹 미디어 자산 게시](/help/assets/publishing-dynamicmedia-assets.md)를 참조하십시오.
...
1. 페이지 왼쪽의 패널에서(사이드 패널의 표시 전환 필요) **[!UICONTROL 구성 요소]** 아이콘을 클릭합니다.
1. **[!UICONTROL 구성 요소]** 머리글의 드롭다운 목록에서 **[!UICONTROL 다이내믹 미디어를 선택합니다.]**
...
1. 페이지에 배치한 Dynamic Media 구성 요소에 따라 구성 대화 상자가 열립니다. [필요한 구성 요소의 ](/help/assets/adding-dynamic-media-assets-to-pages.md#dynamic-media-components) 옵션을 설정합니다.
...
1. **[!UICONTROL 다이내믹 미디어가 표시될 때까지 스크롤합니다.]**
...
**[!UICONTROL 구성 요소]** 아이콘을 누른 다음 **[!UICONTROL 다이내믹 미디어를 필터링하면 동적 미디어 구성 요소를 사용할 수 있습니다.]**
...
구성 요소의 **[!UICONTROL 편집]** 아이콘을 누른 다음 **[!UICONTROL 다이내믹 미디어 설정을 탭하여 *다음 다이내믹 미디어 설정을 편집해야 합니다.]***

![dm-settings-image-preset](assets/dm-settings-image-preset.png)

>[!NOTE]
>
>기본적으로 Dynamic Media 이미지 구성 요소는 적응형입니다. 고정 크기로 설정하려면 **[!UICONTROL Width]** 및 **[!UICONTROL Height와 함께**[!UICONTROL &#x200B;고급&#x200B;]**탭의 구성 요소에서 설정하십시오.]**
...
* 2:1 종횡비
* `equirectangular` 키워드 또는 (`spherical` + `panorama`) 또는 (`spherical` + `panoramic`) 키워드로 태그되었습니다. [태그 사용](/help/sites-authoring/tags.md)을 참조하십시오.
...
Dynamic Media 계정으로 HTTP/2 사용을 시작하는 방법에 대한 자세한 내용은 [HTTP2 콘텐츠 배달](/help/assets/http2.md)을 참조하십시오.
