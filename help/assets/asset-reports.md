...
* [!UICONTROL 일 CQ DAM 이벤트 레코더] 서비스(**[!UICONTROL 도구]** > **[!UICONTROL 작업]** > **[!UICONTROL 웹 콘솔]**&#x200B;에서 사용)을 활성화합니다.
* 보고할 활동 또는 이벤트를 선택합니다. 예를 들어, 다운로드한 자산에 대한 보고서를 생성하려면 [!UICONTROL 자산 다운로드(DOWNLOADED)]를 선택합니다.
