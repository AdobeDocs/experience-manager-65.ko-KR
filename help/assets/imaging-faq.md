...
**[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL 일반 설정]** **[!UICONTROL 게시된 서버 이름]**&#x200B;이라는 필드를 찾습니다. 현재 일반 도메인을 사용 중인 경우 기술 지원 티켓을 제출할 때 이 전환의 일부로 고유한 사용자 지정 도메인으로 이동을 요청할 수 있습니다.
