...
[이미지 작업 시](/help/assets/adding-dynamic-media-assets-to-pages.md#when-working-with-images) 및 [스마트 자르기 작업 시](/help/assets/adding-dynamic-media-assets-to-pages.md#when-working-with-smart-crop)를 참조하십시오.
...
아니오. 스마트 이미징은 Dynamic Media Classic 또는 Adobe Experience Manager - Dynamic Media(온-프레미스, AMS 및 Adobe Experience Manager as a Cloud Service)의 기존 라이선스에 포함되어 있습니다.
...
**[!UICONTROL 설치]** > **[!UICONTROL 응용 프로그램 설정]** > **[!UICONTROL 일반 설정]**&#x200B;게시된 서버 이름&#x200B;]**이라는 필드를 찾습니다.**[!UICONTROL  현재 일반 도메인을 사용 중인 경우 기술 지원 티켓을 제출할 때 이 전환의 일부로 고유한 사용자 지정 도메인으로 이동을 요청할 수 있습니다.
