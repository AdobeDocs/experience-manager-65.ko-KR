...
>[!NOTE]
>
>이 설명서에서는 Adobe Experience Manager에 직접 통합된 Dynamic Media 기능에 대해 설명합니다. Experience Manager에 통합된 Dynamic Media Classic을 사용하는 경우 다음을 참조하십시오. [Dynamic Media Classic 통합 설명서](/help/sites-administering/scene7.md).
>
>다음을 참조하십시오 [이중 사용 시나리오](/help/sites-administering/scene7.md#dual-use-scenario) Dynamic Media과 함께 Dynamic Media Classic과 통합된 Experience Manager을 사용하려는 경우.

Dynamic Media을 관리하는 경우 다음 항목이 유용합니다.

* [Dynamic Media 구성 - Scene7 모드](config-dms7.md) - 신규 Dynamic Media 고객인 경우 이 구성을 사용합니다.
