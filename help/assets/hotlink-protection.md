...
[Experience Manager 고객 지원 센터](https://experienceleague.adobe.com/ko?support-solution=Experience+Manager#support)는 CDN(Content Delivery Network) 수준에서 레퍼러 필터를 구성하여 도메인에 대해 허용된 웹 사이트 목록의 웹 사이트에만 Dynamic Media 콘텐츠가 제공되도록 할 수 있습니다.
