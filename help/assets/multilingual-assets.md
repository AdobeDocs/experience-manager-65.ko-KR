...
번역 워크플로우를 자동화하려면 번역 서비스 제공업체를 [!DNL Experience Manager]과 통합하고 에셋을 여러 언어로 번역하는 프로젝트를 만듭니다. [!DNL Experience Manager] 인간 및 기계 번역 워크플로우를 지원합니다.

인간 번역:번역된 에셋이 반환되고 [!DNL Experience Manager]으로 가져옵니다. 번역 공급자가 [!DNL Experience Manager]과(와) 통합되면 [!DNL Experience Manager] 및 번역 공급자 사이에 자산이 자동으로 전송됩니다.
...
컨텐츠 조각에 대한 번역 프로젝트 만들기[를 참조하십시오.](creating-translation-projects-for-content-fragments.md)
