...
인간 번역:번역된 자산이 반환되고 [!DNL Experience Manager]으로 가져옵니다. 번역 공급자가 [!DNL Experience Manager]과 통합되면 [!DNL Experience Manager] 및 번역 공급자 간에 자산이 자동으로 전송됩니다.
...
번역 서비스 공급자가 [!DNL Experience Manager]과 통합할 커넥터를 제공하지 않는 경우 [대체 프로세스](/help/sites-administering/tc-manage.md#exporting-a-translation-job)를 사용하십시오.
