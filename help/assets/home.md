...
description: 이 안내서에서는 디지털 자산을 만들고, 관리하고, 제공하고, 최적화하는 방법과 같은 모든 Experience Manager 자산 작업에 대해 다룹니다.
seo-description: 디지털 자산을 만들고, 관리하고, 제공하고, 최적화하는 방법과 같은 모든 Adobe Experience Manager 자산 작업에 대해 다룹니다.
...
이 안내서에서는 디지털 자산을 만들고, 관리하고, 제공하고, 최적화하는 방법과 같은 모든 Experience Manager 자산 작업에 대해 다룹니다.

## 주요 Experience Manager 아티클
...
## Adobe Experience Manager 6.5 사용자 가이드

| 사용 안내서 | 설명 |
|--- |---|
| [릴리스 정보](/help/release-notes/home.md) | 최신 릴리스의 새로운 기능, 지원되는 플랫폼, 가치 하락과 제거된 기능, 알려진 문제 등 중요한 정보를 제공합니다 |
...
| [관리 안내서](/help/sites-administering/home.md) | Adobe Experience Manager 관리 방법 이해 |
...
| [배포 사용 안내서](/help/sites-deploying/home.md) | 이 안내서는 Experience Manager의 기본 사항을 보여줍니다. |
| [개발 사용 안내서](/help/sites-developing/home.md) | Adobe Experience Manager 인스턴스 구축 방법 |
...
| [Experience Manager Livefyre](https://marketing.adobe.com/resources/help/ko_KR/livefyre/home.html) | 이 안내서에서는 사용자가 생성한 컨텐츠를 [!DNL Livefyre]와 공유하는 방법을 보여 줍니다. |

## Experience Manager의 주요 리소스

* [Experience Manager 비디오 자습서](https://helpx.adobe.com/kr/experience-manager/kt/index/aem-6-5-videos.html#Assets)
* [GDPR 준비 완료](/help/managing/data-protection-and-privacy.md)
* [Experience League](https://guided.adobe.com/?mv=other#recommended/solutions/experience-manager)
* [Experience Manager Assets 커뮤니티 포럼](https://experienceleaguecommunities.adobe.com/t5/Adobe-Experience-Manager-Assets/ct-p/experience-manager-assets-community)
