...
>[!NOTE]
>
> 비공개 폴더에는 항상 소유자 역할이 있는 구성원이 하나 이상 있습니다.
...
1. [ **[!UICONTROL 폴더 속성]** ] 페이지의 [사용자 **[!UICONTROL 추가]** ] 목록에서 사용자를 선택하고 비공개 폴더의 사용자에게 역할을 할당한 다음 **[!UICONTROL 추가를 클릭합니다]**.
   ...
   >[!NOTE]
   >
   > 비공개 폴더에는 항상 소유자 역할이 있는 구성원이 하나 이상 있습니다. 따라서 관리자는 비공개 폴더에서 모든 소유자 구성원을 제거할 수 없습니다. 그러나 비공개 폴더 관리자에서 기존 소유자를 제거하려면 다른 사용자를 소유자로 추가해야 합니다.
