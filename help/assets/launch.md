...
통합에 [대한 사용 사례에서](#use%20cases%20for%20the%20integration)언급했듯이 AEM Sites의 새로운 Adobe Launch 통합과 포함 코드를 사용하여 Dynamic Media 뷰어를 추적할 수 있습니다.
...
Adobe Analytics 구성 및 Adobe [Launch 구성](#configuringadobeanalytics) 섹션에서 구성 [단계를 완료해야](#configuringadobelaunch) 합니다. 그러나 AEM 관련 구성 단계는 필요하지 않습니다.
...
AEM [Dynamic Media의 포함 코드 기능을 사용하는](https://helpx.adobe.com/experience-manager/6-5/help/assets/embed-code.html) 방법에 대한 자세한 내용은 웹 페이지에 비디오 또는 이미지 뷰어 포함을 참조하십시오.
...
* (선택 사항;비디오 추적이 필요한 경우에만 필요) *오디오 및 비디오용 Adobe Media Analytics* 확장
...
* AEM 작성자 노드가 다이내믹 미디어 - Scene7 실행 모드(dynamicmedia_s7)에서 설정되었습니다.
