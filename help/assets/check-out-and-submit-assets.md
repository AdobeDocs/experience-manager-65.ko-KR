...
1. 도구 모음에서 체크 아웃을 **[!UICONTROL 클릭합니다]**.
...
다른 사용자가 체크 아웃한 자산을 편집할 수 있는지 확인하려면 다른 사용자로 로그인합니다. 체크 아웃한 자산의 축소판에 잠금 기호가 표시됩니다.
   ...
   속성 보기를 **[!UICONTROL 클릭하여]** 잠긴 자산에 대한 메타데이터를 편집할 수 있습니다.

1. 편집을 **[!UICONTROL 클릭하여]** 자산을 편집 모드로 엽니다.
...
1. 인터페이스에서 편집된 자산을 선택하고 [!DNL Assets] 도구 **[!UICONTROL 모음에서 체크]** 인을 클릭합니다. 수정된 자산은 AEM 자산에 체크 인되며 다른 사용자가 편집할 수 있습니다.
...
1. 도구 모음에서 잠금 **[!UICONTROL 해제를 클릭합니다]**. 에셋이 다시 체크 인되어 다른 사용자가 편집할 수 있습니다.
