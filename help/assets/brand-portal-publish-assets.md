...
AEM(Adobe Experience Manager) 자산 관리자는 자산 및 폴더를 AEM Assets 브랜드 포털 인스턴스에 게시하거나 게시 워크플로우를 나중 날짜/시간으로 예약할 수 있습니다. 하지만 먼저 브랜드 포털에서 AEM 자산을 구성해야 합니다. 자세한 내용은 브랜드 포털에서 [AEM 자산 구성을 참조하십시오](/help/assets/configure-aem-assets-with-brand-portal.md).
