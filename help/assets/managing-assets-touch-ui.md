...
1. 자산을 선택하고 도구 모음에서 **[!UICONTROL 삭제]** 옵션 ![](assets/do-not-localize/deleteoutline.png) 을 클릭합니다.

1. 확인 대화 상자에서 다음 옵션 중 하나를 선택합니다.
...
브라우저의 [!DNL Assets] 사용자 인터페이스에서 폴더 또는 컬렉션을 검색할 때 오른쪽 위 모서리에서 모두 [!UICONTROL 선택] 옵션을 사용하여 표시되거나 로드된 모든 자산을 선택할 수 있습니다. 처음에는 100개의 에셋만 카드 보기로 로드되고 200개가 목록 보기로 로드됩니다. 검색 결과 페이지를 스크롤할 때 더 많은 자산이 보기에 로드됩니다. 모두 [!UICONTROL 선택] 옵션은 로드된 자산만 선택합니다.
