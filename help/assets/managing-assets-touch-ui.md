...
1. 미리 보기 모드에서는 [지원되는 이미지 유형](/help/assets/assets-formats.md#supported-raster-image-formats) (대화형 편집 포함)에 대해 확대/축소 옵션을 사용할 수 있습니다.
   ...
   ![사용자를 원래 보기로 되돌리도록 재설정](assets/chlimage_1-11.png)
...
1. 인터페이스에서 하나 이상의 자산을 선택하고 도구 모음에서 [!DNL Assets] 복사 **** 를 클릭합니다. 또는 자산 카드에서 **[!UICONTROL 빠른]** 작업 복사를 선택합니다.
   ![자산 인터페이스의 도구 모음에 있는 복사 옵션](assets/copy_icon.png)
...
1. 도구 모음에서 **[!UICONTROL 자산]** 붙여넣기 옵션을 클릭합니다.

   ![자산 도구 모음의 붙여넣기 옵션](assets/chlimage_1-14.png)
...
1. 자산을 선택하고 도구 모음에서 **[!UICONTROL 이동]** 옵션을 클릭합니다.
   ![자산 도구 모음에서 이동 옵션](assets/move_icon.png)
...
1. 변환을 보거나 삭제하려면 변환을 선택합니다.
   ...
   **변환 삭제**
   ...
   표현물 **[!UICONTROL 패널에서]** 변환을 선택한 다음 도구 모음에서 **[!UICONTROL 변환]** 삭제 옵션을 클릭합니다. 자산 처리가 완료된 후에는 변환을 일괄 삭제할 수 없습니다. 개별 자산의 경우 사용자 인터페이스에서 변환을 수동으로 제거할 수 있습니다. 여러 자산의 경우 Experience Manager을 사용자 지정하여 특정 표현물을 삭제하거나 자산을 삭제하고 삭제된 자산을 다시 업로드할 수 있습니다.

   ![변환 삭제 옵션](assets/delete_renditionicon.png)

   **새 변환 업로드**

   자산에 대한 자산 세부 사항 페이지로 이동하고 도구 모음에서 **[!UICONTROL 변환]** 추가 옵션을 클릭하여 자산에 대한 새 변환을 업로드합니다.

   ![새 변환을 업로드하기 위한 변환 추가 옵션](assets/chlimage_1-16.png)
...
1. 자산을 선택하고 도구 모음에서 **[!UICONTROL 삭제를]** 클릭합니다.

   ![삭제 옵션](assets/delete_icon.png)
...
1. 게시를 취소할 자산/폴더를 선택하고 도구 모음에서 **[!UICONTROL 게시]** 관리 옵션을 클릭합니다.

   ![게시 관리 옵션](assets/manage_publication.png)
...
1. [ **실행 취소** ] 및 **다시 실행** 옵션을 사용하여 잘리지 않은 이미지로 되돌리거나 잘린 이미지를 각각 유지합니다.

   ![실행 취소 및 다시 실행 옵션](assets/chlimage_1-25.png)

1. 해당 [ **회전** ] 옵션을 클릭하여 이미지를 시계 방향 또는 반시계 방향으로 회전합니다.

   ![시계 방향 및 반시계 방향 회전 옵션](assets/chlimage_1-26.png)

1. 이미지를 가로 또는 세로로 뒤집으려면 적절한 **뒤집기** 옵션을 클릭합니다.

   ![이미지를 가로 또는 세로로 뒤집는 옵션](assets/chlimage_1-27.png)

1. 마침 **마침** 옵션 ![](assets/chlimage_1-24.png) 을 클릭하여 이미지 편집을 완료합니다. 마침 **을** 클릭하면 표현물의 재재생도 시작됩니다.
...
1. 도구 모음 **[!UICONTROL 에서]** 인쇄를 클릭합니다.

   ![툴바의 인쇄 옵션](assets/chlimage_1-40.png)
