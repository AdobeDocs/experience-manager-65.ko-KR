...
>[!CAUTION]
>
>기준: [!DNL Experience Manager] 6.4. 클래식 UI는 더 이상 사용되지 않습니다. 공지에 대해서는 다음을 참조하십시오. [사용이 중단되거나 제거된 기능](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/deprecated-removed-features.html). Adobe 터치 지원 UI를 사용하는 것이 좋습니다. 사용자 지정에 대해서는 [검색 패싯](/help/assets/search-facets.md).
