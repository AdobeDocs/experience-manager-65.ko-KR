...
* **이미지 형식**:이미지 구성 요소에서 지원하는 이미지 [형식은 연결된](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/image.html) 자산에서 지원됩니다. Dynamic Media 이미지는 지원되지 않습니다.
