...
[Assets REST API](/help/assets/mac-api-assets.md)를 사용하면 Adobe Experience Manager 개발자가 CRUD 작업(만들기, 읽기, 업데이트, 삭제)을 통해 HTTP API를 통해 직접 컨텐츠(AEM에 저장됨)에 액세스할 수 있습니다.
...
* [엔티티 유형](/help/assets/assets-api-content-fragments.md#entity-types). 여기서 지원되는 각 유형에 해당하는 기능(컨텐츠 조각과 관련)이 설명되어 있습니다
...
* 만들기가 작성자 인스턴스([에 바인딩되어 있고, 현재 이 API](/help/assets/assets-api-content-fragments.md#limitations))를 사용하여 게시할 조각을 복제할 방법이 없습니다.
...
>[!CAUTION]
>
>AEM 인스턴스의 Dispatcher 구성은 `/api`에 대한 액세스를 차단할 수 있습니다.
