...
* 웹 사이트가 AEM에 없는 경우 다음 중 하나를 선택할 수 있습니다.
   ...
   * 사이트가 반응하는 경우 최적화된 이미지를 [제공할 수 있습니다.](/help/assets/responsive-site.md)
...
* [Dynamic Media에서 핫링크 보호 활성화](https://helpx.adobe.com/experience-manager/6-4/help/assets/hotlink-protection.html)
* [웹 애플리케이션에 URL 연결](/help/assets/linking-urls-to-yourwebapplication.md)
* [반응형 사이트에 최적화된 이미지 제공](/help/assets/responsive-site.md)
* [HTTP2 컨텐츠 전달](/help/assets/http2.md)
