...
MSM(다중 사이트 관리자)을 사용하면 여러 위치에서 동일한 사이트 콘텐츠를 사용할 수 있습니다. 이를 위해 MSM은 라이브 카피 기능을 사용합니다:
...
AEM에서 라이브 카피를 만들 때 라이브 카피 분기를 확인하고 탐색할 수 있으며 라이브 카피 분기에 일반 AEM 기능을 사용할 수 있습니다. 즉, 사용자(또는 프로세스)는 라이브 카피 분기(예: 페이지 및/또는 단락) 내에 새 리소스를 만들 수 있습니다. `myCanadaOnlyProduct`).
