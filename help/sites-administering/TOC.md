...
+ 작업 {#operations}
   ...
   + [대량 편집기](bulk-editor.md)
   + [이메일 알림 구성](notification.md)
   + [링크 확인기](external-link-checker.md)
...
+ 보안 {#security}
   ...
   + [Production Ready 모드에서 AEM 실행](production-ready.md)
   ...
   + [AEM에서 CRXDE Lite 사용](enabling-crxde-lite.md)
   ...
   + [권한 관리에 대한 주 보기](touch-ui-principal-view.md)
   + [내용 처리 필터](content-disposition-filter.md)
...
+ 개인화 {#personalization}
   ...
   + [캠페인](campaigns.md)
   + [ContextHub를 사용하여 세그먼트 구성](segmentation.md)
   + [세그먼트 구성](campaign-segmentation.md)
   + [랜딩 페이지를 위한 디자인 가져오기 도구 확장 및 구성](extending-the-design-importer-for-landingpages.md)
...
+ 통합 {#integration}
   ...
   + [Adobe Analytics 속성을 사용한 구성 요소 데이터 매핑](adobeanalytics-mapping.md)
   ...
   + [SharePoint Connector 라이선스, 저작권 고지 사항 및 고지 사항](sharepoint-connector-licenses.md)
   ...
   + [외부 공급자를 통한 분석](external-providers.md)
   + [Adobe Marketing Cloud과 통합](marketing-cloud.md)
   + [Adobe Target와의 통합 수동 구성](target-configuring.md)
   + [Adobe Target과 통합을 위한 사전 요구 사항](target-requirements.md)
   + [Adobe I/O을 사용한 Adobe Target와의 통합](integration-ims-adobe-io.md)
   ...
   + [전자 메일 템플릿의 모범 사례](best-practices-for-email-templates.md)
...
+ 컨텐츠 관리 {#contentmanagement}
   ...
   + [태그 관리](tags.md)
   + [페이지 내보내기 도구](page-exporter.md)
   + [클래식 UI 태깅 콘솔](classic-console.md)
   + [화면에 대한 내용 관리](content-management-screens.md)
