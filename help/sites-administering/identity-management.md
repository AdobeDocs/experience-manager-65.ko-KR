...
>[!NOTE]
>
>프로필에 지정된 정보를 사용하여 [세그먼트](/help/sites-administering/campaign-segmentation.md) 및 [캠페인](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md)을 통해 사용자에게 타깃팅된 콘텐츠를 제공할 수도 있습니다.
...
/home 모든 사용자가 jcr:read rep:glob = */profile*
