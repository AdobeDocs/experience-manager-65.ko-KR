...
* [개인화 ](/help/sites-administering/personalization.md) 방문자가 웹 사이트에 액세스하는 방법을 구성할 수 있도록 해줍니다.

로그인(및 종료) 기능은 등록된 방문자(사용자)에 대한 추가 정보를 포함하는 **프로필**](#profiles-and-user-accounts)&#x200B;의 [ 계정에서 제공합니다. 등록 및 승인에 대한 실제 프로세스는 다음과 같이 다를 수 있습니다.

* 웹 사이트에서 직접 등록

   [커뮤니티 사이트](/help/communities/sites-console.md)는 방문자가 Facebook 또는 Twitter 계정에 직접 등록하거나 로그인할 수 있도록 구성할 수 있습니다.
...
>[!NOTE]
>
>프로필에 지정된 정보를 사용하여 [세그먼트](/help/sites-administering/campaign-segmentation.md) 및 [캠페인](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md)을(를) 통해 타깃팅된 컨텐츠를 사용자에게 제공할 수도 있습니다.

## 등록 Forms {#registration-forms}

[form](/help/sites-authoring/default-components.md#form-component)을 사용하여 등록 정보를 수집한 다음 새 계정과 프로필을 생성할 수 있습니다.
...
자격 증명이 입력될 때 로그인 프로세스를 활성화하는 **로그인** 버튼과 함께 방문자에게 **사용자 이름** 및 **암호**&#x200B;의 표준 필드를 제공합니다.
...
프로필에 대한 세부 정보를 보려면 페이지의 오른쪽 위 모서리에 있는 **내 프로필**&#x200B;을 클릭하십시오.예: `admin` 계정
`http://localhost:4502/home/users/a/admin/profile.form.html/content/geometrixx-outdoors/en/user/profile.html.`

작성 환경에서 충분한 권한이 있는 [클라이언트 컨텍스트](/help/sites-administering/client-context.md)를 사용하여 다른 프로필을 볼 수 있습니다.

1. 페이지를 엽니다.예를 들어, Geometrixx 페이지:

   `http://localhost:4502/cf#/content/geometrixx/en.html`

1. 오른쪽 상단 모서리에서 **내 프로필**&#x200B;을 클릭합니다. 현재 계정의 프로필이 표시됩니다.예를 들어, administrator입니다.
1. 클라이언트 컨텍스트를 열려면 **control-alt-C**&#x200B;를 누르십시오.
1. 클라이언트 컨텍스트의 왼쪽 상단에서 **프로필 로드** 단추를 클릭합니다.

   ![](do-not-localize/loadprofile.png)

1. 대화 상자 창의 드롭다운 목록에서 다른 프로파일을 선택합니다.예: **Alison Parker**
1. **확인**&#x200B;을 클릭합니다.
1. **내 프로필**&#x200B;을 다시 클릭합니다. 그 양식은 앨리슨의 세부 사항으로 갱신될 것이다.
...
1. **내 프로필** 페이지를 두 번 클릭하여 편집합니다.
1. 사이드 킥의 **구성 요소** 탭에서 **양식** 섹션을 확장합니다.
1. 사이드킥의 **드롭다운 목록**&#x200B;을 **About me** 필드 바로 아래에 폼으로 드래그합니다.
...
표준 설치(작성자 또는 게시)에서는 모든 사용자가 모든 사용자의 전체 프로필 정보에 대한 읽기 권한을 갖습니다. 모든 사용자가 &quot;*모든 기존 사용자와 그룹을 자동으로 포함하는 기본 제공 그룹입니다. 구성원 목록은*&quot;을(를) 편집할 수 없습니다.
