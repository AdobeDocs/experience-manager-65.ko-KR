...
[AEM Communities 6.1](/help/communities/overview.md) 확장을 사용하면 UGC용 [일반 저장소](/help/communities/working-with-srp.md)를 사용하여 이 문제를 해결합니다. 개인화와 관련하여, 커뮤니티에는 사이트 방문자가 Facebook 및 Twitter에 로그인할 수 있는 옵션을 제공하는 기능인 [소셜 로그인](/help/communities/social-login.md)이 포함되어 있습니다.
