...
1. *https://&lt;serveraddress>:&lt;serverport>/system/console/configMgr*&#x200B;의 AEM 웹 콘솔로 이동
1. 왼쪽 위 모서리에서 **Main - Crypto Support**&#x200B;으로 이동합니다.
...
1. 5단계에서 보호된 텍스트를 복사하여 OSGI 양식 값에 붙여넣습니다. 이 예에서 암호화된 **SMTP 암호**&#x200B;가 *일 CQ 메일 서비스*&#x200B;에 추가됩니다.
