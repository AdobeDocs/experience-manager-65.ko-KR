...
소프트웨어 배포는 제품 기능, 예 및 핫픽스를 배포하는 데 사용됩니다. 자세한 내용은 [소프트웨어 배포 설명서](https://experienceleague.adobe.com/docs/experience-cloud/software-distribution/home.html#software-distribution)를 참조하십시오.
...
1. **허용 목록 무시**&#x200B;를 선택합니다.
1. 화이트리스트 번들 기본값에 `com.day.cq.dam.cq-dam-jcr-connectors` 추가
1. 저장을 클릭합니다.
...
1. `basic auth` 패키지를 다운로드하여 설치합니다. `zip` 소프트웨어 배포
