...
* **제한:** 간격을 사용하여 결과 수를 제한합니다. 예를 들어 limit:10..20 간격은 0을 기준으로 하고, start는 포괄적이며, end는 배타적입니다. 열기 간격을 지정할 수도 있습니다:limit:10 또는 제한:..20 점이 생략되고 하나의 값만 지정된 경우 GQL은 최대 이 수의 결과를 반환합니다. 예를 들어 limit:10(처음 10개의 결과를 반환합니다)입니다.

### 컨텐츠 내보내기 {#exporting-content}

콘텐츠를 내보내고 Excel 스프레드시트에서 변경해야 할 수 있습니다. 예를 들어 메일 목록을 내보내고 나열된 모든 전화번호의 지역 번호를 Excel에서 직접 변경하거나 다른 회선을 추가할 수 있습니다.
