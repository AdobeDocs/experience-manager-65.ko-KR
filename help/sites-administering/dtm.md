...
* OSGi 구성의 경우 서비스 PID는 입니다. `com.adobe.cq.dtm.impl.servlets.DTMDeployHookServlet`.
...
일부 속성은 Dynamic Tag Management 웹 속성에 대한 포함 탭의 라이브러리 다운로드 섹션에서 가져온 값을 사용합니다. 자세한 내용은 [라이브러리 다운로드](https://microsite.omniture.com/t2/help/en_US/dtm/#Library_Download) Dynamic Tag Management 도움말에서 참조할 수 있습니다.
...
>
>다음은 을(를) 통해 직접 가져옵니다. [DTM 구성](#creating-the-dynamic-tag-management-configuration).
>
>* `myconfig`
>* `companyID`
>* `propertyID`
