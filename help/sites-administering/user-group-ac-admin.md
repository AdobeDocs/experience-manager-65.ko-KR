...
* **저장소**
   ...
   저장소 수준 액세스 제어를 선택합니다. 예를 들어 `jcr:namespaceManagement` 권한 - 노드가 아니라 저장소에만 해당됩니다.
...
액세스 제어 항목을 추가할 때 다음 권한을 선택할 수 있습니다( [보안 API](https://developer.adobe.com/experience-manager/reference-materials/spec/javax.jcr/javadocs/jcr-2.0/javax/jcr/security/Privilege.html) 자세한 내용:
