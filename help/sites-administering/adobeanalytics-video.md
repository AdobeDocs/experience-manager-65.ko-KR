...
>[!NOTE]
>
>계속하기 전에 AEM 내에서 재생 가능한 비디오** **가** 업로드되었는지 확인하십시오.
...
1. CQ 변수를 Adobe Analytics 속성에 매핑하려면 ContentFinder에서 구성 요소의 CQ 변수 옆에 있는 Adobe Analytics 속성을 드래그합니다.
   ...
   매핑 최적화에 대한 자세한 내용은 Adobe Analytics [의 비디오 측정 안내서를 참조하십시오](https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/hbvideo/video_overview.html) .
...
* Adobe Analytics 속성을 사용하여 매핑하기 위해 정의된 CQ 변수의 [정적 집합](#cqvars) .
...
1. 이러한 변수를 prop 1 - 3에 매핑
   ...
   호출에서 **나머지 관련 정보는** pev3이라는 **하나의** 변수로 **연결됩니다**.
