...
* Adobe Analytics 속성을 사용한 매핑에 대해 정의된 [CQ 변수](#cqvars)의 정적 집합입니다.
...
>[!NOTE]
>
>DAM에서 편집할 비디오를 열고 **제목** 메타데이터 필드를 원하는 이름으로 설정하여 비디오의 **사용자 친화적인** 이름을 설정할 수 있습니다. 또한 완료되면 변경한 내용을 저장해야 합니다.

1. 이러한 변수를 prop 1에서 3에 매핑합니다

   호출에서 나머지 관련 정보&#x200B;**는** pev3 **라는 이름의 하나** 변수로 연결됩니다.****
