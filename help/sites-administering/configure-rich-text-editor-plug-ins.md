...
|---|---|---|---|
| 이름 | 기능 | 기능 | 기능 |
| 유형 | 문자열 | String[] (다중 문자열) type 을 String으로 설정하고 Multi in CRXDE Lite 클릭) | 문자열 |
...
1. 스타일시트를 만들고 해당 경로를 지정합니다. [스타일시트 위치 지정](#locationofstylesheet)을 참조하십시오. 스타일시트에 다음 내용을 추가합니다. 원하는 대로 배경색을 변경합니다.
