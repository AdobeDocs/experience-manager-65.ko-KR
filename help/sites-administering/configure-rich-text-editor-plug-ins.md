...
|---|---|---|---|
| 이름 | 기능 | 기능 | 기능 |
| 유형 | 문자열 | String[] (다중 문자열; CRXDE Lite에서 Type을 String으로 설정하고 Multi 클릭) | 문자열 |
...
* 클립보드 내용을 일반 텍스트로 붙여넣습니다. AEM 구성 요소에 삽입하기 전에 복사한 콘텐츠에서 스타일 및 서식의 모든 요소를 제거합니다. 아래 `plaintext`을(를) 사용하여 구성되었습니다.
...
Microsoft® Word와 같은 다른 프로그램에서 AEM에 붙여넣을 때 허용되는 스타일을 명시적으로 정의할 수 있도록-as-Microsoft-Word(`paste-wordhtml`) 모드를 추가로 구성할 수 있습니다.
