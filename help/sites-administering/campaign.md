...
AEM과 [Adobe Campaign Standard](https://experienceleague.adobe.com/docs/campaign-standard.html)(ACS)의 통합은 AEM이 AMS(Adobe 관리 서비스)의 온-프레미스에 설치되어 있는지 여부에 따라 달라집니다.
