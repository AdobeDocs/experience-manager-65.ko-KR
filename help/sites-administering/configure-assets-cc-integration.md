...
Adobe Experience Cloud 고객인 경우, Adobe Experience Manager(AEM) 자산 내의 자산을 Adobe Creative Cloud과 동기화하거나의 자산을 동기화할 수 있습니다. 또한 자산을 Experience Cloud과 동기화하거나 그 반대로 동기화할 수 있습니다. Adobe I/O을 통해 이 동기화를 설정할 수 있습니다.
...
>[!CAUTION]
>
>AEM-Creative Cloud 폴더 공유 기능은 AEM Assets에서 더 이상 사용되지 않습니다. [AEM 및 Creative Cloud 통합 우수 사례](/help/assets/aem-cc-integration-best-practices.md)에서 대체 항목을 자세히 살펴보고 찾을 수 있습니다.
...
1. **[!UICONTROL 구성 만들기]** 대화 상자에서 새 구성의 제목과 이름을 지정하고 **[!UICONTROL 만들기]**&#x200B;를 클릭합니다.
   ...
   ![AEM Assets 및 CC를 통합할 수 있는 새로운 구성 이름 지정](assets/chlimage_1-51.png)
...
1. **[!UICONTROL 테넌트 URL]** 필드에서 AEM Assets의 URL을 지정합니다.
   ...
   >
   >1. **도구 > Cloud Services > 기존 Cloud Services**&#x200B;으로 이동합니다.
   1. Adobe Marketing Cloud 아래에서 **구성 표시**&#x200B;를 클릭합니다.
...
1. 프로시저 [Marketing Cloud](/help/sites-administering/configure-assets-cc-integration.md#add-a-new-configuration-to-marketing-cloud)의 마지막 단계에서 언급한 다음 방법 중 하나를 사용하여 공개 키를 표시합니다. **[!UICONTROL 공개 키 표시]**&#x200B;를 클릭합니다.
...
1. 자산 콘솔에서 폴더를 만들고 여기에 자산을 업로드합니다. 예를 들어 폴더 **mc-demo**&#x200B;를 만들고 여기에 자산을 업로드합니다.
1. 폴더를 선택하고 **공유** ![assets_share](assets/assets_share.png)를 클릭합니다.
1. 메뉴에서 **[!UICONTROL Adobe Marketing Cloud]**&#x200B;을 선택하고 **[!UICONTROL 공유]**&#x200B;를 클릭합니다. 폴더가 Marketing Cloud과 공유되었음을 알리는 메시지가 표시됩니다.

   ![chlimage_1-55](assets/chlimage_1-55.png)

   >[!NOTE]
   `sling:OrderedFolder` 유형의 자산 폴더 공유는 Adobe Marketing Cloud의 공유 컨텍스트에서 지원되지 않습니다. 폴더를 공유하려면 AEM Assets에서 폴더를 만들 때 **[!UICONTROL 주문됨]** 옵션을 선택하지 마십시오.
