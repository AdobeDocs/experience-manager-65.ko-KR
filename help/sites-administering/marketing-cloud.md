...
[Adobe Target](https://business.adobe.com/kr/products/target/adobe-target.html)은(는) 마케터가 온라인 테스트를 디자인 및 실행하고, 즉석으로 대상 세그먼트를 만들고(행동 기반), 콘텐츠 및 온라인 경험의 타깃팅을 자동화하는 데 사용합니다.
...
[Adobe 동적 Tag Management](https://business.adobe.com/kr/products/experience-platform/adobe-experience-platform.html)은(는) 마케터에게 직관적인 도구를 제공하여 무제한의 Adobe 및 타사 태그를 빠르고 쉽게 관리할 수 있도록 합니다. IT 리소스에 대한 의존도를 줄이면서 거의 모든 것을 온라인으로 최적화할 수 있는 더 많은 제어력과 유연성을 제공합니다.
...
[Adobe Campaign](https://business.adobe.com/kr/products/campaign/adobe-campaign.html)을(를) 사용하면 Adobe Experience Manager에서 직접 전자 메일 게재 콘텐츠를 관리할 수 있습니다.
