...
워크플로우 모델 콘솔에 나열된 모델 중 하나를 기준으로 워크플로우 [을 시작할 수 있습니다. ](/help/sites-administering/workflows.md#workflow-models-and-instances) 필수 정보는 페이로드이지만 제목 및/또는 댓글도 추가할 수 있습니다.
...
1. **도구**, **워크플로**&#x200B;를 사용하는 &lt;a0/>모델&#x200B;**콘솔로 이동한 다음**&#x200B;모델&#x200B;**으로 이동합니다.**
...
## 시작 관리자 구성 {#creating-a-launcher-configuration} 만들기

1. **도구**, **워크플로**&#x200B;를 사용하는 **워크플로 발사자** 콘솔로 이동한 다음 **방사포**&#x200B;로 이동합니다.
1. **만들기**&#x200B;를 선택한 다음 **실행 관리자 추가**&#x200B;를 선택하여 대화 상자를 엽니다.
   ...
   * **모드 실행**
      ...
      워크플로우 실행 프로그램이 적용되는 서버 유형입니다. **작성자**, **게시** 또는 **작성자 및 게시**&#x200B;를 선택합니다.
   ...
   * **활성화**
      ...
      * 구성 속성이 만족되면 워크플로우를 시작하려면 **활성화**&#x200B;를 선택합니다.
      * 워크플로가 실행되지 않아야 하는 경우(구성 속성이 충족될 때도 아님) **비활성화**&#x200B;을 선택합니다.
   * **제외 목록**
...
론처 구성을 만든 후 동일한 콘솔을 사용하여 인스턴스를 선택한 다음 **속성 보기**(및 편집) 또는 **삭제**&#x200B;를 선택하면 됩니다.
