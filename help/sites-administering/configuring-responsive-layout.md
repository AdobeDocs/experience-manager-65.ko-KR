...
구성 요소의 크기를 대화 방식으로 변경하여 장치/창 크기에 따라 레이아웃을 다시 정렬하는 응답형 웹 사이트를 만들고 편집할 수 있습니다. 그러면 사용자는 컨텐츠가 에뮬레이터를 사용하여 어떻게 렌더링되는지 볼 수 있습니다.
...
에뮬레이터를 포함하려면 사이트를 장치 그룹에 연결합니다. 자세한 내용은 [장치 목록 추가](/help/sites-developing/responsive.md#adding-the-devices-list) (클래식 및 터치에 적합한 UI 모두에 대해)
...
또한 [클라이언트 라이브러리](https://experienceleague.adobe.com/docs/) 추가 구성 및 함수 호출을 제공합니다. 다음 LESS 추출은 프로젝트에 추가해야 하는 최소값의 예입니다.
