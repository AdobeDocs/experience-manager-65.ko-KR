...
그러나 CRXDE Lite은 `org.apache.sling.jcr.davex` 번들이 제대로 작동하기 위해 종속되므로 WebDAV를 비활성화하면 CRXDE Lite도 효과적으로 비활성화됩니다.
...
1. `http://localhost:4502/system/console/components`의 OSGi 구성 요소 콘솔로 이동
1. 다음 구성 요소를 검색합니다.
