...
1. 다음 중 하나 사용:
   ...
   * [선택 모드](/help/sites-authoring/basic-handling.md#navigating-and-selection-mode)
   ...
   ![chlimage_1-6](do-not-localize/chlimage_1-18.png) chlimage_ ![1-7](do-not-localize/chlimage_1-19.png)
...
1. 모양을 클릭합니다.
1. 검색 아이콘을 클릭하면 자산 [선택기가 열립니다](../assets/search-assets.md#assetselector).
...
>[!NOTE]
>
>다음 예에서는 [캠페인에서](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md)직접 이루어지는 프로모션을 다루며, 이는 바우처에 사용됩니다.
>
