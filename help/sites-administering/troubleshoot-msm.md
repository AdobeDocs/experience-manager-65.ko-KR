...
* [MSM 모범 사례 문서](msm-best-practices.md)를 확인합니다. 여기에는 여러 가지 오해에 대한 설명과 함께 여러 팁이 제공됩니다.
...
이 문제를 방지하려면 **분리**&#x200B;가 아닌 Live Copy **일시 중단** 기능을 사용하십시오. **분리** 작업에 대한 자세한 내용은 [이 문서](msm-livecopy.md)를 참조하십시오.
