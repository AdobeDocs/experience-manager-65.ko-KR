...
# AEM 포털 및 포트릿{#aem-portals-and-portlets}
...
<table>
 <tbody>
  ...
  <tr>
   <td>htmlSelector</td>
   <td>각 URL에 추가되는 선택기입니다. 기본적으로 <strong>portlet</strong>이므로 html 페이지에 대한 모든 요청에서는 <strong>.portlet.html.</strong>로 끝나는 URL을 사용합니다. 포틀릿 렌더링을 위해 AEM 내의 사용자 지정 스크립트를 사용할 수 있습니다.</td>
  </tr>
  <tr>
...
* &quot;cq-author:edit&quot; : 이 권한을 사용하면 사용자는 컨텐츠의 편집 보기를 호출할 수 있습니다.
...
| {buttonWebsites tab} | AEM WCM의 웹 사이트 탭을 여는 단추로 대체된 자리 표시자. |
