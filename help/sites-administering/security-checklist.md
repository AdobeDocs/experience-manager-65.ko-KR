...
1. 문제 영역일 수 있는 기본 렌더러의 구성을 확인합니다.
   ...
   * 예방 조치로서 다른 기본 렌더러(HTML, 일반 텍스트, XML)를 비활성화해야 합니다. 다시 [Apache Sling GET Servlet](/help/sites-deploying/osgi-configuration-settings.md#apache-sling-get-servlet)을 구성하십시오.
