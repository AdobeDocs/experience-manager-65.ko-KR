...
>[!NOTE]
>
>블루프린트 구성을 사용하면 콘텐츠 변경 내용을 라이브 카피로 푸시할 수 있습니다. [라이브 카피 - 소스, 블루프린트 및 블루프린트 구성](/help/sites-administering/msm.md#source-blueprints-and-blueprint-configurations)을 참조하십시오.
