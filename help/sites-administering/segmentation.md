...
[대상](/help/sites-authoring/managing-audiences.md) 콘솔을 사용하여 ContextHub 또는 Client Context용 세그먼트와 Adobe Target 계정의 대상을 관리할 수 있습니다. 이 설명서에서는 ContextHub용 세그먼트 관리 방법에 대해 다룹니다. [Client Context 세그먼트](/help/sites-administering/campaign-segmentation.md) 및 Adobe Target 세그먼트의 경우 관련 설명서를 참조하십시오.
...
예를 들어, 주요 연령 그룹의 사용자를 식별하기 위한 간단한 세그먼트 정의는 사용자의 연령 및 성별을 기반으로 하는 간단한 세그먼트 정의입니다. 이러한 기준에 부합하는 특정 페르소나를 로드하면 해당 세그먼트가 정상적으로 배정된 경우 다음과 같이 표시됩니다.
