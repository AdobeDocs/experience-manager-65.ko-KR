...
1. 출처: [CRXDE Lite](/help/sites-developing/developing-with-crxde-lite.md) 상단 전환기 막대 사용
...
![공식 AEM 설치 또는 확장 썸네일](assets/official-installation.png)
...
패키지 공유는 콘텐츠 패키지를 배포하기 위한 중앙 집중식 공개 서비스였습니다. 패키지 공유가에 의해 대체되었습니다. [소프트웨어 배포](#software-distribution) 그리고 이 버튼은 더 이상 작동하지 않습니다.
...
1. 패키지 관리자에서 패키지를 삭제할 것인지 확인하는 메시지가 표시됩니다. 클릭 **확인** 삭제 확인.
