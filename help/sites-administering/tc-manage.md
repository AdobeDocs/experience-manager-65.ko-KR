...
이미 번역된 소스 페이지의 [이름을 변경하거나 위치를 이동](/help/sites-authoring/managing-pages.md#moving-or-renaming-a-page)해야 하는 경우 이동 후 페이지를 다시 번역하면 새 페이지 이름/위치를 기반으로 새 언어 사본이 만들어집니다. 이전 이름/위치를 기반으로 하는 이전 언어 사본은 여전히 존재합니다.
