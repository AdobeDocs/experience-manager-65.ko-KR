...
1. 이동 [https://portal.azure.com/](https://portal.azure.com/) 로그인하고
1. 검색 대상 **Azure Active Directory** 검색 막대에서 결과를 클릭합니다. 또는 다음 위치로 직접 이동할 수 있습니다 [https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/Overview](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/Overview)
1. 클릭 **앱 등록** - **새 등록**

   ![](assets/oauth-outlook1.png)

1. 요구 사항에 따라 정보를 입력한 다음 **등록**
1. 새로 만든 앱으로 이동하고 을(를) 선택합니다 **API 권한**
1. 이동 **권한 추가** - **그래프 권한** - **위임된 권한**
1. 앱에 대한 아래의 권한을 선택한 다음 를 클릭합니다 **권한 추가**:
   * `SMTP.Send`
   * `Mail.Read`
   * `Mail.Send`
   * `openid`
...
1. 다음으로 이동 **인증서 및 기밀**&#x200B;를 클릭하고 **새 클라이언트 암호** 및 화면의 단계에 따라 암호를 만듭니다. 나중에 사용할 수 있도록 이 암호를 반드시 기록하십시오
1. 누르기 **개요** 왼쪽 창에서 **애플리케이션(클라이언트) ID** 및 **디렉토리(테넌트) ID** 나중에 사용
