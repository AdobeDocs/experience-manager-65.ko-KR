...
배치된 을(를) 선택합니다 `Forum` 에 액세스하고 선택할 구성 요소 `Configure` 편집 대화 상자를 여는 아이콘.
...
* **조정됨**
   ...
   선택하면 게시사이트에 게시하기 전에 주제 및 댓글 게시를 승인해야 합니다. 기본값은 선택 취소되어 있습니다.
...
* **사용자가 주석 및 주제를 삭제하도록 허용**
   ...
   선택하면 게시한 댓글과 주제를 구성원이 삭제할 수 있도록 허용합니다. 기본값은 선택 취소되어 있습니다.
...
* **항목 이동**
   ...
   선택하면 게시측 중재자의 항목 이동을 허용합니다. 기본값은 선택되어 있습니다.
