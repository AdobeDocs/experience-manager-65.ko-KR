 ...
 <tbody>
  ...
  <tr>
   ...
   <td><em>(필수)</em> 'number|path' 형식의 다중 값 문자열
    ...
    </ul> 숫자가 증가하는 값이 되도록 문자열의 순서를 지정해야 하며 숫자와 경로 사이에 공백이 생기지 않아야 합니다.<br /> 예제 항목 :<br /> <code>80|/libs/settings/community/badging/images/gold-badge/jcr:content/gold.png</code></td>
  </tr>
  <tr>
   <td>배지 유형</td>
   <td>문자열</td>
...
**[일정 구성 요소](/help/communities/calendar.md)**
