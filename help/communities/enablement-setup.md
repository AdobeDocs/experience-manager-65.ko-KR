...
참여 커뮤니티 사이트 [를 만드는 자습서는 AEM Communities](overview.md#engagement-community)로 시작하기를 참조하십시오 [](getting-started.md).
...
커뮤니티 사이트에 [대해 Adobe Analytics이 구성된 경우 커뮤니티 구성원](analytics.md)(수강생)에게 할당된 활성 리소스 및 학습 경로에 대해 생성된 [보고서에](reports.md) 더 많은 정보를 사용할 수 있습니다.
...
AEM Communities 시작하기 자습서용으로 만든 태그의 샘플 패키지
