...
구성 요소의 [SocialEvent](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/adobe/cq/social/scf/core/SocialEvent.html) 인스턴스는 `actions` 그것은 `topic`. SocialEvent에는 `verb` 관련 작업을 수행한 후, 다음 항목이 있습니다 *n-1* 관계 간 `actions` 및 `verbs`.
...
사용자 지정 구성 요소의 경우 [SocialEvent 추상 클래스](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/adobe/cq/social/scf/core/SocialEvent.html) 구성 요소의 이벤트를 `actions`그것은 `topic`.
