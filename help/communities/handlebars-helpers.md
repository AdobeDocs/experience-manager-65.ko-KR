...
문자열 구분 모드 목록을 기준으로 [WCM 모드](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html)의 현재 값을 테스트하는 블록 도우미입니다.
...
* **컨텍스트**:문자열 또는 개체
   ...
   `this.id`을(를) 사용하여 요청된 resourceType을 렌더링하기 위해 `id`에서 리소스를 가져옵니다.
...
서버측에서 사용자 지정 SCF 도우미를 구현하고 등록하려면 Java 인터페이스 [TemplateHelper](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/adobe/cq/social/handlebars/api/TemplateHelper.html)을 구현하고 [OSGi 서비스](../../help/sites-developing/the-basics.md#osgi)로 만들고 OSGi 번들의 일부로 설치합니다.
