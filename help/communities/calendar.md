...
배치된 을(를) 선택합니다 `Calendar` 에 액세스하고 선택할 수 있는 구성 요소 `Configure` 편집 대화 상자를 여는 아이콘.
...
* **허용되는 표지 이미지 유형**
  ...
  구분 기호가 &quot;점&quot;인 쉼표로 구분된 이미지 파일 확장자 목록입니다. 기본값은 입니다 `.jpg,.jpeg,.png,.gif,.bmp`.

* **스레드된 회신 허용**

  선택하면 달력 이벤트에 게시된 댓글에 대한 답글을 허용합니다. 기본값은 선택되어 있습니다.

* **사용자가 주석 및 이벤트를 삭제하도록 허용**
...
>[!NOTE]
>
>방문 [태그 관리](/help/sites-administering/tags.md) 태그 네임스페이스(분류)를 추가하는 방법을 배울 수 있습니다.
