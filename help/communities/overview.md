...
* 포럼, 주석 및 기타 커뮤니티 컨텐츠를 통해 **통찰력을** 얻는 동안 UGC(사용자 생성 컨텐츠)라고 합니다.
* 게시 환경의 신뢰할 수 있는 **구성원에 의한 중재** ,
* **Twitter 및 Facebook을 통해 소셜 로그인** ,
* **커뮤니티 콘텐츠의 인라인 번역** ,
* **게시된 커뮤니티 사이트에서 커뮤니티 그룹 만들기** ,
* **배지** 수상을 하고
* **파일 공유**,
* **알림** 및 **활동 스트림**,
* 사용자 생성 컨텐츠에 등록된 다른 멤버의 **태그** (@언급)를 설정하여 관심을 유도할 수 있습니다.
* [카탈로그] 및 [강좌 재생], [할당], [파일 라이브러리] 등의 활성 구성 요소에서 **키보드 탐색을 지원합니다** .
...
* 선택한 [커뮤니티 사이트 템플릿을 기반으로 사이트의 기능](/help/communities/sites.md) 취합:
...
* 필수 기능 제공:
   ...
   * 로그인: 자가 등록, [소셜 로그인](/help/communities/social-login.md), 사용자 프로필
      ...
      * 알림:
구성원은 자신과 관련된 이벤트를 보고, 사용자가 생성한 컨텐츠는 [@mentreleased](/help/communities/overview.md#mentionssupport).

      * 메시지: 회원은 커뮤니티 사이트 내에서 메시지를 보내거나 받을 수 있습니다.
      * 검색: 커뮤니티 사이트 내에서 검색할 수 있는 기능
      * 언어 전환: 다국어 사이트 [](/help/sites-administering/translation.md)언어 선택 기능
...
새 커뮤니티 사이트를 빠르게 만드는 데 도움이 되는 손쉬운 방법을 경험하려면 AEM Communities [로 시작하기를 참조하십시오](/help/communities/getting-started.md).

## 커뮤니티 컨텐츠 지속성 {#community-content-persistence}

커뮤니티 콘텐츠의 성능 및 동기화를 향상시키려면 AEM Communities은 모든 AEM(작성자 및 게시) 인스턴스 간에 공유되는 사용자 생성 컨텐츠(UGC)에 대한 공용 저장소가 필요합니다.
...
작성 환경에서 전역 탐색 콘솔은 다음을 포함한 [커뮤니티 콘솔에](/help/communities/consoles.md)대한 액세스를 제공합니다.
...
* [구성 요소 가이드](/help/communities/components-guide.md)
   ...
   * 모든 커뮤니티 구성 요소의 [샘플에 기본](https://localhost:4502/editor.html/content/community-components/en.html)구성과 실험해 볼 수 있는 기능을 제공하는 샘플 사이트 커뮤니티 구성 요소입니다.
...
사이트 템플릿 [콘솔을 참조하십시오](/help/communities/sites.md).

## 커뮤니티 기능 {#community-functions}

커뮤니티 경험의 예상 기능은 잘 알려져 있습니다. AEM Communities을 사용하면 이러한 기능을 커뮤니티 기능이라고 하는 빌딩 블록으로 사용할 수 있습니다.

커뮤니티 기능은 일반적인 AEM 페이지로서 커뮤니티 사이트 템플릿에 손쉽게 통합되는 기능에 함께 연결된 구성 요소를 포함합니다.

커뮤니티 [기능 콘솔을 참조하십시오](/help/communities/functions.md).
...
작성 환경에서 템플릿 구조에 [그룹 함수가 들어 있는 경우 기존 커뮤니티 사이트 내에 커뮤니티 그룹(하위 커뮤니티)을 만들거나 기존 그룹 내에 중첩할 수 있습니다](/help/communities/functions.md#groups-function).
...
* [AEM Communities 시작하기를 참조하십시오](/help/communities/getting-started.md) .

## 커뮤니티 구성 요소 {#community-components}

커뮤니티 사이트가 내장된 [커뮤니티 구성](/help/communities/author-communities.md) 요소는 AEM 사이트에 커뮤니티 기능을 추가하는 데 사용할 수 있습니다.

구성 요소의 [대화형 탐색을 위해 커뮤니티 구성 요소 안내서를](/help/communities/components-guide.md) 사용할 수 있습니다.
...
새 참여 커뮤니티를 빠르게 만들 수 있는 편리한 기능을 경험하려면 AEM Communities [로 시작하기를 참조하십시오](/help/communities/getting-started.md).
...
활성 Add- [On을 구성할](/help/communities/enablement.md)때 활성 커뮤니티를 만들 수 있으며, 프로덕션 환경에서 사용하려면 추가 라이선스가 필요합니다. 활성 커뮤니티 사이트에는 [assignments 함수가 포함됩니다](#community-functions).

새로운 활성 커뮤니티를 손쉽게 만들려면 [AEM Communities 시작] [을 참조하십시오](/help/communities/getting-started-enablement.md).
