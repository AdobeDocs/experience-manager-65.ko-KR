...
* 필수 기능 제공:
   ...
   * 로그인:자가 등록, [소셜 로그인](/help/communities/social-login.md), 사용자 프로필
      ...
      * 알림:구성원은 자신과 관련된 이벤트를 보고, 사용자가 생성한 컨텐츠는 [@mentreleased](/help/communities/overview.md#mentionssupport).
...
새로운 커뮤니티 사이트를 빠르게 만드는 데 도움이 되는 손쉬운 방법을 경험하려면 AEM Communities [시작하기를 참조하십시오](/help/communities/getting-started.md).
...
* [중첩 그룹을 포함한 커뮤니티 사이트를 빠르게 만드는 자습서용 AEM Communities](/help/communities/getting-started.md) 시작하기를 참조하십시오.
...
새 참여 커뮤니티를 빠르게 만드는 데 도움이 되는 손쉬운 방법을 경험하려면 AEM Communities [로 시작하기를 참조하십시오](/help/communities/getting-started.md).
...
새로운 활성화 커뮤니티를 손쉽게 만들려면 AEM Communities에서 [시작하기를 참조하십시오](/help/communities/getting-started-enablement.md).
