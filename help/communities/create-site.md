...
커뮤니티 사이트 콘솔에서는 커뮤니티 사이트를 만드는 단계를 안내하는 마법사를 제공합니다. 마지막 단계에서 사이트를 커밋하기 전에 `Next` 단계 또는 `Back`로 이전 단계로 이동할 수 있습니다.
...
지원 기능 작업을 경험하려면 [AEM Communities 시작하기 튜토리얼을 참조하십시오.](/help/communities/getting-started-enablement.md)
...
커뮤니티 컨텐츠에 적용할 수 있는 태그는 이전에 [Tagging Console](/help/sites-administering/tags.md#tagging-console)(예: [Tutorial 네임스페이스](/help/communities/setup.md#create-tutorial-tags))을 통해 정의된 AEM 네임스페이스를 선택하여 제어합니다.
...
>[!NOTE]
>
>[터널 ](https://helpx.adobe.com/experience-manager/6-3/help/communities/deploy-communities.html#tunnel-service-on-author) 서비스를 통해 게시 환경에만 존재하는 구성원 및 그룹을 선택할 수 있습니다.
...
[활성 커뮤니티](/help/communities/overview.md#enablement-community)을 빠르게 만드는 유사한 자습서를 보려면 [Getting Started with AEM Communities for Enablement](/help/communities/getting-started-enablement.md)를 참조하십시오.
...
>1. **[!UICONTROL OK]**&#x200B;을 선택합니다.
>1. (선택 사항) **[!UICONTROL Clear]** 또는 **[!UICONTROL 강제 재시도]**&#x200B;를 선택하여 복제 큐를 재설정합니다.
...
이렇게 하려면 [CRXDE](https://localhost:4503/crx/de) Lite를 사용하여 게시의 [resource-mapping](/help/sites-deploying/resource-mapping.md) 테이블을 편집해야 합니다.
...
>[!NOTE]
>
>비활성화하려면 `sling:match` 속성 값에 &#39;x&#39; - `xlocalhost.4503/$` - 및 **모두 저장**&#x200B;을 접두사로 사용하십시오.

![선택 단계](assets/optional-steps.png)

#### 문제 해결:맵 {#troubleshooting-error-saving-map} 저장 중 오류 발생

변경 사항을 저장할 수 없는 경우 노드 이름이 `localhost.4503`이고 &#39;점&#39; 구분 기호가 있고 &#39;콜론&#39; 구분 기호가 있는 `localhost:4503`이 아닌 `localhost`이어야 합니다.
