...
설정 단계에서 을 선택한 다음 `Next`, 사용자 관리, 태그 지정, 중재, 그룹 관리, 분석, 번역 및 활성화와 관련된 구성에 대한 액세스 권한을 제공하는 7개의 섹션이 있습니다.

다음 방문: [활성화를 위한 AEM Communities 시작하기](/help/communities/getting-started-enablement.md) 지원 기능 작업을 경험하는 튜토리얼입니다.
...
참여 커뮤니티를 만들 때 비워 둡니다.

를 신속하게 만드는 유사한 자습서의 경우 [지원 커뮤니티](/help/communities/overview.md#enablement-community), 참조 [활성화를 위한 AEM Communities 시작하기](/help/communities/getting-started-enablement.md).
