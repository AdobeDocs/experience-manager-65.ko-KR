...
예를 들어 커뮤니티 사이트에서 관리자는 비디오 재생과 관련된 다양한 보고서를 볼 수 있습니다.
...
다음 `Marketing Cloud Org Id` 현재 [커뮤니티 사이트 만들기](/help/communities/sites-console.md) 또는 나중에 [수정](/help/communities/sites-console.md#modifying-site-properties) 커뮤니티 사이트 속성입니다.
...
* **제목**
   ...
   (필수) 프레임워크의 표시 제목입니다. 예를 들어, *커뮤니티 프레임워크*.
