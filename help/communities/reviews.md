...
* **[!UICONTROL 닫힘]**
   ...
   이 확인란을 선택하면 검토 내용이 새 검토 및 답글에 닫히고 기본값은 선택 취소입니다.
...
* **[!UICONTROL 리치 텍스트 편집기]**
   ...
   이 확인란을 선택하면 게시물에 마크업이 추가될 수 있습니다. 기본값은 선택 취소입니다.
...
* **[!UICONTROL 사전 관리]**
   ...
   이 확인란을 선택하면 검토 작업이 게시 사이트에 표시되기 전에 승인되어야 합니다. 기본값은 선택 취소입니다.

* **[!UICONTROL 리뷰 삭제]**

   이 옵션이 선택되어 있으면 리뷰를 게시한 멤버는 리뷰를 삭제할 수 있습니다. 기본값은 선택 취소입니다.
...
* **[!UICONTROL 리뷰 플래그 지정]**
   ...
   이 확인란을 선택하면 멤버가 검토 내용을 부적절한 것으로 플래그를 지정할 수 있습니다. 기본값은 선택 취소입니다.

* **[!UICONTROL 플래그 이유 목록]**

   이 확인란을 선택하면 멤버가 드롭다운 목록에서 선택을 할 수 있습니다. 이 이유는 검토를 요청하는 데 적합하지 않습니다. 기본값은 선택 취소입니다.

* **[!UICONTROL 사용자 지정 플래그 이유]**

   이 확인란을 선택하면 멤버가 검토 결과를 부적절한 것으로 보는 이유를 입력할 수 있습니다. 기본값은 선택 취소입니다.

* **[!UICONTROL 관리 임계값]**

   중재자에게 알리기 전에 구성원에 의해 검토에 플래그를 지정해야 하는 횟수를 입력합니다. 기본값은 한 번(1)입니다.
