...
지정 함수는 [활성화를 위한 커뮤니티 사이트](/help/communities/overview.md#enablement-community). 커뮤니티 구성원에게 지원 리소스를 할당할 수 있습니다. 참조 - [지정 필수 항목](/help/communities/essentials-assignments.md) 개발자용.

이 함수는 [사용 추가 기능](/help/communities/enablement.md). 지원 추가 기능을 사용하려면 프로덕션 환경에서 사용할 추가 라이선스가 필요합니다.
...
카탈로그 함수는 [지원 커뮤니티](/help/communities/overview.md#enablement-community) 구성원이 할당된 사용 리소스를 찾을 수 있습니다. 자세한 내용은 [태깅 지원 리소스](/help/communities/tag-resources.md) 및 [카탈로그 핵심 사항](/help/communities/catalog-developer-essentials.md) 개발자용.

커뮤니티 사이트의 모든 지원 리소스 및 학습 경로는 해당 속성이 ` [Show in Catalog](/help/communities/resources.md)`가 true로 설정된 경우에만 추적됩니다. 리소스 및 학습 경로를 명시적으로 포함하려면 [사전 필터](/help/communities/catalog-developer-essentials.md#pre-filters) 를 카탈로그에 추가합니다.
