...
주석 구성 요소는 실제로 주석 시스템을 구성하는 두 구성 요소 중 하나입니다. 따라서 확장할 구성 요소는 두 가지가 있습니다. *주석* 및 *주석*. 편집할 스크립트는 *주석* 구성 요소의 `header.hbs` 파일에 있는 반면 상위 *주석* 구성 요소(주석 시스템)는 작성자가 페이지에 실제로 추가하는 것입니다.
