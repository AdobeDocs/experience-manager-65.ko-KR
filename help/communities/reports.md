...
* [할당 보고서](#assignments-report)
   ...
   [지원 커뮤니티](/help/communities/overview.md#enablement-community)의 경우, SCORM 표준을 구현하는 경우 연관된 점수를 포함하여 학습자의 과제별 진행 상황에 대한 개요를 제공합니다.
...
[Adobe Analytics이 활성화되면 보고서에는 시간에 따른 각 지원 리소스에 대한 보기, 재생, 댓글 및 등급 수가 포함됩니다.](/help/communities/sites-console.md#analytics)
...
* 기존 지원 커뮤니티 사이트 선택:
   ...
   * **보고서** 아이콘을 선택하여 모든 지원 리소스를 포함하는 보고서를 생성합니다.
   * 지원 학습 경로를 선택합니다.
   * **보고서** 아이콘을 선택하여 다음과 같은 보고서를 생성합니다.
