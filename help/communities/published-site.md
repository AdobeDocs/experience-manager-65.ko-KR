...
달력 페이지는 홈 페이지임을 알 수 있습니다. 선택된 참조 사이트 템플릿에 달력 기능이 먼저 포함되고, 그 다음에 활동 스트림 함수, 포럼 함수 등이 포함되기 때문입니다. 이 구조는 사이트 템플릿 [콘솔에서](/help/communities/sites.md#edit-site-template) 또는 작성 환경에서 사이트 속성을 수정할 때 표시됩니다.
...
그룹의 링크는 기본 사이트의 링크 아래에 표시되며 다음 표시가 나타납니다.
...
커뮤니티 구성원에게 중재 권한이 있는 경우 중재 링크가 표시되어 중재 링크를 선택하면 게시된 커뮤니티 컨텐츠가 표시되고 작성자 환경의 [중재 콘솔과](/help/communities/moderate-ugc.md) 유사한 방식으로 중재되도록 [](/help/communities/moderation.md) 할 수 있습니다.
