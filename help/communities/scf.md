...
에 저장된 UGC를 처리하는 방법에 대해 알아보려면 [커뮤니티 콘텐츠 저장소](working-with-srp.md)다음을 참조하십시오.

* [저장소 리소스 공급자 개요](srp.md) - 소개 및 저장소 사용 개요.
* [SRP 및 UGC 핵심 사항](srp-and-ugc.md) - SRP API 유틸리티 메서드 및 예입니다.
...
새로운 프레임워크의 가장 주목할 만한 변경 사항 중 하나는 `Handlebars JS` (HBS)템플릿 언어(서버-클라이언트 렌더링을 위한 널리 사용되는 오픈 소스 기술)입니다.
