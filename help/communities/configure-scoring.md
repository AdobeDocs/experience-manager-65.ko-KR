...
true인 경우 isAssigned는 역할에 배지가 지정되었음을 나타내며 배지는 텍스트로 표시됩니다.

false인 경우 할당됨은 획득한 점수에 대해 배지가 부여되었음을 나타내며 배지는 이미지로 표시됩니다.
...
1. 사용자에게 cURL 을 사용하는 중재자 배지가 할당됩니다.
   ...
   사용자가 두 개의 브론즈 배지를 받고 중재자 배지를 받았으므로 사용자가 포럼 항목과 함께 나타나는 방식입니다.
...
Geometrixx 참여 사이트의 경우 사용자와 해당 점수는 채점 규칙 이름, 커뮤니티 사이트의 사이트 ID( )로 구성된 경로에 있습니다. `engage-ba81p`), 고유 id 및 사용자의 id:

* `.../scoring/forums-scoring/engage-ba81p/6d179715c0e93cb2b20886aa0434ca9b5a540401/riley`

커뮤니티 구성 요소 안내서 사이트의 경우 사용자와 해당 점수는 기본 ID( )인 점수부여 규칙 이름으로 구성된 경로에 있습니다. `default-site`), 고유 id 및 사용자의 id:

* `.../scoring/forums-scoring/default-site/b27a17cb4910a9b69fe81fb1b492ba672d2c086e/riley`

점수는 속성에 저장됩니다 `scoreValue_tl` 직접 값을 포함하거나 간접적으로 atomicCounter를 참조할 수 있습니다.
