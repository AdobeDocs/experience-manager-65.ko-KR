...
* 초안 모드
* 예약된 게시
* 대신 구성( [권한 있는 멤버](/help/communities/users.md#privileged-members-group) 는 다른 커뮤니티 구성원을 대신하여 컨텐츠를 만들 수 있음)
* [블로그 기사 및 댓글의 컨텍스트 및 일괄](/help/communities/moderate-ugc.md) 조정
...
[ **태그] 필드** 탭 아래에서 [설정] **탭에서 [태그** 지정 허용]을 선택한 경우 **적용할 태그를** 지정합니다.
...
로그인한 사용자가 커뮤니티 구성원 또는 [권한](/help/communities/users.md#privileged-members-group) 구성원일 때(구성에 따라) 새 블로그 아티클을 만들고 `New Article` 게시할 수 있습니다.
...
개발자를 위한 [Blog Essentials](/help/communities/blog-developer-basics.md) 페이지에 자세한 내용이 나와 있습니다.

블로그 항목 및 댓글에 대한 중재를 보려면 사용자 생성 [컨텐츠 중재를 참조하십시오](/help/communities/moderate-ugc.md).

블로그 항목 및 댓글에 태그를 지정하려면 사용자 생성 컨텐츠 [태그 지정을 참조하십시오](/help/communities/tag-ugc.md).

블로그 항목 및 댓글 번역에 대한 자세한 내용은 사용자 생성 [컨텐츠 번역을 참조하십시오](/help/communities/translate-ugc.md).
