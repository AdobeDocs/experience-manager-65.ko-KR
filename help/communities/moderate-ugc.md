...
* [달력](/help/communities/calendar.md) :구성원이 달력 이벤트 또는 댓글을 게시합니다.
* [댓글](/help/communities/comments.md) :구성원은 댓글에 댓글 또는 답글을 게시합니다.

* [forum](/help/communities/forum.md) :구성원이 새 주제를 게시하거나 주제에 답글을 달다
* [관념화](/help/communities/ideation-feature.md) :구성원은 아이디어 또는 댓글을 게시합니다.
...
UGC를 중재하는 것은 긍정적인 기여도를 인식할 뿐만 아니라 부정적인 게시물(스팸 및 욕설 등)을 제한하는 데 유용합니다. UGC는 다음과 같은 여러 환경에서 조정할 수 있습니다. [](/help/communities/working-with-srp.md)

* [일괄 중재 콘솔](/help/communities/moderation.md)중재 콘솔은 공개 환경의 관리자 및 [커뮤니티 중재자와](/help/communities/users.md) 작성자 환경의 관리자가 액세스할 수 있습니다. 이는 커뮤니티 콘텐츠가 [일반 스토어에](/help/communities/working-with-srp.md)저장되어 있을 때 가능합니다.

* [게시](/help/communities/in-context.md)환경의 컨텍스트 내 중재 중재는 컨텐츠가 게시된 페이지에서 바로 관리자 및 커뮤니티 중재자가 수행할 수 있습니다.
...
* `Admin`
 [커뮤니티 관리자](/help/communities/users.md) 그룹의 구성원인 사용자

* `Moderator`
커뮤니티 중재자 [그룹의 구성원(](/help/communities/users.md#publishenvironmentusersandgroups) 중재자 권한이 [](/help/communities/in-context.md#moderatorpermissions)있음)
...
UGC가 사전 중재되면 중재 작업으로 승인될 때까지 게시물이 게시된 사이트에 표시되지 않습니다. 커뮤니티 사이트를 [만드는 동안 상자를 선택하면 전체 사이트에 대한 사전 중재가](/help/communities/sites-console.md)`[Content is Premoderated](/help/communities/sites-console.md#moderation)` 활성화됩니다. 구성 요소를 페이지에 배치하면, 조정을 지원하는 구성 요소는 편집 대화 상자의 설정을 사용하여 사전 중재하도록 구성할 수 있습니다.

* [사용자 중재](/help/communities/comments.md) 탭의 주석 [및](/help/communities/reviews.md)검토 **,** **사전 중재 선택**
* [포럼](/help/communities/forum.md)관념화, [QnA](/help/communities/ideation-feature.md), [일정](/help/communities/working-with-qna.md), [설정](/help/communities/calendar.md)**** **, 조정 탭, 확인CheckConditioned**
...
1. / [system/console](https://localhost:4502/system/console/configMgr)/configMgr로 이동하여 웹 콘솔을 엽니다.
...
동일한 리소스에 할당될 때 다음 권한을 통칭하여 **`moderator permissions`** :
