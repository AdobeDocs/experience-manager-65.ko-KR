...
이 섹션에는 커뮤니티를 해결할 때 발생하는 일반적인 문제와 알려진 문제가 포함되어 있습니다.
...
잘못된 패턴 문자 &#39;a&#39;에 요청을 처리할 수 없습니다. `/content/demoforums/forum-test.html` 이 서버에서 로그에 다음 내용이 포함됩니다.
...
이 경고는 다음과 같이 안전하게 무시될 수 있습니다. `jknack.handlebars.Handlebars`에 사용됨 [SCF](scf.md#handlebarsjavascripttemplatinglanguage)에는 자체 i18n helper 유틸리티가 포함되어 있습니다. 시작할 때 AEM별 로 대체됩니다 [i18n 도우미](handlebars-helpers.md#i-n). 이 경고는 기존 도우미의 재정의를 확인하기 위해 타사 라이브러리에서 생성합니다.
