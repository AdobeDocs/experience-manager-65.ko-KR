...
1. 전역 탐색 메뉴에서 **도구** > **Cloud Service** > **번역 Cloud Service**.
...
1. 클릭 **만들기** 및 **구성 편집** 구성 속성을 구성할 수 있는 창이 나타납니다.

1. 콘텐츠 조각은 AEM에서 자산으로 저장됩니다. 다음을 클릭합니다. **에셋** 탭.
...
1. 에셋 콘솔에서 구성할 언어 루트를 선택하고 **속성**.
1. 다음을 클릭합니다. **Cloud Service** 탭.
