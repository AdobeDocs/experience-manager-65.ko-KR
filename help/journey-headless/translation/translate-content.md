...
1. 다음에서 **폴더 만들기** 창, 추가 **제목** 을 누릅니다. **만들기**.
...
1. 다음에서 **고급** 탭에서 **타겟 언어** 드롭다운에서 콘텐츠를 번역할 언어를 선택합니다. **만들기**&#x200B;를 탭하거나 클릭합니다.
...
[이전에 본 바와 같이,](#using-translation-project) 기계 번역된 콘텐츠가 상태로 AEM으로 다시 흐릅니다. **승인됨** 기계번역이 활용되고 있기 때문에 사람의 개입이 필요 없다는 가정이다. 그러나 번역된 컨텐츠는 여전히 검토할 수 있습니다.
