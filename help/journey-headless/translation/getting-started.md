...
>[!TIP]
>
>일반적으로 컨텐츠 설계자는 번역 전문가에게 다음을 제공합니다 **속성 이름**&#x200B;번역에 필요한 모든 필드 중 하나입니다. 이러한 필드 이름은 나중에 여정에서 수행해야 합니다. 이전 단계를 제공하여 번역 전문가의 이해를 돕습니다.
...
일반적으로 인스턴스 및 헤드리스 프로젝트당 규칙에 대해 커넥터를 한 번만 설정합니다. 그런 다음 번역 프로젝트를 사용하여 콘텐츠를 번역하고 해당 번역을 정기적으로 업데이트합니다.
...
* [번역 프로젝트 관리](/help/sites-administering/tc-manage.md) - AEM에서 기계 번역 및 사람 번역을 만들고 관리하는 방법에 대해 알아봅니다.
