...
콘텐츠 조각을 살펴보기 전에 AEM 사용에 대한 간략한 소개가 있지만.... 시스템 로그인 및 사용 경험을 대체할 수 있는 것은 없습니다.
...
폴더를 만들 수 있는 초기 폴더가 제공될 수 있습니다. (일반적으로 개발자 또는 시스템 관리자에 의해) 일부 구성 세부 정보가 루트 폴더에 적용되어야 하기 때문입니다. 이 작업은 사용자의 관심 대상이 아닐 수 있지만 필요한 경우 **속성** 폴더의 **클라우드 서비스**&#x200B;에서 **구성**&#x200B;을(를) 확인할 수 있습니다.
...
* **관련 콘텐츠**
  ...
  상당수의 AEM 버전에서 콘텐츠 조각을 사용할 수 있습니다. 원래는 페이지를 작성할 때 &quot;기존&quot; 용도로 사용할 수 .... 이 컨텍스트에서 계속 사용됩니다. 조각에 포함되지 않았지만 페이지를 작성할 때 작성자가 사용할 수 있어야 하는 에셋(예: 이미지)을 연결할 수 있습니다.
