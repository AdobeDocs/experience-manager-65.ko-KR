...
| 9 | [옵션 - AEM을 통해 단일 페이지 애플리케이션(SPA)을 제작하는 방법](create-spa.md) | AEM의 Headless 기능을 이해했으면 Headful과 Headless 전달을 결합하는 방법을 알아보고 AEM의 SPA 편집기 프레임워크를 사용하여 편집 가능한 SPA를 만드는 방법을 알아봅니다. |
...
하지만 Adobe에서는 학습 스타일에 관계없이 AEM Headless 프로젝트를 시작할 때 성공하기를 원합니다. 따라서 이 두 가지 옵션을 고려하십시오.
