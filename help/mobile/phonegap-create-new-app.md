...
* **이름:** 기본값은 공백 문자가 제거된 Title 속성의 값입니다. AEM 내에서 이 이름을 사용하여 애플리케이션을 참조합니다(예: 애플리케이션을 나타내는 저장소 노드).
...
클라우드 서비스를 빌드하고 Adobe Mobile Services SDK 플러그인을 앱에 통합하기 위한 추가(및 선택 사항) 탭이 있습니다.
