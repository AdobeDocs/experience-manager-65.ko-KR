...
>**전제 조건:**
>
>AEM Mobile On-demand Services으로 작업하고 이 시작 안내서의 단계를 따르려면 먼저 사용자에게 다음이 익숙해야 합니다. [AEM](/help/sites-deploying/deploy.md).
...
>[!NOTE]
>
>AEM에서 템플릿 및 구성 요소의 기본 사항에 대해 일반적으로 알아보려면 다음 리소스를 참조하십시오.
>
