...
>[!NOTE]
>
>AEM 확인 앱을 사용하면 AEM의 앱 세부 사항으로 스크린샷을 직접 전송할 수 있습니다.
>
...
#### ™ 메타데이터 {#android-metadata}

™ 플랫폼을 선택할 때 현재 설정할 수 있는 사용자 지정 메타데이터가 없습니다. 다운로드 버튼을 클릭하면 모든 메타데이터 및 관련 스크린샷이 포함된 속성 파일과 함께 zip 파일이 생성됩니다.
...
* [콘텐츠 서비스](/help/mobile/develop-content-as-a-service.md)
