...
앱 대시보드의 **앱 관리** 타일은 응용 프로그램에 대한 세부 사항을 수정하는 기능을 제공합니다. 세부 사항 페이지를 열려면 앱 타일의 세부 사항 관리 링크를 클릭합니다. 앱 관리 페이지에서 PhoneGap 애플리케이션 구성(config.xml) 설정을 편집하고 다양한 애플리케이션 스토어에 제출할 애플리케이션을 준비할 수 있습니다.

![chlimage_1-116](assets/chlimage_1-116.png)

## 앱 타일 관리 이해 {#understanding-the-manage-app-tile}

**앱 관리** 타일의 각 타일로 드릴다운하여 &#39;...&#39;을 클릭하여 세부 사항을 보거나 편집할 수 있습니다. 오른쪽 아래에 있습니다.

### 기본 탭 {#the-basic-tab}

이 탭에서 앱에 대한 **이름**, **작성자**, **간단한 설명** 및 **설명**&#x200B;을 편집할 수 있습니다.
...
>[!NOTE]
>
>**앱 관리** 타일에 익숙해지면 메타데이터를 보고 편집하려면 [앱 메타데이터 편집](/help/mobile/phonegap-editmetadata.md)을 참조하십시오.
...
**PhoneGap** 버전PhoneGap을 사용하여 응용 프로그램을 컴파일할 버전입니다. 최신 기능과 버그 수정 사항을 최신 버전으로 유지하는 것이 좋습니다.
...
**Plugins** 탭은 앱과 연결된 플러그인을 설명합니다. 이 정보는 빌드 동안 적절한 플러그인을 검색하는 데 사용됩니다.
