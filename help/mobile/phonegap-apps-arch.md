...
description: 이 페이지에서는 /libs/mobileapps/components/page/ng-page 구성 요소(로컬 서버의 CRXDE Lite)를 기반으로 하는 앱에 대해 생성하는 angular 구성 요소에 대해 설명합니다.
...
앱의 해부에 대해 알아본 후에는 [단일 페이지 애플리케이션](/help/mobile/phonegap-single-page-applications.md).
