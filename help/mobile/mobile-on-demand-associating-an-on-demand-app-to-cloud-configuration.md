...
>
>자세한 내용은 관리 섹션의 [AEM Mobile On-demand Services 설정](/help/mobile/aem-mobile-setup.md)을 참조하십시오.

Mobile On-Demand Cloud Services을 구성하려면 앱 대시보드에서 **연결 관리** 타일의 오른쪽 상단에 있는 위쪽 톱니어를 클릭합니다.
...
1. **Mobile**&#x200B;에서 **Apps**&#x200B;를 선택한 다음 카탈로그에서 모바일 온디맨드 앱을 선택합니다.
