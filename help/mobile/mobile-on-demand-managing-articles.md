...
콘텐츠 관리 작업은 애플리케이션 내에서 문서를 만들고 관리 하는 데 도움이 되는 구성 요소입니다. 애플리케이션 내의 아티클에 대해 다음 작업이 수행됩니다.

## 문서 개요 {#articles-overview}

기사는 정보를 전달하기 위해 예술과 함께 텍스트를 기반으로 합니다.
...
## 새로 만들기 아티클 가져오기 {#importing-a-new-article}

기존 Mobile On-Demand 컨텐츠는 Mobile On-Demand에서 AEM으로 다운로드(가져오기)할 수 있습니다. 이를 통해 로컬 컨텐츠 편집 및 보기가 가능합니다.
...
1. Mobile의 카탈로그에서 Mobile On-Demand 앱 을 선택합니다.
1. 문서&#x200B;**관리 타일의**&#x200B;오른쪽 위 모서리에 있는 아래쪽 화살표를 클릭하고 문서 가져오기 를 선택합니다.
1. 대화 상자에서 기사&#x200B;**가져오기를 클릭한 다음 닫기를 클릭합니다**.
1. 이제 Mobile On-Demand 아티클이 문서&#x200B;**관리 타일에**&#x200B;나타납니다.
...
기사, 배너 등과 같은 컨텐츠에는 제목, 설명, 이미지와 같은 수많은 속성이 있습니다. 이 작업은 이러한 속성을 보고 수정하는 데 사용됩니다. 선택적으로, 이러한 변경 사항은 저장 시 Mobile On-Demand에 업로드할 수 있습니다.
...
1. 선택 **속성 보기** 작업 표시줄에서
1. 해당 문서에 대해 사용 가능한 모든 메타 데이터를 보기.
...
이 작업은 선택한 컨텐츠 Mobile On-Demand에서 삭제하고, 선택적으로 로컬 AEM 인스턴스에서 삭제합니다.

문서를 삭제하는 일반적인 작업 과정:

1. 모바일의 카탈로그에서 Mobile On-Demand 앱을 선택합니다.
1. 문서&#x200B;**관리 타일에서**&#x200B;삭제할 문서를 선택합니다.
1. 목록에서 선택되어 있는지 확인하십시오. 필요에 따라 삭제할 다른 항목을 선택합니다.
1. 작업 표시줄에서 삭제&#x200B;**를 클릭합니다**.
1. AEM 및 Mobile On-Demand에서 삭제할 것인지 좋아요.
1. **삭제**&#x200B;를 클릭합니다.
1. 이제 문서가 목록에서 제거되었습니다.
