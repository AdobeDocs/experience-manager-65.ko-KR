...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>구성 요소 브라우저(터치 사용 UI) 또는 Sidekick(클래식 UI)에서 구성 요소를 선택할 수 있는 그룹입니다.<br /> <code>.hidden</code> 값은 실제 단락 시스템과 같이 UI에서 선택할 수 없는 구성 요소에 사용됩니다.</td>
  </tr>
  <tr>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>기본값. 구성 요소 버전은 클릭 및/또는 상황에 맞는 메뉴를 통해 "마우스 오버"에서 액세스할 수 있습니다.<br /> 고급 사용을 위해 해당 클라이언트측 개체는 <code>CQ.wcm.EditRollover</code>입니다.</td>
  </tr>
  <tr>
   <td><code>editbar</code></td>
   <td>구성 요소 버전은 도구 모음을 통해 액세스할 수 있습니다.<br /> 고급 사용을 위해 해당 클라이언트측 개체는 <code>CQ.wcm.EditBar</code>입니다.</td>
  </tr>
  <tr>
