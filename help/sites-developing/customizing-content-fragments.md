...
* [컨텐츠 조각 만들기 및 관리 ](/help/assets/content-fragments/content-fragments.md) 및 컨텐츠  [조각을 사용한 페이지 ](/help/sites-authoring/content-fragments.md) 작성을 참조하십시오.

* [자산 ](/help/assets/manage-assets.md) 관리 및  [자산 사용자 지정 및 확장](/help/assets/extending-assets.md) 을 참조하십시오.
