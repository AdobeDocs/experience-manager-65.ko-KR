...
컨텐츠 조각은 다른 자산 유형처럼 AEM 페이지에서 참조할 수 있습니다. AEM에서는 페이지에 컨텐츠 조각을 포함시킬 수 있는 [**구성 요소인&#x200B;**컨텐츠 조각](https://helpx.adobe.com/experience-manager/core-components/using/content-fragment-component.html)핵심 구성 요소를[제공합니다](/help/sites-authoring/content-fragments.md#adding-a-content-fragment-to-your-page). 이 컨텐츠 조각**&#x200B;핵심 구성 요소를&#x200B;**확장할 수도 있습니다.
...
* **리소스 유형**&#x200B;컨텐츠 조각을 렌더링하는 데 사용되는 구성 요소와 배경 처리를 적용할 위치를 정의하는 데 사용할 수 `sling:resourceTypes` 있는 목록을 제공할 수 있습니다.
...
>[!CAUTION]
>
>AEM 6.5의 경우 클라이언트측 API는 내부적입니다.
