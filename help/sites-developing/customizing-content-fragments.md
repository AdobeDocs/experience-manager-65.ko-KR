...
* 콘텐츠 조각 템플릿:
   ...
   * 새 변형을 추가하는 기능 등은 조각을 적절하게 업데이트해야 합니다.
   * [콘텐츠 조각 템플릿](/help/sites-developing/content-fragment-templates.md)은(는) AEM 에코시스템 내의 다른 템플릿 메커니즘(예: 페이지 템플릿 등)과 다른 방식으로 작동합니다. 따라서 이러한 요소는 별도로 고려되어야 합니다.
...
* **번역**
  ...
  콘텐츠 조각은 [AEM 번역 워크플로](/help/sites-administering/tc-manage.md)와(과) 완전히 통합됩니다. 아키텍처 수준에서 이는 다음을 의미합니다.
...
자세한 내용은 [콘텐츠 조각 템플릿](/help/sites-developing/content-fragment-templates.md)을 참조하세요.
