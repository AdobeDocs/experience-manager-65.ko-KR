...
* [컨텐츠 조각 ](/help/assets/content-fragments/content-fragments.md) 만들기 및 관리 및 컨텐츠  [조각으로 페이지 ](/help/sites-authoring/content-fragments.md) 작성 컨텐츠 조각에 대한 자세한 정보.

* [자산 ](/help/assets/manage-assets.md) 관리 및  [자산 사용자 지정 ](/help/assets/extending-assets.md) 및 확장 을 참조하십시오.
...
이 매개 변수의 매개 변수는 OSGi 번들 **컨텐츠 조각 구성 요소 구성**&#x200B;에 대한 [웹 콘솔](/help/sites-deploying/configuring-osgi.md#osgi-configuration-with-the-web-console)에서 구성할 수 있습니다.
...
* **참조**
속성각 구성 요소에 대해 조각에 대한 참조가 저장되는 위치를 지정하도록 속성 목록을 구성할 수 있습니다.
...
* **컨텐츠 조각** ([컨텐츠 조각](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/adobe/cq/dam/cfm/ContentFragment.html))
   ...
   * **컨텐츠 요소** ([ContentElement](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/adobe/cq/dam/cfm/ContentElement.html))
...
* `ContentFragment` 다음을 적용할 수 있습니다.
   ...
   * `Asset` - 컨텐츠 조각을  `Asset` 나타내는 DAM 추상화 를  `Asset` 직접 업데이트하려면 개체를 다시 만들어야  `ContentFragment` 합니다.
