...
>[!NOTE]
>
>링크는 항상 게시 인스턴스를 참조합니다. 이 링크는 서드파티가 사용하므로 작성자 인스턴스가 아닌 Publish 인스턴스에서 항상 호출됩니다.
>
...
>[!NOTE]
>
>이 인터페이스는 [AEM 6.5 SP1(6.5.1.0)](/help/release-notes/previous/6-5-1.md)에 도입되었습니다.

[default](#default-link-rewriting)에서 다루지 않는 더 복잡한 경우에는 AEM에서 링크 재작성기 공급자 인터페이스를 제공합니다. 번들에 서비스로 구현할 수 있는 `ConsumerType` 인터페이스입니다. AEM이 경험 조각에서 렌더링한 대로 HTML 오퍼의 내부 링크에 대해 수행하는 수정 사항을 무시합니다. 이 인터페이스를 사용하면 비즈니스 요구 사항에 맞게 내부 HTML 링크를 다시 작성하는 프로세스를 사용자 지정할 수 있습니다.
