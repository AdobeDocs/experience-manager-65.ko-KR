...
seo-description: 경험 조각 사용자 지정에 대해 알아봅니다.
...
>[!CAUTION]
>
>***경험*** [조각에 대해 ](/help/sites-developing/page-templates-editable.md) 온라이디언트 템플릿이 지원됩니다.

경험 조각에 대한 새 템플릿을 개발할 때 [편집 가능한 템플릿](/help/sites-developing/page-templates-editable.md)에 대한 표준 방법을 따를 수 있습니다.
...
1. [허용된 ](/help/sites-authoring/experience-fragments.md#configure-allowed-templates-folder) 템플릿은 경험 조각 콘솔에서 구성할 수 있습니다.
...
[경험 ](/help/sites-developing/components.md) 조각에 사용할 구성 요소를 개발하는 경우 표준 방법을 따릅니다.

유일한 추가 구성은 구성 요소가 템플릿에서 [허용되는 구성 요소인지 확인하는 것입니다. 이 작업은 컨텐트 정책](/help/sites-developing/page-templates-editable.md#content-policies)으로 완료됩니다.
...
[Target](/help/sites-administering/experience-fragments-target.md)로 내보내기 기능을 사용하여 다음을 수행할 수 있습니다.

* 경험 조각 만들기,
* 구성 요소를 추가합니다.
* 그런 다음 HTML 형식 또는 JSON 형식으로 Adobe Target 오퍼으로 내보냅니다.

이 기능은 AEM](/help/sites-administering/experience-fragments-target.md#Prerequisites)의 작성자 인스턴스에서 [활성화될 수 있습니다. 유효한 Adobe Target 구성과 링크 외부 도우미에 대한 구성이 필요합니다.
...
1. AEM은 게시된 리소스를 가리키도록 HTML에 있는 모든 내부 링크를 수정합니다.
   ...
   1. `*-href` 특성( `data-href`예:  `custom-href` `img-href`, 등)
...
>[!NOTE]
>
>이 인터페이스는 [AEM 6.5 SP1 (6.5.1.0)](/help/release-notes/sp-release-notes.md)에서 도입되었습니다.
...
>[!NOTE]
>
>서비스 사용자를 통해 리소스 확인자를 가져오는 방법에 대한 자세한 내용은 AEM[의 서비스 사용자를 참조하십시오.](/help/sites-administering/security-service-users.md)
