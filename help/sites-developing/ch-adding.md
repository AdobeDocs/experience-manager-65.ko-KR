...
ContextHub 도구 모음을 미리 보기 모드로 표시할지 여부도 구성해야 합니다. 다음을 참조하십시오 [ContextHub UI 표시 및 숨기기](ch-configuring.md#showing-and-hiding-the-contexthub-ui).
...
다음 세그먼트는 와 함께 설치됩니다. [WKND 튜토리얼 사이트](getting-started.md)
...
* 첫 번째 [지리적 위치](ch-samplestores.md#contexthub-geolocation-sample-store-candidate) 사용자의 위도를 판별하는 데 스토어가 사용됩니다.
* 그런 다음 의 월 데이터 항목 [surferinfo 스토어](ch-samplestores.md#contexthub-surferinfo-sample-store-candidate) 해당 위도에 있는 계절을 결정합니다.
...
ContextHub는 다음을 제공합니다. [진단 페이지](ch-diagnostics.md) 여기서 ContextHub 프레임워크의 개요를 볼 수 있습니다.
