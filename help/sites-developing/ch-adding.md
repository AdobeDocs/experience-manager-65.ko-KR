...
또한 ContextHub 도구 모음이 미리 보기 모드에 나타나는지를 구성해야 합니다. [ContextHub UI 표시 및 숨기기](ch-configuring.md#showing-and-hiding-the-contexthub-ui)를 참조하십시오.
...
모든 저장소 유형은 [`ContextHub.Store.Core`](contexthub-api.md#contexthub-store-core) 클래스의 확장입니다. 새 저장소 유형을 만드는 방법에 대한 자세한 내용은 [사용자 정의 스토어 만들기](ch-extend.md#creating-custom-store-candidates)를 참조하십시오. 샘플 저장소 유형에 대한 자세한 내용은 [샘플 ContextHub 저장소 후보](ch-samplestores.md)를 참조하십시오.
...
* 먼저 [지리적 위치](ch-samplestores.md#contexthub-geolocation-sample-store-candidate) 스토어를 사용하여 사용자의 위치를 결정합니다.
...
ContextHub는 ContextHub 프레임워크의 개요를 볼 수 있는 [진단 페이지](ch-diagnostics.md)을 제공합니다.
