...
1. 변수에 대한 선택적 설명을 지정하고 ![상자 안에 확인 표시가 있는 저장 아이콘을 선택합니다.](assets/Done_Icon.png) 변경 내용을 저장합니다. 변수는 왼쪽 창에서 사용할 수 있는 목록에 표시됩니다.
...
1. **변수 설정** 단계를 워크플로우 편집기로 드래그 앤 드롭한 다음 단계를 선택하고 ![렌치로 표시된 구성 아이콘을 선택합니다.](assets/configure_icon.png) (구성).
...
1. 의미 있는 표현식을 만들 수 있도록 더 많은 변수를 매핑합니다. 상자 안에 확인 표시가 있는 ![저장 아이콘을 선택합니다.](assets/Done_Icon.png) 변경 내용을 저장합니다.
...
[변수 표현식 비디오](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-5/forms/using/variables_expression.mp4)
...
[OR 분할 비디오](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-5/forms/using/variables_orsplit_example.mp4)
...
1. 연필 기호로 표시된 ![편집 아이콘을 선택하십시오.](assets/edit.png) (편집) 아이콘을 클릭합니다.
1. 변수 정보를 편집하고 ![확인 표시가 있는 저장 아이콘을 선택합니다.](assets/Done_Icon.png) 변경 내용을 저장합니다. 변수에 대한 **[!UICONTROL Name]** 및 **[!UICONTROL Type]** 필드를 편집할 수 없습니다.
...
1. 확인 표시 기호가 표시된 ![완료 아이콘을 선택합니다.](assets/Done_Icon.png) 을 클릭하여 변수를 확인하고 삭제합니다.
