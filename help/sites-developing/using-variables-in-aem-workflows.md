...
* [저장할 정보 ](/help/sites-developing/using-variables-in-aem-workflows.md#create-a-variable) 유형을 기반으로 다양한 데이터 유형을 만듭니다.
* [변수 설정 워크플로우 단계를 ](/help/sites-developing/using-variables-in-aem-workflows.md#set-a-variable) 사용하여 변수에 대한 값을 설정합니다.
* [OR 분할 ](/help/sites-developing/using-variables-in-aem-workflows.md#use-a-variable) 및 이동 AEM 워크플로우 단계의 변수를 사용하여 라우팅 결정을 위한 표현식을 정의합니다. 모든 AEM Forms 워크플로우 단계에서 변수를 사용할 수도 있습니다.
...
AEM Forms 워크플로우에서 사용할 수 있는 추가적인 복잡한 데이터 유형에 대해서는 AEM Forms 워크플로우의 [변수](/help/forms/using/variable-in-aem-workflows.md)를 참조하십시오.  ArrayList 데이터 유형을 사용하여 변수 컬렉션을 만듭니다. 모든 프리미티브 및 복잡한 데이터 유형에 대해 ArrayList 변수를 만들 수 있습니다. 예를 들어 ArrayList 변수를 만들고 String을 하위 유형으로 선택하여 변수를 사용하여 여러 문자열 값을 저장합니다.
...
1. 의미 있는 표현식으로 더 많은 변수를 매핑합니다. ![](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/using/chart-component/Done_Icon.png)을 눌러 변경 내용을 저장합니다.
...
이 예에서 라우팅 표현식을 정의하기 전에 [예 2](/help/sites-developing/using-variables-in-aem-workflows.md#example2)를 사용하여 **totalvalue** 변수의 값을 설정합니다. 분기 1은 **totalvalue** 변수의 값이 50000보다 큰 경우 활성화됩니다. 마찬가지로 **totalvalue** 변수의 값이 50,000보다 작으면 분기 2를 활성화할 규칙을 정의할 수 있습니다.
...
모든 AEM Forms 워크플로우 단계에서는 변수를 지원합니다. 자세한 내용은 OSGi](/help/forms/using/aem-forms-workflow-step-reference.md)의 [Forms 중심 작업 과정을 참조하십시오.
