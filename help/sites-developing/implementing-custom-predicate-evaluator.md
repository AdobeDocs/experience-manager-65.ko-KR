...
>[!NOTE]
>
>에 대한 자세한 내용은 `PredicateEvaluator` 및 `com.day.cq.search` 패키지, 자세한 내용은 [Java™ 설명서](https://developer.adobe.com/experience-manager/reference-materials/6-5/javadoc/index.html?com/day/cq/search/package-summary.html).
