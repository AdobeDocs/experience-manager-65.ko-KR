...
* AEM에서 편집할 수 있게 작동되는 외부 React 앱 [이 있습니다.](spa-edit-external.md)
...
1. 만들어진 `wknd-spa/components/imagecard` 구성 요소를 페이지 템플릿의 컨테이너 구성 요소 [에 대해 허용되는 구성 요소에 추가합니다.](/help/sites-authoring/templates.md)
