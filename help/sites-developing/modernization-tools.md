...
description: AEM 현대화 도구 기존 AEM 기능을 최신 기술로 변환하는 데 도움이 됩니다.
...
* [](/help/sites-authoring/default-components-foundation.md)기초 구성 요소를 핵심 구성 요소로 변환[](https://docs.adobe.com/content/help/ko-KR/experience-manager-core-components/using/introduction.html)
