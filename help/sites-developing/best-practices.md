...
[AEM ](/help/communities/overview.md) Communities 온프레미스 커뮤니티의 제작 및 관리를 간소화합니다.

Communities에 대한 몇 가지 우수 사례가 여기에 설명되어 있습니다.

|  |  |  |
|---|---|---|
| 사용자 생성 콘텐츠(UGC)를 사용한 작업 모범 사례 | [코딩 지침](/help/communities/code-guide.md) | [소셜 구성 요소 프레임워크](/help/communities/scf.md)(SCF)에 대한 유연한 이식 가능한 코드 개발을 위한 가이드라인 |
...
|  |  |  |
|---|---|---|
| HTL 개요 | [HTL 개요 및 구문](https://docs.adobe.com/content/help/ko-KR/experience-manager-htl/using/overview.html) | 이 문서에서는 HTL이 무엇인지, 샘플 프로젝트, 구문, 표현식 및 문으로 이동하는 방법을 설명합니다 |
