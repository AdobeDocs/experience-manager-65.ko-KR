...
* `/libs/settings/cloudsettings/legacy/contexthub`에서 `disabled` 속성을 **true**(으)로 설정하려면 CRXDE Lite을 사용하십시오.

>[!NOTE]
>
>[AEM 6.4의 저장소 재구성으로 인해](/help/sites-deploying/repository-restructuring.md) ContextHub 구성 위치가 `/etc/cloudsettings`에서 다음으로 변경됨:
>
