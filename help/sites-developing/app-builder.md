---
title: 개발자 앱 빌더를 사용하여 [!DNL Adobe Experience Manager] 6.5를 확장합니다.
description: 개발자 앱 빌더를 사용하여 [!DNL Adobe Experience Manager] 6.5를 확장합니다.
...
# Adobe 개발자 앱 빌더를 사용하여 [!DNL Adobe Experience Manager] 확장 {#extend-using-app-builder}

## AEM용 App Builder 소개 {#project-firefly}

새로운 Adobe 개발자 앱 빌더는 개발자가 AEM 기능을 쉽게 확장할 수 있는 확장성 프레임워크를 제공합니다.
