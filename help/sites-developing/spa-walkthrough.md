...
AEM SPA 편집기를 활용하도록 SPA을 빌드하면 콘텐츠 작성자는 콘텐츠를 편집하고 만들 때 차이점을 느끼지 않습니다. 일반적인 AEM 기능을 사용할 수 있고 작성자의 워크플로우를 변경할 수 없습니다.
...
1. 새 탭에 `react.model.json`을 로드합니다.
   ...
   AEM SPA 편집기는 [AEM Content Services](/help/assets/content-fragments/content-fragments.md)를 활용하여 페이지 전체 콘텐츠를 JSON 모델로 제공합니다.
