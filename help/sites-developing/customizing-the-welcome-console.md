...
사용 `/libs/cq/core/components/welcome/welcome.jsp` 중인 ConsoleUtil은 [속성이 있는](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/day/cq/commons/ConsoleUtil.html)노드에서 쿼리를 실행합니다.
