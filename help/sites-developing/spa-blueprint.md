...
두 개체는 라우팅 개념과 관련되지만, ` [ModelRouter](/help/sites-developing/spa-routing.md)` 는 현재 응용 프로그램 상태와 동기화되어 있는 데이터 모델 ` [PageModelManager](/help/sites-developing/spa-blueprint.md#pagemodelmanager)` 을 불러와야 합니다.
