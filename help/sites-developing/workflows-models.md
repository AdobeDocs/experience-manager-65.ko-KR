...
모델을 편집하면 사용 가능한 단계가 의 다양한 그룹에 나타납니다. **단계 브라우저**. 예를 들면 다음과 같습니다.
...
1. 워크플로우 모델의 각 단계에 단계를 지정합니다. 예를 들면 다음과 같습니다.

   ![wf-09](assets/wf-09.png)

   스테이지는 두 개 이상의 단계에 지정할 수 있습니다. 예를 들면 다음과 같습니다.
...
1. 속성 편집 **분기 1** / **OR 분할**:
   ...
   * 다음으로: **규칙**: 스크립트에 대한 경로를 설정합니다. 예를 들면 다음과 같습니다.
...
1. 의 속성 편집 **분기 2** / **OR 분할**.
   ...
   * 다음으로: **규칙**경로를 다른 스크립트로 설정합니다. 예를 들면 다음과 같습니다.
