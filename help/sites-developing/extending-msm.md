...
1. 아직 CRXDE Lite 상태입니다. [롤아웃 구성](#create-the-rollout-configuration) 노드를 선택하십시오.
...
1. 이전 단계를 반복하여 `/apps/wcm/core` 폴더 트리를 만듭니다. `resources`(이)라는 `core`에 `sling:Folder` 유형의 노드를 만듭니다. <!-- ![Resources](assets/chlimage_1-77.png) -->
