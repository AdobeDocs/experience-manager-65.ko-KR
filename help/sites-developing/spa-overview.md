...
내보낸 모델의 각 리소스에 대해 SPA는 렌더링할 실제 구성 요소를 매핑합니다. JSON으로 표현되는 모델은 컨테이너 내의 구성 요소 매핑을 사용하여 렌더링됩니다.
...
AEM SPA Editor SDK 파섹 Adobe에서 완벽하게 지원하고 새로운 기능으로 지속적으로 향상되고 확장됩니다. 다음 AEM 기능은 아직 SPA 편집기에서 지원되지 않습니다.
