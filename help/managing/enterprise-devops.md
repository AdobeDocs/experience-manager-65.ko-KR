...
이 환경은 품질 보증 팀이 새 시스템을 모두 [test](/help/sites-developing/test-plan.md)하기 위해 사용합니다.디자인과 기능 모두 적절한 컨텐츠를 사용한 작성자 및 게시 환경이 모두 있어야 하며, 전체 테스트를 활성화하는 데 필요한 모든 서비스를 제공해야 합니다.
