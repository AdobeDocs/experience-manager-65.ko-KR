...
프로젝트에 참여하는 각 페르소나(역할)에 대한 체크리스트가 있습니다. 이 체크리스트에서는 단계별 및 마일스톤별로 세분화된 결과물을 자세히 설명합니다. 결과물을 생성하는 데 필요한 문서도 보여 줍니다. 문서 상태와 품질을 추적하여 프로젝트 전체의 상태를 모니터링할 수 있으며, 이를 통해 투명성과 책임성을 확보할 수 있습니다.

## 다운로드 {#download}

AEM 프로젝트 모범 사례 체크리스트 v2
...
고품질 프로젝트를 성공적으로 제공하려면 체크리스트의 모든 항목을 순서대로 완료해야 합니다.

1. 체크리스트는 프로젝트에 참여하는 **[페르소나](/help/managing/best-practices.md#persona)**(역할)에 따라 정의됩니다. 개인마다 프로젝트에서 맡은 역할에 적합한 체크리스트를 사용해야 합니다.
1. 체크리스트에는 각 마일스톤에 대한 **[필수 문서](/help/managing/best-practices.md#required-documents)** 및 **[결과물](/help/managing/best-practices.md#deliverables)**&#x200B;이 포함됩니다. 관련 페르소나는 상태 및 품질 필드를 적절하게 설정해야 합니다.
