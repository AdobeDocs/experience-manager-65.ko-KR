...
이러한 시나리오의 경우 Adobe은 작성자 인스턴스의 두 노드 공유 없음 클러스터에서 벤치마크 테스트를 실행합니다.
...
>[!NOTE]
>
>이미지 처리량이 높으면 컴퓨팅 리소스가 시스템 I/O에 보조를 맞출 수 있어야 합니다. 예를 들어 이미지를 가져와 워크플로우를 시작하는 경우 WebDAV를 통해 많은 이미지를 업로드하면 워크플로우가 백로그될 수 있습니다.
>
