...
주요 리소스의 지원과 모범 사례 및 지침을 활용하여 AEM 프로젝트를 성공적으로 관리하는 방법에 대해 알아봅니다.

## 주요 문서

이 안내서의 주요 문서는 다음과 같습니다.

* [프로젝트 관리 - 모범 사례 체크리스트](/help/managing/best-practices.md)
...
* [데이터 보호 및 데이터 개인 정보 보호 규정을 위한 Adobe Experience Manager 준비 상태](/help/managing/data-protection-and-privacy.md)
