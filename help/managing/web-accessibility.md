...
AEM을 사용하여 액세스 가능한 웹 사이트 및 콘텐츠를 만드는 것은 다음과 같은 사용자에게 영향을 줍니다.
...
Adobe Experience Manager는 [World Wide Web Consortium](#world-wide-web-consortium)에서 제공하는 [지침](#wcag-accessibility-guidelines)을 따라야 합니다.
