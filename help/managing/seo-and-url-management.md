...
또한 XML 사이트 맵에 구현된 기능은 다양한 사용 사례에도 사용할 수 있습니다. 예를 들어 정식 링크나 언어가 페이지 헤드에 대체됩니다. 자세한 내용은 [SeoTags](https://javadoc.io/doc/com.adobe.cq.wcm/com.adobe.aem.wcm.seo/latest/com/adobe/aem/wcm/seo/SeoTags.html) 인터페이스를 참조하십시오.
