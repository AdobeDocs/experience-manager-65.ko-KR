...
1. **[!UICONTROL 속성 편집]**&#x200B;을 선택하십시오. 선택한 모델 개체, 속성 또는 서비스에 대한 **[!UICONTROL 속성 편집]** 창이 열립니다.
...
>[!NOTE]
>
>**NavigationPropertyName** 인수의 **기본값** 필드에서 사용할 수 있는 값은 **반환 배열의 상태에 따라 다릅니다.** 토글 단추. 활성화되면 컬렉션 유형의 탐색 속성이 표시됩니다.

이 예제에서는 출력 모델 개체를 Person으로 선택하고 탐색 속성 인수를 Friends 또는 BestFriend로 선택할 수도 있습니다(**배열을 반환할지 여부에 따라?**). 이(가) 활성화되거나 비활성화됩니다.
