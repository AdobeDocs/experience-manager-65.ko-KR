...
# 응용 양식의 구분 요소{#separator-component-in-adaptive-forms}
...
* **인라인 스타일:** 이제 AEM Forms을 사용하여 개별 적응형 양식 구성 요소에 인라인 CSS 스타일을 적용하고 실시간으로 변경 내용을 미리 볼 수 있습니다.

레이아웃 모드를 사용하여 구분 구성 요소가 속하는 열의 수를 정의할 수 있습니다. 자세한 내용은 [레이아웃 모드를 사용하여 구성 요소의크기 조정](../../forms/using/resize-using-layout-mode.md)을 참조하십시오.

구분 구성 요소의 속성을 지정하려면

1. 구분 구성 요소를 선택하고 ![cmppr](assets/cmppr.png)을 누릅니다. 세로 막대에서 열린 속성입니다.
...
1. 양식의 변경 내용을 미리 보려면 **미리 보기**&#x200B;를 클릭합니다.
