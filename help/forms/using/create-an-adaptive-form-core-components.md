...
1. 선택 **[!UICONTROL 만들기]**  > **[!UICONTROL 적응형 Forms 만들기]**.
...
1. 선택 **[!UICONTROL 편집]** 새 탭에서 새로 만든 양식을 엽니다. 편집할 양식이 열리고 템플릿에서 사용할 수 있는 콘텐츠가 표시됩니다. 또한 새로 만든 양식을 사용자 지정할 수 있는 사이드바가 표시됩니다.
