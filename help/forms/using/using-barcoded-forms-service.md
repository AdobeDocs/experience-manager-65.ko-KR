...
양식 작성자는 Designer을 사용하여 대화형 바코드 양식을 만듭니다. ([Designer 도움말](https://www.adobe.com/go/learn_aemforms_designer_63)을 참조하세요.) 사용자가 Adobe Reader 또는 Acrobat을 사용하여 바코드 형식을 채우면 바코드가 자동으로 업데이트되어 양식 데이터를 인코딩합니다.
