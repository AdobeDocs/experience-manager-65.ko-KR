...
**앞으로** - 직접 보고서에서 모든 사용자에게 작업을 전달합니다.

**클레임** - 직접 보고서의 작업을 요청하십시오.

**청구 및 열기** - 직접 보고서의 작업을 요청하여 관리자의 할 일 목록에서 자동으로 엽니다.
...
1. DSC를 만듭니다. 자세한 내용은 의 &#39;AEM Forms용 구성 요소 개발&#39; 항목을 참조하십시오 [AEM Forms을 사용한 프로그래밍](https://www.adobe.com/go/learn_aemforms_programming_63) 가이드.
