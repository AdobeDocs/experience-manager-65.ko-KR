...
description: 관리자 및 조직 책임자가 AEM Forms 작업 공간의 [할 일] 탭에서 직접 및 간접 보고서의 작업에 액세스하여 작업하는 방법.
seo-description: 관리자 및 조직 책임자가 AEM Forms 작업 공간의 [할 일] 탭에서 직접 및 간접 보고서의 작업에 액세스하여 작업하는 방법.
...
이제 AEM Forms 작업 공간에서 관리자는 계층 내의 모든 사람에게 할당된 작업(직접 또는 간접 보고서)에 액세스하여 다양한 작업을 수행할 수 있습니다. 작업은 AEM Forms 작업 영역의 [할 일] 탭에서 사용할 수 있습니다. 직접 보고서의 작업에 지원되는 작업은 다음과 같습니다.
