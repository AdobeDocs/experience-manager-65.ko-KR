...
1. AEM Forms 작업 공간 사용자 [지정에 대한 일반 단계를 따릅니다](../../forms/using/generic-steps-html-workspace-customization.md).
...
마지막으로, 작업에 추가할 각 속성에 대한 개발 패키지의 항목을 포함해야 합니다. 하나를 만들려면 AEM Forms 작업 공간 코드 작성을 참조하십시오.
