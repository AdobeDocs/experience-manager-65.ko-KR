...
1. AEM 작성자 인스턴스에 로그인하고 Adobe Experience Manager > **[!UICONTROL 도구]** > **[!UICONTROL 양식]** > **[!UICONTROL PDF]** 생성기 **[!UICONTROL 구성으로 이동합니다]**. 기본 URL은 http://localhost:4502/libs/fd/pdfg/config/ui.html입니다.
