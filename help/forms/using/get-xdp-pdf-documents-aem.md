...
XFA를 참조하는 적응형 양식에는 XFA에서 사용할 수 있는 필드와 함께 필드가 바인딩되어 있습니다. 양식 템플릿을 업데이트할 때 연관된 적응형 양식은 XFA와 동기화를 시도합니다. 자세한 내용은 [적응형 양식을 연결된 XFA](../../forms/using/synchronizing-adaptive-forms-xfa.md)와 동기화 를 참조하십시오.
