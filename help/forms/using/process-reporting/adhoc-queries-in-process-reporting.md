...
## 프로세스 보고 {#ad-hoc-queries-in-process-reporting-1}의 임시 쿼리
...
1. **Report**패널의 오른쪽 위 모서리에 있는 옵션을 사용하여 쿼리 결과에 대해 작업을 수행합니다.
...
1. 프로세스/작업 검색을 실행합니다. 자세한 내용은 [프로세스 검색 쿼리](#to-execute-a-search-query)를 참조하십시오.
