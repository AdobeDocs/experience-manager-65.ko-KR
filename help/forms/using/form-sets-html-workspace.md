...
양식 세트는 단일 양식 세트로 그룹화되고 최종 사용자에게 제공되는 HTML5 양식의 컬렉션입니다. 최종 사용자가 양식 작성을 시작하면 한 양식에서 다른 양식으로 원활하게 전환됩니다. 한 번의 클릭으로 양식 세트를 제출할 수 있습니다. 형식 설정 및 설정 방법에 대한 자세한 내용은 AEM Forms](../../forms/using/formset-in-aem-forms.md)의 [Formset를 참조하십시오.
...
1. 워크벤치에서 업무 프로세스 워크플로우를 생성합니다. 자세한 내용은 [워크벤치 도움말](https://www.adobe.com/go/learn_aemforms_workbench_63)을 참조하십시오.
...
1. **Formset** 탭을 클릭하고 목록에서 관련 서식 세트를 선택한 다음 **확인**&#x200B;을 클릭합니다.

1. 기타 관련 프로세스 속성을 업데이트한 후 응용 프로그램을 배포합니다.

## AEM Forms 작업 공간 {#using-formset-in-nbsp-aem-forms-workspace}에서 형식 집합 사용
