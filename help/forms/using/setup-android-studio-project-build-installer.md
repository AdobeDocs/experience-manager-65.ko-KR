...
![압축된 ™ 소스의 압축을 푼 콘텐츠](assets/mws-content-1.png)
...
1. ™ Studio에서 프로젝트를 설정하고 서명 ID를 제공하려면 다음 단계를 수행하십시오.

   ™ Studio가 설치 및 구성된 컴퓨터에 로그인합니다.
...
1. ™ Studio에서 **[!UICONTROL 프로젝트 가져오기(Eclipse ADT, Gradle 등)]**&#x200B;를 선택합니다.
...
1. 프로젝트를 가져오면 ™ 플러그인 Gradle을 업데이트하는 옵션과 함께 팝업이 나타납니다. 요구 사항에 따라 적절한 버튼을 클릭합니다.
...
1. ™ Studio는 연결된 장치 및 사용 가능한 에뮬레이터를 표시합니다. 응용 프로그램을 실행할 장치를 선택한 다음 **확인**&#x200B;을 클릭합니다.

   ![연결된 장치](assets/connecteddevice.png)

프로젝트를 빌드한 후에는 ™ Debug Bridge 또는 Android™ Studio를 사용하여 앱을 설치하도록 선택할 수 있습니다.

### ™ Debug Bridge 사용 {#andriod-debug-bridge}

다음 명령을 사용하여 [™ Debug Bridge](https://developer.android.com/tools/adb)를 통해 Android™ 장치에 응용 프로그램을 설치할 수 있습니다.
