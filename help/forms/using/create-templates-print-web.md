...
1. Forms Designer를 열고 를 선택합니다. **파일** > **신규** > **빈 양식 사용,** 선택 **다음**&#x200B;을 선택한 다음 을 선택합니다 **완료** 템플릿을 만들기 위해 양식을 엽니다.
...
1. 선택 **만들기** > **파일 업로드**.
   ...
   다음 위치로 이동하여 선택합니다. **create_first_ic_print_template** 템플릿(XDP) 및 선택 **열기** AEM Forms 서버로 XDP 템플릿을 가져옵니다.
...
1. 선택 **+** 왼쪽 창에서 **표** 1 및 마우스 오른쪽 버튼 클릭 **Cell1** 및 선택 **개체 이름 바꾸기** 끝 **날짜**.
...
1. 선택 **도구** ![망치 아이콘](assets/hammer-icon.svg) > **구성 브라우저**.
   * 다음을 참조하십시오. [구성 브라우저](/help/sites-administering/configurations.md) 설명서 를 참조하십시오.
1. Configuration Browser 페이지에서 **만들기**.
1. 다음에서 **구성 만들기** 대화 상자, 지정 **Create_First_IC_templates** 폴더의 제목으로 을 선택합니다. **편집 가능한 템플릿**, 및 선택 **만들기**.
...
1. **만들기**&#x200B;를 선택합니다.
1. 다음에서 **템플릿 유형 선택** 구성 마법사, 선택 **대화형 통신 - 웹 채널** 및 선택 **다음**.
1. 다음에서 **템플릿 세부 정보** 구성 마법사, 지정 **Create_First_IC_Web_Template** 를 템플릿 제목으로 사용하십시오. 선택적 설명을 지정하고 을(를) 선택합니다 **만들기**.

   다음을 포함하는 확인 메시지: **Create_First_IC_Web_Template** 이 표시됩니다.

1. 선택 **열기** 템플릿 편집기에서 템플릿을 엽니다.
1. 선택 **초기 컨텐츠** 다음 옆에 있는 드롭다운 목록에서 **미리 보기** 옵션을 선택합니다.

   ![템플릿 편집기](assets/template_editor_initial_content_new.png)

1. 선택 **루트 패널** 다음을 선택합니다. **+** 템플릿에 추가할 수 있는 구성 요소 목록을 봅니다.
...
1. 패널을 선택하고 ![configure_icon](assets/configure_icon.png) (구성).
1. 속성 창에서 다음을 수행합니다.
   ...
   1. 속성을 저장하려면 을 선택합니다. ![저장](/help/forms/using/assets/done_icon.png).
...
1. 선택 **도구** ![망치 아이콘](assets/hammer-icon.svg) > **템플릿**.
1. 다음 위치로 이동 **Create_First_IC_Web_Template** 템플릿을 선택하고 **사용**.
1. 선택 **사용** 다시 한 번 확인해 보십시오.
...
1. 다음 항목 선택 **문서 컨테이너** 콘텐츠 트리를 사용한 루트 패널 및 선택 **정책** 대화형 통신에서 사용할 수 있는 구성 요소를 선택합니다.
...
1. 속성을 저장하려면 을 선택합니다. ![저장](assets/done_icon.png).
