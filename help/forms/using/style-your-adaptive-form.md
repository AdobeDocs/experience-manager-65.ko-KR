...
1. 만들기를 **누릅니다**. 테마가 만들어지고 편집할 양식을 여는 대화 상자가 나타납니다. 열기 **를** 눌러 새로 만든 테마를 새 탭에서 엽니다. 테마가 테마 편집기에서 열립니다. 스타일링을 위해 테마 편집기는 AEM Forms과 함께 제공된 즉시 사용 가능한 양식을 사용합니다.
...
1. 선택기 패널에서 **헤더** > **텍스트** 옵션을탐색합니다. 선택기 패널은 테마 편집기의 왼쪽에 있습니다. 패널이 보이지 않으면 ![토글 사이드 패널](assets/toggle-side-panel.png) 사이드 패널을 누릅니다.
...
1. AEM Forms 서버에서 ![adobeexperiencemaneconeman](assets/adobeexperiencemanager.png) Adobe Experience Manager **** > **** 도구 ![를](assets/hammer.png) 탐색하고, **** ****&#x200B;망치 도구 > DeploymentAger >Cloud Service으로 이동합니다. Cloud Service 페이지에서 **타사 서비스** > **Typekit**&#x200B;으로 이동하고 Typekit **에서 지금** 구성을클릭합니다. 구성을 이미 사용할 수 있는 경우 + 단추를 클릭하여 새 인스턴스를 만듭니다.
