...
테마를 사용하여 적응형 양식에 고유한 모양 및 스타일을 제공할 수 있습니다. 적응형 양식 편집기와 함께 제공되는 기본 테마를 적용하거나 고유한 사용자 지정 테마를 만들 수 있습니다. AEM [!DNL Forms]은 [테마 편집기](https://helpx.adobe.com/experience-manager/6-3/forms/using/themes.html)를 제공하여 사용자 지정 테마를 만듭니다. 단일 테마는 모바일, 태블릿 또는 데스크톱에서 연 동일한 적응형 양식에 다른 모양을 제공할 수 있습니다. CSS 또는 LESS에 대한 이전 지식은 테마 편집기를 사용할 필요가 없지만 원하는 것입니다.
...
1. **[!UICONTROL 적응형 양식 컨테이너]**&#x200B;의 속성을 엽니다. 속성 브라우저에서 **[!UICONTROL 기본]** > **[!UICONTROL 적응형 양식 테마]**&#x200B;로 이동합니다. **[!UICONTROL 적응형 양식 테마]** 필드에는 모든 기본 제공 및 사용자 지정 테마가 나열됩니다. 기본적으로 캔버스 테마가 적용됩니다.
1. **[!UICONTROL 적응형 양식 테마]** 필드에서 테마를 선택합니다. 예: **설문 조사 테마** ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 탭하여 선택한 테마를 적용합니다.
...
1. 헤더의 기존 로고와 텍스트를 변경합니다. 로고를 제거하려면
   ...
   1. [!UICONTROL 헤더] 구성 요소에서 로고 이미지를 탭하고 ![cmppr](assets/cmppr.png) **[!UICONTROL 속성]**&#x200B;을 탭합니다. [!UICONTROL image] 속성에서 X를 탭하여 기존 로고 이미지를 제거합니다.
   1. **[!UICONTROL 업로드]**&#x200B;를 탭하고 logo.png를 선택한 다음, ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 탭하여 변경 내용을 저장합니다. [시작하기 전에](/help/forms/using/style-your-adaptive-form.md#before-you-start) 섹션에서 이미지를 다운로드했습니다.
   1. 헤더 텍스트 `We.Retail`를 탭하고 ![aem_6_3_edit](assets/aem_6_3_edit.png) **[!UICONTROL 편집]**&#x200B;을 탭합니다. 헤더 텍스트를 `we retail`로 변경합니다. `we retail`의 `we`에만 굵은 서식만 적용합니다.
...
1. 제목을 제거하고 자리 표시자 텍스트를 추가합니다.
   ...
   1. **[!UICONTROL 제목]** 필드의 콘텐츠를 삭제하고 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 탭합니다.
...
1. **[!UICONTROL 만들기]**&#x200B;를 누릅니다. 테마가 만들어지고 편집할 양식을 여는 대화 상자가 나타납니다. **[!UICONTROL 열기]**&#x200B;를 눌러 새 탭에서 새로 만든 테마를 엽니다. 테마가 테마 편집기에서 열립니다. 스타일링을 위해 테마 편집기에서는 AEM [!DNL Forms]과 함께 제공된 기본 적응형 양식을 사용합니다.

   테마 편집기 UI 사용에 대한 자세한 내용은 [테마 편집기 정보](/help/forms/using/themes.md#aboutthethemeeditor)를 참조하십시오.

1. **[!UICONTROL 테마 옵션]** ![테마 옵션](assets/theme-options.png) > **[!UICONTROL 구성]**&#x200B;을 탭합니다. **[!UICONTROL 양식 미리 보기]** 필드에서 **shipping-address-add-update-form** 적응형 양식을 선택하고 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 탭하고 **[!UICONTROL 저장]**&#x200B;을 탭합니다. 이제 테마 편집기는 기본 적응형 양식 대신 고유한 적응형 양식을 사용하도록 구성됩니다. **[!UICONTROL 취소]**&#x200B;를 눌러 테마 편집기로 돌아갑니다.
...
1. 선택기 패널에서 **[!UICONTROL 헤더]** > **[!UICONTROL 텍스트]** 옵션을 탐색합니다. 선택기 패널은 테마 편집기 왼쪽에 있습니다. 패널이 표시되지 않으면 ![토글-사이드 패널](assets/toggle-side-panel.png) 사이드 패널 전환 을 탭합니다.

1. **[!UICONTROL Text]** 아코디언에서 다음 속성을 설정하고 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 탭합니다.
...
1. [!UICONTROL 헤더] 위젯을 탭하고 **[!UICONTROL 헤더]**&#x200B;를 탭합니다. 헤더 위젯의 스타일을 지정하는 옵션이 왼쪽에 나타납니다. **[!UICONTROL Dimension 및 위치]** 아코디언을 확장하고 **[!UICONTROL 높이]**&#x200B;를 `120px`로 설정하고 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 탭합니다.
1. 헤더 위젯의 **[!UICONTROL 배경]** 아코디언을 확장하고 **[!UICONTROL 배경색]**&#x200B;을 `F6921E.`로 설정합니다.

   **[!UICONTROL 이미지 및 그라데이션]** > **[!UICONTROL + 추가]**&#x200B;를 마우스로 가리킨 다음 **[!UICONTROL 이미지]**&#x200B;를 탭합니다. 다음 속성을 설정하고 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 누릅니다.
...
1. 테마 편집기에서 헤더에서 로고를 탭하고 **[!UICONTROL 헤더 로고]**&#x200B;를 누릅니다. Dimension 및 위치 아코디언을 확장하고 다음 속성을 설정하고 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 누릅니다.
...
1. 바닥글 위젯을 탭하고 **[!UICONTROL 바닥글]**&#x200B;을 탭합니다. **[!UICONTROL 배경]** 아코디언을 확장하고 **[!UICONTROL 배경색]**&#x200B;을 `F6921E`로 설정하고 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 탭합니다.
...
1. **[!UICONTROL 고객 ID]** 필드를 탭하고 **[!UICONTROL 필드 위젯]** 옵션을 탭합니다. 다음 속성을 설정하고 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 누릅니다.
...
1. **[!UICONTROL 고객 ID]** 필드 위의 빈 영역을 탭하고 **[!UICONTROL 응답형 패널 컨테이너]**&#x200B;를 탭합니다. **[!UICONTROL 배경]** > **[!UICONTROL 배경색]**&#x200B;을 F1F2F2로 설정합니다. ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 누릅니다.
...
1. **[!UICONTROL Submit]** 단추를 탭하고 **[!UICONTROL Button]** 옵션을 탭합니다. 다음 속성을 설정하고 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)를 누릅니다.
...
1. **[!UICONTROL 첨부]** 단추를 탭하고 ![aem_6_3_edit](assets/aem_6_3_edit.png)아이콘을 탭합니다. **[!UICONTROL Dimension 및 위치]** 아코디언에서 다음 속성을 설정합니다.
...
1. **[!UICONTROL 정부 승인 주소 증명]** 옵션을 탭하고 ![aem_6_3_edit](assets/aem_6_3_edit.png)아이콘을 탭합니다. 다음 속성을 설정합니다.
...
1. **[!UICONTROL Submit]** 단추를 탭하고 ![aem_6_3_edit](assets/aem_6_3_edit.png) 아이콘을 탭합니다. 다음 속성을 설정합니다.
...
[!DNL Adobe Fonts] 는 웹 글꼴 서비스입니다. 적응형 양식과 함께 서비스를 구성하고 사용할 수 있습니다. 적응형 양식에서 [!DNL Adobe Fonts]을 사용하려면

>[!NOTE]
>
>![typekit-to-adobe-](assets/typekit-to-adobe-fonts.png) [!DNL Typekit] fontsis는 이제 Adobe Fonts라고 하며 Creative Cloud 및 기타 구독에 포함되어 있습니다. [추가 정보](https://fonts.adobe.com/).

1. [Adobe Fonts](https://typekit.com/) 계정을 만들고, 키트를 만들고, Font Myriad Pro를 키트에 추가하고, 키트를 게시하고, 키트 ID를 얻습니다. 적응형 양식에서 [!DNL Adobe Fonts](웹 글꼴)을 사용해야 합니다.
1. AEM [!DNL Forms] 서버에서 ![adobeexperiencemanager](assets/adobeexperiencemanager.png) **[!UICONTROL Adobe Experience Manager]** > **[!UICONTROL 도구]** ![햄머](assets/hammer.png) > **[!UICONTROL Adobe Fonts]**&#x200B;로 이동합니다. 이제 구성 폴더를 엽니다. 구성을 이미 사용할 수 있는 경우 **[!UICONTROL 만들기]** 단추를 클릭하여 새 인스턴스를 만듭니다.

   구성 만들기 대화 상자에서 구성에 대한 **제목**&#x200B;을 지정하고 **[!UICONTROL 만들기]**&#x200B;를 클릭합니다. 구성 페이지로 리디렉션됩니다. 표시되는 [!UICONTROL 구성 요소 편집] 대화 상자에서 **키트 ID**&#x200B;를 제공하고 **[!UICONTROL 확인]**&#x200B;을 클릭합니다.

1. [!DNL Adobe Fonts] 구성을 사용하도록 테마를 구성합니다. 작성자 인스턴스에서 테마 편집기에서 **[!UICONTROL 전역 테마]**&#x200B;를 엽니다. 테마 편집기에서 **[!UICONTROL 테마 옵션]** ![테마 옵션](assets/theme-options.png) > **[!UICONTROL 구성]**&#x200B;으로 이동합니다. **[!UICONTROL Adobe Fonts 구성]** 필드에서 키트를 선택하고 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
