...
1. 누르기 **[!UICONTROL 피할당자 추가]**. 에서 사용자 지정 **[!UICONTROL 할당자]** 항목을 위임할 수 있는 필드입니다. 다음을 지정합니다. **[!UICONTROL 워크플로 모델]** 따라서 지정된 사용자에게 위임할 수 있습니다. 워크플로우 모델을 두 개 이상 선택할 수 있습니다.
...
>[!NOTE]
>
>(Forms 중심 워크플로 항목만 해당) **피할당자가 &#39;부재 중&#39; 설정을 사용하여 위임하도록 허용** 옵션 **작업 할당** 워크플로우의 단계입니다. 앞에서 언급한 옵션이 활성화된 항목만 다른 사용자에게 위임됩니다.
