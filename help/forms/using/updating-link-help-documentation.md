...
# 문서 {#updating-the-link-to-the-documentation} 링크 업데이트

**도움말 > 작업 공간 도움말**&#x200B;을 선택하여 AEM Forms 작업 영역의 기본 도움말 컨텐츠에 액세스할 수 있습니다. Adobe 웹 사이트에 있는 온라인 설명서를 가리킵니다. 하지만 다른 URL을 가리키도록 업데이트할 수 있습니다.
...
온라인 설명서의 URL을 업데이트하려면 [사용자 정의 일반 단계](/help/forms/using/generic-steps-html-workspace-customization.md)를 수행한 다음 단계를 따릅니다.

1. `/libs/ws/js/runtime/templates`의 `userinfo.html` 파일을 `/apps/ws/js/runtime/templates`로 복사합니다.
1. 변경:
