...
Form 컨트롤에서 도구 설명, 화면 Reader 텍스트 및 캡션과 같은 여러 옵션을 사용할 수 있는 경우 화면 Reader은 이러한 속성 중 하나만 사용합니다. 기본 순서는 사용자 정의 화면 Reader 텍스트, 도구 설명, 캡션 및 이름입니다. [액세스 가능성] 팔레트의 [화면 Reader] **우선 순위** 옵션을 사용하여 기본 순서를 재정의할 수 있습니다.
