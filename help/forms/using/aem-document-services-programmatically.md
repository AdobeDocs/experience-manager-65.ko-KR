...
>[!NOTE]
>
>이러한 모든 서비스는 Document 개체를 URL에서 Javadoc를 찾을 수 있는 입력 매개 변수로 사용합니다 [https://helpx.adobe.com/experience-manager/6-3/forms/javadocs/index.html](https://helpx.adobe.com/experience-manager/6-3/forms/javadocs/index.html)
