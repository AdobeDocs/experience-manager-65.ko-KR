...
1. **고급**&#x200B;을 선택합니다. 고급 탭에는 더 많은 필드가 포함되어 있습니다. 이러한 필드는 대부분 기본값이 포함되어 있습니다.
   ...
   * **스로틀 사용:** 이 옵션을 활성화하면 지정된 시간에 AEM Forms에서 처리하는 감시 폴더 작업 수가 제한됩니다. 배치 크기 값은 최대 작업 수를 결정합니다. 자세한 내용은 [조절](/help/forms/using/admin-help/configuring-watched-folder-endpoints.md#about-throttling)을 참조하십시오.
