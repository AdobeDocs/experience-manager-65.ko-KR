...
1. 누르기 **Adobe Experience Manager** 아이콘(화면 왼쪽 위 모서리)을 클릭합니다.
1. 누르기 **도구** > **Forms** > **감시 폴더를 구성합니다.** 이미 구성된 감시 폴더 목록이 표시됩니다.
1. 누르기 **신규**. 감시 폴더를 만드는 데 필요한 필드 목록이 표시됩니다.
...
1. 누르기 **고급**. 고급 탭에는 더 많은 필드가 포함되어 있습니다. 이러한 필드는 대부분 기본값이 포함되어 있습니다.
   ...
   * **실패 시 파일 유지:** True로 설정하면 실패 시 입력 파일이 유지됩니다. 기본값은 true입니다.
...
1. 탭 **Adobe Experience Manager** 아이콘(화면 왼쪽 상단).
1. 누르기 **도구** > **Forms** > **감시 폴더를 구성합니다.** 이미 구성된 감시 폴더 목록이 표시됩니다.
1. 감시 폴더 화면의 왼쪽에서 감시 폴더를 선택하고 을 누릅니다 **편집.** 감시 폴더를 만드는 데 필요한 필드 목록이 표시됩니다. 다음에 나열된 필드: **기본** 탭은 필수입니다. 고급 탭에는 더 많은 필드가 포함되어 있습니다. 이러한 필드는 대부분 기본값이 포함되어 있습니다. 요구 사항에 따라 이러한 속성을 수정할 수 있습니다.
1. 속성을 수정한 후 을 누릅니다. **업데이트**. 수정된 속성이 저장됩니다.
