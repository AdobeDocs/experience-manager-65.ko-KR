...
1. 적응형 양식 작성 모드에서 양식 컨테이너 개체를 선택하고 을 누릅니다 ![cmppr1](assets/cmppr1.png) 속성을 엽니다.
...
1. 누르기 ![check-button1](assets/check-button1.png) 속성을 저장합니다.
...
1. 작성 모드에서 적응형 양식을 열고 양식 개체를 선택한 다음 을 누릅니다 ![edit-rules1](assets/edit-rules1.png) 규칙 편집기를 엽니다.
1. 선택 **[!UICONTROL 양식]** 양식 개체 트리에서 다음을 누릅니다 **[!UICONTROL 만들기]**.
1. 선택 **[!UICONTROL 코드 편집기]** 모드 선택 드롭다운에서 선택합니다.
1. 코드 편집기에서 **[!UICONTROL 코드 편집]**. 누르기 **[!UICONTROL 편집]** 확인 대화 상자에서 확인할 수 있습니다.
1. 선택 **[!UICONTROL 제출 성공]** 또는 **[!UICONTROL 제출 중 오류]** 다음에서 **[!UICONTROL 이벤트]** 드롭다운.
1. 선택한 이벤트에 대한 규칙을 작성하고 탭합니다. **[!UICONTROL 완료]** 을 눌러 규칙을 저장합니다.
