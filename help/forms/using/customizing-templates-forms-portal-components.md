...
* **htmlStyle**&amp; **pdfStyle**: 렌더링에 각각 사용되는 HTML 및 PDF 아이콘의 스타일을 표시합니다. 유효한 값은 &quot; 입니다.**__FP_display_none**&quot; 또는 비어 있습니다.
...
1. **지역화 지원**: 정적 텍스트를 현지화하려면 속성을 사용합니다 `${localize-YOUR_TEXT}` 가 아직 없는 경우 현지화된 값을 사용할 수 있도록 합니다.
   *설명한 예에서 속성은 다음과 같습니다 `${localize-Apply}` 및 `${localize-Download}` 적용 및 다운로드 텍스트를 현지화하는 데 사용됩니다.*
