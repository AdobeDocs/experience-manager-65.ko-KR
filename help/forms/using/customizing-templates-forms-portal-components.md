...
양식 포털에서 양식 목록에 있는 사용자 정의 메타데이터를 사용할 수 있습니다. 자산에 대한 사용자 정의 템플릿을 만드는 동안 레이아웃을 수정하고 CSS 스타일 세트와 함께 사용자 정의 메타데이터를 사용할 수 있습니다.

다양한 Forms 포털 구성 요소에 대한 사용자 지정 템플릿을 만들려면 다음 단계를 수행하십시오.
...
다음은 Forms 포털에서 검색 및 라이브러리 구성 요소에 대한 사용자 정의 Geometrixx Gov 카드 레이아웃을 가져오는 사용자 정의 템플릿의 샘플 구현입니다.
...
모든 Forms Portal 구성 요소에 대한 사용자 정의 템플릿에는 반복 가능한 항목과 반복되지 않는 항목이 포함되어 있습니다. 반복 가능한 항목은 나열된 기본 엔티티입니다. 반복 가능한 항목의 예는 검색 및 목록, 초안 및 제출, 링크 구성 요소입니다.

양식 포털에서는 자리 표시자가 사용자 지정/OOTB 메타데이터를 표시하는 구문을 제공합니다. 자리 표시자는 양식, 초안 또는 제출 결과를 표시한 후에 채워집니다.
...
다양한 양식 포털 구성 요소는 나열을 위해 사용할 수 있는 OOTB 메타데이터의 전용 세트를 제공합니다.
...
1. **데이터 반복 가능** 요소에는 **링크 구성 요소의 중요성이** 없습니다. 링크 구성 요소의 템플릿에서 이 속성을 사용하지 않는 것이 좋습니다.
