...
* **경로**: 초안/제출 메타데이터 노드의 경로 초안 또는 제출 서류를 열 수 있도록 .HTML 확장자와 함께 URL로 사용하십시오.
...
1. 초안 및 제출 구성 요소 아래의 초안 섹션에 있는 삭제 옵션에 대해 CSS 클래스 이름을 &quot;__FP_deleteDraft&quot;로 지정합니다. 또한 해당 초안의 초안 ID인 값 **${draftID}**&#x200B;을(를) 가진 &quot;draftID&quot; 특성을 포함하십시오.
