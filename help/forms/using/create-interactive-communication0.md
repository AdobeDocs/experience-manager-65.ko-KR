...
1. 인터랙티브 커뮤니케이션의 웹 채널에서 [지금](../../forms/using/create-interactive-communication0.md#create-interactive-communication-for-web-channel) 지불 및 **가입** 하이퍼링크를 삽입하려면 웹 채널에 **대한 대화형 통신** 만들기 13 - 18단계를반복합니다.
