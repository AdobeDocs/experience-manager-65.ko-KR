...
1. **미리 보기** 옵션 옆의 드롭다운 목록에서 **스타일**&#x200B;을 선택합니다.
   ...
   ![대화형 통신을 위해 스타일 모드 선택](assets/select_style_ic_web_new.png)
...
1. [웹 채널에 대한 대화형 통신 만들기](../../forms/using/create-interactive-communication0.md#create-interactive-communication-for-web-channel) 중 13 - 18단계를 반복하여 대화형 커뮤니케이션의 웹 채널에 있는 **지금 지불** 및 **구독** 하이퍼링크를 삽입합니다.
