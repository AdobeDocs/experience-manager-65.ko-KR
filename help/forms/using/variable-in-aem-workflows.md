...
* [저장할 정보 유형을 기반으로 ](../../forms/using/variable-in-aem-workflows.md#create-a-variable) 다양한 데이터 유형을 만듭니다.
* [변수 설정 워크플로우 단계를 ](../../forms/using/variable-in-aem-workflows.md#set-a-variable) 사용하여 변수에 대한 값을 설정합니다.
* [모든 AEM Forms 워크플로우 단계에서 ](../../forms/using/variable-in-aem-workflows.md#use-a-variable) 다양한 변수를 사용하여 저장된 값을 검색하고 OR 분할 및 이동 단계에서 라우팅 표현식을 정의합니다.
...
문서 및 양식 데이터 모델 데이터 형식에 대해 [AEM Forms 추가 기능 패키지](https://helpx.adobe.com/kr/aem-forms/kb/aem-forms-releases.html)가 필요합니다.  ArrayList 데이터 유형을 사용하여 변수 컬렉션을 만듭니다. 모든 기본 및 복잡한 데이터 유형에 대해 ArrayList 변수를 만들 수 있습니다. 예를 들어 ArrayList 변수를 만들고 변수를 사용하여 여러 문자열 값을 저장하려면 하위 유형으로 String을 선택합니다.

다음 단계를 실행하여 변수를 만듭니다.

1. AEM 인스턴스의 도구 ![](/help/forms/using/assets/hammer.png) > 워크플로 > 모델로 이동합니다.
...
1. 변수에 대한 선택적 설명을 지정하고 ![done_icon](assets/done_icon.png)을 눌러 변경 내용을 저장합니다. 이 변수는 왼쪽 창에서 사용할 수 있는 목록에 표시됩니다.
...
1. **변수 설정** 단계를 워크플로우 편집기로 드래그하여 놓고 단계를 탭한 다음 ![configure_icon](assets/configure_icon.png)(구성)을 선택합니다.
...
1. 의미 있는 표현을 만들 변수를 더 매핑합니다. ![done_icon](assets/done_icon.png)을 눌러 변경 사항을 저장합니다.
...
이 예에서 라우팅 표현식을 정의하기 전에 [example 2](../../forms/using/variable-in-aem-workflows.md#example2)을 사용하여 **totalvalue** 변수의 값을 설정합니다. 분기 1은 **totalvalue** 변수의 값이 50000보다 큰 경우 활성화됩니다. 마찬가지로, **totalvalue** 변수의 값이 50000보다 작으면 분기 2를 활성화하도록 규칙을 정의할 수 있습니다.
...
모든 AEM Forms 워크플로우 단계는 변수를 지원합니다. 자세한 내용은 OSGi[의 Forms 중심 워크플로우를 참조하십시오.](../../forms/using/aem-forms-workflow-step-reference.md)
...
문서 및 양식 데이터 모델 변수 데이터 형식에는 [AEM Forms 추가 기능 패키지](https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html)이 필요합니다.
...
1. 편집할 변수 이름 옆에 있는 ![edit](assets/edit.png) (편집) 아이콘을 누릅니다.
...
AEM Forms 워크플로우 단계의 변수 사용에 대한 자세한 예는 AEM 워크플로우의 [변수를 참조하십시오.](https://helpx.adobe.com/experience-manager/kt/forms/using/authoring_variables_in_aem_forms-workflow1.html)
