...
1. 고급 아래에서 옵션을 활성화합니다.**AEM Forms 앱과 동기화**&#x200B;하고 **저장**&#x200B;을 탭합니다.

여러 양식을 동기화하려면 작성 인스턴스에서 양식 관리자에서 여러 양식을 선택하고 **AEM Forms 앱과 동기화**&#x200B;를 누릅니다. 양식이 게시되면 AEM Forms 앱이 게시 서버에 연결하여 양식을 가져올 수 있습니다.
