...
[테마 편집기](../../forms/using/themes.md)를 사용하여 스타일을 지정하여 응용 양식의 전체 모양과 스타일을 정의할 수 있습니다. 또한 개별 적응형 양식 구성 요소에 인라인 CSS 스타일을 적용할 수 있으며 변경 내용을 바로 미리 볼 수 있습니다. 인라인 스타일은 테마에 제공된 스타일을 재정의합니다.
...
![인라인 스타일이 적용된 후 텍스트 상자 스타일 적용](assets/applied-style.png)
