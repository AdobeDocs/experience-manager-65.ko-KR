...
AEM Forms 앱에서 프로세스를 시작하려면 시작점이 있어야 합니다 **작업 공간** 진행 중입니다. 또한 **[!UICONTROL Mobile Workspace의 시각화]** startpoint에 대한 옵션입니다.

![mws_startpoint_select_option](assets/mws_startpoint_select_option.png)

**워크벤치에서 정의된 프로세스를 시작하려면**

1. AEM Forms 앱에서 사용할 수 있는 시작점을 보려면 [홈 화면](../../forms/using/home-screen.md).
...
1. 에 세부 사항을 입력합니다. **[!UICONTROL Startpoint]** 양식.
   ...
   을 사용하여 이 작업에 주석을 추가할 수 있습니다 [첨부 파일](../../forms/using/add-attachments.md) 버튼을 클릭합니다.

1. 양식을 채운 후 **[!UICONTROL 제출]** 버튼을 클릭합니다.
