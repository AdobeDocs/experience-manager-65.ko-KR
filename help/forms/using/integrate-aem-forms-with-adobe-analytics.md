...
![Analytics 개요](/help/forms/using/assets/analytics-workflow.png)
...
>[!NOTE]
>둘 다 [기존 Analytics](/help/forms/using/configure-analytics-forms-documents.md) 및 Launch Analytics 기능이 동시에 활성화되어 있습니다. **Analytics 시작** 이 우선합니다.
...
1. 필드를 탭하고 을(를) 선택합니다 ![규칙 편집기](/help/forms/using/assets/edit-rules-icon.svg) 규칙 편집기 페이지를 열려면 다음을 수행하십시오.
