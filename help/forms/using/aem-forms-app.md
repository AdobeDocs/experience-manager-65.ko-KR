...
AEM Forms 앱에는 AEM Forms 서버가 필요합니다. 사용자는 AEM Formsserver에서 만든 양식을 렌더링하여 채우고 초안으로 저장한 다음 제출할 수 있습니다. 이 앱은 서버에 연결하여 활성화된 양식을 해당 앱에서 가져옵니다. AEM Forms 앱은 서버와 동기화되며 앱이 로드되면 사용자는 오프라인에서 작업할 수 있습니다. 앱이 오프라인 상태인 경우 데이터가 장치에 저장되고 앱이 온라인 상태일 때 데이터가 서버와 동기화됩니다.
