...
1. 고급 아래에서 옵션을 활성화합니다. **[!UICONTROL AEM Forms 앱과 동기화]** 및 탭 **[!UICONTROL 저장]**.

양식이 게시되면 앱은 서버와 동기화되고 양식을 가져옵니다. 여러 양식을 동기화하려면 작성자 인스턴스에서 Forms Manager에서 여러 양식을 선택하고 을 누릅니다 **[!UICONTROL AEM Forms 앱과 동기화]**.
