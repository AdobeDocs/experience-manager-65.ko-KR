...
AEM Forms 작업 공간에서 XDP Forms와 연결된 기본 작업 프로필에서 기본 렌더링 및 제출 서비스가 변경되고 새 서비스가 도입되었습니다. 자세한 내용은 [새로운 렌더링 및 제출 서비스](/help/forms/using/new-render-submit-service.md). XDP Forms에서 작동하는 기존 프로세스를 마이그레이션하여 이러한 서비스를 사용하려면 다음을 수행할 수 있습니다 [다음 단계](new-render-submit-service.md).
