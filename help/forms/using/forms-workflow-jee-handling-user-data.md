...
1. 공개 인스턴스 만들기 `ProcessManager` 클라이언트 ( `com.adobe.idp.workflow.client.ProcessManager`) 사용 `ServiceClientFactory` 올바른 연결 설정을 사용하는 인스턴스입니다.
   ...
   자세한 내용은 다음을 위한 Java API 참조 를 참조하십시오 [클래스 ProcessManager](https://helpx.adobe.com/experience-manager/6-3/forms/ProgramLC/javadoc/com/adobe/idp/workflow/client/ProcessManager.html).
