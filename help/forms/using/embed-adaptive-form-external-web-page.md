...
* AEM 서버 및 웹 페이지가 서로 다른 도메인에 있는 경우 섹션에 나열된 단계를 수행하고 AEM Forms이 크로스 도메인 사이트에 적응형 양식을 제공할 수 있도록 [활성화합니다](#cross-site).
...
## AEM Forms이 도메인 간 사이트에 적응형 양식을 제공할 수 있도록 설정 {#cross-site}

1. AEM 작성자 인스턴스의 AEM 웹 콘솔 구성 관리자로 이동합니다 `https://'[server]:[port]'/system/console/configMgr`.
