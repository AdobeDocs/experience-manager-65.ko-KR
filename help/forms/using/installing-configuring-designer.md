...
1. **AEM Forms Designer 6.5.15.0**&#x200B;을(를) 설치한 후 다운로드한 설치 관리자 파일을 두 번 클릭하여 [AEM Forms Designer 6.5.16.0](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=ko)을(를) 다운로드하여 설치하십시오.
