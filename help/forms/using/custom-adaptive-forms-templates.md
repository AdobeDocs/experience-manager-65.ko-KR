...
>[!NOTE]
>
>AEM Forms에 동적 템플릿이 도입되었습니다. AEM Sites 템플릿 편집기를 사용하여 다음을 수행할 수 있습니다 [동적 템플릿 만들기 또는 편집](../../forms/using/template-editor.md). 아래 문서에 언급된 템플릿은 정적 템플릿입니다. 기본 설치에서는 사용할 수 없습니다. [호환성 패키지 설치](../../forms/using/compatibility-package.md) 환경에서 이러한 템플릿을 가져옵니다.
