...
* 빈 템플릿: 머리글, 바닥글 및 초기 컨텐츠 없이 양식을 만들 수 있습니다. 텍스트 상자, 단추 및 이미지와 같은 구성 요소를 추가할 수 있습니다. 빈 템플릿을 사용하면 [AEM Site 페이지에 임베드](/help/forms/using/embed-adaptive-form-aem-sites.md)할 수 있는 양식을 만들 수 있습니다.
