...
1. 선택 **Forms** > **문서 단편**.
1. 선택 **만들기** > **텍스트** 또는 텍스트 자산을 선택하고 **편집**.
...
1. 선택 **다음**. 서신 관리는 텍스트에 텍스트 단락 및 데이터 요소를 추가할 수 있는 편집기 페이지를 표시합니다.
...
2. 선택 **[!UICONTROL 링크]**. 선택 **[!UICONTROL 대체 텍스트]** 기존 데이터 모델 개체 이름 또는 텍스트를 제거하는 필드입니다.

3. URL을 지정하고 다음을 선택합니다. ![저장](assets/save_icon.svg).
...
1. **다음**&#x200B;을 선택합니다.
1. 선택 **자산 추가**.
1. 목록에 에셋을 추가하려면 에셋 선택 페이지에서 에셋을 선택한 다음 를 선택합니다 **완료**.

   ![목록에 추가할 자산 선택](assets/selectassets.png)

1. 자산이 목록 항목 페이지에 추가됩니다.
목록 내의 에셋 순서를 변경하려면 을 선택하고 화살표 아이콘( ![드래그드롭](assets/dragndrop.png) )을 클릭하여 끌어서 놓습니다. 사용자가 서신 만들기 사용자 인터페이스에서 편지 템플릿을 열면 여기에서 정의한 순서로 콘텐츠가 어셈블됩니다.
...
1. **다음**&#x200B;을 선택합니다.
1. 선택 **자산 추가**.
1. 조건에 에셋을 추가하려면 에셋 선택 페이지에서 해당 에셋을 선택하고 **완료**. 에셋이 [표현식] 창에 추가됩니다.
...
1. 조건 내에서 에셋의 순서를 변경하려면 을 선택하고 화살표 아이콘( ![드래그드롭](assets/dragndrop.png) )을 클릭하여 끌어서 놓습니다. 사용자가 서신 만들기 사용자 인터페이스에서 편지 템플릿을 열면 여기에서 정의한 순서로 콘텐츠가 어셈블됩니다.
1. 선택 **삭제** 행을 삭제합니다. 기본 행에 대해 삭제를 선택하면 에셋 정보만 지워집니다.
1. 선택 **복사** 행을 복제합니다.
1. 선택 **편집** 에셋을 변경하거나 표현식을 편집합니다.

   추가 사항:

   * 에셋을 업데이트하려면 에셋 열 아래의 폴더 아이콘을 선택합니다.
   * 표현식 빌더를 열어 표현식을 삽입하려면 표현식 열 아래의 폴더 아이콘을 선택합니다. 표현식 빌더에 대한 자세한 내용은 [표현식 빌더](/help/forms/using/expression-builder.md).
...
1. 선택 **만들기** > **레이아웃 단편**.
1. 서신 관리는 사용 가능한 XDP를 표시합니다. 레이아웃 조각의 기반으로 사용할 XDP를 선택하고 을(를) 선택합니다 **다음**.
...
1. 다음 항목 선택 **표** 을(를) 탭하고 레이아웃에 대해 다음 정보를 지정합니다.
