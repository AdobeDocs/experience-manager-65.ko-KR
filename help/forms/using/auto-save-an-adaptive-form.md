...
1. (선택 사항) 익명 사용자를 위해 콘텐츠를 자동으로 저장하려면 **익명 사용자에 대해 자동 저장 사용** 옵션을 선택하고 **[!UICONTROL 확인]**.
   ...
   >
   >서비스를 구성하려면 다음 위치에서 AEM Web Console 구성으로 이동합니다. `https://server:port/system/console/configMgr` 및 편집 **[!UICONTROL Forms 일반 구성 서비스]** 을 선택합니다. **[!UICONTROL 모든 사용자]** 옵션 **[!UICONTROL 허용]** 필드를 작성하고 구성을 저장합니다.
