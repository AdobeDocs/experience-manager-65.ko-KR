...
1. 사용자 프로필 커넥터 구성 대화 상자에서 사용자 프로필 속성을 추가, 제거 또는 업데이트할 수 있습니다. 양식 데이터 모델에서 지정된 속성을 사용할 수 있습니다. 다음 형식을 사용하여 사용자 프로필 속성을 지정합니다.
   ...
   * `name=profile/empLocation/*/city,type=string`
   >[!NOTE] {graybox=&quot;true&quot;}
   >
   >위 ***** 예제의 경우 CRXDE 구조의 AEM 사용자 프로필에서 `profile/empLocation/` 노드 아래의 모든 노드를 나타냅니다. 즉, 양식 데이터 모델은 `city` 노드 아래의 노드에 `string` `profile/empLocation/` 있는 유형의 속성에 액세스할 수 있습니다. 그러나 지정된 속성을 포함하는 노드는 일관된 구조를 따라야 합니다.
...
1. 도구 > **[!UICONTROL 클라우드 서비스 > 데이터 소스로 이동합니다]**. 클라우드 구성을 만들 폴더를 눌러 선택합니다.
   ...
   클라우드 [서비스 구성을 위한 폴더 만들기 및 구성에 대한 자세한 내용은 클라우드 서비스 구성을](../../forms/using/configure-data-sources.md#cloud-folder) 위한 폴더 구성을 참조하십시오.

1. 만들기를 **[!UICONTROL 눌러]** 데이터 소스 **[!UICONTROL 구성 만들기 마법사를]**&#x200B;엽니다. 구성에 대한 이름과 제목을 지정하고, 서비스 유형 **[!UICONTROL 드롭다운에서]** RESTful Service를 **[!UICONTROL 선택하고, 필요에 따라 구성에 대한 축소판 이미지를 찾아 선택한 다음]** 다음을 **[!UICONTROL 누릅니다]**.
1. RESTful 서비스에 대해 다음 세부 사항을 지정합니다.
   ...
   * 인증 유형 선택 — 없음, OAuth2.0, 기본 인증, API 키 또는 사용자 정의 인증 — 을 클릭하여 RESTful 서비스에 액세스하고 그에 따라 인증에 대한 세부 정보를 제공합니다.
   API 키를 **[!UICONTROL 인증]** 유형으로 선택하는 경우 API 키의 값을 지정합니다. API 키는 요청 헤더 또는 쿼리 매개 변수로 전송할 수 있습니다. 위치 드롭다운 목록에서 이러한 옵션 **[!UICONTROL 중]** 하나를 선택하고 그에 따라 매개 변수 이름 **[!UICONTROL 필드에서 헤더 또는 쿼리 매개 변수의 이름을]** 지정합니다.
...
1. 만들기를 **[!UICONTROL 눌러]** 데이터 소스 **[!UICONTROL 구성 만들기 마법사를]**&#x200B;엽니다. 구성에 대한 이름과 제목을 지정하고, 서비스 유형 **[!UICONTROL 드롭다운에서]** SOAP 웹 서비스를 **[!UICONTROL 선택하고, 필요에 따라 구성에 대한 축소판 이미지를 찾아 선택한 다음, 다음을]** 누릅니다 ****.
...
1. 만들기를 **[!UICONTROL 눌러]** 데이터 소스 **[!UICONTROL 구성 만들기 마법사를]**&#x200B;엽니다. 구성에 대한 이름과 제목을 지정하고, 서비스 유형 **[!UICONTROL 드롭다운에서]** OData **[!UICONTROL 서비스를]** 선택하고, 필요에 따라 구성에 대한 축소판 이미지를 찾아 선택한 다음, 다음을 **[!UICONTROL 누릅니다]**.
