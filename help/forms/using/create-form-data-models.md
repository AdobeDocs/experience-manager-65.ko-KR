...
* **사전 구성된 데이터 소스** 사용:데이터 소스  [구성](../../forms/using/configure-data-sources.md)에 설명된 대로 데이터 소스를 구성한 경우 양식 데이터 모델을 만드는 동안 선택할 수 있습니다. 선택한 데이터 소스의 모든 데이터 모델 개체, 속성 및 서비스를 양식 데이터 모델에서 사용할 수 있도록 합니다.
...
[데이터 소스 구성](../../forms/using/configure-data-sources.md)에 설명된 대로 양식 데이터 모델에 사용할 데이터 소스를 구성했는지 확인합니다. 구성된 데이터 소스를 기반으로 양식 데이터 모델을 만들려면 다음을 수행하십시오.
...
양식 데이터 모델 편집기와 양식 데이터 모델을 편집하고 구성하는 데 사용할 수 있는 방법에 대한 자세한 내용은 [양식 데이터 모델로 작업](../../forms/using/work-with-form-data-model.md)을 참조하십시오.
