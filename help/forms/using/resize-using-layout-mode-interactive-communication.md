...
[ **미리 보기** ] 옵션 옆에 있는 대화형 통신 제작 인터페이스 상단에 표시되는 드롭다운 목록에서 **레이아웃을** 선택합니다. 양식은 레이아웃 모드로 표시됩니다.

1. AEM 작성자 인스턴스에 로그인하고 **Adobe Experience Manager** > **Forms** > **Forms**&#x200B;및 문서로 이동합니다.
1. 새로 만들거나 기존 [대화형 통신을 엽니다](../../forms/using/create-interactive-communication.md).
