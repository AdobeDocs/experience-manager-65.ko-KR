...
다음 [보호 모드](../../forms/using/get-xdp-pdf-documents-aem.md) 은 기본적으로 켜져 있습니다. 프로덕션 환경에 대해 사용하도록 설정합니다. 개발 환경에서 비활성화하여 Destiner에서 HTML 5 Forms을 미리 볼 수 있습니다. 비활성화하려면 다음 단계를 수행하십시오.
...
1. 옵션 창에서 **서버 옵션** 페이지에서 다음 세부 정보를 제공하고 **확인**.
   ...
   * **Forms Manager 컨텍스트:** Forms Manager UI가 배포되는 컨텍스트 경로입니다. 기본값은 다음과 같습니다.
   ...
   >[!NOTE]
   >
   >AEM Forms 서버가 작동 중인지 확인합니다. HTML 미리 보기는 CRX 서버에 연결하며 *생성* 미리 보기.
