...
AEM Forms은 Dynamics 365를 [Forms 데이터 통합](/help/forms/using/data-integration.md) 모듈과 통합하는 클라우드 서비스를 제공합니다. Microsoft® Dynamics 시나리오에서 Home Mortgage 응용 프로그램 연습을 사용하려면 We.Finance 참조 사이트에 사용할 Microsoft® Dynamics 365를 구성해야 합니다.
