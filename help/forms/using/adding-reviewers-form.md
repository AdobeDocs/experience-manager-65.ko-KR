...
다음 단계를 수행하기 전에 를 참조하십시오. [전제 조건](../../forms/using/adding-reviewers-form.md#prerequisite).

그룹을 만들고 구성원을 추가하려면 다음으로 이동합니다. **도구** > **작업** > **보안** > **그룹**.
자세한 내용은 [사용자 관리 및 서비스](/help/sites-administering/security.md).
만든 그룹을 기본 제공 사용자 그룹의 구성원으로 추가해야 합니다. **forms-submission-reviewers**. 이 사용자 그룹은 AEM Forms과 함께 제공되며 사용자가 제출 검토자로 추가되었는지 확인합니다.
