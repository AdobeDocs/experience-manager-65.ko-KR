...
AEM Forms의 최신 기능 및 개선 사항에 대한 자세한 내용은 [AEM Forms의 새로운 기능](../../forms/using/whats-new.md).
...
AEM Forms은 적응형 양식뿐만 아니라 XFA 양식, PDF forms 및 관련 자산을 관리할 수 있는 양식 관리 도구를 제공합니다. 자세한 내용은 [양식 관리 소개](../../forms/using/introduction-managing-forms.md).
