...
OSGi 및 AEM Forms JEE 워크플로우(JEE Process Management의 AEM Forms)의 양식 중심 AEM 워크플로우에는 다른 기능이 있습니다. 다음 표는 JEE 워크플로우의 OSGi 및 AEM Forms에서 양식 중심의 AEM 워크플로우에서 사용할 수 있는 중요한 기능을 이해하는 데 도움이 됩니다.
...
1. 기본 AEM Forms 문서 서비스는 OSGi의 양식 중심 AEM 워크플로우와 JEE 워크플로우의 AEM Forms 모두에 사용할 수 있습니다. AEM Workflow는 OSGi 및 AEM Forms JEE(프로세스 관리) 워크플로우에서 양식 중심의 AEM 워크플로우에 기본 문서 서비스를 사용합니다.
...
양식 중심의 워크플로우를 실행하는 중요한 두 가지 방법 중 하나는 [AEM Inbox](../../forms/using/manage-applications-inbox.md) 및 AEM Forms 앱을 사용하는 것입니다. 하지만 AEM Inbox 및 AEM Forms 앱의 기능은 다릅니다. AEM Inbox는 [양식 중심 워크플로우에서만](../../forms/using/aem-forms-workflow.md) 작동하는 반면 AEM Forms 앱은 양식 중심 워크플로우와 프로세스 관리에서 모두 작동합니다.
