...
1. 관리자로 AEM 작성자 [!DNL Forms] 인스턴스에 로그인합니다. CRXDE Lite을 [!UICONTROL 엽니다]. AEM 로고 > **[!UICONTROL 도구]** > 일반 **** > **[!UICONTROL CRXDE Lite]** 를 [누르거나 브라우저에서 https://localhost:4502/crx/de/index.jspURL을](https://localhost:4502/crx/de/index.jsp) 열어 CRXDE Lite을 열 수 있습니다.

1. CRXDE Lite의 /etc/clientlibs로 [!UICONTROL 이동합니다]. /etc/clientlibs 하위 폴더를 마우스 오른쪽 단추로 클릭하고 **[!UICONTROL 만들기]** > 노드 **[!UICONTROL 만들기를 클릭합니다]**. 이름 **[!UICONTROL 필드]** 유형에서 **WeRetailFormTestCases를 선택합니다**. cq:ClientLibraryFolder로 **유형을** 선택하고 확인을 **[!UICONTROL 클릭합니다]**. 노드를 만듭니다. 대신 어떤 이름이든 사용할 수 있습니다 `WeRetailFormTestCases`.
1. 다음 속성을 노드에 추가하고 `WeRetailFormTestCases` 모두 **[!UICONTROL 저장을 누릅니다]**.
...
1. WeRetailFormTestCases **[!UICONTROL 노드를 마우스 오른쪽 단추로]** 클릭하고 **[!UICONTROL 만들기]** > 파일 **[!UICONTROL 만들기를]**&#x200B;클릭합니다. 이름 **[!UICONTROL 필드]** 에서 `js.txt` 을 입력하고 **[!UICONTROL 확인을 클릭합니다]**.
...
1. AEM 테스트 UI를 엽니다(AEM > **[!UICONTROL 도구]** > **[!UICONTROL 작업]** ****>테스트). 테스트 세트( **We retail - Tests** )가 UI에 나열됩니다.
...
1. CRXDE [!UICONTROL lite]에서 `/content/forms/af/create-first-adaptive-form` 폴더로 이동합니다. create-first-adaptive-form **[!UICONTROL 폴더 노드를 마우스 오른쪽 단추로 클릭하고]** 만들기 **[!UICONTROL > 파일]**&#x200B;만들기를 클릭합니다 ****. 이름 **[!UICONTROL 필드]** 에서 `prefill.xml` 을 입력하고 **[!UICONTROL 확인을 클릭합니다]**. 파일에 다음 코드를 추가합니다.
...
1. 테스트 이름(Prefill test)을 눌러 테스트 케이스 결과를 검토합니다. 결과 [!UICONTROL 패널이] 열립니다. 테스트 케이스 이름을 [!UICONTROL 결과] 패널에서 눌러 테스트의 모든 세부 사항을 확인합니다.
