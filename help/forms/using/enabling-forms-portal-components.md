...
1. 동적 템플릿을 사용하는 페이지의 경우 다음 단계를 수행하십시오.
   ...
   1. 탭 **레이아웃 컨테이너** 탭 ![FeedManagement](/help/forms/using/assets/feedmanagement.png). 에서 **허용된 구성 요소** 탭에서 을 활성화합니다 **문서 서비스 및 문서 서비스 설명** 옵션 및 탭 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
