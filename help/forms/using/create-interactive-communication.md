...
* 테스트 데이터를 포함하거나 실제 데이터 소스(예: ® Dynamics 인스턴스)를 사용하여 [양식 데이터 모델](/help/forms/using/data-integration.md)을(를) 설정합니다.
...
1. 다음 정보를 입력합니다. :
   ...
   * **[!UICONTROL 작성자]**:The 작성자 이름은 로그인한 사용자의 사용자 이름에서 자동으로 가져옵니다.
