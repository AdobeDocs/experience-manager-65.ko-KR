...
1. **[!UICONTROL 만들기]**&#x200B;를 탭합니다. 대화형 통신이 만들어지고 경고 상자가 나타납니다. 누르기 **[!UICONTROL 편집]** 에 설명된 대로 대화형 통신의 콘텐츠 작성을 시작하려면 [대화형 통신 작성 사용자 인터페이스를 사용하여 콘텐츠 추가](#step2). 또는 을 누를 수 있습니다. **[!UICONTROL 완료]** 나중에 [대화형 통신]을 편집하도록 선택합니다.
