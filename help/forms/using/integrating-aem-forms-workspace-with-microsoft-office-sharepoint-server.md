...
1. 웹 브라우저에서 SharePoint 사이트(예: `https://[myMOSSserver]:44299/default.aspx`)로 이동합니다. 여기서 `[myMOSSserver]`은 Sharepoint 서버의 이름 또는 IP 주소입니다.
...
1. 페이지 뷰어 페이지에서 다음 작업을 수행합니다.
   ...
   1. [링크] 상자에 AEM Forms 작업 영역의 URL(예: `https://[AEM_forms_Server]:8080/lc/ws`)을 입력합니다. 여기서 `[AEM_forms_Server]`은 AEM Forms 서버의 IP 또는 이름을 나타냅니다.
