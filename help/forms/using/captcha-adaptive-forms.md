...
1. reCAPTCHA에 대한 클라우드 서비스를 구성합니다.
   ...
   1. 구성 요소 편집 대화 상자에서 1단계에서 얻은 사이트 및 비밀 키를 지정합니다. 탭 **설정 저장** 그런 다음 **확인** 구성을 완료합니다.
...
1. CAPTCHA 위젯의 제목을 지정합니다. 기본값은 입니다. **Captcha**. 선택 **제목 숨기기** 제목을 표시하지 않으려면
1. 에서 **Captcha 서비스** 드롭다운에서 을 선택합니다. **reCaptcha** reCAPTCHA 서비스를 사용하도록 설정하려면 [Google ReCAPTCHA 서비스](#google-recaptcha). 설정 드롭다운에서 구성을 선택합니다. 또한 크기를 **일반** 또는 **컴팩트** reCAPTCHA 위젯용.
