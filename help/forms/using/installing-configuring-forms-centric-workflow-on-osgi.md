...
OSGi에서 [Forms 중심의 워크플로우를 사용하여 적응형 양식 기반의 워크플로우를](../../forms/using/aem-forms-workflow.md) 신속하게 구축할 수 있습니다. 이러한 워크플로우를 통해 검토 및 승인 워크플로우, 비즈니스 프로세스 워크플로우 및 기타 반복적인 작업을 자동화할 수 있습니다. 또한 이러한 워크플로우를 통해 문서 처리(PDF 문서 작성, 조합, 배포 및 보관, 문서에 대한 액세스를 제한하는 디지털 서명 추가, 바코드된 양식 디코딩 등)와 양식 및 문서에서 Adobe Sign 서명 워크플로우를 사용할 수 있습니다.
...
AEM Forms은 강력한 엔터프라이즈급 플랫폼입니다. OSGi의 Forms 중심 워크플로우는 AEM Forms의 기능 중 하나에 불과합니다. 전체 기능 목록은 AEM Forms [소개를 참조하십시오](introduction-aem-forms.md).

>[!NOTE]
>
>OSGi의 Forms 중심 워크플로우를 사용하면 JEE 스택에 프로세스 관리 기능을 완전히 설치하지 않고도 OSGi 스택에서 다양한 작업을 위한 워크플로우를 신속하게 구축 및 배포할 수 있습니다. Forms 중심의 AEM 워크플로우와 JEE의 OSGi 및 프로세스 관리(PROCESS Management)를 [비교하여](capabilities-osgi-jee-workflows.md) 이 기능의 차이점과 유사점을 살펴볼 수 있습니다.
>
...
>[!NOTE]
>
>데이터 캡처 기능 [설치 및 구성 문서에 설명된 대로 OSGi에 이미 AEM Forms을 설치한 경우 문서의](../../forms/using/installing-configuring-forms-centric-workflow-on-osgi.md#next-steps) 다음 단계 [섹션으로](../../forms/using/installing-configuring-aem-forms-osgi.md) 건너뜁니다.
...
Adobe Sign을 AEM Forms과 함께 사용하려면 Adobe Sign [와 AEM Forms을 통합합니다](../../forms/using/adobe-sign-integration-adaptive-forms.md).
