...
[적응형 양식 조각은](../../forms/using/adaptive-form-fragments.md) 필드 그룹이나 양식을 만들 때 사용할 수 있는 필드 그룹이 포함된 패널입니다. 양식을 쉽고 빠르게 만들 수 있습니다. 사이드바의 자산 브라우저를 사용하여 적응형 양식 조각을 양식에 드래그하여 놓고 양식 편집기에서 편집할 수 있습니다.
