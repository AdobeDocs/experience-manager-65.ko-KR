...
일반 탭에서 첨부 파일 다운로드, 오프라인 모드, 랜딩 화면, 자동 저장 및 동기화 설정을 변경합니다. 앱의 [홈 화면](../../forms/using/home-screen.md)을 변경할 수 있습니다.
...
* **오프라인 모드**: AEM Forms 앱에 대해 오프라인 서비스를 사용하거나 사용하지 않도록 설정합니다. 자세한 내용은 [오프라인 모드에서 작업](/help/forms/using/work-offline-mode.md)을 참조하십시오.
...
* **자동 저장 빈도**: [모바일 앱에서 양식 데이터를 로컬로 저장하는 빈도](../../forms/using/autosave-data-app.md)를 설정합니다.
* **동기화 빈도**: 온라인 모드에서 [모바일 앱을 AEM Forms 서버와 동기화](../../forms/using/sync-app.md)하는 빈도를 설정합니다.
