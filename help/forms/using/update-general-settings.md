...
## 앱 {#working-with-the-form}에서 일반 설정 업데이트
...
1. 설정 화면으로 이동하려면 홈 화면의 왼쪽 상단에 있는 메뉴 단추를 누른 다음 **설정**&#x200B;을 누릅니다.
...
* **자동 저장 빈도**:모바일  [앱에서 양식을 데이터 형식으로 저장하는 빈도를 ](../../forms/using/autosave-data-app.md) 설정하려면
* **동기화 빈도**:온라인 모드에서  [모바일 앱이 AEM Forms 서버와 ](../../forms/using/sync-app.md) 동기화되는 빈도를 설정하려면
