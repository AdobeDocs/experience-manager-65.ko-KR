...
* XML 스키마를 사용하는 적응형 [양식의](../../forms/using/prepopulate-adaptive-form-fields.md#main-pars-header-3)경우 XML 스키마 구조를 준수하는 프리필 XML을 사용합니다.
* JSON 스키마를 사용하는 적응형 [양식의](../../forms/using/prepopulate-adaptive-form-fields.md#json-schema-based-adaptive-forms)경우 JSON 스키마를 준수하는 프리필 JSON을 사용하십시오.
* FDM 스키마를 사용하는 적응형 양식의 경우 FDM 스키마와 호환되는 프리필 JSON을 사용합니다.
* 양식 모델이 [없는 적응형 양식의](../../forms/using/prepopulate-adaptive-form-fields.md#p-adaptive-form-with-no-form-model-p)경우 바인딩된 데이터가 없습니다. 모든 필드는 언바운드 필드이며 언바운드 XML을 사용하여 프리필됩니다.
