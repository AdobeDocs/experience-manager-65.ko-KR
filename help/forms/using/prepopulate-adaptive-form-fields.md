...
* XFA [양식 템플릿을 사용하는 적응형 양식의](../../forms/using/prepopulate-adaptive-form-fields.md)경우 XFA 템플릿의 데이터 스키마를 준수하는 자동 완성 XML을 사용합니다.
* XML 스키마를 사용하는 적응형 양식의 경우 [XML 스키마](#xml-schema-af)구조에 맞는 자동 완성 XML을 사용합니다.
* JSON 스키마를 사용하는 적응형 양식의 [경우](#json-schema-based-adaptive-forms)JSON 스키마를 준수하는 프리필 JSON을 사용하십시오.
* FDM 스키마를 사용하는 적응형 양식의 경우 FDM 스키마와 호환되는 프리플 JSON을 사용하십시오.
* 양식 모델이 [없는 적응형 양식의](#adaptive-form-with-no-form-model)경우 바인딩된 데이터가 없습니다. 모든 필드는 제본되지 않은 필드이며 제본되지 않은 XML을 사용하여 미리 입력됩니다.
...
* SERVICE_NAME은 OSGI 미리 채우기 서비스의 이름을 나타냅니다. 자동 완성 [서비스 만들기를 참조하십시오](../../forms/using/prepopulate-adaptive-form-fields.md#create-and-run-a-prefill-service).
