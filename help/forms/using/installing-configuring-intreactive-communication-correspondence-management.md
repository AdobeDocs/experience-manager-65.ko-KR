...
이전 버전에서 업그레이드하고 통신 관리에 이미 투자한 경우 [호환성 패키지를](../../forms/using/installing-configuring-intreactive-communication-correspondence-management.md#install-compatibility-package) 설치하여 통신 관리를 계속 사용할 수 있습니다. 인터랙티브한 커뮤니케이션과 통신 관리의 차이에 대한 자세한 내용은 인터랙티브한 커뮤니케이션 [개요를 참조하십시오](/help/forms/using/interactive-communications-overview.md#interactive-communications-vs-correspondence-management).

AEM Forms는 강력한 엔터프라이즈급 플랫폼입니다. 대화형 통신은 AEM Forms 기능 중 하나에 불과합니다. 전체 기능 목록은 AEM Forms [소개를 참조하십시오](../../forms/using/introduction-aem-forms.md).
...
1. AEM [패키지 공유에서](https://localhost:4502/crx/packageshare/login.html)**AEM 6.5 Forms Add-on 패키지** 또는 **최신 서비스**&#x200B;팩을 **검색하고 운영 체제에 해당하는 패키지를 클릭한 다음 다운로드를**&#x200B;클릭합니다. 라이센스 계약을 읽고 동의한 다음 확인을 **클릭합니다**. 다운로드가 시작됩니다. 다운로드하면 패키지 **옆에** 다운로드된 단어가 나타납니다.
...
인터랙티브한 커뮤니케이션은 AEM 6.5 Forms에서 고객 커뮤니케이션을 제작하는 데 기본적으로 권장됩니다. 이전 버전에서 업그레이드하거나 마이그레이션한 경우, 문자(통신 관리)를 계속 사용할 계획인 경우 AEMFD [호환성 패키지를](https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq640/fd/AEM-FORMS-6.4-COMPAT)설치합니다.

AEM 6.5 양식에서 AEM 6.4 양식, AEM 6.3 양식 및 AEM 6.2 양식의 다음 자산을 사용할 수 있습니다.
...
AEM 양식은 Adobe Marketing Cloud 솔루션인 Adobe Target과 통합되어 개인화되고 매력적인 고객 경험을 다양한 디지털 채널에 전달할 수 있습니다. Adobe Target을 사용하여 인터랙티브한 커뮤니케이션을 개인화하려면 Adobe Target을 [AEM Forms와 통합하십시오](../../forms/using/ab-testing-adaptive-forms.md#setupandintegratetargetinaemforms).
...
* [통신 관리 서신 만들기](../../forms/using/create-letter.md)
