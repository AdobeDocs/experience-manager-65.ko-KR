...
AEM Forms 작업 영역 사용자 지정을 위한 [일반 단계를 따르고 요구 사항에 따라 CSS, HTML 또는 둘 다를 사용자 정의하는 단계를 따릅니다.](../../forms/using/generic-steps-html-workspace-customization.md)
