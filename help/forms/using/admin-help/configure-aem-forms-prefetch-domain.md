...
# AEM 양식을 구성하여 도메인 정보 {#configure-aem-forms-to-prefetchdomain-information} 프리페치
...
1. 다음 노드를 추가합니다(굵게 표시됨).
   ...
   이 예에서는 프리페치용으로 여러 도메인이 구성됩니다. 도메인 이름은 &quot;/&quot;로 구분됩니다. 위 예제에는 *Domain_Name1*, *Domain_Name2* 및 *Domain_Name3*&#x200B;이 표시됩니다.

1. 업데이트된 파일을 가져오려면 사용자 관리에서 **[!UICONTROL 구성 > 구성 파일 가져오기 및 내보내기]**&#x200B;를 클릭합니다.
1. **[!UICONTROL 찾아보기]**&#x200B;를 클릭하여 파일을 찾은 다음 가져오기를 클릭한 다음 **[!UICONTROL 확인]**&#x200B;을 클릭합니다.
