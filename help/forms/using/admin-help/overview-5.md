...
description: 다양한 파일 형식을 PDF으로 변환하는 방법에 대해 알아봅니다.
...
PDF 생성기는 다양한 파일 형식을 PDF으로 변환합니다. 또한 PDF을 다른 파일 형식으로 변환하고 PDF 문서의 크기를 최적화합니다. 지원되는 파일 형식 목록은 다음을 참조하십시오. [PDF 생성기에 대한 소프트웨어 지원](/help/forms/using/aem-forms-jee-supported-platforms.md)

**처리를 위해 PDF 생성기로 파일 보내기**

다음 세 가지 방법으로 파일을 PDF 생성기로 보내 처리할 수 있습니다.

* 관리자는 관리 콘솔에서 PDFG 페이지에 액세스할 수 있습니다. (참조: [PDF 생성기를 사용하여 파일 변환](/help/forms/using/admin-help/converting-files-using-pdf-generator.md).)
