...
* 기본적으로 사용할 파일 유형 설정 지정(참조) [PDF 생성기 구성 파일 가져오기 및 내보내기](/help/forms/using/admin-help/importing-exporting-pdf-generator-configuration.md))
...
[기타 응용 프로그램 설정(Windows에만 해당)](/help/forms/using/admin-help/configuring-file-type-settings.md#other-applications-settings-windows-only)
...
**문서 정보 변환**: 소스 파일의 문서 정보를 기반으로 PDF 문서 속성을 추가합니다. 여기에는 문서 제목, 작성자, 주제 및 키워드 등의 정보가 포함됩니다.
