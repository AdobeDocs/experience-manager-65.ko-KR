...
1. 포함된 글꼴의 사용 중인 하위 세트만 포함하려면 **포함된 모든 글꼴 하위 집합**&#x200B;을 선택합니다.
   ...
   >[!NOTE]
   >
   >*일부 글꼴의 포함&#x200B;**해제**와 함께 이 옵션을 사용하는 경우 포함&#x200B;****에 글꼴 추가 목록의 글꼴은 계속 포함 취소됩니다.*
...
이러한 옵션은 AutoCAD 파일이 변환되는 방식을 결정합니다. 이러한 옵션에 액세스하는 방법에 대한 지침은 [파일 유형 설정 만들기 또는 편집](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings)을 참조하십시오.
