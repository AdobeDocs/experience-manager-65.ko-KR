...
**기본 언어:** 문자를 식별하는 데 사용하는 OCR 엔진의 언어입니다. 기본값은 영어(미국)입니다.
...
이러한 옵션은 Microsoft PowerPoint 파일을 변환하는 방법을 결정합니다. 이러한 옵션에 액세스하는 방법에 대한 자세한 내용은 파일 [유형 설정 만들기 또는 편집을 참조하십시오](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).
...
이러한 옵션은 AutoCAD 파일을 변환하는 방법을 결정합니다. 이러한 옵션에 액세스하는 방법에 대한 자세한 내용은 파일 [유형 설정 만들기 또는 편집을 참조하십시오](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).
...
이러한 옵션은 OpenOffice 파일을 변환하는 방법을 결정합니다. 이러한 옵션에 액세스하는 방법에 대한 자세한 내용은 파일 [유형 설정 만들기 또는 편집을 참조하십시오](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).
