...
* URL, URI, XCI 및 파일 위치에 대한 절대 및 상대 경로를 지정합니다. ([출력](/help/forms/using/admin-help/specify-file-locations-output.md#specify-file-locations-for-output)의 파일 위치 지정 참조)
...
* 애플리케이션 서버에서 글꼴을 사용할 수 있도록 합니다. ([글꼴을 사용 가능하게 만들기 참조](/help/forms/using/admin-help/make-fonts-available.md#make-fonts-available))
* 포함할 글꼴을 지정합니다. ([포함할 글꼴 지정 참조](/help/forms/using/admin-help/specify-fonts-embed.md#specify-fonts-to-embed))
