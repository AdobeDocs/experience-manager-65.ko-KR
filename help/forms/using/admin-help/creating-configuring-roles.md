...
**AEM Forms Contentspace 관리자:** 관리 콘솔의 Content Services(사용되지 않음) 페이지에서 설정을 보고 수정할 수 있습니다
...
**Rights Management 관리자:** Rights Management 페이지에서 필요한 모든 작업을 수행합니다.
...
Reader **PERM_APPLICATION_EXTENSIONS_WEB_APPLICATION:** Acrobat Reader DC 확장 웹 응용 프로그램 사용
...
**Rights Management 정책 집합 추가 코디네이터:** 정책 집합 코디네이터의 권한을 추가, 제거 및 변경합니다.
...
**Rights Management 정책 집합 보기 이벤트:** 정책 집합 내의 정책이나 문서에 대한 정책 및 문서 이벤트를 봅니다.
