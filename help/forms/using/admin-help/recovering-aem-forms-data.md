...
1. CRX 저장소를 복원/복구합니다.
   ...
   * **독립형**
      ...
      *작성자 및 게시 인스턴스 복원*: 재해가 발생하면 다음에 설명된 단계를 수행하여 리포지토리를 마지막 백업 상태로 복원할 수 있습니다. [백업 및 복원.](https://helpx.adobe.com/experience-manager/kb/CRXBackupAndRestoreProcedure.html)
