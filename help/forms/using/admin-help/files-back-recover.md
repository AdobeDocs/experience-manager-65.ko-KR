...
컨텐츠 저장소 루트 디렉토리의 기본 위치 `[GDS root]/lccs_data`는 GDS 위치 `[GDS root]` 에 설명된 [위치입니다](files-back-recover.md#gds-location). 콘텐트 저장소 루트 디렉터리에 있는 다음 디렉토리를 백업합니다.
...
인덱스 루트 디렉토리의 기본 위치는 각 노드 `[aem-forms root]/lucene-indexes` 에 있습니다.
