...
컨텐츠 저장소 루트 디렉토리의 기본 위치는 다음과 같습니다 `[aem-forms root]/lccs_data`.
...
컨텐츠 저장소 루트 디렉토리의 기본 위치는 다음과 같습니다 `[GDS root]/lccs_data`, 위치 `[GDS root]` 은 에 설명된 위치입니다. [GDS 위치](files-back-recover.md#gds-location). 컨텐츠 저장소 루트 디렉토리에 있는 다음 디렉토리를 백업합니다.
...
인덱스 루트 디렉토리의 기본 위치는 다음과 같습니다. `[aem-forms root]/lucene-indexes` 각 노드에 대해 다음을 수행합니다.
...
>[!NOTE]
>
>기본적으로 AEM Forms와 함께 설치된 Adobe 글꼴은 `[aem-forms root]/fonts` 디렉토리.
