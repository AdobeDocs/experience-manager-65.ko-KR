...
EMC Documentum Connector for EMC Documentum을 사용하면 AEM 양식과 EMC Documentum 간에 통신이 가능합니다. 자세한 배경 정보는 [서비스 참조](https://www.adobe.com/go/learn_aemforms_services_63)의 &quot;ECM용 커넥터&quot;를 참조하십시오.
...
### 저장소 자격 증명 {#change-the-user-name-and-password-for-a-repository-credential}의 사용자 이름 및 암호 변경
...
## 작업 공간 작업 큐 {#enable-the-request-for-sharing-of-workspace-task-queues} 공유 요청 사용
