...
**일련 번호:** Adobe에서 발급한 각 인증서(예: 0002054)에 일련 번호가 할당됩니다. Adobe 엔터프라이즈 지원 또는 Adobe 엔터프라이즈 계정 담당자는 이 일련 번호를 사용하여 특정 제품 주문 또는 OEM 관계에 대한 인증서를 추적할 수 있습니다.
...
Acrobat Reader DC 확장을 구매한 고객에게 프로덕션 인증서가 발급됩니다. 이러한 인증서는 인증서 프로필 표에 *Max*(으)로 표시된 CA(인증 기관)에서 허용하는 최대 기간 동안 유효합니다.
...
비공동 작업 환경에서 온라인 댓글이 필요한 경우 Adobe 지원 센터에 자세한 내용을 문의하십시오. Mode 속성은 배포 유형과 일치하며 *프로덕션* 또는 *평가*&#x200B;입니다.
