...
참조 사이트 사용 사례의 이메일 커뮤니케이션을 위해 게시 인스턴스에서 AEM DS 서비스 설정이 필요합니다. 게시 인스턴스에서 AEM DS 서비스 설정을 구성하는 자세한 단계는 AEM DS 설정 [구성을 참조하십시오](../../forms/using/configuring-the-processing-server-url-.md).
