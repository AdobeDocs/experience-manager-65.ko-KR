...
* **AEM Essentials** AEM QuickStart, AEM Forms Add-on 패키지 및 참조 사이트 패키지. 추가 [기능 및 참조 사이트 패키지 세부 사항은 AEM Forms 릴리스를](https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html) 참조하십시오.
...
1. 로그인 자격 증명을 제공합니다. 로그인하면 AEM Forms 클라우드 서비스 구성 페이지로 리디렉션됩니다. 저장 **및 닫기를 클릭합니다**. 클라우드 서비스 구성이 저장됩니다.
