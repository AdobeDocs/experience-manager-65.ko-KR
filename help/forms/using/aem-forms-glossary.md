...
[AEM Forms에서 Adobe 로그인](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-advanced-authoring/adobe-sign-integration-adaptive-forms)
...
| **서비스 이름** | **설명** | **설명서 링크** |
|------------------------------|---------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| **Forms 서비스** | 템플릿 및 XML을 사용하여 PDF forms을 렌더링하고, 가져오기/내보내기를 위해 양식 데이터를 통합하고, 조각 기반 렌더링을 지원합니다. | [Forms 서비스 설명서](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/output-service) |
...
| **어셈블러 서비스** | PDF 및 XDP 문서를 결합하고, 재정렬하고, 확인하고, 보완합니다. | [어셈블러 서비스 설명서](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/assembler-service) |
...
[사용자 정의 구성 요소](https://experienceleague.adobe.com/en/docs/experience-manager-core-components/using/adaptive-forms/customize-adaptive-forms-core-components)
...
[데이터 소스](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/form-data-model/configure-data-sources)

관계형 데이터베이스의 JDBC, 웹 서비스의 REST 끝점, SAP 시스템의 OData 등 외부 데이터를 양식에 통합하는 인터페이스입니다. AEM Forms 데이터 통합 프레임워크를 통해 관리됩니다.

## 문서 조각

[문서 조각](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/letters-correspondences/lists)
...
[양식 세트](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/html5-forms/formset-in-aem-forms)
...
[게시 인스턴스](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/publish-process-aem-forms/publishing-unpublishing-forms)
...
[AEM Forms에서 작업 제출](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-basic-authoring/configuring-submit-actions)
...
[웹 레이어](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/aem-forms-architecture-deployment#architecture)
