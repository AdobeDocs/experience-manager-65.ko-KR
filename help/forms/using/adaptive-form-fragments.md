...
1. 클릭하여 열기 **양식 모델** 탭 및 **다음에서 선택** 드롭다운 메뉴에서 조각에 대해 다음 모델 중 하나를 선택합니다.
   ...
   * **양식 템플릿** : AEM Forms 업로드 템플릿를 사용 하 여 단편을 만들도록 지정 합니다. 조각에 대 한 양식 모델로 적절 한 XDP 템플릿를 선택 합니다.
...
사용자가 만든 적응형 양식 단편은 AEM 컨텐츠 finder의 탭 적응형 양식 단편에 표시 됩니다. 적응형 양식에 적응형 양식 단편을 삽입 하려면 다음을 수행 하십시오.
...
적응형 양식 조각은 적응형 양식에서 참조로 삽입 되며 독립 실행형 적응형 양식 조각과 동기화 됩니다. 이는 적응형 양식 단편을 업데이트 하는 경우 변경 사항이 조각이 사용 되는 모든 적응형 양식에 반영 됨을 의미 합니다.
...
* 적응형 양식 내에서 참조로 삽입 되는 적응형 양식 단편은 편집할 수 없습니다. 편집하려면 독립 실행형 적응형 양식 조각을 편집하거나 적응형 양식에 조각을 임베드하십시오.
