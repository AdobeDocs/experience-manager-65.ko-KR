...
적응형 양식 조각을 처음부터 만들거나 기존 적응형 양식의 패널을 단편으로 저장할 수 있습니다.
...
1. 조각 생성 대화 상자에서 다음 정보를 지정합니다.
   ...
   * **조각 모델 루트**: XSD 기반 적응형 양식에만 표시됩니다. 조각 모델의 루트를 지정합니다. 다음을 선택할 수 있습니다. **/** 또는 드롭다운에서 XSD 복합 유형을 선택하십시오. 복잡한 유형을 조각 모델 루트로 선택하는 경우에만 다른 적응형 양식에서 조각을 재사용할 수 있습니다.
...
적응형 양식에 삽입하는 모든 조각은 자리 표시자 이미지로 표시됩니다. 자리 표시자는 조각에 최대 10개의 하위 패널 제목을 표시합니다. 자리 표시자 이미지 대신 전체 조각을 표시하도록 AEM Forms 를 구성할 수 있습니다.

양식에 전체 조각을 표시할 수 있도록 다음 절차를 수행하십시오.
...
1. 사용 안 함 **[!UICONTROL 조각 대신 자리 표시자 활성화]** 확인란을 선택하여 자리 표시자 이미지가 아닌 전체 조각을 표시할 수 있습니다.
...
DOR(Document of Record)은 양식 정보를 인쇄 또는 문서 형식으로 유지하는 데 도움이 됩니다. 따라서 나중에 언제든지 고객에 대한 정보를 추적할 수 있으며, 기록 문서를 사용하여 양식과 컨텐츠를 PDF 형식으로 함께 보관할 수도 있습니다. [적응형 양식 단편을 위한 기록 문서 생성 방법](/help/forms/using/generate-document-of-record-for-non-xfa-based-adaptive-forms.md).
...
<table>
 <tbody>
  ...
  <tr>
   <td><p>미리보기</p> </td>
   <td><p>XML 파일의 데이터를 조각과 병합하여 조각을 HTML 또는 사용자 지정 미리 보기로 미리 보는 옵션을 제공합니다. 자세한 내용은 양식</a> 미리 보기를 참조하십시오<a href="/help/forms/using/previewing-forms.md" target="_blank">.<br /> <br /> </p> </td>
  </tr>
  <tr>
