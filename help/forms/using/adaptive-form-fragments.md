...
1. Https:// [*hostname*] : [*포트*] /aem/forms.html에서 인스턴스 작성자에 AEM Forms 로그인 합니다.
...
1. **확인**&#x200B;을 클릭합니다.
   ...
   단편을 편집 하려면 패널 툴바에서 [자산 ]**편집]을 클릭**[!UICONTROL  합니다. 조각이 편집 모드의 새 탭 또는 창에서 열립니다.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>선택한 조각에 대 한 검토를 시작 하 고 관리할 수 있습니다. 자세한 내용은 리뷰 </a> 만들기 및 관리를 참조 <a href="../../forms/using/create-reviews-forms.md" target="_blank"> 하십시오. <br /> <br /> </p> </td>
  </tr>
  <tr>
   <td><p>사전 만들기</p> </td>
...
적응형 양식 조각이 포함 된 적응형 양식을 현지화 하려면 조각과 양식을 개별적으로 현지화 해야 합니다. 이 개념은 조각을 한 번 현지화 하 고 여러 적응형 양식에서 재사용 하는 것입니다.

>[!NOTE]
>
>조각의 현지화 키는 적응형 양식에 대 한 XLIFF 파일에 표시 되지 않습니다.
