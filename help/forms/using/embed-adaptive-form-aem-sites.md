...
외부 웹 페이지에 적응형 양식을 포함하는 방법에 대한 자세한 내용은 외부 웹 페이지에 적응형 양식 포함[을 참조하십시오.](/help/forms/using/embed-adaptive-form-external-web-page.md)
...
구성 요소AEM Forms은 사이트 페이지에 추가할 수 있는 구성 요소를 제공합니다. AEM Forms 컨테이너 구성 요소를 사용하면 적응형 양식과 대화형 통신을 포함할 수 있습니다.

* **[자산](/help/forms/using/embed-adaptive-form-aem-sites.md#asset-browser)**
브라우저사용자가 만드는 모든 양식과 대화형 통신을 자산 아래에서 사용할 수 있습니다. 양식을 페이지에서 자산으로 드래그하여 놓을 수 있습니다.

## 전제 조건 {#prerequisites}

편집 가능한 템플릿을 사용하는 AEM 사이트 페이지에 적응형 양식 또는 인터랙티브한 커뮤니케이션을 포함하려면 AEM 양식 구성 요소가 관련 템플릿에서 허용되는 구성 요소로 구성되어야 합니다. 자세한 내용은 [페이지 템플릿 만들기](/help/sites-authoring/templates.md)의 **정책 및 속성(레이아웃 컨테이너)** 섹션을 참조하십시오.
...
## 응용 양식 또는 대화형 통신 포함 {#af-component}
...
1. 사이트 페이지에서 포함된 AEM Forms 컨테이너 구성 요소를 누른 다음 작업 표시줄에서 ![settings_icon](assets/settings_icon.png)을 누릅니다. **[!UICONTROL AEM Forms 컨테이너 편집]** 대화 상자가 열립니다.
...
* 편집 모드에서 사이트 페이지 내에서 적응형 양식 또는 대화형 통신을 누른 다음 새 창&#x200B;]**에서**[!UICONTROL &#x200B;편집을 누릅니다. 원본 양식은 수정할 수 있는 편집 모드로 열립니다.
