...
개발자 또는 사이트 소유자인 경우 조직에서 사용 중인 메타데이터를 반영하도록 AEM Forms에 대한 최종 사용자 인터페이스인 Forms 포털을 사용자 지정할 수 있습니다. 자세한 내용은 Forms 포털 을 참조하십시오. [포털에서 양식 게시 소개](../../forms/using/introduction-publishing-forms.md).
