...
개발자 또는 사이트 소유자인 경우 조직에서 사용 중인 메타데이터를 반영하도록 AEM Forms에 대한 최종 사용자 인터페이스인 Forms 포털을 사용자 지정할 수 있습니다. Forms Portal에 대한 자세한 내용은 [포털에서 양식 게시 소개](../../forms/using/introduction-publishing-forms.md)를 참조하십시오.
...
#### 광범위한 메타데이터 {#extensive-list-of-metadata} 목록
...
## 양식 메타데이터 {#view-form-metadata} 보기
...
## 양식 메타데이터 값 {#add-update-form-metadata-values} 추가/업데이트
