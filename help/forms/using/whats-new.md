...
트랜잭션 보고서 구성 및 사용에 대한 자세한 내용은 [트랜잭션 보고서 개요](../../forms/using/transaction-reports-overview.md).
...
이제 대화형 통신 작성자가 다음을 정의할 수 있습니다 [데이터 표시 패턴](create-interactive-communication.md#datadisplaypatterns) 필드, 변수 및 양식 데이터 모델 요소의 경우 예를 들어 날짜, 통화 또는 전화 형식 등이 있습니다.

**새로운 유형의 차트 사용**

이제 다음을 추가할 수 있습니다. [Quadrant 차트 및 여러 시리즈](../../forms/using/chart-component-interactive-communications.md) 인터랙티브한 커뮤니케이션용.

**테이블의 열 정렬**

이제 다음을 수행할 수 있습니다 [표의 열 정렬](../../forms/using/create-interactive-communication.md#sortcolumns) ( Interactive Communication)에서 생성합니다. 정적 텍스트 또는 데이터 모델 개체로 테이블 열을 바인딩하고 정렬할 수 있습니다.

**웹 채널에서 새 구성 요소 사용**

이제 웹 채널에 단추 및 구분 기호 구성 요소를 추가할 수 있습니다. 자세한 내용은 [웹 채널에 단추 구성 요소 추가](../../forms/using/create-interactive-communication.md#add-button-component-to-the-web-channel) 및 [웹 채널의 구분 기호 구성 요소](../../forms/using/create-interactive-communication.md#separatorcomponent).

**구성 요소의 크기를 조정할 레이아웃 모드**

이제 로 전환할 수 있습니다. [레이아웃 모드](../../forms/using/resize-using-layout-mode.md) wysiwyg 인터페이스를 사용하여 웹 채널에서 구성 요소의 크기를 조정할 수 있습니다.
...
### 적응형 Forms에서 Adobe Sign의 클라우드 기반 디지털 서명 사용 {#use-adobe-sign-s-cloud-based-digital-signatures-in-adaptive-forms}

[클라우드 기반 디지털 서명](https://helpx.adobe.com/sign/kb/digital-certificate-providers.html) 또는 원격 서명은 데스크탑, 모바일 및 웹에서 작동하는 차세대 디지털 서명으로, 서명자 인증을 위한 최고 수준의 규정 준수 및 보증을 충족합니다. 이제 다음을 수행할 수 있습니다 [적응형 양식 서명](../../forms/using/working-with-adobe-sign.md) 클라우드 기반 디지털 서명을 사용하여 작성합니다.
...
AEM Forms을 통해 다음 작업을 수행할 수 있습니다. [적응형 양식 원활하게 포함](../../forms/using/embed-adaptive-form-aem-sites-spa.md) 또는 AEM Sites 단일 페이지 애플리케이션(SPA)의 대화형 커뮤니케이션입니다. 포함된 적응형 양식 및 대화형 커뮤니케이션은 완전히 작동하며 사용자는 페이지를 종료하지 않고 양식을 작성하고 제출할 수 있습니다. 따라서 사용자가 웹 페이지의 다른 요소 컨텍스트에 남아 있고 적응형 양식 또는 대화형 커뮤니케이션과 동시에 상호 작용할 수 있습니다.

#### 적응형 양식 테이블의 열 정렬 {#sort-columns-of-adaptive-form-tables}

다음을 수행할 수 있습니다 [적응형 양식 테이블의 열 정렬](../../forms/using/adaptive-forms-tables.md#sortcolumnstable) 오름차순 또는 내림차순으로 표시합니다. 정적 텍스트, 데이터 모델 개체 속성 또는 정적 텍스트 및 데이터 모델 개체 속성의 조합으로 테이블 열에 정렬을 적용할 수 있습니다.

#### 특정 경로에 적응형 Forms 템플릿의 가용성을 제한합니다 {#restrict-the-availability-of-adaptive-forms-templates-to-specific-paths}
...
#### 적응형 양식에 확인란을 동적으로 추가합니다 {#add-check-boxes-to-the-adaptive-form-dynamically}

이제 규칙을 정의하여 [동적으로 적용형 양식에 확인란 추가](../../forms/using/rule-editor.md#setpropertyrule) 사용자 지정 함수, 양식 개체 또는 개체 속성을 기반으로 합니다.
...
이동 단계, 또는 분할 단계 및 모든 AEM Forms 워크플로우 단계는 변수를 지원합니다. MetaDataMap 인터페이스를 사용하여 변수에 대한 기본 지원이 없는 워크플로우 단계의 변수에 액세스할 수 있습니다. 자세한 내용은 [AEM 워크플로우의 변수](../../forms/using/variable-in-aem-workflows.md).

![워크플로우에서 변수 설정](assets/variable.png)

#### 다양한 적응형 Forms으로 워크플로우 사용  {#use-a-workflow-with-different-adaptive-forms}

다음을 수행할 수 있습니다 [지정 작업에 대한 적응형 양식 지정](../../forms/using/aem-forms-workflow-step-reference.md#assign-task-step) 및 런타임에 양식 중심의 워크플로우의 기록 단계에 대한 문서입니다. 이를 통해 워크플로우가 다른 응용 Forms에서 작업할 수 있습니다. 워크플로우를 디자인하는 동안 적응형 양식을 선택하는 방법을 결정할 수 있습니다. 적응형 양식은 절대 경로에 있거나, 워크플로우에 페이로드로 제출되거나, 변수를 사용하여 계산된 경로에서 사용할 수 있습니다.
...
* [입력 데이터 유효성 검사](../../forms/using/work-with-form-data-model.md#automated-validation-of-input-data) 제한 목록을 기반으로 합니다. 유효한 데이터만 데이터 소스에 전송되도록 합니다.
* [기본 끝점 무시](../../forms/using/configure-data-sources.md#configure-soap-web-services) wsdl(웹 서비스 설명 언어) 파일에 정의됩니다.

* [기본값 무시](../../forms/using/configure-data-sources.md#configure-restful-web-services) [스키마, 호스트 및 기본 경로](../../forms/using/configure-data-sources.md#configure-restful-web-services) Swagger 정의 파일에 정의됩니다.

## 플랫폼 및 보안 업데이트 {#platform-and-security-updates}

### 주요 플랫폼 업데이트 {#major-platform-updates}

AEM Forms은 지원되는 운영 체제, 애플리케이션 서버, 데이터베이스, 데이터베이스 드라이버, JDK, LDAP 서버 및 이메일 서버의 모든 조합을 사용하여 설정할 수 있습니다. 다음은 의 주요 변경 사항입니다 [지원되는 플랫폼](../../forms/using/aem-forms-jee-supported-platforms.md):
...
#### 새 HTML 5 기반 UI {#new-html-based-uis}
...
* 이제 AEM 6.5 Forms에서 jQuery를 3.2.1로 사용하고 jQuery UI 1.12.1을 사용합니다. [업그레이드 설명서](/help/forms/home.md) 변경 사항의 영향을 받습니다.
