...
HTML5 양식에서는 기본적으로 오류 메시지와 경고의 위치와 모양(글꼴과 색상)이 고정되어 있으며 선택한 필드에 대해서만 오류가 표시되고 하나의 오류만 표시됩니다.

이 문서는에 대한 HTML 5 양식 오류 메시지를 사용자 지정하는 단계를 제공합니다.

* 오류 메시지의 모양과 위치를 변경합니다. 필드의 위쪽, 아래쪽 및 오른쪽에 표시되는 오류를 만들 수 있습니다.
* 특정 시점에 여러 필드에 대한 오류 메시지를 표시합니다.
* 필드를 선택했는지 여부와 관계없이 오류를 표시합니다.
...
오류 메시지의 위치를 사용자 지정하려면 다음을 추가합니다. &lt;div> 각 오류 및 경고 필드에 태그를 지정하고 &lt;div> 왼쪽 또는 오른쪽에 태그를 지정하고 &lt;div> 태그에 가깝게 배치하십시오. 자세한 단계는 아래 절차를 참조하십시오.
...
1. 편집할 sample.css 파일을 엽니다.css 파일에는 2개의 ID(#customError)가 #customWarning. 이러한 ID를 사용하여 색상, 글꼴 크기 등과 같은 다양한 속성을 변경할 수 있습니다.
...
기본적으로 html5 양식은 기본 프로필을 사용합니다. https://&lt;server>/content/xfaforms/profiles/default.html?contentRoot=&lt;xdp location=&quot;&quot;>템플릿(&amp;t)=&lt;name of=&quot;&quot; the=&quot;&quot; xdp=&quot;&quot;>

사용자 지정 오류 메시지가 있는 양식을 보려면 다음 오류 프로필이 있는 양식을 렌더링합니다. https://&lt;server>/content/xfaforms/profiles/error.html?contentRoot=&lt;xdp location=&quot;&quot;>템플릿(&amp;t)=&lt;name of=&quot;&quot; the=&quot;&quot; xdp=&quot;&quot;>
