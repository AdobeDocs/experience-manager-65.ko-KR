...
1. **Adobe 받은 편지함**:AEM 백엔드에 있는 상단 메뉴  [막대 ](assets/bell.svg) Bell 아이콘
...
1. 그런 다음 카밀라는 PDF 양식을 선택하고 **자동화된 전환 시작**&#x200B;을 클릭하여 전환 프로세스를 시작합니다. 양식을 변환한 경우 **전환 덮어쓰기**&#x200B;를 클릭해야 할 수 있습니다.
   ...
   * **선택 사항**:액세스 가능한 초마린 테마를 사용하려면 응용 양식 테마 지정을 클릭하고 옵션 목록에 나타나는 액세스 가능한 초마린 테마를 선택하면 됩니다.
   ...
   전환 중에 완료 백분율이 표시됩니다. 상태가 **Converted**&#x200B;이면 **output** 폴더를 클릭하고 응용 양식을 선택한 다음 **편집**&#x200B;을 클릭하여 변환된 양식을 엽니다.
...
## 응용 양식 모바일 보기 데모(Aya) {#mobile-view-demo}
...
1. **가족 상태** 드롭다운을 사용하여 동적 기능을 시연하려면 다음 **동적 논리**&#x200B;을 사용하십시오.
...
**이 섹션:** Aya는 필요한 정보를 집에 찾아서 데스크탑에서 애플리케이션을 재개했습니다. Aya는 응용 프로그램을 재개하기 위해 온라인 양식 포털로 이동합니다. 몇 가지 간단한 사용자 정의 기능을 사용하면 기관은 자동으로 링크를 생성하여 이메일로 전송하여 애플리케이션을 다시 시작할 수 있습니다.

### 응용 양식(Aya) {#aya-user-story-continued-adaptive-form} 계속
...
**이 섹션:** 조지는 정부 기관 Aya의 비즈니스 분석가로 서비스 요청을 받고 있습니다. George는 검토용으로 자신에게 지정된 모든 서비스 요청 응용 프로그램을 볼 수 있는 하나의 대시보드를 가지고 있습니다.
...
1. *https://&lt;aemserver>:&lt;port>/aem/start.html*&#x200B;로 이동합니다.
1. 사용자 아이콘(오른쪽 상단)을 클릭하고 현재 관리 사용자와 로그인되어 있는 경우 &quot;**로그아웃**&quot; 또는 &quot;**가장 대상**&quot; 메뉴 옵션을 사용합니다.
   ...
   1. 또는 가장:
      ...
      1. &quot;**가장 대상(a3/>)&quot; 필드에 &quot;** George **&quot;을 입력합니다.**

      1. [확인]을 클릭하여 가장합니다.


1. 오른쪽 상단 모서리에서 알림(벨) 아이콘을 클릭합니다.
1. 받은 편지함으로 이동하려면 &quot;**모두 보기**&quot;를 클릭합니다.
...
1. &quot;**MS Dynamics** 열기&quot; 단추를 클릭하여 MS Dynamics 레코드를 새 창에서 엽니다.
...
**본 섹션:** CX Lead는 Aya와 환영 전화 통화를 설정하여 Aya가 승인한 정부 서비스의 사용 방법을 설명합니다.
...
**이 섹션:** Aya는 이메일 메시지를 수신하여 Yahoo의 혜택을 요약하고 채울 양식 필드도 포함하는 대화형 통신에 대한 링크를 포함합니다. PDF 혜택 명세서 및 인터랙티브한 커뮤니케이션과 동일한 테마/브랜딩 방식으로 이메일에 연결된 링크가 포함되어 있습니다.
...
1. 이메일 클라이언트에서 위로 스크롤하고 &quot;**온라인 시작 키트 보기**&quot;를 클릭합니다.
...
1. IC에 대한 빠른 참조:
   ...
   *https://&lt;aemserver>:&lt;port>/content/dam/formsanddocuments/adobe-gov-forms/welcome-handbook/we-gov-welcome-handbook/jcr:content?channel=web&amp;mode=preview&amp;wcmmode=disabled*
   ...
   ![환영 혜택 ](/help/forms/using/assets/welcome_benefits_handbook.png) ![안내책대화형 커뮤니케이션 링크](/help/forms/using/assets/interactive_communication.png)

## 갱신 알림 시민(Aya) {#renewal-reminder-citizen-aya}

**이 섹션: Camila** 는 1년 후 통신 미리 알림도 예약합니다. (자동화/실행 및 이메일 워크플로우 단계).
...
1. 이메일 클라이언트로 이동합니다.
1. 갱신 알림 이메일을 찾아 엽니다.
1. 응용 양식을 열려면 &quot;**새 응용 프로그램 제출**&quot; 단추를 클릭하십시오.
...
**이 섹션:** Camila는 대시보드로 이동하여 서비스 요청 양식을 작성하고 포기하는 시민들 %, 요청 제출부터 승인/거부 반응까지, 시민에게 보낸 혜택에 대한 참여 통계, 그리고 일반 시민에게 보낸 혜택에 대한 고객 참여 통계와 같은 기관 KPI를 모두 확인할 수 있습니다.
...
1. 페이지 보기 페이지(3단계에서 액세스)로 돌아가면 표시 설정을 변경하여 &quot;**목록 보기**&quot;에서 항목을 볼 수도 있습니다.
