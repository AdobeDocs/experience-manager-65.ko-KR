...
- **서비스 팩 적용 범위**: Adobe은 지난 18개월 이내에 릴리스된 서비스 팩을 실행하는 AEM Forms 환경에 대한 기술 지원을 제공합니다. Adobe 현재 버전이 이 18개월 기간을 벗어나는 경우 최적의 성능, 보안 및 지속적인 지원을 유지하기 위해 최신 서비스 팩으로 업그레이드하는 것이 좋습니다.
...
>[!NOTE]
>
> 지원되는 형식 또는 플랫폼 버전과 관련된 모든 쿼리는 AEM Forms 지원 센터에 문의하십시오.
