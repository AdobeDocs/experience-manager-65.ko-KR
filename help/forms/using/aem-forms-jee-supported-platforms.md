...
- **사용 중단**: 플랫폼 지원이 전체 설치 관리자 릴리스마다 업데이트됩니다. Platform Matrix에서 더 이상 사용되지 않는 것으로 표시된 소프트웨어는 후속 릴리스에서 또는 해당 소프트웨어의 지원 종료 시점에 도달하면 지원되는 플랫폼에서 제거할 수 있습니다.

#### 서비스 팩


- **서비스 팩 범위**: Adobe에서는 최신 6개의 서비스 팩을 사용하는 AEM Forms 환경에 대한 기술 지원을 제공합니다. 현재 버전이 마지막 6개의 서비스 팩보다 빠른 경우 최적의 성능, 보안 및 지속적인 지원을 위해 최신 버전으로 업그레이드하는 것이 좋습니다.

- **패치 업데이트 지침**: 패치 설치 관리자를 사용하여 업데이트하는 동안 기본 전체 설치 관리자 버전이 두 개 이하의 이전 릴리스인지 확인해야 합니다. 예를 들어 서비스 팩 6.5.23.0을(를) 설치하는 동안 기본 전체 설치 관리자 버전이 6.5.18.0 또는 6.5.12.0인지 확인하십시오.
...
<tbody>
 ...
 <tr>
  <td>® J9 가상 컴퓨터(빌드 2.9, JRE 1.8.0) IBM® JDK SR6-FP26<br /> </td>
  <td>A: 지원됨</td>
  <td>마이너 릴리스 및 업데이트</td>
 </tr>
 <tr>
  <td>® JAVA1.8.0_291(빌드 8.0.6.30)<br /> </td>
  <td>A: 지원됨</td>
  <td>마이너 릴리스 및 업데이트</td>
 </tr>
</tbody>
...
<tbody>
 ...
 <tr>
  <td><p>® SQL Server 2019(더 이상 사용되지 않음) </p> </td>
  <td><p>저장소 마이크로커널</p> </td>
  <td><p>지원됨</p> </td>
 </tr>
 <tr>
...
- ® DB2®는 새로 설치하는 경우 지원되지 않습니다. AEM 6.5 Forms으로 업그레이드하는 기존 고객에게만 지원됩니다.
...
@@ -242,187 +206,150 @@ Adobe Experience Manager Forms을 실행하려면 Java™ 가상 컴퓨터가 필요합니다. wh
...
<tbody>
 <tr>
  ...
  <tr>
  <td>MySQL</td>
  <td><p>MySQL Connector/J 5.7(더 이상 사용되지 않음)</p> </td>
 ...
 <tr>
  <td>® SQL Server<br /> </td>
  <td><p>® SQL Server JDBC 드라이버 8.2.2 <br /> </p> <p>sqljdbc8.jar(더 이상 사용되지 않음) </p> </td>
  <td><p>® 웹 사이트에서 다운로드합니다.</p> </td>
 </tr>
 <tr>
  <td>® SQL Server<br /> </td>
  <td><p>® SQL Server JDBC 드라이버 12.10.0 <br /> </p> <p>sqljdbc12.10.0.jar</p> </td>
  <td><p>® 웹 사이트에서 다운로드합니다.</p> </td>
 </tr>
 <tr>
  <td>Oracle</td>
...
<tbody>
 ...
 <tr>
  <td><p>JBoss® EAP(Enterprise Application Platform) 7.4.23 <sup>[2] [3] [7]</sup> </p> </td>
  <td><p>A: 지원됨</p> </td>
...
>[!NOTE]
>
>- AEM Forms 서비스 팩 6.5.25.0부터 JBoss® EAP(Enterprise Application Platform) 7.4.23이 지원됩니다. 이 [링크](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq650/featurepack/jboss-eap-7.4.23-1.0.16.zip)를 사용하여 소프트웨어 배포 포털에서 JBoss® EAP 7.4.23을 다운로드할 수 있습니다.
>- ® WebSphere® 클러스터는 Network Deployment Edition에서만 지원됩니다.
...
<tbody>
 <tr>
  ...
  <tr>
  <td>® Windows Server 2019(64비트)(더 이상 사용되지 않음)</td>
  <td>A: 지원됨</td>
  <td>서비스 팩 및 주요 업데이트</td>
 </tr>
    <tr>
  <td>® Windows Server 2022(64비트)</td>
  <td>A: 지원됨</td>
  <td>서비스 팩 및 주요 업데이트</td>
 </tr>
 <tr>
...
1. JEE의 AEM Forms은 SUSE® Linux® Enterprise Server 12의 JBoss®를 지원하지 않습니다. ® WebSphere®만 SUSE® Linux® Enterprise Server 12에서 지원됩니다.
...
@@ -432,12 +359,12 @@ AEM F를 설정할 플랫폼을 선택하는 동안 다음 예외를 고려하십시오.
...
1. [!DNL Microsoft® Windows Server 2019]은(는) [!DNL MySQL 5.7] 및 [!DNL JBoss® EAP 7.1]을(를) 지원하지 않으며, [!DNL Microsoft® Windows Server 2019]은(는) [!DNL Experience Manager Forms Service Pack 6.5.10.0 and later]에 대한 턴키 설치를 지원하지 않습니다. (CQDOC-18312)
...
@@ -449,274 +376,219 @@ 또한 Adobe AEM용 소프트웨어를 선택할 때 다음 사항을 고려하십시오
...
<tbody>
 ...
 <tr>
  <td>® Active Directory 2016(더 이상 사용되지 않음)</td>
...
>- PDF Generator은 Microsoft® Windows에서 Acrobat 기반 기본 변환을 위해 지원되는 32비트 Windows 빌드의 Adobe Acrobat Pro DC(Continuous track, 최신 버전)와 Office 기반 변환을 위해 32비트 Microsoft® Office Professional Plus가 필요합니다. FRL(Feature Restricted Licensing) 또는 Adobe 엔터프라이즈 배포 프로세스를 통해 Acrobat을 활성화합니다. 문서 서비스 설치 문서의 [Adobe Acrobat Pro DC 설치](install-configure-document-services.md#install-adobe-acrobat-pro-dc)를 참조하십시오.
...
>[!NOTE]
>
>Adobe Acrobat 2020(클래식 트랙)은 AEM Forms에서 지원되지 않습니다. 대신 Adobe Acrobat Pro DC(Continuous track, 최신 버전)를 사용하십시오.
>
...
<tbody>
 ...
 <tr>
  <td><p>® Windows® 10(Enterprise, Pro, Basic)</p> <p>32비트 또는 64비트 버전</p> <p> </p> </td>
  <td>서비스 팩 및 주요 업데이트</td>
 </tr>
 <tr>
  <td>® Windows® 2019 Server(더 이상 사용되지 않음)</td>
  <td>서비스 팩 및 주요 업데이트</td>
 </tr>
 <tr>
...
- ® Windows® 2016 Server, Microsoft® Windows® 2019 Server, Microsoft® Windows® 10, Windows® 11 또는 Microsoft® Windows Terminal Server 2025
- PAE, NX 및 SSE2를 지원하는 1GHz 이상의 프로세서
- 32비트용 RAM 1GB 또는 64비트 OS용 RAM 2GB
- Designer을 설치할 수 있는 관리 권한
- ® Visual C++ 2019(VC 14.28 이상) 32비트 런타임
...
<tbody>
 ...
 <tr>
  <td>™ 4.4 이상 버전의 기본 Android™ 브라우저</td>
  <td>모든 업데이트</td>
 </tr>
</tbody>
</table>
...
| Google Android™ | ™ 5.1 이상 AEM Forms 앱은 7인치 및 10인치 삼성 갤럭시 태블릿과 인기 있는 스마트폰에서 인증을 받았습니다. |
| ® Windows | ® Microsoft® Windows 10 운영 체제를 실행하는 표면 장치, 태블릿, 노트북 및 데스크탑 |
...
지원되는 형식 또는 플랫폼 버전과 관련된 모든 쿼리는 [AEM Forms 지원](https://business.adobe.com/in/support/main.html)에 문의하십시오.
...
### 릴리스 6.5.25.0(2026년 5월 28일)

| 추가된 지원 | 제거된 지원 | 지원 중단됨 |
| -------------- | --------------- | ------------------- |
| JBoss® EAP(Enterprise Application Platform) 7.4.23 | JBoss® EAP(엔터프라이즈 응용 프로그램 플랫폼) 7.4.10 | |
| ® Content Manager 클라이언트 8.7 | ® Content Manager 클라이언트 8.5 | |
| ® Windows Terminal Server 2025 | | |


### 릴리스 6.5.24.0(2025년 11월 26일)

| 추가된 지원 | 제거된 지원 | 지원 중단됨 |
| -------------- | --------------- | ------------------- |
| ® Office 2024 | | ® Office 2021 |
| PDF Generator 및 관련 문서 서비스용 Adobe Acrobat Pro DC (Continuous track, 최신 버전) | Adobe Acrobat 2020 (클래식 트랙) | JBoss® EAP(엔터프라이즈 응용 프로그램 플랫폼) 7.4.10 |

### 릴리스 6.5.23.0(2025년 6월 6일)

| 추가된 지원 | 제거된 지원 | 지원 중단됨 |
| -------------- | --------------- | ------------------- |
| MongoDB Enterprise 7.0 | MongoDB Enterprise 5.0 | MongoDB Enterprise 6.0 |
| MYSQL 8.4 | SUSE® Linux® Enterprise Server 12(64비트) | MYSQL 8.0.27 |
| ® SQL Server 2022 | 센토스 | ® SQL Server 2019 |
| ® SQL Server JDBC 드라이버 12.10.0 | Red Hat® Enterprise Linux® 7(커널 4.x)(64비트) | ® SQL Server JDBC 드라이버 8.2 |
| Red Hat® Enterprise Linux® 9(커널 5.x)(64비트) | | Red Hat® Enterprise Linux® 8(커널 4.x)(64비트) |
| PDF Generator 및 관련 문서 서비스용 Adobe Acrobat 2020(클래식 트랙) | | ® Office 2019 |
...
| 추가된 지원 | 제거된 지원 | 지원 중단됨 |
| -------------- | --------------- | ------------------- |
| MongoDB Enterprise 4.4 | Windows Server 2016(64비트) | ® Windows Server 2019(64비트) |
...
| ® Windows Server 2022(64비트) | ® SQL Server 2016 |  |
|  | JBoss® EAP 7.1.4 |  |
|  | 내 SQL JDBC 커넥터 5.1.44 |  |
|  | ® SQL Server JDBC 드라이버 6.2.1.0 |  |
|  | ® SQL Server JDBC 드라이버 6.2.2.0 |  |
|  | SQL Server용 ® JDBC 드라이버 8.x |  |
|  | ® Sharepoint 2016 |  |
|  | ® Office 2016 |  |
|  | ® Office Visio 2016 |  |
|  | ® Publisher 2016 |  |
...
| 추가된 지원 | 제거된 지원 | 지원 중단됨 |
| -------------- | --------------- | ------------------- |
|  | ® J9 가상 시스템(빌드 2.8, JRE 1.8.0) | MongoDB Enterprise 4.0 |
|  | Oracle Database 12c 릴리스 1 | MongoDB Enterprise 4.2 |
|  | Oracle 데이터베이스 18c | ® DB2® 11.1 |
|  | Oracle OUD(Unified Directory) 11g 릴리스 2 | Oracle Database 12c 릴리스 2 |
|  | ® Lotus Domino 9.0 | MySQL 5.7.35 |
|  | ® FileNet 5.2 | ® SQL Server JDBC 드라이버 6.2.1.0 |
|  | Adobe Flash Player | JBoss® EAP(Enterprise Application Platform) 7.1.4 |
|  | | ® Content Manager Server 8.5 수정 팩 2 |
|  | | ® Content Manager 클라이언트 8.5 |
|  | | ® SQL Server 2016 |
|  | | ® 윈도우 서버 2016 |
...
| 추가된 지원 | 제거된 지원 | 지원 중단됨 |
| -------------- | --------------- | ------------------- |
| 응용 프로그램 서버 JBoss™ EAP 7.4용 Oracle Java® SE 11(64비트) SDK | | Adobe Acrobat 2017 |
