...
| Microsoft® SQL Server 2022 | 센토스 | Microsoft® SQL Server 2019 |
| Microsoft® SQL Server JDBC 드라이버 12.10.0 | Red Hat® Enterprise Linux® 7(커널 4.x)(64비트) | Microsoft® SQL Server JDBC 드라이버 8.2 |
| Red Hat® Enterprise Linux® 9(커널 4.x)(64비트) | | Red Hat® Enterprise Linux® 8(커널 4.x)(64비트) |
