...
<table>
 <tbody>
  ...
  <tr>
   <td><p>Red Hat Enterprise Linux 7(커널 3.x)(64비트)</br><b>참고:</b> Red Hat Enterprise Linux 6은 2020년 11월 30일에 유지 관리 단계 종료 및 확장 수명 단계로 전환됩니다. Adobe은 업그레이드 및 신규 설치를 위해 Red Hat Enterprise Linux 7을 권장합니다.</p> </td>
   <td><p>A:지원됨</p> </td>
...
* AEM Forms on JEE는 당사의 [서드파티 소프트웨어 지원 정책에 따라 다양한 서드파티 소프트웨어를 지원합니다](../../forms/using/aem-forms-jee-supported-platforms.md#p-third-party-patch-support-policy-p).
* JEE의 AEM Forms은 타사 공급업체의 지원에 따라 플랫폼을 지원합니다. 일부 조합은 타사 공급업체에서 허용하지 않을 수 있습니다. 예를 들어, 많은 공급업체가 Oracle을 사용하여 애플리케이션 서버를 인증하지 않았습니다. 따라서 JEE의 AEM Forms 또한 이러한 조합을 지원하지 않습니다. 지원되는 소프트웨어 버전을 선택하려면 타사 공급업체의 지원 매트릭스를 확인하십시오.
...
>* 작업 영역은 Macintosh OS X 10.6 및 10.7에서 Safari 5.1을 지원하고 Acrobat DC 이상 버전을 지원합니다. Adobe Reader, Acrobat과 Safari 5.1 호환성에 대한 자세한 내용은 https://helpx.adobe.com/x-productkb/multi/safari-5-1-incompatible-reader.html을 [참조하십시오](https://helpx.adobe.com/x-productkb/multi/safari-5-1-incompatible-reader.html).
...
JEE의 AEM Forms에 대한 타사 소프트웨어 요구 사항은 해당 제품 문서의 &quot;시스템 요구 사항&quot; 섹션에 설명되어 있습니다. 모든 설명서는 https://adobe.com/go/learn_aemforms_documentation_65에서 액세스할 수 [있습니다](https://adobe.com/go/learn_aemforms_documentation_65) .
