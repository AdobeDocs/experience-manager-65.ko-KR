...
전자 메일 알림도 [메타데이터](../../forms/using/use-metadata-in-email-notifications.md)을 사용합니다. 예를 들어 기한, 우선순위, 워크플로우 이름 등이 있습니다. [사용자 지정 메타데이터](../../forms/using/use-metadata-in-email-notifications.md#using-custom-metadata-in-an-email-notification)를 사용하도록 템플릿을 구성할 수도 있습니다.
