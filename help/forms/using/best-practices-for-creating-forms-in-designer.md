...
양식을 디자인할 때는 LiveCycle Designer의 개체 라이브러리에 있는 탭의 개발 개체를 사용합니다. [창] > [오브젝트 라이브러리]를 선택하거나 Shift+F12를 눌러 이 패널을 표시할 수 있습니다(그림 1 참조).
...
* WCAG 2.0
   ...
   * 1.4.3 대비(최소): 텍스트 및 텍스트 이미지의 시각적 표시에서는 다음을 제외하고 대비 비율이 4.5:1 이상입니다. (레벨 AA)
   * 1.4.6 대비(향상): 텍스트 및 텍스트 이미지의 시각적 표시에서 다음을 제외한 대비 비율은 최소 7:1입니다. (레벨 AAA)
...
LiveCycle Designer에서 기본 언어를 설정하려면 폼의 Locale 속성과 최상위 하위 폼의 Locale 속성을 설정합니다. 기본 언어에 대한 변경 내용을 식별하려면 해당 폼의 언어가 아닌 다른 언어를 사용하는 개체의 Locale 속성을 변경합니다.
