...
그림 7: **일반적인 주문 양식에 대한 기본 읽기 순서 시각화**
...
![좌표를 사용하여 레이아웃 팔레트로 오브젝트 위치 정확하게 지정](/help/forms/using/assets/image-10.png)
...
* 보조 기술 사용자는 때때로 작업을 완료하는 데 추가 시간이 필요할 것입니다. 시간 루틴이 만료될 예정인 모든 경우에 확장을 허용할 액세스 가능한 메시지를 표시합니다. JavaScript를 통해 만든 경고 상자는 보조 기술에서 사용할 수 있습니다. 사용자에게 임박한 시간 초과를 경고하는 메시지가 포함된 새 창이 배포될 수도 있습니다.
...
* WCAG 1.0
   ...
   * 8.1 스크립트 및 애플릿과 같은 프로그래밍 요소를 보조 기술과 직접 액세스하거나 호환할 수 있습니다 [기능이 중요하고 다른 곳에 제시되지 않은 경우 우선 순위 1], 그렇지 않은 경우 (P2).
   * 9.3 스크립트의 경우 장치 종속 이벤트 핸들러(P2)가 아닌 논리 이벤트 핸들러를 지정합니다.
...
Flash 기반 미디어의 경우 [링크](/help/forms/using/best-practices-for-creating-forms-in-designer.md) 캡션 제공에 대한 자세한 정보.
...
![객체의 로케일 변경](/help/forms/using/assets/image-18.png)
