...
# 양식의 자산 검토 만들기 및 관리{#creating-and-managing-reviews-for-assets-in-forms}
...
1. 자산에 진행 중인 검토가 없는 경우 작업 표시줄에 검토 시작 ![aem6forms_review_chat_comment](assets/aem6forms_review_chat_comment.png) 아이콘이 나타납니다. 검토 시작 ![aem6forms_review_chat_comment](assets/aem6forms_review_chat_comment.png) 아이콘을 클릭합니다.
1. 다음 정보를 입력합니다.
...
1. 자산이 검토 진행 중이며 사용자가 검토 개시자인 경우 작업 표시줄에 검토 관리 ![aem6forms_review_chat_comment](assets/aem6forms_review_chat_comment.png) 아이콘이 나타납니다. 검토 개시자만 검토를 관리(업데이트/종료)할 수 있습니다.
