...
+ 릴리스 노트 {#release-notes-new-features}
   ...
   + [더 이상 사용되지 않는 기능](https://docs.adobe.com/content/help/en/experience-manager-65/release-notes/deprecated-removed-features.html)
+ 시작하기 {#getting-started}
   ...
   + [자동화된 양식 변환 서비스 소개](https://docs.adobe.com/content/help/en/aem-forms-automated-conversion-service/table-of-contents/introduction.html)
   ...
   + AEM Forms 참조 자료 {#aem-forms-reference-collaterals}
      + [We.Finance 및 직원 셀프 서비스 참조 사이트 설정 및 구성](using/setup-reference-sites.md)
...
+ AEM Forms 설치 및 구성 {#install-aem-forms}
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [JEE for WebSphere에 AEM Forms 설치 및 배포](http://www.adobe.com/go/learn_aemforms_installWebSphere_65)
...
+ AEM Forms 업그레이드 {#upgrade-aem-forms}
   ...
   + JEE에서 AEM Forms 업그레이드 {#aem-forms-jee-upgrade}
      ...
      + [업그레이드 검사 목록 및 계획](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_65)
      + [JEE에서 AEM 6.5 양식으로 업그레이드](using/upgrade-forms-jee.md)
      + [JEE for JBoss의 AEM Forms 릴리스에서 AEM 6.5 Forms로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_65)
      + [JEE에서 JBoss 턴키용 AEM Forms 릴리스에서 AEM 6.5 Forms로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
      + [AEM Forms 릴리스에서 WebSphere용 JEE의 AEM 6.5 Forms로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65)
...
+ 적응형 양식 - 고급 저작 {#adaptive-forms-advanced-authoring}
   ...
   + [표준 유효성 검사 오류 메시지 응용 양식](/help/forms/using/standard-validation-error-messages-adaptive-forms.md)
...
+ 워크플로우 {#workflows}
   ...
   + [AEM Forms 워크플로우 로그인](/help/forms/using/forms-workflow-logs.md)
...
+ Forms 디자이너 {#use-forms-designer}
   ...
   + [Designer FormCalc 참조](http://www.adobe.com/go/learn_aemforms_formCalc_65)
...
+ 개발자 참조 {#developer-reference}
   ...
   + [어셈블러 서비스 및 DCX 참조](http://www.adobe.com/go/learn_aemforms_ddxRef_65)
