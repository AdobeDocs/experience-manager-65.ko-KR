...
sub-product: 양식
audience: end-user
user-guide-title: Adobe Experience Manager 6.5 Forms 가이드
...
+ AEM Forms 설치 및 구성 {#install-aem-forms}
   ...
   + JEE에 AEM Forms 설치 {#jee-installation}
      ...
      + [AEM Forms 워크벤치 설치](using/install-workbench.md)
...
+ 업그레이드 AEM Forms {#upgrade-aem-forms}
   ...
   + JEE에서 AEM Forms 업그레이드 {#aem-forms-jee-upgrade}
      ...
      + [JBoss용 JEE의 AEM Forms 릴리스에서 AEM 6.5 Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_65)
      + [JBoss 턴키용 JEE의 AEM Forms 릴리스에서 AEM 6.5 Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
      + [WebSphere용 JEE의 AEM Forms 릴리스에서 AEM 6.5 Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65)
      + [WebLogic용 JEE의 AEM Forms 릴리스에서 AEM 6.5 Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_65)
...
+ 개발자 참조 {#developer-reference}
   ...
   + [AEM Forms(JEE Java API 참조)](https://helpx.adobe.com/experience-manager/6-5/forms/programlc/javadoc/index.html)
