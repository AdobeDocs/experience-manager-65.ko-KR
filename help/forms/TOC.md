...
sub-product: 양식
audience: end-user
user-guide-title: AEM 6.5 양식 사용 안내서
...
+ AEM Forms 설치 및 구성 {#install-aem-forms}
   ...
   + JEE에 AEM Forms 설치 {#jee-installation}
      ...
      + [AEM Forms 설치 및 구성 Document Security 서버](using/installing-and-configuring-the-document-security-server.md)
      + [단일 서버 AEM Forms 설치 준비](http://www.adobe.com/go/learn_aemforms_prepareInstallsingle_65)
...
+ 업그레이드 AEM Forms {#upgrade-aem-forms}
   ...
   + JEE에서 AEM Forms 업그레이드 {#aem-forms-jee-upgrade}
      ...
      + [AEM Forms 릴리스에서 JBoss용 JEE의 AEM 6.5 Forms로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_65)
      + [AEM Forms 릴리스에서 JBoss 턴키용 JEE의 AEM 6.5 Forms로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
      + [AEM Forms 릴리스에서 WebSphere용 JEE의 AEM 6.5 Forms로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65)
      + [AEM Forms 릴리스에서 WebLogic용 JEE의 AEM 6.5 Forms로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_65)
...
+ 적응형 양식 - 고급 작성 {#adaptive-forms-advanced-authoring}
   ...
   + [AEM Sites에 적응형 양식 또는 대화형 통신 임베드 단일 페이지 애플리케이션](/help/forms/using/embed-adaptive-form-aem-sites-spa.md)
...
+ 워크플로우 {#workflows}
   ...
   + [AEM Forms 작업 과정 로그인](/help/forms/using/forms-workflow-logs.md)
...
+ 개발자 참조 {#developer-reference}
   ...
   + [JEE Java API 참조 AEM Forms](https://helpx.adobe.com/experience-manager/6-5/forms/programlc/javadoc/index.html)
