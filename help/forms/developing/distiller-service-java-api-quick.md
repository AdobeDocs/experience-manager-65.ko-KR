...
description: Distiller 서비스 Java API QuickStart(SOAP)
...
Java API Quick Start(SOAP)는 다음 Distiller® 서비스에 대해 사용할 수 있습니다.
...
다음 코드 예제는 *Loan.ps*&#x200B;이라는 PostScript 파일을 *Loan.pdf*&#x200B;라는 PDF 파일로 변환합니다. ([PostScript를 PDF 문서로 변환](/help/forms/developing/converting-postscript-pdf-documents.md#converting-postscript-to-pdf-documents)을 참조하십시오.)
