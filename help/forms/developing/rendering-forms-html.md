...
양식 디자인이 HTML 양식으로 렌더링되면 각 두 번째 수준 하위 양식이 HTML 페이지(패널)로 렌더링됩니다. 디자이너에서 하위 폼의 계층 구조를 볼 수 있습니다. 루트 하위 양식에 속하는 하위 하위 양식(루트 하위 양식의 기본 이름은 form1)은 패널 하위 양식입니다. 다음 예제에서는 양식 디자인의 하위 양식을 보여 줍니다.
