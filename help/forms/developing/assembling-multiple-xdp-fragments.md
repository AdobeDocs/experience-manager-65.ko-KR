...
[프로그래밍 방식으로 PDF 문서 조립](/help/forms/developing/programmatically-assembling-pdf-documents.md#programmatically-assembling-pdf-documents)
...
[여러 XDP 구성요소 ](assembling-multiple-xdp-fragments.md#assembling-multiple-xdp-fragments)
[어셈블리빠른 시작(SOAP 모드):Java API를 사용하여 여러 XDP ](/help/forms/developing/assembler-service-java-api-quick.md#quick-start-soap-mode-assembling-multiple-xdp-fragments-using-the-java-api)
[조각 어셈블리AEM Forms Java 라이브러리 ](/help/forms/developing/invoking-aem-forms-using-java.md#including-aem-forms-java-library-files)
[파일 추가연결 속성 설정](/help/forms/developing/invoking-aem-forms-using-java.md#setting-connection-properties)
...
[어셈블리MTOM을 사용하여 AEM Forms 호출](/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-mtom)
