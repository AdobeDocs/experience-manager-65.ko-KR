...
대부분의 AEM Forms 저장소 서비스는 다음 그림과 같이 이름이 지정된 응용 프로그램 `Applications/FormsApplication,` 과 빠르게 상호 작용합니다.
...
>[!NOTE]
>
>웹 브라우저를 사용하여 AEM Forms 저장소를 찾아볼 수 있습니다. 저장소를 찾아보려면 웹 브라우저에 다음 URL을 입력합니다 `https://[server name]:[server port]/repository`. 웹 브라우저를 사용하여 빠른 시작 결과를 확인할 수 있습니다. 예를 들어 AEM Forms 저장소에 컨텐츠를 추가하는 경우 웹 브라우저에서 컨텐츠를 볼 수 있습니다.
