...
다음 코드 예제에서는 Loan.doc라는 *Word* 파일을 Loan.pdf라는 PDF 문서로 *변환합니다*. (Word [문서를 PDF 문서로 변환을 참조하십시오](/help/forms/developing/converting-file-formats-pdf.md#converting-word-documents-to-pdf-documents).)
