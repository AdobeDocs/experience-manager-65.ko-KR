...
권한이 활성화된 양식을 렌더링하려면 사용 권한 런타임 옵션을 설정해야 합니다. 양식에 사용 권한을 적용하는 데 사용되는 자격 증명의 별칭도 지정해야 합니다. 별칭 값을 지정한 후 양식에 적용할 각 사용 권한을 지정합니다.
