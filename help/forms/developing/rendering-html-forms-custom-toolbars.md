...
fscCSS는 특정 노드와 연결된 스타일 시트입니다. CSS 파일의 스타일은 도구 모음 모양을 지정합니다. *fscVCSS*&#x200B;은(는) 세로 도구 모음의 스타일시트이며 렌더링된 HTML 양식의 왼쪽에 표시됩니다. *fscIECSS*&#x200B;은(는) Internet Explorer에서 렌더링되는 HTML 양식에 사용되는 스타일시트입니다.
...
>[!NOTE]
>
>사용자 지정 도구 모음을 사용하는 HTML 양식을 렌더링하기 전에 HTML 양식이 렌더링되는 방법을 알아야 합니다. ([HTML으로 Forms 렌더링](/help/forms/developing/rendering-forms-html.md)을 참조하십시오.)
