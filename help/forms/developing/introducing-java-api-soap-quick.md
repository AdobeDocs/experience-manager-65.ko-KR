...
JEE의 AEM *Forms를 사용한 프로그래밍에서* 대부분의 빠른 시작은 작업을 수행하기 위해 특정 서비스를 호출합니다. 하지만 일부 빠른 시작은 지정된 워크플로우를 수행하기 위해 여러 AEM Forms 서비스를 불러옵니다. 다음 목록은 두 개 이상의 AEM Forms 서비스를 호출하는 Java 빠른 시작을 제공합니다.
