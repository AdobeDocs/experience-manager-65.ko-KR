...
대부분의 빠른 시작은에 있습니다. *JEE에서 AEM Forms을 사용한 프로그래밍* 작업을 수행하려면 특정 서비스를 호출합니다. 그러나 일부 빠른 시작은 주어진 워크플로우를 수행하기 위해 여러 AEM Forms 서비스를 호출합니다. 다음 목록은 두 개 이상의 AEM Forms 서비스를 호출하는 Java 빠른 시작을 제공합니다.
