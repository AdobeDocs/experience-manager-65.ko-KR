...
>[!NOTE]
>
>사용자 지정 CSS 파일을 사용하는 HTML 양식을 렌더링하기 전에 HTML 양식 렌더링에 대해 명확하게 이해하는 것이 중요합니다. (HTML[으로 Forms 렌더링 참조)](/help/forms/developing/rendering-forms-html.md)
...
## Java API {#render-an-html-form-that-uses-a-css-file-using-the-java-api}를 사용하여 CSS 파일을 사용하는 HTML 양식 렌더링
...
## 웹 서비스 API {#render-an-html-form-that-uses-a-css-file-using-the-web-service-api}를 사용하여 CSS 파일을 사용하는 HTML 양식 렌더링
