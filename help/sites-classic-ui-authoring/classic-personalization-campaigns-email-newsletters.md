...
1. 이메일 서비스의 개인화 필드를 활성화하려면 이메일 서비스를 구성하는 동안 프레임워크 구성을 추가하십시오. 다음을 참조하십시오 [Silverpop Engage 구성](/help/sites-administering/silverpop.md) 및 [정확한 Target 구성](/help/sites-administering/exacttarget.md) 추가 정보.
...
1. 클릭 **서비스 추가** 위치: **Cloud Services** 탭. 서비스 목록이 표시됩니다. 다음 중 원하는 구성을 선택합니다. **정확한 타겟** 또는 **Silverpop** - 드롭다운 목록의 목록에서
