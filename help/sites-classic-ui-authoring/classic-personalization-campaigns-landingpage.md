...
1. 랜딩 페이지 캔버스가 포함된 AEM의 페이지를 만듭니다. AEM에는 **Importer Page**&#x200B;라는 샘플이 제공됩니다.
...
**작업 구성** Post 옵션의 선택 사항에 따라 작업 구성이 변경됩니다. 예를 들어 Create Lead 를 선택하면 Lead 가 추가되는 목록을 구성할 수 있습니다.
