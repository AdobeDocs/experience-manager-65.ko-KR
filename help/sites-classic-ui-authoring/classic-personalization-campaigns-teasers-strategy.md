...
>[!NOTE]
>
>티저 구성 요소는 이제 AEM 6.2에서 더 이상 사용되지 않습니다. 대신 [타겟 구성 요소](/help/sites-authoring/content-targeting-touch.md).
...
* 다음 **티저 구성 요소** 는 즉시 사용할 수 있으며, 콘텐츠 페이지에서 특정 티저 단락의 인스턴스를 만들 수 있도록 해 줍니다. 사이드 킥에서 티저 구성 요소를 드래그한 다음 티저 정의를 지정하여 자신만의 티저 단락을 만들 수 있습니다. **참고:** 티저 구성 요소는 이제 AEM 6.2에서 더 이상 사용되지 않습니다. 대신 [타겟 구성 요소](/help/sites-authoring/content-targeting-touch.md).
