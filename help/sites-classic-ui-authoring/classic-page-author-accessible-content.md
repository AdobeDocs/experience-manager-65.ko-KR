...
* 차트 및 그래프:
  ...
  AEM에서는 [충족하는 방법 - 텍스트가 아닌 콘텐츠(1.1.1)](#how-to-meet-non-text-content)와 같이 이미지의 구성 대화 상자에서 **대체 텍스트**&#x200B;와 **설명** 필드를 조합하여 사용할 수 있습니다.
...
* **테이블 사용**:
   ...
   * `<caption>` 요소를 사용하여 표에 보이는 캡션을 제공할 수 있습니다. 기본적으로 캡션은 표 중앙에 표시되지만 CSS를 사용하여 적절하게 배치할 수 있습니다. 캡션은 표와 프로그래밍 방식으로 연결되어 있으므로 콘텐츠에 소개를 제공하는 데 유용한 방법입니다.
