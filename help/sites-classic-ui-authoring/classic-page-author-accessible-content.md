...
>[!NOTE]
>
>위의 시나리오 양쪽에서 기본값 **대체 텍스트** 값이 다음에 표시되지 않음 **고급 이미지 속성** 탭. 기본값을 변경하려면 **대체 텍스트** 필드.
...
* 차트 및 그래프:
  ...
  ![그래프의 예. 다음은 대안을 제공하는 가장 좋은 방법입니다.](assets/chlimage_1-2a.jpeg)
...
다음과 같은 관련 컨트롤 그룹이 있는 경우 **라디오 그룹**&#x200B;그룹 및 개별 컨트롤에 대한 제목이 필요할 수 있습니다. 라디오 버튼(**항목**)이 생성될 때 개별 제목이 지정되는 반면 AEM에서 라디오 버튼 집합을 추가하면 **제목** 필드가 이 그룹 제목을 제공합니다.
