...
>[!NOTE]
>
>다음 문서는 클래식 UI에 중점을 둡니다. 최신 터치 지원 UI에서의 작성에 대한 자세한 내용은 [표준 작성 설명서](/help/assets/assets.md).
...
1. 터치 활성화 UI
   ...
   * 다음을 참조하십시오. [표준 작성 설명서](/help/sites-authoring/author.md) 터치 기반 UI를 사용하여 작성하는 방법에 대한 자세한 내용은 를 참조하십시오. 다음 문서는 클래식 UI에 중점을 둡니다.
