...
다음으로는 이 Scaffold가 만드는 페이지의 구조를 정의해야 합니다. To do this go into **[design mode](/help/sites-authoring/page-authoring.md#sidekick)**on the scaffold page.**대화 상자 편집기**에서 Scaffold를 편집할 수 있는 링크가 나타납니다.
