...
* 웹 사이트가 Experience Manager에 없는 경우 다음을 참조하십시오. [Dynamic Media 자산 제공](/help/assets/delivering-dynamic-media-assets.md) 터치 사용 사용자 인터페이스에서 클릭합니다.

자세한 내용은 다음 항목을 참조하십시오.

* [페이지에 Dynamic Media 에셋 추가](/help/sites-classic-ui-authoring/dynamic-media-assets-adding-to-page.md)
