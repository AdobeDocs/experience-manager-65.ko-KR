...
* 티저를 만드는 경우:
   ...
   1. [티저에 대한 터치포인트 만들기](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md#creatingatouchpointforyourteaser) (콘텐츠 페이지에 티저 추가).
...
>[!NOTE]
>
>다음을 참조하십시오 [세분화](/help/sites-administering/campaign-segmentation.md) 세그먼트 정의에 대한 자세한 지침은 을 참조하십시오.
...
1. 출처: **캠페인** 왼쪽 창에서 오른쪽 창의 새 브랜드 아이콘을 선택하고 **속성...**

   다음을 입력할 수 있습니다. **제목**, **설명** 아이콘으로 사용할 이미지
...
>[!NOTE]
>
>이전 릴리스와 마찬가지로 에서도 경험을 페이지로 만들 수 있습니다. **웹 사이트** 콘솔(및 이전 릴리스에서 만든 모든 페이지는 여전히 완벽하게 지원됨)
>
...
* [티저](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md#teasers):
   ...
   * [티저에 대한 터치포인트 만들기](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md#creatingatouchpointforyourteaser) (콘텐츠 페이지에 티저 추가).
...
* [뉴스레터](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md#newsletters):
   ...
   * [뉴스레터 전송](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md#sendingnewsletters) 구독자 또는 잠재 고객에게 보냅니다.
...
1. 클릭 **터치포인트 추가...** 대화 상자를 엽니다. 추가할 경험을 지정합니다.
...
대시보드에서 을(를) 클릭하여 모든 리드에 액세스합니다 **잠재 고객** 왼쪽 창에서 엽니다. 다음에서 리드에 액세스할 수도 있습니다. **목록** 창.

![screen_shot_2012-02-21at114748am](assets/screen_shot_2012-02-21at114748am.png)

>[!NOTE]
>
>사용자의 아바타를 추가하거나 수정하려면 클릭스트림 클라우드(Ctrl+Alt+c)를 열고 프로필을 로드한 다음 를 클릭합니다 **편집**.
...
1. 필드에 정보를 적절히 입력합니다. 다음을 클릭합니다. **주소** 탭.

   ![screen_shot_2012-02-21at115045am](assets/screen_shot_2012-02-21at115045am.png)

1. 주소 정보를 적절하게 입력합니다. 클릭 **저장** 리드를 저장합니다. 가망 고객을 더 추가해야 하는 경우 **저장 및 새로 만들기**.
...
1. AEM에서 MCM으로 이동하여 **잠재 고객**.

1. 활성화하거나 비활성화할 리드를 선택하고 **활성화** 또는 **비활성화**.
...
1. **다음**&#x200B;을 클릭합니다. 가망 고객이 속할 목록을 선택합니다. 목록에 포함되지 않도록 하려면 필드의 정보를 삭제합니다. 기본적으로 AEM은 날짜 및 시간을 포함하는 목록 이름을 만듭니다. 클릭 **가져오기**.
...
1. MCM에서 **잠재 고객** 사용 가능한 모든 가망 고객을 조회합니다.

1. 가망 고객 옆에 있는 확인란을 선택하여 목록에 추가할 가망 고객을 선택합니다. 원하는 만큼 리드를 추가할 수 있습니다.

   ![screen_shot_2012-02-21at123835pm](assets/screen_shot_2012-02-21at123835pm.png)

1. 다음에서 **도구** 메뉴, 선택 **목록에 추가....** 다음 **목록에 추가** 창이 열립니다.

   ![screen_shot_2012-02-21at124019pm](assets/screen_shot_2012-02-21at124019pm.png)

1. 리드를 추가할 목록을 선택하고 **확인**. 리드가 해당 목록에 추가됩니다.
...
1. MCM에서 **잠재 고객**. Lead 목록에서 편집할 Lead 옆에 있는 확인란을 선택합니다. 모든 잠재 고객 정보가 오른쪽 창에 나타납니다.
...
1. 필요에 따라 편집하고 **저장** 변경 사항을 저장합니다.

   >[!NOTE]
   >
   >리드 아바타를 변경하려면 사용자 프로필로 이동하십시오. Ctrl+Alt+c를 누르고 를 클릭하여 클릭스트림 클라우드에서 프로필을 로드할 수 있습니다. **로드**&#x200B;을 클릭한 다음 프로필을 선택합니다.

### 기존 리드 삭제 {#deleting-existing-leads}

MCM에서 기존 리드를 삭제하려면 리드 옆에 있는 확인란을 선택하고 **삭제**. 가망 고객 목록 및 모든 관련 목록에서 가망 고객이 제거됩니다.
...
다음을 클릭: **목록**&#x200B;또한 목록이 다른 목록의 구성원인지 확인하고 설명을 볼 수 있습니다.
...
1. 이름(필수)을 입력하고 원하는 경우 설명을 입력한 다음 **저장**. 목록은에 표시됩니다. **목록** 창.
...
1. 목록에서 편집할 목록 옆에 있는 확인란을 선택하고 **편집**. 다음 **목록 편집** 창이 열립니다.
...
기존 목록을 삭제하려면 MCM에서 목록 옆에 있는 확인란을 선택하고 을 클릭합니다 **삭제**. 목록이 제거됩니다. 목록과 연계된 Lead 는 제거되지 않으며 목록과의 연계만 삭제됩니다.
...
1. 다음에서 **도구** 메뉴, 선택 **병합 목록**.

   >[!NOTE]
   >
   >한 번에 하나의 목록만 병합할 수 있습니다.

1. 다음에서 **병합 목록** 창에서 병합할 목록을 선택하고 **확인**.

   ![screen_shot_2012-02-21at10259pm](assets/screen_shot_2012-02-21at10259pm.png)

   병합한 목록이 구성원 한 명씩 증가해야 합니다. 병합된 목록을 보려면 병합한 목록과 **도구** 메뉴, 선택 **리드 표시**.
...
>[!NOTE]
>
>병합된 목록을 멤버쉽에서 제거하는 것은 목록에서 리드를 제거하는 것과 동일합니다. 를 엽니다. **목록** 탭을 클릭하고 병합된 목록이 포함된 목록을 선택한 다음 목록 옆에 있는 빨간색 원을 클릭하여 멤버십을 제거합니다.
...
1. 다음에서 **도구** 메뉴, 선택 **리드 표시**. AEM은 해당 목록의 멤버인 가망 고객을 표시합니다. 목록을 검색하거나 구성원을 검색할 수 있습니다.

   >[!NOTE]
   >
   >또한 목록에서 가망 고객을 선택한 다음 를 클릭하여 삭제할 수 있습니다 **구성원 제거**.
