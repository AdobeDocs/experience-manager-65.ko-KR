...
AEM Forms는 해당 관리 기능, 문서 보안 및 통합된 분석과 함께 양식 작성, 관리 및 게시를 결합하여 흥미 있는 종단 간 환경을 생성합니다. [AEM Forms을 위한 새로운 비디오 기능 자습서 중 일부를 참조하십시오.](https://helpx.adobe.com/experience-manager/kt/forms/index/aem-6-5-forms.html)
...
Screens는 다양한 유형의 화면을 포함하는 다이내믹하고 인터랙티브한 디지털 경험 및 인터랙션을 포괄적인 디지털 마케팅 플랫폼과 함께 게시할 수 있는 Adobe Experience Manager 기능입니다.  [추가 정보.](https://docs.adobe.com/content/help/ko-KR/experience-manager-screens/user-guide/aem-screens-introduction.html)
