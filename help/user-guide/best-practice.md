...
* [저희의 공식 AEM 교육 카탈로그는 여기에 있습니다.](https://training.adobe.com/training/current-courses.html#solution=adobeExperienceManager&amp;p=1)
* AEM에서 인증을 받으려면 [공식 AEM 인증에 대한 전체 안내서는 여기에서 확인할 수 있습니다.](https://training.adobe.com/certification/exams.html#p=1&amp;solution=adobeExperienceManager)

AEM Community는 제안 및 공동 작업에서 예제 워크플로우, 자습서 및 컨텐츠 코드 샘플을 계속 생성합니다.

* [AEM 6.4 튜토리얼 및 비디오의 전체 목록은 여기에 있습니다.](https://helpx.adobe.com/kr/experience-manager/kt/index/aem-6-5-videos.html)
* [AEM Community 방법 문서의 전체 목록이 여기에 있습니다.](https://helpx.adobe.com/kr/experience-manager/topics/how-to.html)
* [AEM 기술 자료 문서의 전체 목록은 여기에 있습니다.](https://helpx.adobe.com/kr/experience-manager/kb/index/full_kb_list.html)
...
새 제품도 있습니다. [AEM을 사용하여 첫 번째 웹 사이트를 만드는 단계별 안내서인 WKND 튜토리얼](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/overview.html?lang=ko-KR) 및 [Digital Foundation 솔루션 배포를 위한 단계별 방법](https://helpx.adobe.com/marketing-cloud/how-to/digital-foundation.html): AEM은 주요 빌딩 블록입니다.
...
보안인 AEM 설치 시 주요 고려 사항입니다. [배포 시 AEM 설치가 안전한지 확인하는 데 필요한 다양한 단계 및 조치에 대해 알아봅니다.](/help/sites-administering/security-checklist.md) 검사 목록은 위쪽에서 아래쪽으로 적용하기 위한 것입니다.

## AEM FAQ {#faq}

다음 확인: [AEM FAQ](/help/sites-administering/aem-faqs.md) AEM에 대해 가장 자주 묻는 질문 중 일부에 대한 답변을 얻으십시오.
