...
1. [영역을 만들거나](#creating-new-areas) [영역을 Live Copy로 만들기](#creating-new-areas). 영역에는 구성 요소가 타겟팅되는 위치인 페이지의 *영역*&#x200B;에 사용할 수 있는 모든 활동이 포함됩니다. 영역을 만들면 빈 영역이 만들어지지만 영역을 Live Copy로 만들면 사이트 구조에서 콘텐츠를 상속할 수 있습니다.
...
사이트나 Live Copy는 해당 사이트나 Live Copy에서 사용 가능해야 하는 활동을 포함하는 영역에 연결합니다. 기본적으로 사이트 또는 라이브 카피는 마스터 영역에 연결되지만, 마스터 영역 이외의 다른 영역도 연결할 수 있습니다.
...
사용 사례에 따라 여러 가지 방법으로 타겟팅된 콘텐츠에 대한 다중 사이트 지원을 설정할 수 있습니다. 이 섹션에서는 이 지원이 어떻게 하나의 브랜드에 이론적으로 실행되는지를 설명합니다. 또한 [예: Geograph에 따라 콘텐츠를 타깃팅](#example-targeting-content-based-on-geography)에서 여러 사이트에서 콘텐츠를 타깃팅하는 실제 응용 프로그램을 볼 수 있습니다.
...
* 영국인들은 유럽 지역과 연결되어 있으며 마스터 영역으로부터 상속을 받습니다.
...
탭을 새로 고치면 캐나다 사이트는 우리 쪽에서 아무런 작업을 하지 않아도 새 이미지로 변경됩니다. 이는 캐나다가 미국과 마스터 영역을 공유하기 때문입니다. 영국과 호주 사이트에서는 이미지가 변경되지 않습니다.
...
>[!NOTE]
>
>브랜드 이름을 클릭하면 기본적으로 기본 영역이라는 기본 영역이 축소됩니다. **다른 영역을 만들 때까지**. Then, when you select a brand in either the **Activity** or **Offers** console, you see the **Area** console.
...
1. 사이트 또는 페이지를 선택하고 **속성 보기**&#x200B;를 클릭합니다.
1. **Personalization** 탭을 클릭합니다.
1. **브랜드** 메뉴에서 영역을 연결할 브랜드를 선택합니다. 브랜드를 선택한 후에는 **영역 참조** 메뉴에 사용 가능한 영역이 표시됩니다.

   ![chlimage_1-283](assets/chlimage_1-283.png)

1. **영역 참조** 드롭다운 메뉴에서 영역을 선택하고 **저장**&#x200B;을 클릭합니다.
...
1. 상속을 분리하거나 일시 중단하려는 페이지로 이동하고 모드 드롭다운 메뉴에서 **타깃팅**&#x200B;을 클릭합니다.
1. 페이지가 Live Copy인 영역에 연결되어 있으면 상속 상태가 표시됩니다. **타깃팅 시작**&#x200B;을 클릭합니다.
...
1. 활동을 일시 중단하려면 **일시 중단**&#x200B;을 클릭하세요. 일시 중단된 활동은 빨간색으로 표시됩니다.
...
1. 마스터에서 Live Copy를 분리하려는 페이지로 이동하고 모드 드롭다운 메뉴에서 **타깃팅**&#x200B;을 클릭합니다.
1. 페이지가 Live Copy인 영역에 연결되어 있으면 상속 상태가 표시됩니다. **타깃팅 시작**&#x200B;을 클릭합니다.
1. Select **Detach Live Copy** from the drop-down menu in the toolbar. AEM confirms that you want to detach the Live Copy.
1. 활동에서 Live Copy를 분리하려면 **분리**&#x200B;를 클릭하십시오. 분리된 후에는 상속에 대한 드롭다운 메뉴가 더 이상 표시되지 않습니다. 이제 이 활동은 로컬 활동입니다.
...
1. 상속을 복원할 페이지로 이동하고 모드 드롭다운 메뉴에서 **타깃팅**&#x200B;을 클릭합니다.
1. **타깃팅 시작**&#x200B;을 클릭합니다.
1. 도구 모음의 드롭다운 메뉴에서 **Live Copy 다시 시작**&#x200B;을 선택합니다.

   ![chlimage_1-288](assets/chlimage_1-288.png)

1. **다시 시작**&#x200B;을 클릭하여 Live Copy 상속을 다시 시작할지 확인합니다. 상속을 다시 시작하는 경우 현재 활동에 대한 수정 사항은 모두 잃게 됩니다.
...
1. **개인화** > **활동** 또는 **오퍼**&#x200B;로 이동한 다음 내 브랜드로 이동합니다.
1. 삭제할 영역 옆에 있는 아이콘을 클릭합니다.
1. **삭제**&#x200B;를 클릭하고 영역을 삭제할 것인지 확인하십시오.
