...
또한 모든 Adobe Target 활동에 대한 목표와 지표를 관리하고 Adobe Target 대상자를 관리할 수도 있습니다. Adobe Target 활동 보고(A/B 테스트에 대한 우승자 전환 포함)도 포함됩니다.
...
1. [타겟](#diagramtargetconfiguringtheaudiences): 각 경험이 타겟팅하는 대상자를 지정합니다. 특정 대상을 타기팅할 수 있습니다. A/B 테스트를 사용하는 경우 트래픽 중 어느 정도의 비율이 어느 경험으로 가는지를 결정할 수 있습니다.
...
콘텐츠 타겟팅의 만들기 단계에는 경험 생성이 포함됩니다. 이 단계에서는 활동의 경험을 만들거나 삭제하고 각 경험에 오퍼를 추가할 수 있습니다.
...
1. 화면의 아무 곳이나 클릭하여 변경 내용을 저장합니다.
...
[타겟팅 프로세스](/help/sites-authoring/content-targeting-touch.md#the-targeting-process-create-target-and-goals-settings)의 타겟 단계에는 만들기 단계에서 작업에 사용한 경험과 대상자를 매핑하는 작업이 포함됩니다. 타겟 페이지에는 각 경험이 타겟팅하는 대상이 표시됩니다. 각 경험의 대상자를 지정하거나 변경할 수 있습니다. Adobe Target을 사용하는 경우 대상에 대한 트래픽 비율을 특정 경험으로 타겟팅할 수 있도록 해 주는 A/B 테스트를 생성할 수도 있습니다.
...
[타겟팅 프로세스](/help/sites-authoring/content-targeting-touch.md#the-targeting-process-create-target-and-goals-settings)의 목표 및 설정 단계에는 브랜드 활동의 행동을 구성하는 작업이 포함되어 있습니다. 활동이 시작되고 끝나는 시기와 활동 우선순위를 지정합니다. 또한 목표를 추적할 수도 있습니다. 특히 활동으로 측정할 사항을 결정할 수 있습니다.
...
성공 지표에 대한 자세한 내용은 [Adobe Target 설명서](https://experienceleague.adobe.com/docs/target/using/activities/success-metrics/success-metrics.html?lang=ko)를 참조하세요.
