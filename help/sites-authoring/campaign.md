...
1. **클라우드 서비스**&#x200B;를 선택하고 **+**&#x200B;을 클릭하여 구성을 추가합니다. 표시되는 아무 구성이나 선택합니다. **+** 기호를 탭하거나 클릭하여 다른 구성을 추가한 후, **Adobe Campaign**&#x200B;을 선택합니다.
...
Adobe Campaign에 대한 컨텐츠를 승인하려면 **Workflow**&#x200B;을 선택하고 **Adobe Campaign에 대한 승인**&#x200B;을 선택하여 워크플로우를 적용하고 **워크플로우 시작**&#x200B;을 클릭합니다. 단계를 거쳐 컨텐츠를 승인합니다. 마지막 워크플로우 단계에서 **승인** 대신 **거부**&#x200B;를 선택하여 컨텐츠를 거부할 수도 있습니다.
...
1. 도구 모음에서 **Adobe Experience Manager 컨텐츠 연결**&#x200B;을 선택하여 AEM에서 사용할 수 있는 컨텐츠 목록에 액세스합니다.

   >[!NOTE]
   작업 표시줄에 **Adobe Experience Manager**&#x200B;과 연결 옵션이 표시되지 않으면 이메일 속성에서 **Adobe Experience Manager**&#x200B;으로 설정된 **컨텐츠 편집 모드**&#x200B;가 올바르게 구성되어 있는지 확인하십시오.
