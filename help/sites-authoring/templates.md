...
* [템플릿 편집](#editingtemplates) 다음을 정의합니다.
...
* [템플릿 활성화](#enablingatemplateauthor) 페이지 생성 시 사용
* [템플릿 허용](#allowing-a-template-author) 웹 사이트의 필요한 페이지 또는 분기
* [템플릿 게시](#publishingatemplateauthor) 게시 환경에서 사용할 수 있도록 설정
...
1. **도구 ->** **일반**&#x200B;에서 **템플릿 콘솔**&#x200B;을 연 후 필요한 폴더로 이동합니다.
   ...
   >
   >
   >를 사용하는 것이 좋습니다. [프로젝트용 템플릿 폴더를 만들었습니다.](/help/sites-developing/page-templates-editable.md#template-folders).
...
1. 선택 **템플릿 유형**&#x200B;을 선택한 다음 을 선택합니다. **다음**.
   ...
   >[!NOTE]
   >
   >템플릿 유형은 사전 정의된 템플릿 레이아웃이며 템플릿에 대한 템플릿으로 생각할 수 있습니다. 개발자 또는 시스템 관리자가 미리 정의합니다. 자세한 내용은 개발자 문서를 참조하십시오. [페이지 템플릿 - 편집 가능](/help/sites-developing/page-templates-editable.md#template-type).
...
* 이미지
   ...
   * 다음으로 사용할 이미지 [템플릿의 축소판](/help/sites-authoring/templates.md#template-thumbnail-image) 을 눌러 페이지 만들기 마법사와 같은 선택을 지원합니다.
...
* **구성 요소 추가**
   ...
   * 구성 요소 잠금이 해제된 시기를 표시하는 마커
   ...
   >[!NOTE]
   >
   >동일하지는 않지만 구성 요소 및 에셋을 템플릿에 추가하는 것은 [페이지 작성](/help/sites-authoring/editing-content.md) 시 수행되는 작업과 매우 비슷합니다.
...
1. 다음 **페이지 디자인** 대화 상자가 열리고 두 개의 섹션으로 나뉩니다.
   ...
   * 왼쪽 반은 [페이지 정책](/help/sites-authoring/templates.md#page-policies)
   * 오른쪽 절반은 [페이지 속성](/help/sites-authoring/templates.md#page-properties)
...
1. [고유한 폴더 만들기](#creatingatemplatefolderdeveloper) 를 참조하십시오.
1. [템플릿 게시](#publishingatemplateauthor) 다음에서 **템플릿** 콘솔.
