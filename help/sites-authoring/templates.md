...
동안 **페이지 정책** 옵션 **페이지 정보** 메뉴를 사용하면 다음 작업을 수행할 수 있습니다. [필요한 페이지 정책 선택](#editingatemplatepagepolicies):
...
* **정책 및 속성(일반)**
  ...
  구성 요소에 대해 콘텐츠 정책을 만들거나 기존 콘텐츠 정책을 선택합니다. 이렇게 하면 디자인 세부 사항을 정의할 수 있습니다.
