...
seo-description: 리치 텍스트 편집기를 사용하여 컨텐츠 작성
...
전체 화면 모드는 작성에 사용할 수 있는 구성된 모든 옵션을 표시합니다. 사용 가능 여부는 구성에 [따라](/help/sites-administering/rich-text-editor.md)다릅니다.
...
>[!NOTE]
>
>Microsoft Word의 중첩된 목록을 RTE에 복사하면 일관되지 않은 결과가 나올 수 있으며 RTE에서 텍스트를 붙여넣은 후 수동으로 수정해야 할 수 있습니다.
