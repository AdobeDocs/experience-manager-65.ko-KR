...
특정 사항에 대한 개요를 제공하기 전에 염두에 둘 몇 가지 일반적인 팁 및 힌트입니다.
...
* 버전이 페이지 편집기에서 시작/작성되지 않습니다. 이제는 사이트 콘솔에서 수행됩니다(선택한 리소스에 대한 **만들기** 또는 [타임라인](/help/sites-authoring/basic-handling.md#timeline)을 통해).
...
1. 카드 보기:
   ...
   * 다음과 같은 방법으로 [필요한 리소스를 선택](/help/sites-authoring/basic-handling.md#viewingandselectingyourresources)하여 선택 모드에 들어갑니다.
