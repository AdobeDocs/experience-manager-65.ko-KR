...
>[!NOTE]
>
>스캐폴딩이 있지만 [모드](/help/sites-authoring/author-environment-tools.md#page-modes) 스캐폴드에서 새 페이지를 만들 수 있을 뿐만 아니라 스캐폴드의 유지 관리 및 작성도 클래식 UI에서 수행됩니다. 자세한 내용은 클래식 UI 작성 설명서의 [스캐폴딩](/help/sites-classic-ui-authoring/classic-feature-scaffolding.md)을 참조하십시오.
