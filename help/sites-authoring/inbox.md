...
* **열 사용자 지정**: AEM 받은 편지함을 사용자 지정하여 열의 기본 제목을 변경하고, 열의 위치를 다시 정렬하고, 워크플로우의 데이터를 기반으로 추가 열을 표시할 수 있습니다.
   ...
   * **열 편집**: 열 제목 위에 마우스를 놓고 선택 ![편집](assets/edit.svg) 아이콘 - 열 표시 이름을 입력합니다.
   * **열 삭제**: 다음을 선택합니다. ![삭제](assets/delete_updated.svg) 아이콘을 클릭하여 AEM 받은 편지함에서 열을 삭제합니다.
...
1. 에서 필요한 필드를 작성합니다. **기본** 및 **고급** 탭; 만 **제목** 는 필수입니다. 다른 모든 것은 선택 사항입니다.
   ...
   * **고급**
      ...
      * **이름**: URL을 구성하는 데 사용됩니다. 공백이 있는 경우 **제목**.
