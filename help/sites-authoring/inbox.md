...
* 작업:
   ...
   * AEM UI 내의 다양한 지점(예: 아래)에서 생성할 수 있습니다. **프로젝트**,
...
>[!NOTE]
>
>기본 AEM에는 관리자 사용자 그룹에 할당된 관리 작업이 미리 로드되어 있습니다. 다음을 참조하십시오 [기본 관리 작업](#out-of-the-box-administrative-tasks) 을 참조하십시오.
...
1. 항목에 대해 작업을 수행하기 위해서는 해당 항목 옆에 있는 썸네일을 선택합니다. 해당 항목에 적용할 수 있는 작업에 대한 아이콘이 도구 모음에 표시됩니다.
   ...
   * **재지정**/**위임** 항목.
   * **열기** 항목; 항목 유형에 따라 이 작업은 다음을 수행할 수 있습니다.
...
1. 선택 **만들기**, 그런 다음 **작업**.
1. 에서 필요한 필드를 작성합니다. **기본** 및 **고급** 탭; 만 **제목** 는 필수입니다. 다른 모든 것은 선택 사항입니다.
   ...
   * **기본**:
      ...
      * **프로젝트**
      * **할당자**
      * **콘텐츠**; 페이로드와 유사하게 작업에서 저장소의 위치에 대한 참조입니다.
      * **설명**
      * **작업 우선순위**
      * **시작 날짜**
      * **기한**
   ...
   * **고급**
      ...
      * **이름**: URL을 구성하는 데 사용됩니다. 공백이 있는 경우 다음을 기반으로 합니다. **제목**.
...
특정 작업에 대해 다음을 만들 수 있습니다. [프로젝트](/help/sites-authoring/projects.md) 해당 작업 기준:
...
1. 필요한 속성을 지정합니다.
   ...
   * **고급**
   ...
   >[!NOTE]
   >
   >다음을 참조하십시오 [프로젝트 만들기](/help/sites-authoring/touch-ui-managing-projects.md#creating-a-project) 전체 정보.
