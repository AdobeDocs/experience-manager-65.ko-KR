...
**인구 통계 트레이트** 다음을 포함하여 선택된 모집단 특성
...
**파생 트레이트** 일부 인구 통계 트레이트는 등록 없이 결정하기 어렵지만, 행동 트레이트와 인구 통계 트레이트를 결합하여 도출해낼 수 있습니다.
...
**하위 세그먼트** 세그먼트는 여러 개의 하위 세그먼트로 세분화될 수 있습니다. 이렇게 하려면 트레이트를 추가로 정의합니다.

**티저 페이지** 티저 페이지는 특정 대상자를 대상으로 합니다. 이 페이지에는 티저 단락에 사용할 수 있는 재사용 가능한 콘텐츠가 들어 있습니다.

**캠페인** 캠페인은 티저 페이지 및 이메일 마케팅 페이지(예: 뉴스레터 또는 초대)의 컬렉션입니다. 일반적으로 캠페인은 제한된 기간 동안 운영되며 다른 캠페인으로 대체됩니다.
...
>[!NOTE]
>
>다음을 참조하십시오. [세분화](/help/sites-administering/campaign-segmentation.md) AEM의 세그먼트에 대한 추가 정보를 참조하십시오.
