---
title: 컨텐츠 페이지를 위한 응답형 레이아웃
description: Adobe Experience Manager을 사용하면 페이지에 대한 응답형 레이아웃을 실현할 수 있습니다.
...
* **레이아웃** 모드에서 **구성 요소를 여기로 드래그하십시오.**&#x200B;를 탭/클릭하여 전체 구성 요소를 선택할 수 있습니다. 그러면 이 모드에 대한 도구 모음이 표시됩니다.
   ...
   * **숨겨진 구성 요소 표시** - 모든 또는 개별 구성 요소를 표시합니다. 숫자는 현재 존재하는 숨겨진 구성 요소의 수를 가리킵니다. 계산기는 숨겨진 구성 요소의 수를 보여줍니다.
