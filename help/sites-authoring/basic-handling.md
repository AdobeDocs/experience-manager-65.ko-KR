...
로그인 후 바로 [탐색 패널](#navigation-panel)에 도착합니다. 옵션 중 하나를 선택하면 해당 콘솔이 열립니다.
...
<table>
 <tbody>
  ...
  <tr>
   <td>상거래</td>
   <td>이렇게 하면 <a href="/help/commerce/cif-classic/administering/ecommerce.md">Commerce</a> 사이트와 관련된 제품, 제품 카탈로그 및 주문을 관리할 수 있습니다.</td>
  </tr>
  <tr>
   <td>경험 조각</td>
...
* 이동 경로
  ...
  이동 경로는 레일의 중간에 표시되며 항상 현재 선택한 항목에 대한 설명을 표시하는 경우 이동 경로를 사용하여 특정 콘솔 내에서 탐색할 수 있습니다. Sites 콘솔에서는 웹 사이트 수준을 탐색할 수 있습니다.
...
* [보기](/help/sites-authoring/basic-handling.md#viewingandselectingyourresourcescardlistcolumn)
  ...
  보기 아이콘은 AEM 도구 모음의 맨 오른쪽에 있습니다. 또한 현재 뷰를 나타내므로 해당 뷰의 모양도 변경됩니다. 예를 들어 기본 **열 보기** 보기에서 다음이 표시됩니다.
...
* **페이지 편집기**
  ...
  페이지를 처음 편집하면 일련의 슬라이드가 페이지 편집기를 소개합니다.
...
일부 창은 공간이 제한되어 있으므로 도구 모음이 사용할 수 있는 공간보다 바로 길어질 수 있습니다. 이 경우 추가 옵션이 나타납니다. 생략 부호(세 점 또는 **..**)를 클릭하거나 탭합니다. 나머지 모든 작업을 포함하는 드롭다운 선택기를 엽니다. 예를 들어 **사이트** 콘솔에서 페이지를 선택하면 다음이 수행됩니다.
...
* 썸네일을 탭하거나 클릭하면 리소스가 선택됩니다.
  ...
  * 페이지 언어
  * 게시 세부 정보
  * [페이지 설정/해제 시간](/help/sites-authoring/editing-page-properties.md#on-off-time)(설정된 경우)
...
* [보기] 단추 아래에 있는 **보기 설정** 옵션을 사용하여 표시할 열을 선택하십시오. 다음 열이 표시될 수 있습니다.
  ...
  * **수정됨** - 마지막 수정 일자 및 수정자
    * 마지막 게시 이후 페이지가 업데이트된 경우 열 항목에 경고 아이콘이 배지로 지정됩니다.
    * ![마지막 게시 이후 수정됨](assets/modified.png)
  * **게시됨** - 게시 상태
    * 페이지에 [설정/해제 시간](/help/sites-authoring/editing-page-properties.md#on-time)이 설정되어 있으면 열 항목에 시계 아이콘으로 배지가 지정됩니다.
    * 자세한 내용을 보려면 아이콘 위로 마우스를 가져갑니다.
    * ![설정 해제 시간](assets/on-off-time.png)
  * **템플릿** - 페이지의 기반이 되는 템플릿
...
* [선택한 항목과 관련된 다양한 이벤트 보기](#timelineviewevents)
  ...
  * 드롭다운 목록에서 이벤트 유형을 선택할 수 있습니다.
    ...
    * 주석
    * 편집 및 게시를 포함한 활동
      * 페이지에 [설정/해제 시간](/help/sites-authoring/editing-page-properties.md#on-off-time)이 설정되어 있고 현재 시간이 설정/해제 시간 창을 벗어난 경우 잘못된 페이지 활동이 표시될 수 있습니다.
      * 이는 페이지가 유효성 창을 벗어났음을 나타낼 뿐 페이지 게시가 취소되었을 필요는 없습니다.
