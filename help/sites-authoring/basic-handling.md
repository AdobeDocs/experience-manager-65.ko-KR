...
* **[도구](/help/sites-authoring/basic-handling.md#tools-panel)** 해머로 표시
...
위치 [카드 보기](#cardviewquickactions) 특정 작업은 빠른 작업 아이콘으로 사용할 수 있을 뿐만 아니라 도구 모음에 있습니다. 빠른 작업 아이콘은 한 번에 하나의 항목에 사용할 수 있으므로 미리 선택하지 않아도 됩니다.
...
* 카드 보기에는 현재 수준의 각 항목에 대한 정보 카드가 표시됩니다. 이는 다음과 같은 정보를 제공합니다.
   ...
   * 필요한 경우 워크플로우의 일부로 작업을 수행해야 합니다.
      ...
      * 필요한 작업을 나타내는 마커는 의 항목과 관련될 수 있습니다. [받은 편지함](/help/sites-authoring/inbox.md).
...
* [보기] 버튼 아래에 있는 **보기 설정** 옵션을 사용하여 표시할 열을 선택합니다. 다음 열을 표시할 수 있습니다.
   ...
   * **페이지에서 보낸 시간**
   ...
   기본적으로 페이지 URL 부분을 구성하는 **이름** 열이 표시됩니다. 일부 경우 작성자는 다른 언어로 된 페이지에 액세스해야 하며 작성자가 페이지의 언어를 모르는 경우 페이지 이름(일반적으로 변경되지 않음)을 확인하면 도움이 될 수 있습니다.
...
>
>다음을 참조하십시오. [키보드 단축키](/help/sites-authoring/keyboard-shortcuts.md) 추가 정보.
