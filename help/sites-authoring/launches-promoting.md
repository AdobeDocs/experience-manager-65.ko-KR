---
title: 론치 홍보
description: 게시하기 전에 컨텐츠를 소스(프로덕션)로 다시 이동하도록 론치 페이지를 프로모션합니다.
...
1. 과 함께 [중첩 론치 만들기](#creatinganestedlaunchlaunchwithinalaunch)로 이동하고 **론치** 콘솔 또는 **참조** 레일.
1. **론치 홍보**&#x200B;를 선택하여 마법사를 엽니다.
...
어떤 소스로도 홍보할 수 있습니다.
      ...
      * **프로모션 후 실행 삭제**
홍보 후 선택한 론치와 론치 내에 중첩된 론치가 삭제됩니다.
   * **범위**
