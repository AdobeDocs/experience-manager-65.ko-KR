...
1. [세그멘테이션 콘솔](http://localhost:4502/miscadmin#/etc/segmentation)을 **&lt;host>:&lt;port>/miscadmin#/etc/segmentation**&#x200B;에서 엽니다.
1. 새 페이지를 만들고 제목을 입력합니다(예: **AC 세그먼트**). **세그먼트(Adobe Campaign)** 템플릿).
...
1. 트레이트를 두 번 클릭하고, 이 경우 Adobe Campaign에 정의된 남성 세그먼트(예: **MALE**)를 나타내는 ID를 입력하고 **OK**&#x200B;을 클릭합니다. 다음 메시지가 나타납니다.*`targetData.segmentCode == "MALE"`*
...
1. **사이트**&#x200B;에서 **캠페인** 폴더로 이동합니다(예: We.Retail).
...
1. **페이지 만들기**&#x200B;를 클릭하고 페이지 제목을 입력(예: 남성 세그먼트에 대한 경험을 만드는 동안 남성)하고 **경험** 템플릿 선택)하여 세그먼트에 대한 경험을 만듭니다.
1. 만든 경험 페이지를 엽니다.
...
1. 타깃팅된 컨텐츠가 있는 뉴스레터 만들기:Geometrixx Outdoors의 이메일 캠페인 아래에서 **만들기** > **페이지**&#x200B;를 클릭하거나 탭하고 Adobe Campaign 메일 템플릿 중 하나를 선택합니다.

   ![chlimage_1-188](assets/chlimage_1-188.png)

1. 뉴스레터에서 [텍스트 및 개인화] 구성 요소를 추가합니다.
1. &quot;기본값입니다&quot;와 같은 텍스트를 [텍스트 및 개인화] 구성 요소에 추가합니다.
1. **편집** 옆의 화살표를 클릭하고 **타게팅**&#x200B;을 선택합니다.
