...
* 페이지가 이동되면 이동 전에 만든 버전과 더 이상 차이를 수행할 수 없습니다.
   ...
   * 차이 문제가 발생하는 경우 다음을 확인하십시오. [타임라인](/help/sites-authoring/basic-handling.md#timeline) 를 사용하여 페이지가 이동되었는지 여부를 확인할 수 있습니다.
...
>[!NOTE]
>
>페이지 차이 메커니즘 작업 및 페이지 차이에 영향을 줄 수 있는 제한 사항에 대한 자세한 내용은 다음을 참조하십시오. [개발자 설명서](/help/sites-developing/pagediff.md) 을 참조하십시오.
