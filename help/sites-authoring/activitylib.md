...
활동 콘솔 을 사용하여 마케팅을 만들고, 구성하고, 관리할 수 있습니다 [활동](/help/sites-authoring/personalization.md#activities) 브랜드 중:
...
>
>* 다음과 같은 경우 **xt_only** 옵션: **아님** Adobe Target 테넌트(클라이언트 코드)에서 활성화한 다음 **모두** AEM의 XT 및 A/B 활동.
>
...
1. 활동을 만들 브랜드를 클릭하거나 탭하고, 을 클릭하거나 탭합니다 **만들기** 그런 다음 **활동 만들기**. 편집 중인 경우 활동을 선택한 다음 을 클릭하거나 탭합니다 **편집**.
