...
1. 활동을 만들 브랜드를 클릭하고 **만들기** 그런 다음 **활동 만들기**. 편집할 경우 활동을 선택한 다음 을 클릭합니다. **편집**.
1. 다음 정보를 입력한 다음 **다음**:
...
1. 게시하려면 **게시**. 게시를 취소하려면 **게시 취소**. 활동이 게시되거나 게시 취소되고, 활동 콘솔에서 활동 상태가 변합니다(새로 고침이 필요할 수 있음).
...
1. 위치 **개인화**, 클릭 **활동** 을 클릭하여 다음 위치로 이동합니다. **활동** 콘솔.
1. 활동을 보려는 브랜드를 클릭합니다.
1. 활동을 선택하고 **속성 보기** 을(를) 클릭하고 **보고서** 을(를) 탭하고 성능을 확인하거나 우승 경험을 전환할 활동을 선택합니다. 성능 데이터가 표시됩니다.

   ![chlimage_1-115](assets/chlimage_1-115.png)

1. 다음을 클릭합니다. **우승자 푸시** 링크를 클릭하여 해당 경험을 기본 경험으로 푸시할 수 있습니다.
...
1. 클릭 **예** 우승자를 전환할지 확인하려면 현재 경험을 비활성화하고 우승 경험의 콘텐츠로 바꿉니다.
