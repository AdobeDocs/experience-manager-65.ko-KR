...
1. 템플릿을 선택하고 을(를) 클릭합니다. **다음**. 표준 프로젝트 템플릿에 대해 자세히 알 수 있습니다 [여기 있습니다.](/help/sites-authoring/projects.md#project-templates)

   ![프로젝트 만들기 마법사](assets/create-project-wizard.png)

1. 을(를) 정의합니다 **제목** 및 **설명** 그리고 **축소판** 필요한 경우 이미지를 선택합니다. 사용자와 사용자가 속한 그룹을 추가하거나 삭제할 수도 있습니다.
