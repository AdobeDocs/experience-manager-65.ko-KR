...
1. 템플릿을 선택합니다. 즉시 제공되는 단순 프로젝트, 미디어 프로젝트, [번역 프로젝트](/help/sites-administering/tc-manage.md) 및 [제품 사진 촬영 제품](/help/sites-authoring/managing-product-information.md)을(를) 사용할 수 있으며 **다음**&#x200B;을 클릭합니다.
