...
* 페이지 버전을 만듭니다.
* 예를 들어 페이지에 대한 변경 내용을 실행 취소하려면 페이지를 이전 버전으로 복원하십시오.
...
* 다음 [타임라인 레일](#creating-a-new-version-timeline)
* 다음 [만들기](#creating-a-new-version-create-with-a-selected-resource) 옵션(리소스를 선택한 경우)
...
1. 를 엽니다. **타임라인** 열.
1. 댓글 필드 옆에 있는 화살표를 클릭/탭하여 옵션을 표시합니다.
...
1. 사용할 수 있는 버전은 다음에 나열됩니다.
   ...
   ![버전 복원 - 폴더 내 모든 페이지 목록](/help/sites-authoring/assets/versions-restore-version-01.png)
...
1. 선택 **현재 항목에 비교**. 다음 [페이지 비교](/help/sites-authoring/page-diff.md) 을 열고 차이점을 표시합니다.
...
>[!TIP]
>
>[타임워프를 론치와 함께 사용하여 향후 상태를 미리 볼 수도 있습니다](/help/sites-authoring/launches.md) AEM 6.5.10.0 이상을 실행하는 경우
...
타임워프는 [모드](/help/sites-authoring/author-environment-tools.md#page-modes) 페이지 편집기의 시작하려면 다른 모드와 마찬가지로 전환하면 됩니다.
