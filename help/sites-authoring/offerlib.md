...
1. 탐색 콘솔에서 **Personalization** > **오퍼**&#x200B;를 클릭합니다.

   ![screen-shot_2019-03-05at124139-1](assets/screen-shot_2019-03-05at124139-1.png)

1. **만들기**&#x200B;를 클릭한 다음 **만들기** **브랜드**&#x200B;를 클릭합니다.
...
1. **오퍼 페이지** 템플릿을 선택한 후 **다음**&#x200B;을 클릭합니다.
1. 오퍼의 제목을 입력하고 선택적으로 오퍼와 연결할 태그를 하나 이상 선택하거나 입력한 다음 **만들기**&#x200B;를 클릭합니다.
1. 확인 대화 상자에서 편집할 오퍼를 열려면 **페이지 열기**&#x200B;를 클릭합니다.
...
1. 오퍼 콘솔에서 오퍼 옆에 있는 아이콘을 클릭하고 **편집**&#x200B;을 클릭합니다.
...
1. 오퍼 콘솔에서 오퍼 옆에 있는 아이콘을 클릭하고 **삭제**&#x200B;를 클릭합니다.

   오퍼를 선택하고 **삭제**&#x200B;를 클릭합니다.

1. 대화 상자가 나타나면 **삭제**&#x200B;를 클릭하여 삭제를 확인합니다.
1. 오퍼가 하나 이상의 경험에서 사용되는 경우 오퍼가 참조되고 있음을 나타내는 대화 상자가 표시됩니다.

   * 오퍼를 삭제하고 경험에서 제거하려면 **강제 삭제**&#x200B;를 클릭하세요.
   * 오퍼를 유지하려면 **취소**&#x200B;를 클릭하세요.
