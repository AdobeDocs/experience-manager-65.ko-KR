...
이메일에 대한 요청을 관리하는 데 도움이 되는 **이메일** 타일은 다음을 시작합니다. **이메일 요청** 워크플로입니다.
...
| 편집자 | 이 역할의 사용자는 프로젝트 콘텐츠를 업로드하고 편집할 수 있습니다. | 프로젝트, 연결된 메타데이터 및 관련 에셋에 대한 읽기 및 쓰기 액세스<br>촬영 목록 업로드, 사진 촬영, 에셋 검토 및 승인 권한<br>에 대한 쓰기 권한 `/etc/commerce`<br>특정 프로젝트에 대한 권한 수정 | `workflow-users` 그룹 |
...
창의적인 프로젝트를 위해 사진작가 등의 추가적인 역할도 제공하고 있다. 이러한 역할을 사용하여 특정 프로젝트의 사용자 지정 역할을 파생시킬 수 있습니다.
