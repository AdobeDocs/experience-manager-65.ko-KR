...
에셋을 페이지에 추가하려면 을 선택하고 필요한 위치로 드래그합니다. 다음과 같은 작업을 수행할 수 있습니다.
...
해당 리소스(예: **사이트** 콘솔의 페이지 또는 **Assets** 콘솔의 에셋)에 대해 [타임라인을 사용하여 선택한 항목에 대한 최근 활동을 표시할 수 있습니다](/help/sites-authoring/basic-handling.md#timeline).
...
페이지 정보 버튼(이퀄라이저 아이콘)에는 마지막 편집과 마지막 게시에 대한 세부 사항을 보여 주는 메뉴가 열립니다. 페이지, 사이트, 인스턴스 및 사용 권한의 특성에 따라 다음 옵션을 사용할 수 있습니다.
...
* 관리자가 [이 옵션을 사용하도록 설정한 경우 [클래식 UI에서 열기](/help/sites-authoring/select-ui.md#switching-to-classic-ui-when-editing-a-page)](/help/sites-administering/enable-classic-ui-editor.md)
...
* [스캐폴딩](/help/sites-authoring/scaffolding.md) - 구조를 공유하지만 내용이 다른 대용량 페이지 집합을 만드는 데 도움이 됩니다.
...
* [미리 보기](/help/sites-authoring/editing-content.md#previewing-pages) - 페이지가 게시 환경에 표시된 대로 해당 페이지를 보거나 컨텐츠의 링크를 사용하여 탐색하는 데 사용됩니다.
