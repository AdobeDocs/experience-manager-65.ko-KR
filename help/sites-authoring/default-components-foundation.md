...
[!NOTE]`jcr:created``cq:lastModified``cq:template`

   * AEM DAM에 있는 디지털 자산을 표시하는 Adobe Experience Manager용의 사용자 지정 회전판 구성 요소를 만들 수 있습니다. 자세한 내용은 [Adobe Experience Manager용 사용자 지정 회전판 구성 요소 만들기[#$tu132]를 참조하십시오.
...
### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu136]를 대신 활용할 것을 권장합니다.
...
AEM JCR에 있는 데이터를 표시하는 사용자 지정 AEM 차트 컨트롤을 만들 수 있습니다. 자세한 내용은 [차트에 Adobe Experience Manager 데이터 표시[#$tu149]를 참조하십시오.![](assets/dc_chart_use.png)

>
>
>

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [컨텐츠 조각 코어 구성 요소[#$tu153]를 대신 활용할 것을 권장합니다.

>
>
>

[!CAUTION]](/help/sites-authoring/content-fragments.md)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu158]를 대신 활용할 것을 권장합니다.
...
### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu163]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_download_use.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu173]를 대신 활용할 것을 권장합니다.
...
>Flash {#flash}
>
>[!CAUTION]](/help/sites-administering/aem-as-portal.md)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu186]를 대신 활용할 것을 권장합니다.
...
### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [이미지 코어 구성 요소[#$tu209]를 대신 활용할 것을 권장합니다.
...
일단 이미지가 업로드되면(그 전은 아님) [즉석 편집](/help/sites-authoring/editing-content.md#edit-content)을 사용하여 이미지를 필요에 따라 자르거나 회전할 수 있습니다.[](/help/sites-authoring/editing-content.md#component-edit-dialog)

![](do-not-localize/chlimage_1-15.png)](assets/chlimage_1-91.png)

[!NOTE]](/help/sites-authoring/editing-content.md#edit-content)

![](do-not-localize/chlimage_1-15.png)즉석 편집기에서는 편집할 때 이미지의 원래 크기와 종횡비를 사용합니다. 높이 및 너비 속성을 지정할 수도 있습니다. 속성에 정의된 모든 크기와 종횡비는 편집 변경 사항을 저장할 때 적용됩니다.
...
>![](do-not-localize/chlimage_1-16.png)](/help/sites-developing/designer.md)
>
[!NOTE]

![](do-not-localize/chlimage_1-16.png)Internet Explorer에서는 업로드의 진행 상태를 모니터링할 수 없습니다.
...
[!NOTE]](/help/sites-authoring/responsive-layout.md)

이 구성 요소는 [HTL(HTML Template Language)[#$tu253]을 사용하여 구현되었습니다.

>


### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [목록 코어 구성 요소[#$tu257]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_list_use.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu295]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/chlimage_1-95.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [컨텐츠 조각 코어 구성 요소[#$tu325]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/chlimage_1-96.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [빠른 검색 코어 구성 요소[#$tu343]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_search_usenotfound.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. [탐색[#$tu378], [언어 탐색[#$tu379] 및 [탐색 표시 코어 구성 요소[#$tu380]를 대신 활용하는 것이 좋습니다.
...
### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [회전 메뉴 코어 구성 요소[#$tu390]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_slideshow_use.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [텍스트 코어 구성 요소[#$tu406]를 대신 활용할 것을 권장합니다.

>


>**표** 구성 요소는 표를 만들고, 채우고, 형식을 지정할 수 있도록 미리 구성되어 있습니다. 이 대화 상자를 사용하면 표를 구성하고 다음 방법 중 하나를 사용하여 컨텐츠를 만들 수 있습니다.
처음부터 새로 만들기****[](/help/sites-authoring/rich-text-editor.md)**[](#text)**
...
![태그 클라우드는 웹 사이트 내에서 컨텐츠에 적용되는 태그들을 그래픽으로 보여 줍니다.](assets/dc_table_use.png)
...
[!CAUTION]](/help/sites-authoring/tags.md)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [텍스트 코어 구성 요소[#$tu432]를 대신 활용할 것을 권장합니다.
...
![chlimage_1-98](assets/chlimage_1-98.png)[](/help/sites-authoring/rich-text-editor.md)****
...
즉석 편집 {#inplace-editing}](assets/dc_text_use.png)
...
[!CAUTION]](/help/sites-authoring/editing-content.md)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [이미지[#$tu448] 및 [텍스트 코어 구성 요소[#$tu449]를 대신 활용할 것을 권장합니다.

>


다음을 구성할 수 있습니다.[](#text)[](#image)
...
[!CAUTION]](assets/dc_textimage_use.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [제목 코어 구성 요소[#$tu474]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_title_use.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu490]를 대신 활용할 것을 권장합니다.
...
비디오[](/help/sites-administering/config-video.md#configuringvideoprofiles)
...
* `FLV`(Flash 비디오)
* 열 {#columns}
* `FLV`열은 AEM의 컨텐츠 레이아웃을 제어하는 메커니즘입니다. 표준 설치에서 2 및/또는 3개의 열을 만들기 위한 구성 요소가 제공됩니다.


## 다음 예제는 사용 중인 2열 구성 요소입니다. 새 구성 요소를 위한 자리 표시자를 사용할 수 있습니다.{#columns}

![dc_columncontroluse](assets/dc_columncontroluse.png)

2열 {#columns-1}

![기본적으로 2개의 동일한 열로 설정되는 열 컨트롤 구성 요소입니다.](assets/dc_columncontroluse.png)
...
## 구성 요소의 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu520]를 대신 활용할 것을 권장합니다.
...
각 양식 구성 요소가 다른 용도로 사용되더라도 비슷한 옵션 및 매개 변수로 구성되는 경우가 많습니다.[](/help/sites-developing/developing-forms.md)

### 양식 구성 요소를 구성할 때, 대화 상자에서 다음 탭을 사용할 수 있습니다.{#settings-common-to-many-form-components}
...
>[!NOTE]다음 탭에서는 필요한 매개 변수를 제공합니다. 필요한 매개 변수는 개별 구성 요소 유형에 따라 달라질 수 있지만 다음을 포함합니다.
**제목 및 텍스트**
...
필수 필드이며 다음 문자만 포함할 수 있습니다.**
   ...
   * **영숫자**
      ...
      * **제목**
      * `_ . / : -`필드에 표시되는 제목입니다. 비워 두면 기본 제목이 표시됩니다.
   * **설명**
...
### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [양식 컨테이너 코어 구성 요소[#$tu581]를 대신 활용할 것을 권장합니다.
...
[!NOTE]](assets/dc_form-1.png)

기초 구성 요소 양식 구성 요소는 다른 기초 구성 요소 양식 구성 요소(예: 단추, 텍스트, 숨김 등)의 사용만 지원합니다. 기초 구성 요소 양식 없이 [코어 구성 요소[#$tu587] 양식 구성 요소를 사용할 수 없으며, 반대의 경우도 마찬가지입니다.
   ...
   * **계정 요청**
      ...
      * **암호를 변경할 때 사용하는 페이지입니다.**
         ...
         * **콘텐츠 저장**
            ...
            **컨텐트 경로**
      * 양식에 포함된 내용을 저장할 컨텐트 경로입니다. 슬래시 `/`로 끝나는 경로를 입력합니다. 즉, 양식을 게시할 때마다 지정된 위치에 새 노드가 만들어집니다(예: /).
**

         * `/forms/feedback/`**

            **데이터 보기...**            `/forms/feedback/`양식 결과에 대한 정보를 Bulk Editor에서 액세스하려면 이 단추를 클릭합니다. 여기에서 정보를 .tsv(탭으로 구분) 파일로 내보낼 수 있습니다(예를 들면 Excel 스프레드시트에서 사용하기 위해).
...
### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [양식 텍스트 코어 구성 요소[#$tu706]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_form_accountname.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [양식 텍스트 코어 구성 요소[#$tu712]를 대신 활용할 것을 권장합니다.
...
Captcha {#captcha}](assets/dc_form_addressfield.png)

[!CAUTION]

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu719]를 대신 활용할 것을 권장합니다.
...
확인란 그룹 {#checkbox-group}](assets/dc_form_captcha.png)

[!CAUTION]

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [양식 옵션 코어 구성 요소[#$tu726]를 대신 활용할 것을 권장합니다.
...
[!NOTE]](assets/dc_form_checkboxgroupuse.png)
...
[!CAUTION]](/help/sites-developing/developing-forms.md#preloading-form-fields-with-multiple-values)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu736]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/chlimage_1-100.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [양식 옵션 코어 구성 요소[#$tu742]를 대신 활용할 것을 권장합니다.
...
[!NOTE]](assets/dc_form_dropdownlistuse.png)
...
### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu752]를 대신 활용할 것을 권장합니다.
...
사용자 지정 업로드 구성 요소를 만들어 파일을 Sling 서블릿에 업로드할 수 있습니다. 자세한 내용은 [Adobe Experience Manager에 파일 업로드[#$tu757]를 참조하십시오.

>


### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [양식 숨김 코어 구성 요소[#$tu761]를 대신 활용할 것을 권장합니다.
...
![양식의 다른 필드 값에 따라 특정 양식 구성 요소를 표시하거나 숨기도록 양식을 사용자 지정할 수도 있습니다. 양식 필드의 표시 여부를 변경하는 방법은 해당 필드가 특정한 조건에서만 필요한 경우에 유용합니다.](assets/dc_form_hiddenfield.png)

>[양식 구성 요소 표시 및 숨기기](/help/sites-developing/developing-forms.md#showing-and-hiding-form-components)를 참조하십시오.
이미지 단추 {#image-button}
[!CAUTION]](/help/sites-developing/developing-forms.md#showing-and-hiding-form-components)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [양식 단추 코어 구성 요소[#$tu770]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_form_imagebutton.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu776]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_form_imageupload.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu782]를 대신 활용할 것을 권장합니다.
...
암호 필드 {#password-field}](assets/dc_form_link.png)

[!CAUTION]

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu789]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_form_password.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu795]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_password_reset.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [양식 옵션 코어 구성 요소[#$tu804]를 대신 활용할 것을 권장합니다.
...
### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [양식 단추 코어 구성 요소[#$tu814]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_form_submitbuttonuse.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소[#$tu822]를 대신 활용할 것을 권장합니다.
...
### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [양식 텍스트 코어 구성 요소[#$tu841]를 대신 활용할 것을 권장합니다.
...
[!CAUTION]](assets/dc_form_text.png)

### 이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [양식 단추 코어 구성 요소[#$tu847]를 대신 활용할 것을 권장합니다.
