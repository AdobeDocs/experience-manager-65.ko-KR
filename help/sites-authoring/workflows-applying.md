...
1. [리소스를](/help/sites-authoring/basic-handling.md#viewingandselectingyourresources) 선택하고 타임라인을 [엽니다](/help/sites-authoring/basic-handling.md#timeline) (또는 타임라인을 연 다음 리소스를 선택합니다).
